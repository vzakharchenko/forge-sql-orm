    ...
    if (stateStore.isLoading) {
        ...
        return(<div>
                ...
                <div className="reset-section">
                    <h2>Reset All</h2>
                    <p>
                        Click the button below to revert all test entities to their initial state.
                        This removes any changes you’ve made during testing.
                    </p>
                    <br/>
                ...
                <br/>
                <p>
                    Use the tabs below to navigate between different examples of optimistic
                    locking. Each tab demonstrates a different versioning approach, along
                    with instructions on how to test the locking behavior.
                </p>
                <br/>
                <Tabs onChange={(index) => console.log('Selected Tab', index + 1)}
                      defaultSelected={1} id="default">
                    <TabList> {
                        UPDATE_TYPES.map(e => {
                            switch (e) {
                    ...
                    <TabPanel>
                        <Panel>
                            <div>
                                ...
                                <p>
                                    This entity does not use any versioning or optimistic locking mechanism.
                                    When two users open the same record in different browser tabs and both make
                                    changes, the last update simply overwrites the previous changes. There is
                                    no conflict detection in place.
                                </p>
                                <h3>How to Test</h3>
                                <ol>
                                    <li>Open this entity’s update form in two separate browser tabs.</li>
                                    <li>In the first tab, change any field and click <strong>Update</strong>.</li>
                                    <li>In the second tab, also change a field and click <strong>Update</strong>.</li>
                                    <li>Both updates will succeed, and the second update will overwrite the first one.
                                    </li>
                                </ol>
                                <br/>
                    ...
                    <TabPanel>
                        <Panel>
                            <div className="entity-section">
                                ...
                                <p>
                                    This entity uses an integer field for optimistic locking. When a user updates
                                    the record, the version number increments. A second user with an outdated
                                    version will encounter an error upon saving.
                                </p>
                                <h3>How to Test</h3>
                                <ol>
                                    <li>Open this entity’s update form in two separate browser tabs.</li>
                                    <li>In the first tab, change any field and click <strong>Update</strong>.
                                        This succeeds and increments the version number.
                                    </li>
                                    <li>In the second tab, attempt to update the record without refreshing.</li>
                                    <li>The update will fail with an optimistic locking error, indicating the record
                    ...
                    <TabPanel>
                        <Panel>
                            <div className="entity-section">
                                ...
                                <p>
                                    This entity uses a datetime field for optimistic locking.
                                    Whenever the record is updated, the date-based version changes. Any subsequent
                                    update with the old date value will fail.
                                </p>
                                <h3>How to Test</h3>
                                <ol>
                                    <li>Open this entity’s update form in two separate browser tabs.</li>
                                    ...
                                    <li>The second update will fail with an optimistic locking error because the
                                        version date has changed.
                                    </li>
                                </ol>
                                <br/>
                    ...
                    <TabPanel>
                        <Panel>
                            <div className="entity-section">
                                ...
                                <p>
                                    This entity uses a timestamp column for optimistic locking. Whenever the record
                                    is updated, the timestamp is refreshed. Any subsequent update attempts with an
                                    outdated timestamp will fail.
                                </p>
                                <h3>How to Test</h3>
                                <ol>
                                    <li>Open this entity’s update form in two separate browser tabs.</li>
                                    <li>In the first tab, modify any field and click <strong>Update</strong>.
                                        This refreshes the timestamp.
                                    </li>
                                    <li>In the second tab, try to update the record without reloading the page.</li>
                                    <li>The second update will fail, indicating that another process has already
                                        changed the record.
                                    </li>
                                </ol>
                                <br/>
