import {
  ...
  u as dr,
  v as fn,
} from "./index-C9eA0WTh.js";
import { a as fe } from "./react-dom-vendor-BO7srUs7.js";
import "./client-core-vendor-B0uy4GXQ.js";
import "./lodash-vendor-CUc-YdNV.js";
function vn(e, t, r) {
...
var bn = "Invariant failed",
  it = (function (e) {
    function t(r) {
      var n;
      return (Te(this, t), (n = vn(this, t)), (n.message = r), n);
    }
    return (
      Re(t, e),
      Pe(t, [
...
function fr() {
  ...
  return (M(e, "There is a matching HTMLElement for selector " + dt.apply(void 0, arguments)), e);
}
function ut(e) {
  var t = e.contextId,
    r = e.draggableId;
...
var Un = Ie(function () {
  ...
  tt = { isLeavingWindow: Symbol("leaving"), isEnteringWindow: Symbol("entering") };
function Bn(e) {
  var t = e.dragLeave;
  return ct() ? t.hasOwnProperty(tt.isLeavingWindow) : !1;
}
(function () {
  ...
  ne.bindAll(
    ...
    [
      ...
      { type: "dragend", listener: n },
      {
        type: "dragenter",
        listener: function (o) {
          (!r.isOverWindow && r.enterCount === 0 && (o[tt.isEnteringWindow] = !0),
            (r.isOverWindow = !0),
            r.enterCount++);
        },
      },
      {
        ...
        listener: function (o) {
          (r.enterCount--,
            r.isOverWindow &&
              r.enterCount === 0 &&
              ((o[tt.isLeavingWindow] = !0), (r.isOverWindow = !1)));
        },
      },
    ],
    { capture: !0 },
...
function Vn(e) {
  ...
  rt.isActive = !0;
  var i = { current: o };
  ze({ event: t, current: o.dropTargets });
  ...
  function u(g) {
    var f = we(g),
      m = Er(g.target) ? Be({ x: f.clientX, y: f.clientY }) : g.target,
      y = n({ target: m, input: f, source: r.payload, current: i.current.dropTargets });
    (y.length && (g.preventDefault(), ze({ event: g, current: y })),
    ...
    [
      ...
      },
      {
        ...
        listener: function (f) {
          ...
          (f.preventDefault(),
            ze({ event: f, current: i.current.dropTargets }),
            l.drop({
              current: i.current,
...
function Qn(e) {
  var t = qn(e);
  return function () {
    (t.usageCount--, !(t.usageCount > 0) && (t.unmount(), nt.delete(e.typeKey)));
  };
}
function Pr(e, t) {
  var r = t.attribute,
...
function Jn(e) {
  ...
  function l(g) {
    var f = ge(Pr(g.element, { attribute: a, value: "true" }), i(g));
    return Ie(f);
  }
  function d(g) {
    var f,
  ...
  function u(g) {
    var f = g.eventName,
      m = g.payload,
      y = Ge(m.location.current.dropTargets),
      b;
    try {
      for (y.s(); !(b = y.n()).done; ) {
        var x,
  ...
  var c = {
    ...
    onDropTargetChange: function (f) {
      var m = f.payload,
        ...
        b = new Set(),
        x = Ge(m.location.previous.dropTargets),
        I;
      try {
        for (x.s(); !(I = x.n()).done; ) {
          var S,
      ...
      var E = Ge(m.location.current.dropTargets),
        j;
      try {
        for (E.s(); !(j = E.n()).done; ) {
          var N,
  ...
  function p(g) {
    ...
    for (var I = Ve(b), S = Ve(x), w = [], h = 0; h < I.length; h++) {
      var A,
        O = I[h],
        T = S[h];
      if (T != null) {
...
var jt = Hn(),
  ...
  $e = st.monitor;
function ua(e) {
  var t = ge(st.registerUsage(), da(e), Pr(e.element, { attribute: "draggable", value: "true" }));
  return Ie(t);
}
function ca(e, t, r) {
  return (
    (t = re(t)),
    Ce(e, Cr() ? Reflect.construct(t, r || [], re(e).constructor) : t.apply(e, r))
  );
}
function Cr() {
  try {
    ...
    a = v.useCallback(
      function (o) {
        ...
        if (i.isDragging) {
          ...
          var l = o.error;
          l instanceof it && o.preventDefault();
        }
      },
      [r],
    );
...
var ga = (function (e) {
  function t() {
    return (Te(this, t), ca(this, t, arguments));
  }
  return (
    Re(t, e),
    Pe(
...
function Ae(e) {
  ...
  var n = t.droppableId === r.droppableId,
    a = r.index > t.index,
    o = n && a;
  return o ? Xe(Xe({}, r), {}, { index: r.index - 1 }) : Xe({}, r);
}
function gt(e) {
...
function Ka() {
  (Se(),
    (at = ne.bindAll(
      ...
      ].concat(Ue(Ar({ onDragEnd: Se }))),
      { capture: !1 },
    )));
}
function Se() {
  var e;
  ((e = at) === null || e === void 0 || e(), (at = null));
}
function Wa() {
  var e;
    ...
    function () {
      return $e({
        ...
        onDragStart: function (o) {
          var i = o.location,
            l = o.source;
          (qe.start({ input: i.current.input }), zt.start());
          var d = l.data;
          M(ve(d));
          var u = d.draggableId,
            c = d.droppableId,
        ...
        onDrag: function (o) {
          var i = o.location;
          (qe.updateInput({ input: i.current.input }), n(i));
        },
        ...
        onDrop: function () {
          (qe.stop(), zt.stop(), t.stopDrag({ reason: "DROP" }));
        },
      });
    },
    [t, r, n],
          ...
          (u(U, J),
            ...
            K &&
              requestAnimationFrame(function () {
                var F = ut({ contextId: p, draggableId: W });
                F && F.focus();
              }));
        }
      },
...
var ot = {
  ...
  home: function (t) {
    ...
    var o = { x: n.x - a.rect.x, y: n.y - a.rect.y },
      ...
      l = i.mainAxis,
      d = i.crossAxis;
    return D(D({}, l.name, o[l.name]), d.name, o[d.name] + _e);
  },
  away: function (t) {
    var r = t.droppable.direction,
    ...
    var o = { x: n.x - a.rect.x, y: n.y - a.rect.y },
      ...
      l = i.mainAxis,
      d = i.crossAxis;
    return D(D({}, l.name, o[l.name] - 0.5 * a.rect[l.style.length]), d.name, o[d.name] + _e);
  },
};
function Ro(e, t) {
  var r,
  ...
  if (t.type === "START_KEYBOARD_DRAG") {
    ...
    return er(
      ...
      te(
        te({}, t.payload),
        {},
        { previewOffset: ot.initial({ draggableDimensions: n, direction: a.direction }) },
      ),
    );
  }
...
function To(e) {
  var t = e.children,
    ...
    w = v.useCallback(
      function (F) {
        ...
        ((y.current = F), (b.current = ut({ contextId: f, draggableId: r })));
      },
      [f, r, c, n, S, I],
    ),
    h = Xr(n),
    A = v.useReducer(Zr, He),
    O = X(A, 2),
    T = O[0],
    E = O[1],
  ...
  (v.useEffect(
    function () {
      if (T.type === "idle" && !o) {
        var F = y.current;
        et(F instanceof HTMLElement);
        var k = b.current;
        return (
          et(k instanceof HTMLElement),
          ne.bindAll(k, [
            {
              type: "keydown",
              listener: function (Q) {
...
function Lo(e) {
  var t = e.children,
    ...
    g = v.useCallback(
      function (b) {
        if (b) {
          var x = ut({ contextId: p, draggableId: a });
          x?.focus();
        }
      },
      [p, a],
...
var rr = ye + 2 * We,
  Yo = Oe({
    ...
    scrollMarginTop: rr,
    scrollMarginBottom: rr + We,
  }),
  zo = Oe({ position: "absolute", top: 0, left: 0 }),
  Go = Oe({ opacity: 0 }),
  Vo = {
  ...
  ti = v.forwardRef(function (e, t) {
    ...
    return v.createElement(
      ...
      se({ ref: t, testId: a }, o, {
        ...
        style: {
          "--_14yez9t": Ne("var(--ds-surface-overlay, ".concat(gn, ")")),
          "--_qzf6oc": Ne(
          ...
          "--_9ksfq": Ne("var(--ds-border-focused, ".concat(un, ")")),
        },
      }),
    );
  }),
...
var ii = (function (e) {
  function t() {
    return (Te(this, t), oi(this, t, arguments));
  }
  return (
    Re(t, e),
    Pe(t, [
...
function gi(e, t, r) {
  return (
    (t = re(t)),
    Ce(e, rn() ? Reflect.construct(t, r || [], re(e).constructor) : t.apply(e, r))
  );
}
function rn() {
  try {
