...
import { g as ur, a as Vs, r as cr, s as nt } from "./client-core-vendor-C8wDqbS4.js";
import { r as Wh } from "./lodash-vendor-DMLdzvRJ.js";
function Kh(e, t) {
...
function kt() {
  if (Rc) return mn;
  ((Rc = 1), Object.defineProperty(mn, "__esModule", { value: !0 }), (mn.BridgeAPIError = void 0));
...
function je() {
  if (Ac) return yn;
  ((Ac = 1), Object.defineProperty(yn, "__esModule", { value: !0 }), (yn.getCallBridge = void 0));
  const e = kt();
  function t(n) {
    return !!n?.callBridge;
  }
...
function jg() {
  if (hl) return Fn;
  ((hl = 1), Object.defineProperty(Fn, "__esModule", { value: !0 }), (Fn.__realtime = void 0));
  const t = (0, je().getCallBridge)(),
...
function Ta(e, t, r) {
  (er(e, jt) || Bo(e, jt, Sr({}, e[jt])), Xg(r) || (e[jt][t] = r));
}
function Gg(e) {
...
var go = { structural: Hg, default: Wg };
function xr(e, t, r) {
  return zv(e)
    ? e
    : Array.isArray(e)
...
var us = qo(mb),
  ...
  kv = Dt(us);
function Va(e) {
  return e.deep === !0 ? xr : e.deep === !1 ? zo : Cb(e.defaultDecorator);
}
function Eb(e) {
  var t;
...
var Pb = {
    ...
    array: function (t, r) {
      var n = Ua(r);
      return (I.useProxies === !1 || n.proxy === !1 ? Ey : gy)(t, Va(n), n.name);
    },
    map: function (t, r) {
      var n = Ua(r);
...
var _l,
  ...
  jb = 1,
  Ib =
    (_l = (wl = ho(function () {}, "name")) == null ? void 0 : wl.configurable) != null ? _l : !1,
...
function xv(e, t, r) {
  ...
  return (I.inBatch--, (I.trackingDerivation = a), Lb(e), va(n), o);
}
function Lb(e) {
  for (
    var t = e.observing_,
...
function $b() {
  if (((I.pendingReactions.length || I.inBatch || I.isRunningReactions) && Z(36), (Pv = !0), io)) {
    var e = No();
...
var Tv = "action",
  ...
  hs = Na(Tv),
  Yb = Na(Hb, { bound: !0 }),
  gs = Na(Mv, { autoAction: !0 }),
  Jb = Na(Wb, { autoAction: !0, bound: !0 });
function Nv(e) {
  var t = function (n, a) {
    ...
    if (Or(n)) return Dt(Na(e ? Mv : Tv, { name: n, autoAction: e }));
  };
  return t;
}
var ut = Nv(!1);
...
function oy(e) {
  ...
  var t = e.useProxies,
    r = e.enforceActions;
  if (
    (t !== void 0 && (I.useProxies = t === Ga ? !0 : t === ny ? !1 : typeof Proxy < "u"),
...
function Oo(e, t) {
  if (typeof e == "object" && e !== null) {
    if (Wo(e)) return (t !== void 0 && Z(23), e[L].atom_);
...
function Cy(e, t) {
  if ((e || Z(29), Hs(e) || Ho(e) || _o(e) || jr(e) || At(e))) return e;
  if (e[L]) return e[L];
  Z(24, e);
}
function bs(e, t) {
...
var Dl,
  Py = ((Dl = No().Iterator) == null ? void 0 : Dl.prototype) || {};
function Xs(e) {
...
function Yy(e) {
  var t = e.bind(this),
    r = ms(this);
  function n() {
    r.reaction || ((r.reaction = Jy(r)), r.mounted || xa.register(this, r, this));
    var a = void 0,
      o = void 0;
    if (
...
var Ka = function (t) {
    return Ss({ perimeter: $m() ? Ca.FEDRAMP_MODERATE : Ca.COMMERCIAL }, t);
  },
  Un = function (t, r) {
    if (!t && !r) return !0;
    if (!t || !r) return !1;
...
function R0() {
  ...
  return ((a.displayName = "ChevronLeftLargeIcon"), (Jn.default = a), Jn);
}
var ad;
function A0() {
  if (ad) return Kn;
...
function D0() {
  ...
  return ((a.displayName = "ChevronRightLargeIcon"), (Qn.default = a), Qn);
}
var sd;
function T0() {
  if (sd) return Xn;
...
function Fp() {
  if (pd) return ea;
  ((pd = 1), Object.defineProperty(ea, "__esModule", { value: !0 }), (ea.bind = void 0));
  function e(t, r) {
    var n = r.type,
      a = r.listener,
      o = r.options;
...
function Rw() {
  return jo && de("platform-dst-react-18-use-id") ? jo() : "uid".concat(Cw());
}
function Aw() {
  if (jo && de("platform-dst-react-18-use-id")) {
    var e = jo();
    return function (t) {
...
function ta(e, t) {
  return Uw(ri("", null, null, "", null, null, 0), e, { length: -e.length }, t);
}
function Ww() {
  return _e;
}
...
function Qw(e) {
  return Kp(uo("", null, null, null, [""], (e = Wp(e)), 0, [0], e));
}
      ...
      case 0:
        switch (m) {
          ...
          case 59:
            E += ";";
          default:
            if ((Xa((S = bd(E, t, r, l, u, a, s, w, (O = []), (_ = []), d)), o), m === 123))
                ...
                switch (f === 99 && xe(E, 3) === 110 ? 100 : f) {
                  ...
                  case 115:
                    uo(
                      ...
                      S,
                      S,
                      n && Xa(bd(e, S, S, 0, 0, a, s, w, a, (O = []), d), _),
                      a,
                      _,
                      d,
                      s,
      ...
      default:
        ...
        switch (((E += ei(m)), m * v)) {
          ...
          case 44:
            ...
            break;
          case 64:
            (Mt() === 45 && (E += lo(Ye())), (f = Mt()), (u = d = Pt((w = E += Zw(co())))), m++);
            break;
          case 45:
            h === 45 && Pt(E) == 2 && (v = 0);
        }
...
function bd(e, t, r, n, a, o, i, s, c, l, u) {
  for (var d = a - 1, f = a === 0 ? o : [""], p = cc(f), h = 0, v = 0, g = 0; h < n; ++h)
    for (var y = 0, m = Pa(e, d + 1, (d = qw((v = i[h])))), w = e; y < p; ++y)
      (w = Gp(v > 0 ? f[y] + " " + m : re(m, /&\f/g, f[y]))) && (c[g++] = w);
  return ri(e, t, r, a === 0 ? ic : s, c, l, u);
}
function ek(e, t, r) {
  return ri(e, t, r, Up, ei(Ww()), Pa(e, 2, -2), 0);
}
function yd(e, t, r, n) {
...
var ok = function (t, r, n) {
  ...
  ik = function (t, r) {
    ...
    do
      switch (Ra(a)) {
        case 0:
          (a === 38 && Mt() === 12 && (r[n] = 1), (t[n] += ok(ze - 1, r, n)));
          break;
        case 2:
          t[n] += lo(a);
          break;
  ...
  ck = function (t) {
    if (!(t.type !== "rule" || !t.parent || t.length < 1)) {
      ...
      if (!(t.props.length === 1 && r.charCodeAt(0) !== 58 && !md.get(n)) && !a) {
        md.set(t, !0);
        for (var o = [], i = sk(r, o), s = n.props, c = 0, l = 0; c < i.length; c++)
...
var wd;
function pk() {
  return (wd || ((wd = 1), (Zi.exports = vk())), Zi.exports);
}
var Qi, kd;
function hk() {
  if (kd) return Qi;
...
var yk = {
  ...
  Sd = function (t, r) {
    switch (t) {
      ...
      case "animationName":
        if (typeof r == "string")
          return r.replace(_k, function (n, a, o) {
            return ((Rt = { name: a, styles: o, next: Rt }), a);
          });
    }
    return yk[t] !== 1 && !Zp(t) && typeof r == "number" && r !== 0 ? r + "px" : r;
  };
function Aa(e, t, r) {
  if (r == null) return "";
  var n = r;
...
var kk = function (t) {
  ...
  Ok = Cc.useInsertionEffect ? Cc.useInsertionEffect : !1,
  Qp = Ok || kk,
  eh = b.createContext(typeof HTMLElement < "u" ? fk({ key: "css" }) : null);
eh.Provider;
var th = function (t) {
  ...
  Ek = th(function (e, t, r) {
    ...
    return (
      ...
      b.createElement(
        b.Fragment,
        null,
        b.createElement(xk, { cache: t, serialized: s, isStringTag: typeof a == "string" }),
        b.createElement(a, c),
      )
    );
  }),
...
var Ak = function (t) {
  ...
  jk = th(function (e, t) {
    ...
    return b.createElement(
      b.Fragment,
      null,
      b.createElement(Ak, { cache: t, serializedArr: r }),
      i,
    );
  });
function nh(e, t) {
...
var sr = jw(),
  ...
  $k = { default: Bs.default, compact: Bs.compact, none: "inherit" },
  Bk = {
    default: "0 ".concat(sr + sr / 4, "px"),
    compact: "0 ".concat(sr + sr / 4, "px"),
    none: "0",
  },
  Fk = { compact: "0 ".concat(sr / 4, "px"), default: "0 ".concat(sr / 4, "px"), none: "0" },
  zk = { default: "middle", compact: "middle", none: "baseline" },
              ...
              se(
                se(
                  se(
                    se(
                      se(
                        se(se({}, t === "default" && qk), t === "primary" && Uk),
                        t === "link" && Vk,
                      ),
                      t === "subtle" && Gk,
                    ),
    ...
    return (
      ...
      Qt(
        ...
        Qt(
          ...
          v ? Qt("span", { css: [Te, Id({ spacing: $ }), Dd(l, r1)] }, v) : null,
          a1(l, [Te, Xk({ spacing: $ })]),
          h ? Qt("span", { css: [Te, Id({ spacing: $ }), Dd(l, n1)] }, h) : null,
          T ? Qt("span", { css: [Qk, Me] }, T) : null,
        ),
      )
    );
  });
  ...
  vc = k.memo(
    k.forwardRef(function (t, r) {
      var n = t.appearance,
        ...
        w = Nw(),
        O = w.mode,
        _ = i1({ children: o, iconBefore: i, iconAfter: s }),
        S = b.useState(!1),
        E = Q(S, 2),
        A = E[0],
        D = E[1],
...
function f1(e, t) {
  if (e.length !== t.length) return !1;
  for (var r = 0; r < e.length; r++) if (!d1(e[r], t[r])) return !1;
  return !0;
}
function v1(e, t) {
  t === void 0 && (t = f1);
  ...
  return k.createElement(
    ...
    k.createElement(
      ...
      k.createElement(
        ...
        p1(_, q, { max: m, ellipsis: A, transform: H }, P),
      ),
      k.createElement(Md, {
        key: "right-navigator",
        component: n.Next,
      ...
      G({ "aria-sort": v(), onClick: y ? void 0 : c, ref: t, "data-testid": u }, d, {
        ...
        style: ra(
          ...
          {},
          {
            ...
            "--_jz8ahf": be("solid 2px ".concat("var(--ds-border-focused, ".concat(Ro, ")"))),
...
function x1() {
  if (qd) return na;
  ((qd = 1), Object.defineProperty(na, "__esModule", { value: !0 }), (na.default = void 0));
  var e = r(wt()),
    t = r(Xo);
  function r(a) {
    return a && a.__esModule ? a : { default: a };
...
function P1() {
  if (Ud) return aa;
  ((Ud = 1), Object.defineProperty(aa, "__esModule", { value: !0 }), (aa.default = void 0));
  var e = r(wt()),
    t = r(Xo);
  function r(a) {
    return a && a.__esModule ? a : { default: a };
...
function I1(e) {
  var t = e.onClose,
    ...
    a = b.useCallback(
      function (i) {
        r || n.current || i.key !== j1 || ((n.current = !0), t(i));
      },
      [t, r],
    ),
...
var D1 = b.createContext(null),
  T1 = b.createContext(null);
function M1() {
  var e = b.useContext(T1);
  return e;
}
function N1(e) {
  var t = e.isOpen,
...
var da = { none: 0, small: 100, medium: 350, large: 700 },
  rs = 0.5,
  L1 = { none: da.none, small: da.small * rs, medium: da.medium * rs, large: da.large * rs },
  $1 = function () {
  ...
  q1 = function (t, r) {
    for (var n = r.concat([]), a = U1(r), o = 0; o < t.length; o++) {
      var i = t[o],
        s = !a[i.key];
      s && n.splice(o + 1, 0, i);
    }
...
var W1 = b.createContext(function () {
  ...
  J1 = { top: "bottom", bottom: "top", left: "right", right: "left" },
  X1 = function (t) {
    var r = t.children,
      n = t.duration,
      a = n === void 0 ? "large" : n,
...
function Ia(e, t) {
  ...
  var r = t,
    ...
    v = r.padding,
    g = v === void 0 ? 0 : v,
    y = mh(typeof g != "number" ? g : _h(g, Fa)),
    m = f === ia ? nO : ia,
    w = e.rects.popper,
    O = e.elements[h ? m : f],
  ...
  if (S) {
    if (o) {
      var $,
        ...
        Qe = H + Me - Ve - St,
        Ce = H + le - Ve,
        et = ba(p ? Do(Y, Qe) : Y, H, p ? kr(j, Ce) : j);
      ((S[O] = et), (B[O] = et - H));
    }
    if (s) {
      var tt,
        ...
        rt = p && zt ? mO(ue, Ie, nr) : ba(p ? ue : Se, Ie, p ? nr : Pe);
      ((S[_] = rt), (B[_] = rt - Ie));
    }
    t.modifiersData[n] = B;
  }
      ...
      p = {
        ...
        forceUpdate: function () {
          if (!f) {
            ...
            if (rf(m, w)) {
              ((u.rects = {
                reference: eS(m, za(w), u.options.strategy === "fixed"),
                popper: gc(w),
              }),
                (u.reset = !1),
...
function US(e) {
  ...
  (I1({ onClose: pt, isDisabled: W === "hide" || W === "fade-out" }),
    b.useEffect(
      function () {
        if (W === "hide") return Ae;
  ...
  var Ie = b.useCallback(
    ...
    Tr = W !== "hide" && !!i,
    xt = !U && Tr,
    qa = W !== "hide" && W !== "fade-out",
    Vh = b.useCallback(function () {
      var N;
      (N = j.current) === null || N === void 0 || N.requestHide({ isImmediate: !0 });
    }, []);
  N1({ isOpen: Tr && qa, onClose: Vh });
  var kc = function () {
      var ie;
  ...
  return k.createElement(
    ...
    typeof t == "function"
      ...
      : k.createElement(qt, G({}, ai, { ref: ye, role: "presentation" }), t, Sc),
    Tr
      ? k.createElement(
          MS,
          { zIndex: FS },
...
var ix = function (t) {
    ...
    var ke = function (Se) {
      ...
      St = function () {
        return Y || (op(o || [], A, m).length > 2 ? Po : R_);
      },
      Ve = function () {
    ...
    return k.createElement(
      ...
      !Ge &&
        Ie &&
        k.createElement(Pp, { isLoading: h, spinnerSize: Po, testId: u, loadingLabel: c }, Ie),
    );
  },
  sx = b.lazy(function () {
    return dm(
      () => import("./body-BwqEiMGI.js"),
