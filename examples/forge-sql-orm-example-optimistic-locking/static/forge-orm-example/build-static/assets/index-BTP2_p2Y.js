...
var x = Wh(),
  b = wt();
const O = ur(b),
  Ec = Gh({ __proto__: null, default: O }, [b]);
var ci = {},
  is = function (e, t) {
    return (
      (is =
...
function _g() {
  return (
    il ||
      ((il = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), Bt.__exportStar(yg(), e));
      })(yi)),
    yi
  );
}
...
var xb = {
    ...
    array: function (t, r) {
      var n = Ua(r);
      return (I.useProxies === !1 || n.proxy === !1 ? Om : vm)(t, Va(n), n.name);
    },
    map: function (t, r) {
      var n = Ua(r);
    ...
    object: function (t, r, n) {
      return Ir(function () {
        return nm(I.useProxies === !1 || n?.proxy === !1 ? fn({}, n) : um({}, n), t, r);
      });
    },
    ref: Dt(_b),
    shallow: Dt(wb),
...
var yl,
  ...
  Pb = 1,
  Rb =
    (yl = (_l = ho(function () {}, "name")) == null ? void 0 : _l.configurable) != null ? yl : !1,
...
function Mv(e) {
  var t = function (n, a) {
    if (yt(n)) return Er(n.name || Gb, n, e);
...
function rm(e) {
  ...
  var t = e.useProxies,
    r = e.enforceActions;
  if (
    (t !== void 0 && (I.useProxies = t === Ga ? !0 : t === em ? !1 : typeof Proxy < "u"),
...
function $v(e) {
  var t = { name: e.name_ };
  return (
    e.observing_ && e.observing_.length > 0 && (t.dependencies = om(e.observing_).map($v)),
    t
  );
}
function om(e) {
...
function um(e, t) {
  ...
  return (
    cv(),
    (e = fn(e, t)),
    (n = (r = e[L]).proxy_) != null ? n : (r.proxy_ = new Proxy(e, lm))
  );
}
function it(e) {
...
var pm = Rr("ObservableArrayAdministration", Ks);
function Wo(e) {
  return $o(e) && pm(e[L]);
}
var hm = {},
    ...
    return (
      ...
      (t.replace = function (n) {
        ...
        return (
          Zt(function () {
            for (
              var o = gm(n), i = new Map(), s = !1, c = Xr(a.data_.keys()), l;
              !(l = c()).done;
...
var mm = Rr("ObservableObjectAdministration", Gv);
function Pl(e) {
  return (
    El[e] ||
    (El[e] = {
    ...
    return (
      ...
      Ir(function () {
        ...
        ((c.proxy_ = s),
          ...
          _m && Object.defineProperty(s, "0", ym));
      }),
      s
    );
  }
...
function Oo(e, t) {
  ...
  } else if (yt(e) && _o(e[L])) return e[L];
  X(28);
}
function Sm(e, t) {
...
var Il,
  xm = ((Il = No().Iterator) == null ? void 0 : Il.prototype) || {};
function Js(e) {
  return ((e[Symbol.iterator] = Em), Object.assign(Object.create(xm), e));
}
function Em() {
  return this;
}
...
var Am = 1e4,
    ...
    function e(t) {
      ...
      (Object.defineProperty(this, "finalize", {
        ...
        Object.defineProperty(this, "sweep", {
          ...
          writable: !0,
          value: function (n) {
            (n === void 0 && (n = Am), clearTimeout(r.sweepTimeout), (r.sweepTimeout = void 0));
            var a = Date.now();
  ...
  Dm = typeof FinalizationRegistry < "u" ? FinalizationRegistry : Im,
  xa = new Dm(function (e) {
    var t;
...
var Tl;
function Mm() {
  return (Tl || ((Tl = 1), (Ei.exports = Tm())), Ei.exports);
}
var Nm = Mm();
function Ml(e) {
...
function Lm(e, t) {
  ...
  (a.reaction || (Ml(a), xa.register(r, a, a)),
    O.useDebugValue(a.reaction, Rm),
    Nm.useSyncExternalStore(a.subscribe, a.getSnapshot, a.getSnapshot));
  var o, i;
  if (
...
function Bm(e, t) {
  ...
  return (
    ...
    $m && Object.defineProperty(i, "name", { value: e.name, writable: !0, configurable: !0 }),
...
var Fm = { $$typeof: !0, render: !0, compare: !0, type: !0, displayName: !0 };
function zm(e, t) {
  Object.keys(e).forEach(function (r) {
    Fm[r] || Object.defineProperty(t, r, Object.getOwnPropertyDescriptor(e, r));
  });
}
var Ai;
Pm(To.unstable_batchedUpdates);
...
function Gm(e) {
  ...
  return (
    ...
    Vm(t, "componentWillUnmount", function () {
      var i,
        s = ys(this);
...
function Hm(e) {
  var t = e.bind(this),
    r = ys(this);
  function n() {
    r.reaction || ((r.reaction = Wm(r)), r.mounted || xa.register(this, r, this));
    var a = void 0,
      o = void 0;
    if (
...
function Vl(e, t) {
  return this.state !== t ? !0 : !qm(this.props, e);
}
function Yo(e, t) {
  return (
    e.isMobxInjector === !0 &&
...
var Jm = Object.defineProperty,
  ...
  Ee = (e, t, r, n) => {
    for (var a = n > 1 ? void 0 : n ? Xm(t, r) : t, o = e.length - 1, i; o >= 0; o--)
      (i = e[o]) && (a = (n ? i(t, r, a) : i(a)) || a);
    return (n && a && Jm(t, r, a), a);
  };
const ji = "Loading ...";
class Oe {
  constructor() {
...
var Wa = "@all-features",
  Dy = (function () {
    function e() {
      (ve(this, e), C(this, "eventToValue", new Map()), (this.emitter = new Iy()));
    }
    return pe(e, [
      {
        key: "onGateUpdated",
...
var Ka = function (t) {
    return Ss({ perimeter: My() ? Ca.FEDRAMP_MODERATE : Ca.COMMERCIAL }, t);
  },
  Un = function (t, r) {
    if (!t && !r) return !0;
    if (!t || !r) return !1;
  ...
  $y = Object.entries(Zs).map(function (e) {
    var t = Z(e, 2),
      r = t[0],
      n = t[1];
...
function Es(e) {
  ...
  return (
    (Es = function (n) {
      ...
      function a() {
        return Fy(n, arguments, J(this).constructor);
      }
      return (
...
var Uy = 5e3,
  Vy = "https://api.atlassian.com/flags",
  Gy = "https://api.stg.atlassian.com/flags",
  Hy = "https://api.dev.atlassian.com/flags",
  Wy = "https://api.stg.atlassian-us-gov-mod.com/flags",
  Ky = "https://api.atlassian-us-gov-mod.com/flags",
  Yy = "https://atlassian-statsig-proxy-archetype.atl-paas.%s.atl-ic.net",
  Jy = "oasis-stg.com/flags",
  Xy = "atlassian-isolated.net/flags",
  Zy = "/gateway/api/flags",
  Gi = (function () {
    function e() {
      ve(this, e);
    }
    return pe(e, null, [
      ...
      },
      {
        ...
        value: function (r) {
          ...
          if (n === void 0) return r ? Yy.replace("%s", r) : null;
          var a = n.protocol,
            o = n.hostname,
            i = o.match(/([^.]+)\.oasis-stg\.com$/);
          if (i) return "".concat(a, "//api.").concat(i[1], ".").concat(Jy);
          var s = o.match(/([^.]+)\.atlassian-isolated\.net$/);
          return s ? "".concat(a, "//api.").concat(s[1], ".").concat(Xy) : null;
        },
      },
      {
...
var t_ = (function (e) {
  function t() {
    ...
    return (
      ve(this, t),
      (r = Qy(this, t, ["NoFetchDataAdapter", "nofetch"])),
...
var Fr,
  ...
  p_ = mp ? Qs.ENABLE_PLATFORM_FF === "true" : !1,
  h_ = mp ? Qs.STORYBOOK_ENABLE_PLATFORM_FF === "true" : !1,
  g_ = p_ || h_,
...
var Q_ = (function (e) {
  ...
  e0 = U_(
    O.forwardRef(function (e, t) {
      return O.createElement(Q_, W({}, e, { forwardedRef: t }));
    }),
  );
function t0(e, t, r) {
  return (
    ...
    pe(t, [
      {
        ...
        value: function () {
          ...
          return O.createElement(
            i0,
            { testId: c },
            o ? O.createElement(s0, { contentsOpacity: s, testId: c }, a) : a,
            o &&
              O.createElement(
                c0,
                { testId: c },
...
var Kn = {},
  ...
  Xu = b.memo(function (t) {
    var r,
      ...
      m = n.name,
      _ = f ? { __html: f } : void 0;
    if (d && !be("platform-visual-refresh-icons"))
    ...
    return b.createElement(
      ...
      b.createElement("svg", {
        ...
        className: R([
          ...
          p ? "_1bsb1kw7 _4t3i1kw7" : w === "utility" ? m0[g] : k === "small" ? b0[g] : g0[g],
        ]),
      }),
    );
  });
  ...
  so = b.memo(
    b.forwardRef(function (e, t) {
      var r = e.as,
        ...
        g = e.children,
        m = Q(e, X0),
        _ = typeof f == "string" ? b.createElement(Z0, null, f) : f,
        w = _
...
var mw = function () {
  ...
  $p = function (e) {
    return (e === void 0 && (e = ""), { value: 1, prefix: e, uid: mw() });
  },
  yw = $p(),
  ...
  Xi,
  jo = (Xi = O.useId) !== null && Xi !== void 0 ? Xi : void 0;
function Ew() {
  return jo && be("platform-dst-react-18-use-id") ? jo() : "uid".concat(Sw());
}
function Cw() {
  if (jo && be("platform-dst-react-18-use-id")) {
    var e = jo();
    return function (t) {
      ...
      default:
        ...
        switch (((E += ei(_)), _ * v)) {
          ...
          case 44:
            ...
            break;
          case 64:
            (Mt() === 45 && (E += lo(Ye())), (f = Mt()), (u = d = Pt((w = E += Yw(co())))), _++);
            break;
          case 45:
            h === 45 && Pt(E) == 2 && (v = 0);
        }
...
var hk = {
  ...
  es = tk(function (e) {
    return Yp(e) ? e : e.replace(gk, "-$&").toLowerCase();
  }),
  Od = function (t, r) {
    switch (t) {
      case "animation":
    ...
    return hk[t] !== 1 && !Yp(t) && typeof r == "number" && r !== 0 ? r + "px" : r;
  };
function Aa(e, t, r) {
  if (r == null) return "";
  var n = r;
...
var yk = function (t) {
  ...
  Jp = _k || yk,
  Xp = b.createContext(typeof HTMLElement < "u" ? lk({ key: "css" }) : null);
Xp.Provider;
var Zp = function (t) {
    ...
    se(
      se(
        se(
          ...
          !be("platform-component-visual-refresh") && s,
        ),
        {},
        {
          cursor: "pointer",
        ...
        !be("platform-component-visual-refresh") &&
          se(
            se(
              {
                "&:visited": se({}, s),
...
var Fd = "--local-dynamic-table-text-color",
  ...
  oh = b.forwardRef(function (e, t) {
    var r = e.width,
      ...
      g = n ? "th" : "td",
      m = be("platform-component-visual-refresh");
    return b.createElement(
      g,
...
function R1(e) {
  ...
  b.useEffect(
    function () {
      if (!(r && be("platform_only_attach_escape_handler_on_view")))
        return Qo.bindAll(
          document,
          [
...
function Ia(e, t) {
  ...
  var r = t,
    ...
    v = r.padding,
    g = v === void 0 ? 0 : v,
    m = gh(typeof g != "number" ? g : bh(g, Fa)),
    _ = f === ia ? eO : ia,
    w = e.rects.popper,
    k = e.elements[h ? _ : f],
  ...
  if (S) {
    if (o) {
      var $,
        ...
        Te = fe[U],
        ke = ba(0, E[F], de[F]),
        Me = w ? E[F] / 2 - V - ke - me - P.mainAxis : he - ke - me - P.mainAxis,
...
function IS(e) {
  ...
  return (
    jS(r),
    be("platform_design_system_team_portal_logic_r18_fix")
...
var LS = Rw.tooltip(),
  ff = { componentName: "tooltip", packageName: "@atlaskit/tooltip", packageVersion: "20.4.2" },
...
function FS(e) {
  ...
  var Ie = b.useCallback(
    ...
    ue = b.useCallback(
      function (N) {
        try {
          if (!N.target.matches(":focus-visible") && be("platform-tooltip-focus-visible-new"))
            return;
        } catch {}
        Ge({ type: "keyboard" });
      },
      ...
      pe(t, [
        {
          ...
          value: function () {
            ...
            var o = n.refWidth,
              i = Q(n, qS),
              s = op(a, o);
            return O.createElement(Rh, W({ inlineStyles: s }, i));
          },
        },
      ])
    );
            ...
            return O.createElement(
              ...
              O.createElement(
                ...
                g.map(function (_, w) {
                  ...
                  return be("platform-component-visual-refresh")
                    ? O.createElement(
                        v,
                        W(
                          {
...
var nx = function (t) {
    ...
    var ke = function (Se) {
      ...
      St = function () {
        return Y || (ap(o || [], A, _).length > 2 ? Po : E_);
      },
      Ve = function () {
        return h ? O.createElement($_, { testId: u }) : D && O.createElement(B_, { testId: u }, D);
      },
      Qe = o && o.length,
      Ce,
      et = !1;
    ...
    return O.createElement(
      ...
      !Ge &&
        Ie &&
        O.createElement(Cp, { isLoading: h, spinnerSize: Po, testId: u, loadingLabel: c }, Ie),
    );
  },
  ax = b.lazy(function () {
    return cy(
      () => import("./body-Ds4VYaCa.js"),
  ...
  ox = b.forwardRef(function (t, r) {
    ...
    var v = O.createElement(e0, W({ ref: r }, l));
    return u && p
      ? O.createElement(
          r0,
          { fallback: v },
...
var gx = [
  ...
  mx = O.forwardRef(function (e, t) {
    var r = e.appearance,
      ...
      ue =
        Dr && be("platform-component-visual-refresh") ? "subtle" : r || ne?.appearance || "default",
      nr = ne?.spacing || S,
      rt = ne?.isDisabled || i,
      qt = !rt && !c,
      Tr = rt || c,
      ...
      W(
        ...
        qa,
        {
          ...
          xcss: Dp(
            De.base,
            ue === "default" &&
              (be("platform-component-visual-refresh") ? Kr.rootRefreshed : Kr.root),
            ue === "default" &&
              qt &&
              (be("platform-component-visual-refresh") ? Kr.interactiveRefreshed : Kr.interactive),
            ue === "primary" && gf.root,
            ...
            ue === "subtle" &&
              (be("platform-component-visual-refresh") ? eo.rootRefreshed : eo.root),
            ue === "subtle" &&
              qt &&
              (be("platform-component-visual-refresh") ? eo.interactiveRefreshed : eo.interactive),
            De.linkDecorationUnset,
            xt && (be("platform-component-visual-refresh") ? yr.rootRefreshed : yr.root),
            ...
            rt && De.disabled,
            rt &&
              (!be("platform-component-visual-refresh") || (ue !== "default" && ue !== "subtle")) &&
              De.sharedDisabled,
            rt &&
              ue === "default" &&
              (be("platform-component-visual-refresh") ? Kr.disabledRefreshed : Kr.disabled),
            h && !Pe && De.circle,
...
var _f = function (t) {
    var r = t.icon,
      ...
      a = {
        label: "",
        color: "currentColor",
        size: be("platform_dst_button_chevron_sizing")
          ? function (o) {
...
var Sx = { componentName: "tabs", packageName: "@atlaskit/tabs", packageVersion: "18.1.6" },
  kf = function (t) {
    var r = t.tabPanel,
      n = t.index,
      a = t.isSelected,
