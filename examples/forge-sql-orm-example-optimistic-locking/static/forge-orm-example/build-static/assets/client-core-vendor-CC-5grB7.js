...
function kn(e) {
  ...
  return (
    ...
    Object.keys(e).forEach(function (f) {
      var v = Object.getOwnPropertyDescriptor(e, f);
    ...
    st ||
      ...
      (function (e) {
        ...
        class b {
          ...
          static warn(...h) {
            b.level >= e.LogLevel.Warn && console.warn(f, ..._(h));
          }
          static error(...h) {
            b.level >= e.LogLevel.Error && console.error(v, ..._(h));
          }
        }
  ...
  return (
    ct ||
      ...
      (function (e) {
        ...
        e._DJB2 = c;
        const f = (_, b) => (0, e._DJB2)(JSON.stringify((0, e._getSortedObject)(_, b)));
        e._DJB2Object = f;
        const v = (_, b) => {
...
function Ie() {
  ...
  function y(f, v, _) {
    ...
    const E = v && v.customIDs ? v.customIDs : {},
      h = [
        `uid:${(b = v == null ? void 0 : v.userID) !== null && b !== void 0 ? b : ""}`,
        `cids:${Object.keys(E)
  ...
  function c(f, v, _) {
    return v ? y(f, v, _) : (0, e._DJB2)(`k:${f}`);
  }
    ...
    gt ||
      ...
      (function (e) {
        ...
        const c = () => {
          ...
          return (h = a == null ? void 0 : a.document) !== null && h !== void 0 ? h : null;
        };
        ...
        const v = (h, a) => {
          ...
          typeof (l == null ? void 0 : l.addEventListener) == "function" &&
            l.addEventListener(h, a);
        };
...
function Ht() {
  ...
  const h = (l, r, i, o) => {
    ...
    const w = r.__evaluation,
      d =
        ((n = w == null ? void 0 : w.explicit_parameters) === null || n === void 0
          ? void 0
          : n.includes(i)) === !0;
    let m = "",
      D =
        (t = w == null ? void 0 : w.undelegated_secondary_exposures) !== null && t !== void 0
          ? t
          : [];
    d &&
    ...
    const k = (g = r.__evaluation) === null || g === void 0 ? void 0 : g.parameter_rule_ids,
      C = {
        config: r.name,
        parameterName: i,
        ruleID: (s = k == null ? void 0 : k[i]) !== null && s !== void 0 ? s : r.ruleID,
...
function Qt() {
  if (yt) return he;
  (yt = 1), Object.defineProperty(he, "__esModule", { value: !0 }), (he.UrlConfiguration = void 0);
  const e = ge(),
    y = Ce(),
    c = {
  ...
  return (he.UrlConfiguration = f), he;
}
var qe = {},
  mt;
function Ze() {
    ...
    mt ||
      ...
      (function (e) {
        ...
        (e._notifyVisibilityChanged = l),
          ...
          (0, y._addWindowEventListenerSafe)("blur", () => (0, e._notifyVisibilityChanged)(f)),
          (0, y._addDocumentEventListenerSafe)("visibilitychange", () => {
            (0, e._notifyVisibilityChanged)(document.visibilityState === "visible" ? c : f);
          }),
          (0, y._addWindowEventListenerSafe)((0, y._getUnloadEvent)(), () => {
            (b = !0), (0, e._notifyVisibilityChanged)(f);
          });
      })(qe)),
    qe
  );
  ...
  var e =
    ...
    function (w, d, m, D) {
      ...
      return new (m || (m = Promise))(function (C, L) {
        ...
        function x(B) {
          B.done ? C(B.value) : k(B.value).then(U, W);
        }
  ...
  let p = class _e {
    ...
    constructor(d, m, D, k) {
      ...
      (this._sdkKey = d),
        ...
        (this._loggingEnabled =
          (C = k == null ? void 0 : k.loggingEnabled) !== null && C !== void 0
            ? C
            : (k == null ? void 0 : k.disableLogging) === !0
        ...
        (this._maxQueueSize =
          (L = k == null ? void 0 : k.loggingBufferMaxSize) !== null && L !== void 0 ? L : r);
      const U = k == null ? void 0 : k.networkConfig;
      this._logEventUrlConfig = new a.UrlConfiguration(
        v.Endpoint._rgstr,
        U == null ? void 0 : U.logEventUrl,
        U == null ? void 0 : U.api,
        U == null ? void 0 : U.logEventFallbackUrls,
      );
    }
      ...
      return e(this, void 0, void 0, function* () {
        ...
        try {
          ...
          return (
            ...
            (C ? yield this._sendEventsViaBeacon(d) : yield this._sendEventsViaPost(d)).success
              ? (this._emitter({ name: "logs_flushed", events: d }), !0)
              : (f.Log.warn("Failed to flush events."), this._saveFailedLogsToStorage(d), !1)
          );
        } catch {
          return f.Log.warn("Failed to flush events."), !1;
        }
      });
    }
    _sendEventsViaPost(d) {
      ...
      return e(this, void 0, void 0, function* () {
        const D = yield this._network.post(this._getRequestData(d)),
          k = (m = D == null ? void 0 : D.code) !== null && m !== void 0 ? m : -1;
        return { success: k >= 200 && k < 300 };
      });
    }
    _sendEventsViaBeacon(d) {
      return e(this, void 0, void 0, function* () {
        return { success: yield this._network.beacon(this._getRequestData(d)) };
      });
    }
    _getRequestData(d) {
      return {
    ...
    _saveFailedLogsToStorage(d) {
      ...
      try {
        ...
        f.Log.warn("Unable to save failed logs to storage");
      }
    }
    _retryFailedLogs(d) {
      const m = this._getStorageKey();
      e(this, void 0, void 0, function* () {
        ...
        f.Log.warn("Failed to flush stored logs");
      });
    }
    _getStorageKey() {
    ...
    _normalizeAndAppendEvent(d) {
      ...
      f.Log.debug("Enqueued Event:", k), this._queue.push(k);
    }
...
function Re() {
  ...
  function l(n) {
    const t = h(n);
    return (0, f._getObjectFromStorage)(t);
  }
  function r(n) {
...
function Yt() {
  ...
  return (ne._getFullUserHash = f), ne;
}
var Se = {},
  kt;
function Zt() {
  ...
  function y(c, f, v) {
    try {
      ...
      if (_ && typeof _ == "object" && f in _) return _;
    } catch {}
...
function an() {
  ...
  let E = class {
    ...
    getDataSync(i) {
      const o = i && (0, f._normalizeUser)(i, this._options),
        n = this._getCacheKey(o),
        t = this._inMemoryCache.get(n, o);
      if (t) return t;
      const u = this._loadFromCache(n);
      return u ? (this._inMemoryCache.add(n, u), this._inMemoryCache.get(n, o)) : null;
    }
    setData(i, o) {
      const n = o && (0, f._normalizeUser)(o, this._options),
    ...
    _prefetchDataImpl(i, o) {
      return e(this, void 0, void 0, function* () {
        const n = i && (0, f._normalizeUser)(i, this._options),
          t = this._getCacheKey(n),
    ...
    _fetchAndPrepFromNetwork(i, o, n) {
      var t;
      return e(this, void 0, void 0, function* () {
        const u = (t = i == null ? void 0 : i.data) !== null && t !== void 0 ? t : null,
        ...
        const p = (0, _._typedJsonParse)(s, "has_updates", "Response"),
          ...
          d = c.StableID.get(w);
        let m = null;
        if ((p == null ? void 0 : p.has_updates) === !0) m = h("Network", s, d, o);
        else if (u && (p == null ? void 0 : p.has_updates) === !1)
          m = h("NetworkNotModified", u, d, o);
        else return null;
  ...
  function h(r, i, o, n) {
    return {
      ...
      receivedAt: Date.now(),
      stableID: o,
      fullUserHash: (0, f._getFullUserHash)(n),
    };
  }
  J._makeDataAdapterResult = h;
  class a {
    constructor() {
      this._data = {};
    }
    get(i, o) {
      ...
      const t = this._data[i],
        u = t == null ? void 0 : t.stableID,
        g = (n = o == null ? void 0 : o.customIDs) === null || n === void 0 ? void 0 : n.stableID;
      return g && u && g !== u
...
var $e = {},
  It;
function ln() {
  return It || ((It = 1), Object.defineProperty($e, "__esModule", { value: !0 })), $e;
}
var be = {},
  pe = {},
  Ct;
function tt() {
  ...
  return (
    (pe.SDKType = {
      _get: (c) => {
        var f;
        return ((f = e[c]) !== null && f !== void 0 ? f : "js-mono") + (y ?? "");
      },
      _setClientType(c, f) {
        e[c] = f;
      },
            ...
            try {
              c.Log.warn(`Caught error in ${i}`, { error: o }),
                y(this, void 0, void 0, function* () {
                  ...
                  const L = f.SDKType._get(this._sdkKey),
        ...
        function a(r) {
          ...
          for (; o && o !== Object.prototype; )
            Object.getOwnPropertyNames(o)
              .filter((n) => typeof (o == null ? void 0 : o[n]) == "function")
              .forEach((n) => i.add(n)),
...
var Ge = {},
  Rt;
function un() {
  return Rt || ((Rt = 1), Object.defineProperty(Ge, "__esModule", { value: !0 })), Ge;
}
var Ve = {},
  Mt;
function cn() {
...
function _n() {
  ...
  function b(E) {
    const h = E.findIndex(
      (l, r) =>
        r < v && String.fromCharCode(l) === "=" && f.includes(String.fromCharCode(E[r - 1])),
    );
    if (h === -1) {
...
function gn() {
  ...
  let E = class {
    ...
    _pickNewFallbackUrl(n, t) {
      ...
      const g = new Set((u = n == null ? void 0 : n.previous) !== null && u !== void 0 ? u : []),
  ...
  z.NetworkFallbackResolver = E;
  function h(o, n) {
    var t;
    const u = (t = o == null ? void 0 : o.toLowerCase()) !== null && t !== void 0 ? t : "";
    return (
      n ||
  ...
  function r(o) {
    ...
    try {
      ...
      return f.Log.error("Failed to parse FallbackInfo"), null;
    }
  }
  function i(o) {
    try {
...
function nn() {
  ...
  return (
    (Ee.SDKFlags = {
      ...
      get: (y, c) => {
        var f, v;
        return (v = (f = e[y]) === null || f === void 0 ? void 0 : f[c]) !== null && v !== void 0
          ? v
          : !1;
      },
    }),
      ...
      (function (e) {
        ...
        function u(s, p) {
          ...
          try {
            ...
            f.Log.warn("Failed to save SessionID");
          }
        }
        function g(s) {
          const p = t(s);
...
function fn() {
  ...
  var e =
    ...
    function (I, S, O, T) {
      ...
      return new (O || (O = Promise))(function (M, P) {
        ...
        function $(A) {
          A.done ? M(A.value) : R(A.value).then(fe, V);
        }
        $((T = T.apply(I, S || [])).next());
      });
    };
  ...
  let m = class {
    ...
    beacon(S) {
      return e(this, void 0, void 0, function* () {
        if (!D(S)) return !1;
        const O = this._getInternalRequestArgs("POST", S);
        yield this._tryToCompressBody(O);
        const T = yield this._getPopulatedURL(O),
          R = navigator;
    ...
    get(S) {
      const O = this._getInternalRequestArgs("GET", S);
    ...
    _sendRequest(S) {
      ...
      return e(this, void 0, void 0, function* () {
        ...
        const { method: P, body: fe, retries: V, attempt: $ } = S,
        ...
        const F = $ ?? 1,
          ...
          ve = yield this._getPopulatedURL(S);
        let G = null;
        ...
        try {
          ...
          if (
            ...
            !V ||
              F > V ||
              !d.has((T = G == null ? void 0 : G.status) !== null && T !== void 0 ? T : 500))
          ) {
          ...
          return (
            yield B(F),
            this._sendRequest(Object.assign(Object.assign({}, S), { retries: V, attempt: F + 1 }))
          );
        }
      });
    }
    _getLogEventCompressionMode(S) {
      let O = S == null ? void 0 : S.logEventCompressionMode;
      return (
        !O &&
          (S == null ? void 0 : S.disableCompression) === !0 &&
          (O = o.LogEventCompressionMode.Disabled),
    ...
    _isRateLimited(S) {
      ...
      const T = Date.now(),
        R =
          (O = this._leakyBucket[S]) !== null && O !== void 0
            ? O
    ...
    _getPopulatedURL(S) {
      var O;
      return e(this, void 0, void 0, function* () {
        const T = (O = S.fallbackUrl) !== null && O !== void 0 ? O : S.urlConfig.getUrl();
        (S.urlConfig.endpoint === v.Endpoint._initialize ||
          S.urlConfig.endpoint === v.Endpoint._download_config_specs) &&
          (this._lastUsedInitUrl = T);
        const R = Object.assign(
            {
              [v.NetworkParam.SdkKey]: S.sdkKey,
              [v.NetworkParam.SdkType]: E.SDKType._get(S.sdkKey),
              [v.NetworkParam.SdkVersion]: i.SDK_VERSION,
              [v.NetworkParam.Time]: String(Date.now()),
              [v.NetworkParam.SessionID]: a.SessionID.get(S.sdkKey),
            },
            S.params,
          ),
          M = Object.keys(R)
        ...
        try {
          (S.body = T.btoa(R).split("").reverse().join("")),
            (S.params = Object.assign(
              Object.assign({}, (O = S.params) !== null && O !== void 0 ? O : {}),
              { [v.NetworkParam.StatsigEncoded]: "1" },
            ));
        } catch (M) {
          f.Log.warn(`Request encoding failed for ${S.urlConfig.getUrl()}`, M);
        }
    }
      ...
      return e(this, void 0, void 0, function* () {
        ...
        if (!(typeof T != "string" || !C(S, this._options)))
          try {
            ...
            P.write(R).catch(f.Log.error), P.close().catch(f.Log.error);
            const fe = M.readable.getReader(),
              V = [];
            let $;
            for (; !($ = yield fe.read()).done; ) V.push($.value);
            const A = V.reduce((ue, ve) => ue + ve.length, 0),
              F = new Uint8Array(A);
            let K = 0;
            ...
            f.Log.warn(`Request compression failed for ${S.urlConfig.getUrl()}`, R);
          }
      });
    }
    _getInternalRequestArgs(S, O) {
      const T = this._fallbackResolver.getActiveFallbackUrl(O.sdkKey, O.urlConfig),
        R = Object.assign(Object.assign({}, O), { method: S, fallbackUrl: T });
      return "data" in O && k(R, O.data), R;
    }
  };
  ie.NetworkCore = m;
  const D = (I) => (I.sdkKey ? !0 : (f.Log.warn("Unable to make request without an SDK key"), !1)),
    k = (I, S) => {
  ...
  function C(I, S) {
    ...
    const O = I.urlConfig.customUrl != null || I.urlConfig.fallbackUrls != null,
      T = b.SDKFlags.get(I.sdkKey, "enable_log_event_compression") === !0;
  ...
  function L(I, S) {
    return I != null && I.signal.aborted && typeof I.signal.reason == "string"
      ? I.signal.reason
      : typeof S == "string"
        ? S
        : S instanceof Error
  ...
  function U(I) {
    return (
      ((I == null ? void 0 : I.signal.aborted) &&
  ...
  function W(I, S) {
    I.urlConfig.endpoint === v.Endpoint._initialize &&
      c.Diagnostics._markInitNetworkReqStart(I.sdkKey, { attempt: S });
  }
  function x(I, S, O, T, R) {
    I.urlConfig.endpoint === v.Endpoint._initialize &&
      c.Diagnostics._markInitNetworkReqEnd(I.sdkKey, c.Diagnostics._getDiagnosticsData(S, O, T, R));
  }
  function B(I) {
    return e(this, void 0, void 0, function* () {
      yield new Promise((S) => setTimeout(S, Math.min(u * (I * I), g)));
    });
  }
  return ie;
}
var We = {},
  Kt;
function vn() {
  return Kt || ((Kt = 1), Object.defineProperty(We, "__esModule", { value: !0 })), We;
}
var xe = {},
  Bt;
function hn() {
...
function yn() {
  ...
  let i = class {
    constructor(t, u, g, s) {
      ...
      (s == null ? void 0 : s.logLevel) != null && (v.Log.level = s.logLevel),
        s != null && s.disableStorage && l.Storage._setDisabled(!0),
        s != null &&
          s.initialSessionID &&
          E.StatsigSession.overrideInitialSessionID(s.initialSessionID, t),
        s != null && s.storageProvider && l.Storage._setProvider(s.storageProvider),
        s != null && s.enableCookies && h.StableID._setCookiesEnabled(t, s.enableCookies),
        s != null && s.disableStableID && h.StableID._setDisabled(t, !0),
        (this._sdkKey = t),
        (this._options = s ?? {}),
        (this._memoCache = {}),
        (this.overrideAdapter =
          (p = s == null ? void 0 : s.overrideAdapter) !== null && p !== void 0 ? p : null),
        (this._logger = new f.EventLogger(t, D, g, s)),
    ...
    _enqueueExposure(t, u, g) {
      if ((g == null ? void 0 : g.disableExposureLog) === !0) {
...
var He = {},
  Vt;
function Sn() {
  return Vt || ((Vt = 1), Object.defineProperty(He, "__esModule", { value: !0 })), He;
}
var j = {},
  Jt;
function bn() {
  ...
  function c(a, l, r, i) {
    ...
    return {
      name: a,
      details: l,
      ruleID: (o = r == null ? void 0 : r.rule_id) !== null && o !== void 0 ? o : "",
      __evaluation: r,
      value: i,
    };
  }
  function f(a, l, r) {
    var i;
    return Object.assign(Object.assign({}, c(a, l, r, (r == null ? void 0 : r.value) === !0)), {
      idType: (i = r == null ? void 0 : r.id_type) !== null && i !== void 0 ? i : null,
    });
  }
  j._makeFeatureGate = f;
  function v(a, l, r) {
    var i;
    const o = (i = r == null ? void 0 : r.value) !== null && i !== void 0 ? i : {};
    return Object.assign(Object.assign({}, c(a, l, r, o)), {
      get: h(a, r == null ? void 0 : r.value),
    });
  }
  ...
  function _(a, l, r) {
    ...
    return Object.assign(Object.assign({}, o), {
      groupName: (i = r == null ? void 0 : r.group_name) !== null && i !== void 0 ? i : null,
    });
  }
  j._makeExperiment = _;
  function b(a, l, r, i) {
    ...
    return Object.assign(Object.assign({}, c(a, l, r, void 0)), {
      get: h(a, r == null ? void 0 : r.value, i),
      groupName: (o = r == null ? void 0 : r.group_name) !== null && o !== void 0 ? o : null,
      __value: (n = r == null ? void 0 : r.value) !== null && n !== void 0 ? n : {},
    });
  }
  j._makeLayer = b;
  function E(a, l, r, i) {
  ...
  function h(a, l, r) {
    return (i, o) => {
      var n;
      const t = (n = l == null ? void 0 : l[i]) !== null && n !== void 0 ? n : null;
      return t == null
        ? (o ?? null)
...
var Qe = {},
  zt;
function pn() {
  return zt || ((zt = 1), Object.defineProperty(Qe, "__esModule", { value: !0 })), Qe;
}
var ae = {},
  Wt;
function En() {
    ...
    xt ||
      ...
      (function (e) {
        ...
        Object.defineProperty(e, "Storage", {
          ...
          c(En(), e),
          c(nn(), e),
          Object.assign((0, f._getStatsigGlobal)(), { Log: b.Log, SDK_VERSION: E.SDK_VERSION });
      })(X)),
    X
  );
}
var Un = wn();
export { kn as a, ot as c, Dn as g, wn as r, Un as s };
