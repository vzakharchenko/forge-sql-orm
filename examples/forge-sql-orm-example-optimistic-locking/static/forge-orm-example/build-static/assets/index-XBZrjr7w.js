...
import { r as wt, a as Ho, c as fg } from "./react-dom-vendor-B_rzBOmK.js";
import { g as dr, a as nc, r as lr, b as Mt, s as rt } from "./client-core-vendor-BsnvkX1x.js";
import { r as vg } from "./lodash-vendor-BISPxPhj.js";
function pg(e, t) {
...
function hv(e) {
  ...
  var t = {};
  if (e != null) for (var r = Ss(e), n = 0; n < r.length; n++) r[n] !== "default" && Wo(t, e, r[n]);
  return (bg(t, e), t);
}
function gv(e) {
...
function Ye() {
  if ($c) return Sn;
  (($c = 1), Object.defineProperty(Sn, "__esModule", { value: !0 }), (Sn.BridgeAPIError = void 0));
...
function Jo() {
  if (Gc) return En;
  ((Gc = 1), Object.defineProperty(En, "__esModule", { value: !0 }), (En.withRateLimiter = void 0));
  const e = Ye(),
    t = (r, n, a, o) => {
      let i = Date.now(),
        c = 0;
...
function Sg() {
  if (Jc) return xn;
  ((Jc = 1), Object.defineProperty(xn, "__esModule", { value: !0 }), (xn.invokeRemote = void 0));
  const e = Ov(),
...
function Cg() {
  if (Zc) return Rn;
  ((Zc = 1), Object.defineProperty(Rn, "__esModule", { value: !0 }), (Rn.submit = void 0));
  const e = we(),
    t = Ye(),
    r = (0, e.getCallBridge)(),
    n = async (a) => {
...
function Pg() {
  if (Qc) return An;
  ((Qc = 1), Object.defineProperty(An, "__esModule", { value: !0 }), (An.close = void 0));
  const e = we(),
    t = Ye(),
    r = (0, e.getCallBridge)(),
    n = async (a) => {
...
function Rg() {
  if (el) return In;
  ((el = 1), Object.defineProperty(In, "__esModule", { value: !0 }), (In.open = void 0));
  const e = we(),
    t = Ye(),
    r = (0, e.getCallBridge)(),
    n = async () => {
...
function Ag() {
  if (tl) return jn;
  ((tl = 1), Object.defineProperty(jn, "__esModule", { value: !0 }), (jn.refresh = void 0));
  const e = we(),
    t = Ye(),
    r = (0, e.getCallBridge)(),
    n = async (a) => {
...
function Ig() {
  if (rl) return Dn;
  ((rl = 1), Object.defineProperty(Dn, "__esModule", { value: !0 }), (Dn.createHistory = void 0));
...
function Dg() {
  if (il) return Mn;
  ((il = 1), Object.defineProperty(Mn, "__esModule", { value: !0 }), (Mn.Translator = void 0));
  const e = Ev();
  class t {
    locale;
    translationsGetter;
...
function Tg() {
  if (sl) return Fn;
  ((sl = 1), Object.defineProperty(Fn, "__esModule", { value: !0 }), (Fn.ensureLocale = void 0));
  const e = Sv(),
...
var Ii = {},
  ll;
function Fg() {
  return (ll || ((ll = 1), Object.defineProperty(Ii, "__esModule", { value: !0 })), Ii);
}
var ul;
function xv() {
  return (
...
function Lg() {
  if (dl) return Tn;
  ((dl = 1), Object.defineProperty(Tn, "__esModule", { value: !0 }), (Tn.getContext = void 0));
  const e = we(),
    t = xv(),
    r = (0, e.getCallBridge)(),
    n = async () => {
...
function Bg() {
  if (vl) return Nn;
  ((vl = 1), Object.defineProperty(Nn, "__esModule", { value: !0 }), (Nn.theme = void 0));
  const t = (0, we().getCallBridge)();
...
function Pv() {
  if (gl) return zn;
  ((gl = 1), Object.defineProperty(zn, "__esModule", { value: !0 }), (zn.events = void 0));
  const e = we(),
    t = zg(),
    r = (0, e.getCallBridge)(),
    n = async (o, i) => {
  ...
  return ((zn.events = { emit: n, on: a }), zn);
}
var bl;
function qg() {
  if (bl) return Bn;
  ((bl = 1), Object.defineProperty(Bn, "__esModule", { value: !0 }), (Bn.emitReadyEvent = void 0));
  const e = Pv(),
    t = Rv(),
    r = "EXTENSION_READY",
    n = async () => {
...
function Rv() {
  if (_l) return Pn;
  ((_l = 1), Object.defineProperty(Pn, "__esModule", { value: !0 }), (Pn.view = void 0));
  const e = Cg(),
    t = Pg(),
    r = Rg(),
    n = Ag(),
...
function Ug() {
  if (yl) return qn;
  ((yl = 1), Object.defineProperty(qn, "__esModule", { value: !0 }), (qn.router = void 0));
  const t = (0, we().getCallBridge)(),
    r = async (i) => {
...
function $g() {
  return (
    wl ||
      ((wl = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), er.__exportStar(Ug(), e));
      })(Di)),
    Di
  );
}
...
function Vg() {
  if (kl) return Un;
  ((kl = 1), Object.defineProperty(Un, "__esModule", { value: !0 }), (Un.Modal = void 0));
  const e = we(),
    t = Ye(),
    r = (0, e.getCallBridge)(),
    n = () => {};
...
function Kg() {
  if (Sl) return $n;
  ((Sl = 1), Object.defineProperty($n, "__esModule", { value: !0 }), ($n.productFetchApi = void 0));
  const e = Cv(),
    t = async (o) => {
      const i = {};
...
function eb() {
  ...
  return (($t.createTranslationFunction = i), $t);
}
var Bi = {},
  Kn = {},
  gr = {},
...
function tb() {
  if (Dl) return to;
  ((Dl = 1), Object.defineProperty(to, "__esModule", { value: !0 }));
  const e = lr();
  class t {
    constructor(n) {
      ((this._sdkKey = n),
...
var Bv = typeof Object.getOwnPropertySymbols < "u";
function bb(e) {
  var t = Object.keys(e);
  if (!Bv) return t;
...
function ic(e, t) {
  return { annotationType_: e, options_: t, make_: Nb, extend_: Bb, decorate_20223_: zb };
}
function Nb(e, t, r) {
...
function ri(e, t) {
  return { annotationType_: e, options_: t, make_: Ub, extend_: $b, decorate_20223_: Vb };
}
function Ub(e, t, r) {
  return this.extend_(e, t, r, !1) === null ? 0 : 1;
}
...
function Jv(e, t, r) {
  if (Ka(t)) return Cs.decorate_20223_(e, t);
  if (Er(t)) {
    Ga(e, t, Cs);
    return;
  }
...
var i_ = {
  ...
  s_ = "computed.struct",
  Ps = ic(Yv),
  c_ = ic(s_, { equals: Io.structural }),
  ni = function (t, r) {
    if (Ka(r)) return Ps.decorate_20223_(t, r);
    if (Er(r)) return Ga(t, r, Ps);
    if (ur(t)) return It(ic(Yv, t));
    var n = ur(r) ? r : {};
...
var Wl,
  ...
  l_ = 1,
  u_ =
    (Wl = (Jl = Ao(function () {}, "name")) == null ? void 0 : Jl.configurable) != null ? Wl : !1,
  Yl = { value: "action", configurable: !0, writable: !1, enumerable: !1 };
function Pr(e, t, r, n) {
  r === void 0 && (r = !1);
  function a() {
...
function Rs(e) {
  switch (e.dependenciesState_) {
    ...
    case Y.POSSIBLY_STALE_: {
      for (var t = sc(!0), r = jr(), n = e.observing_, a = n.length, o = 0; o < a; o++) {
        var i = n[o];
        if (ii(i)) {
  ...
  return (
    ...
    (t.runReaction_ = function () {
      if (!this.isDisposed) {
        ...
        var n = I.trackingContext;
        if (((I.trackingContext = this), Rs(this))) {
    ...
    (t.dispose = function () {
      this.isDisposed || ((this.isDisposed = !0), this.isRunning || (st(), As(this), ct()));
    }),
...
function op() {
  I.inBatch > 0 || I.isRunningReactions || Is(w_);
}
function w_() {
...
var ip = "action",
  ...
  js = Ha(ip),
  C_ = Ha(S_, { bound: !0 }),
  Ds = Ha(sp, { autoAction: !0 }),
  P_ = Ha(E_, { autoAction: !0, bound: !0 });
function cp(e) {
  var t = function (n, a) {
    if (mt(n)) return Pr(n.name || x_, n, e);
    if (mt(a)) return Pr(n, a, e);
    if (Ka(a)) return (e ? Ds : js).decorate_20223_(n, a);
    if (Er(a)) return Ga(n, a, e ? Ds : js);
...
function dp(e) {
  var t = { name: e.name_ };
  return (
    e.observing_ && e.observing_.length > 0 && (t.dependencies = z_(e.observing_).map(dp)),
    t
  );
}
function z_(e) {
...
var qi = Vv("flow"),
  U_ = Vv("flow.bound", { bound: !0 }),
  sn = Object.assign(function (t, r) {
    if (Ka(r)) return qi.decorate_20223_(t, r);
    if (Er(r)) return Ga(t, r, qi);
    var n = t,
...
function $_(e, t) {
  return e ? ci(e) || !!e[L] || oc(e) || Mo(e) || ii(e) : !1;
}
function vp(e) {
  return $_(e);
}
...
var V_ = {
  ...
  set: function (t, r, n) {
    var a;
    return Er(r) ? ((a = Br(t).set_(r, n, !0)) != null ? a : !0) : !1;
  },
  deleteProperty: function (t, r) {
    var n;
    return Er(r) ? ((n = Br(t).delete_(r, !0)) != null ? n : !0) : !1;
  },
    ...
    return (
      ...
      (t.spliceWithArray_ = function (n, a, o) {
        ...
        if (
          ...
          var s = it(this, { object: this.proxy_, type: Zl, index: n, removedCount: a, added: o });
          if (!s) return Es;
...
var J_ = Ir("ObservableArrayAdministration", cc);
function si(e) {
  return Zo(e) && J_(e[L]);
}
var Y_ = {},
  ...
  gp = (function () {
    function e(r, n, a) {
      ...
      (n === void 0 && (n = Cr),
        ...
        mt(Map) || W(18),
        Tr(function () {
          ((o.keysAtom_ = Uv("ObservableMap.keys()")),
            (o.data_ = new Map()),
            (o.hasMap_ = new Map()),
            r && o.merge(r));
        }));
...
function Ql(e) {
  return ((e[Symbol.toStringTag] = "MapIterator"), uc(e));
}
function X_(e) {
  ...
  bp = (function () {
    function e(r, n, a) {
      ...
      (n === void 0 && (n = Cr),
        ...
        Tr(function () {
          ((o.atom_ = Uv(o.name_)), r && o.replace(r));
        }));
    }
    var t = e.prototype;
    return (
...
function eu(e) {
  return ((e[Symbol.toStringTag] = "SetIterator"), uc(e));
}
  ...
  _p = (function () {
    ...
    return (
      ...
      (t.delete_ = function (n, a) {
        ...
        if (ot(this)) {
          var o = it(this, { object: this.proxy_ || this.target_, name: n, type: ru });
          if (!o) return null;
        }
        try {
          var i;
...
function nm(e) {
  At(lc.prototype, "" + e, yp(e));
}
function wp(e) {
  if (e > Ui) {
    for (var t = Ui; t < e + 100; t++) nm(t);
    Ui = e;
  }
}
wp(1e3);
...
function No(e, t) {
  if (typeof e == "object" && e !== null) {
    ...
    if (Dr(e)) {
      ...
      return (r || W(25, t, Ts(e)), r);
    }
    if (ci(e)) {
      if (!t) return W(26);
      var n = e[L].values_.get(t);
      return (n || W(27, t, Ts(e)), n);
    }
    if (oc(e) || ii(e) || Mo(e)) return e;
  } else if (mt(e) && Mo(e[L])) return e[L];
  W(28);
}
function om(e, t) {
  if ((e || W(29), oc(e) || ii(e) || Mo(e) || Dr(e) || Pt(e))) return e;
  if (e[L]) return e[L];
  W(24, e);
}
function Ts(e, t) {
...
function Ms(e, t, r, n, a) {
  ...
  if ((n.push(e), a.push(t), c)) {
    ...
    for (var p = 0; p < f; p++) {
      var h = d[p];
      if (!(Xt(t, h) && Ms(e[h], t[h], r - 1, n, a))) return !1;
    }
  }
...
var su,
  im = ((su = Yo().Iterator) == null ? void 0 : su.prototype) || {};
function uc(e) {
...
typeof __MOBX_DEVTOOLS_GLOBAL_HOOK__ == "object" &&
  __MOBX_DEVTOOLS_GLOBAL_HOOK__.injectMobx({ spy: O_, extras: { getDebugName: Ts }, $mobx: L });
...
var lu;
function gm() {
  return (lu || ((lu = 1), ($i.exports = hm())), $i.exports);
}
var bm = gm();
function uu(e) {
...
function _m(e, t) {
    ...
    var n = {
      ...
      subscribe: function (c) {
        return (
          Fa.unregister(n),
          (n.onStoreChange = c),
          n.reaction || (uu(n), (n.stateVersion = Symbol())),
          function () {
            var s;
  ...
  var a = r.current;
  (a.reaction || (uu(a), Fa.register(r, a, a)),
...
function ym(e, t) {
  ...
  if (du && e.$$typeof === du && ((n = !0), (a = e.render), typeof a != "function"))
...
function Om(e, t) {
  ...
  for (var a = 0; a < r.length; a++)
    if (!Object.hasOwnProperty.call(t, r[a]) || !vu(e[r[a]], t[r[a]])) return !1;
  return !0;
}
function vu(e, t) {
  return e === t ? e !== 0 || 1 / e === 1 / t : e !== e && t !== t;
}
var pu = Symbol("patchMixins"),
...
function gu(e, t) {
  var r = function () {
    for (var a = arguments.length, o = new Array(a), i = 0; i < a; i++) o[i] = arguments[i];
    hu.call.apply(hu, [this, e, t].concat(o));
  };
  return r;
}
function Em(e, t, r) {
...
var bu = Symbol("ObserverAdministration"),
  _u = Symbol("isMobXReactObserver");
function Fs(e) {
  var t;
  return (t = e[bu]) != null
    ? t
...
function xm(e) {
  ...
  if (e.__proto__ !== _.PureComponent) {
    if (!t.shouldComponentUpdate) t.shouldComponentUpdate = mu;
    else if (t.shouldComponentUpdate !== mu)
      throw new Error(
...
function xp(e) {
  var t = e.children,
    ...
    a = O.useRef(Ns({}, n, r)),
    o = a.current;
  return O.createElement(yu.Provider, { value: o }, t);
}
  ...
  return be(e, [
    {
      ...
      value: function (r) {
        return (
          ...
          Ue(r) === "object" && (this.payload = Ji(Ji({}, this.payload), r)),
          this
        );
      },
    },
...
var io = {
  ...
  By = typeof window > "u" ? _.useEffect : _.useLayoutEffect,
  vc = O.memo(
...
var qp = (function (e) {
  function t() {
    return (ge(this, t), $y(this, t, arguments));
  }
  return (
    Qe(t, e),
    be(t, [
      {
        ...
        value: function () {
          ...
          return O.createElement(
            zy,
            { testId: s },
            o ? O.createElement(qy, { contentsOpacity: c, testId: s }, a) : a,
            o &&
              O.createElement(
                Uy,
                { testId: s },
                ...
                (function (S, x, A) {
                  var D,
                    ...
                    U = {
                      ...
                      f: V.bind(n, 4),
                      d: function (H, N) {
                        return ((D = H), (R = 0), (M = n), (U.n = N), l);
                      },
                    };
                  function V(G, H) {
                    for (R = G, M = H, a = 0; !$ && q && !N && a < B.length; a++) {
                      var N,
                        j = B[a],
                        _e = U.p,
                        se = j[2];
                  ...
                  return function (G, H, N) {
                    ...
                    for ($ && H === 1 && V(H, N), R = H, M = N; (a = R < 2 ? n : M) || !$; ) {
                          ...
                          if ((R || (G = "next"), (a = D[G]))) {
                            ...
                            (R === 1 && (a = D.return) && a.call(D),
                              R < 2 &&
                                ...
                                (R = 1)));
                          D = n;
                        } else if ((a = ($ = U.n < 0) ? M : S.call(x, U)) !== l) break;
                      } catch (j) {
                        ((D = n), (R = 1), (M = j));
                      } finally {
                        q = 1;
...
function o0() {
  if (nd) return so;
  ((nd = 1), Object.defineProperty(so, "__esModule", { value: !0 }));
  const e = Mt(),
    t = n0(),
    r = a0();
  let n = class {
...
var lo = function (t) {
  ...
  m0 = Object.entries(pc).map(function (e) {
    var t = J(e, 2),
      r = t[0],
      n = t[1];
...
var us = "LocalOverride:Recognized",
    ...
    return be(e, [
      ...
      },
      {
        ...
        value: function (r, n) {
          ...
          return o == null
            ? null
            : Be(Be({}, r), {}, { value: o, details: Be(Be({}, r.details), {}, { reason: us }) });
        },
      },
      {
          ...
          return o == null
            ...
            : Be(
                ...
                {},
                {
                  ...
                  details: Be(Be({}, r.details), {}, { reason: us }),
                },
              );
        },
      },
  ...
  q0 = ["sdkKey", "environment", "updateUserCompletionCallback", "perimeter"];
function kd(e, t) {
  var r = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e);
        ...
        value: function (r) {
          ...
          try {
            ...
            return (
              ...
              new pd(r, {}, "", { time: Date.now(), reason: pc.Error })
            );
          }
        },
      },
                    ...
                    switch ((g.prev = g.next)) {
                      ...
                      case 19:
                        return (
                          ...
                          (this.statsigClient = new gt.StatsigClient(Od, this.user, p)),
                ...
                function (b) {
                  for (;;)
                    switch ((b.prev = b.next)) {
                      ...
                      case 4:
                        ((l = b.sent), (u = vd(o, l.customAttributesFromFetch)), (b.next = 13));
                        break;
                      case 8:
                        throw (
                          (b.prev = 8),
        ...
        value: function (r) {
          ...
          try {
            ...
            return (
              ...
              hd.fromLayer(gt._makeLayer(r, { reason: "Error" }, null))
            );
          }
        },
      },
...
if (typeof window < "u")
  if (window.__FEATUREGATES_JS__ === void 0) window.__FEATUREGATES_JS__ = K;
    ...
    var Sd =
      ((uo = Gs) === null || uo === void 0 || (ds = uo.getPackageVersion) === null || ds === void 0
        ? void 0
...
var Hr,
  ...
  eh = typeof process < "u" && typeof hc < "u",
  J0 = eh ? hc.ENABLE_PLATFORM_FF === "true" : !1,
  Y0 = eh ? hc.STORYBOOK_ENABLE_PLATFORM_FF === "true" : !1,
  X0 = J0 || Y0,
...
function iw() {
  if (xd) return ra;
  ((xd = 1), Object.defineProperty(ra, "__esModule", { value: !0 }), (ra.default = void 0));
  var e = r(wt()),
    t = r(di);
  function r(a) {
...
function lw() {
  if (Ad) return la;
  ((Ad = 1), Object.defineProperty(la, "__esModule", { value: !0 }), (la.default = void 0));
  var e = r(wt()),
    t = th;
  function r(a) {
    return a && a.__esModule ? a : { default: a };
...
function uw() {
  if (Id) return ta;
  ((Id = 1), Object.defineProperty(ta, "__esModule", { value: !0 }), (ta.default = void 0));
  var e = n(wt()),
    t = n(iw()),
    r = n(lw());
  function n(o) {
...
function vw() {
  if (jd) return da;
  ((jd = 1), Object.defineProperty(da, "__esModule", { value: !0 }), (da.default = void 0));
  var e = r(wt()),
    t = r(di);
  function r(a) {
    return a && a.__esModule ? a : { default: a };
...
function pw() {
  if (Dd) return fa;
  ((Dd = 1), Object.defineProperty(fa, "__esModule", { value: !0 }), (fa.default = void 0));
  var e = r(wt()),
    t = th;
  function r(a) {
    return a && a.__esModule ? a : { default: a };
...
function hw() {
  if (Td) return ua;
  ((Td = 1), Object.defineProperty(ua, "__esModule", { value: !0 }), (ua.default = void 0));
  var e = n(wt()),
    t = n(vw()),
    r = n(pw());
  function n(o) {
...
var gw = hw();
const bw = dr(gw);
var gc = _.createContext("elevation.surface"),
  _w = function () {
    return _.useContext(gc);
  };
gc.displayName = "SurfaceProvider";
var mw = [
    "as",
    "children",
    "backgroundColor",
  ...
  Ew = {
    ...
    return o ? _.createElement(gc.Provider, { value: o }, A) : A;
  });
function xw(e) {
  return e in rh;
}
...
var Mw = [
  ...
  Fw = function (t) {
    var r = t.children;
    return _.createElement("span", { className: P([Ks.separator]) }, r);
  },
  ko = _.memo(
    _.forwardRef(function (e, t) {
      var r = e.as,
      ...
      return _.createElement(
        ...
        Z({}, b, {
          ...
          rowGap: d,
          wrap: c ? "wrap" : void 0,
          xcss: ah(l === "hug" && Ks.hug, l === "fill" && Ks.fill, p),
          testId: h,
          ref: t,
        }),
        w,
...
var oh = _.createContext(!1),
  ...
  $w = { medium: "_11c82smr", UNSAFE_small: "_11c8dcr7", large: "_11c81ixg", small: "_11c81o8v" },
  ...
  ih = _.forwardRef(function (e, t) {
    ...
    return p ? v : _.createElement(zw, { value: !0 }, v);
  });
function Kw() {
...
var Hw = ["as", "children", "isInset", "testId", "style", "xcss"],
  ...
  Yw = ["className"],
  Nd = { root: "_19itglyw _vchhusvi _r06hglyw _80omtlke", disabled: "_80om13gf" },
  sh = _.forwardRef(function (e, t) {
    ...
    return _.createElement(
      ...
      Z({ as: "button", tabIndex: h ?? (Kw() && !n ? 0 : void 0), style: d }, w, {
        ...
        onClick: y,
        disabled: n,
        xcss: nh(Nd.root, n && Nd.disabled, p),
        testId: f,
        ref: t,
      }),
      r,
...
function dh() {
  return Oo && ye("platform-dst-react-18-use-id")
    ? ye("platform-dst-react-18-use-id-selector-safe")
      ? Oo().replace(/[:«»]/g, "_")
      : Oo()
    : "uid".concat(ck());
}
function uk() {
  if (Oo && ye("platform-dst-react-18-use-id")) {
    var e = dh();
    return function (t) {
...
function Ck() {
  return ((me = $e > 0 ? Ee(_n, --$e) : 0), un--, me === 10 && ((un = 1), hi--), me);
}
function We() {
  return ((me = $e < hh ? Ee(_n, $e++) : 0), un++, me === 10 && ((un = 1), hi++), me);
}
function Dt() {
  return Ee(_n, $e);
}
...
function gh(e) {
  return ((hi = un = 1), (hh = xt((_n = e))), ($e = 0), []);
}
function bh(e) {
  return ((_n = ""), e);
}
function Eo(e) {
  return ph(Ya($e - 1, Ws(e === 91 ? e + 2 : e === 40 ? e + 1 : e)));
}
function Pk(e) {
  for (; (me = Dt()) && me < 33; ) We();
...
function Ak(e, t) {
  for (; We() && e + me !== 57; ) if (e + me === 84 && Dt() === 47) break;
  return "/*" + Ya(t, $e - 1) + "*" + pi(e === 47 ? e : We());
}
function Ik(e) {
  for (; !za(Dt()); ) We();
  return Ya(e, $e);
        ...
        switch (y) {
          ...
          case 59 + u:
            (b == -1 && (x = ee(x, /\f/g, "")),
              p > 0 &&
                xt(x) - d &&
                fo(p > 32 ? $d(x + ";", n, r, d - 1) : $d(ee(x, " ", "") + ";", n, r, d - 2), s));
            break;
          case 59:
            x += ";";
          default:
...
function Ud(e, t, r, n, a, o, i, c, s, l, u) {
  for (var d = a - 1, f = a === 0 ? o : [""], p = wc(f), h = 0, v = 0, g = 0; h < n; ++h)
    for (var b = 0, y = Ba(e, d + 1, (d = wk((v = i[h])))), w = e; b < p; ++b)
      (w = ph(v > 0 ? f[b] + " " + y : ee(y, /&\f/g, f[b]))) && (s[g++] = w);
  return gi(e, t, r, a === 0 ? mc : c, s, l, u);
}
function Dk(e, t, r) {
  return gi(e, t, r, fh, pi(xk()), Ba(e, 2, -2), 0);
}
function $d(e, t, r, n) {
  return gi(e, t, r, yc, Ba(e, 0, n), Ba(e, n + 1, -1), n);
}
function nn(e, t) {
  for (var r = "", n = wc(e), a = 0; a < n; a++) r += t(e[a], a, e, t) || "";
  return r;
}
function Tk(e, t, r, n) {
  switch (e.type) {
...
var Nk = function (t, r, n) {
    for (var a = 0, o = 0; (a = o), (o = Dt()), a === 38 && o === 12 && (r[n] = 1), !za(o); ) We();
    return Ya(t, $e);
  },
  Bk = function (t, r) {
    var n = -1,
    ...
    do
      switch (za(a)) {
        case 0:
          (a === 38 && Dt() === 12 && (r[n] = 1), (t[n] += Nk($e - 1, r, n)));
          break;
        case 2:
          t[n] += Eo(a);
          break;
  ...
  qk = function (t) {
    if (!(t.type !== "rule" || !t.parent || t.length < 1)) {
      ...
      if (!(t.props.length === 1 && r.charCodeAt(0) !== 58 && !Vd.get(n)) && !a) {
        Vd.set(t, !0);
        for (var o = [], i = zk(r, o), c = n.props, s = 0, l = 0; s < i.length; s++)
    ...
    case 4765:
      if (xt(e) - 1 - t > 6)
        switch (Ee(e, t + 1)) {
          ...
          case 115:
            return ~Hs(e, "stretch") ? _h(ee(e, "stretch", "fill-available"), t) + e : e;
        }
      break;
    case 4949:
      if (Ee(e, t + 1) !== 115) break;
    case 6444:
      switch (Ee(e, xt(e) - 3 - (~Hs(e, "!important") && 10))) {
        case 107:
          return ee(e, ":", ":" + Q) + e;
        case 101:
          return (
...
var Kd;
function Hk() {
  return (Kd || ((Kd = 1), (hs.exports = Kk())), hs.exports);
}
var gs, Hd;
function Wk() {
  if (Hd) return gs;
...
function e1(e, t, r) {
  var n = "";
  if (Array.isArray(r)) for (var a = 0; a < r.length; a++) n += qa(e, t, r[a]) + ";";
  else
    for (var o in r) {
      var i = r[o];
      if (typeof i != "object") {
        ...
        for (var s = 0; s < i.length; s++) Wd(i[s]) && (n += bs(o) + ":" + Jd(o, i[s]) + ";");
      else {
        var l = qa(e, t, i);
        switch (o) {
          case "animation":
...
function Oc(e, t, r) {
  ...
  Ct = void 0;
  var o = e[0];
  if (o == null || o.raw === void 0) ((n = !1), (a += qa(r, t, o)));
  else {
    var i = o;
    a += i[0];
  }
...
var Sh = function (t) {
  ...
  n1 = function (t, r) {
    var n = {};
    for (var a in r) Sc.call(r, a) && (n[a] = r[a]);
    return ((n[Js] = t), n);
  },
  a1 = function (t) {
    var r = t.cache,
  ...
  o1 = Sh(function (e, t, r) {
    ...
    var c = Oc(o, void 0, _.useContext(Eh));
    i += t.key + "-" + c.name;
    var s = {};
    for (var l in e) Sc.call(e, l) && l !== "css" && l !== Js && (s[l] = e[l]);
    return (
      (s.className = i),
      r && (s.ref = r),
      _.createElement(
  ...
  Yt = function (t, r) {
    var n = arguments;
    if (r == null || !Sc.call(r, "css")) return _.createElement.apply(void 0, n);
    var a = n.length,
      o = new Array(a);
    ((o[0] = i1), (o[1] = n1(t, r)));
  ...
  u1 = Sh(function (e, t) {
    var r = [],
      n = function () {
        ...
        var d = Oc(l, t.registered);
        return (r.push(d), kc(t, d, !1), t.key + "-" + d.name);
      },
      a = function () {
        for (var s = arguments.length, l = new Array(s), u = 0; u < s; u++) l[u] = arguments[u];
  ...
  Qd = {
    background: {
      default: {
        ...
        hover: {
          light: "var(--ds-background-neutral-hovered, ".concat(Nu, ")"),
          dark: "var(--ds-background-neutral-hovered, ".concat(Bu, ")"),
        },
        active: {
          light: "var(--ds-background-neutral-pressed, ".concat(Zd, ")"),
        ...
        selected: {
          ...
          dark: "var(--ds-background-selected, ".concat($r, ")"),
        },
        focusSelected: {
          light: "var(--ds-background-selected, ".concat(nt, ")"),
          dark: "var(--ds-background-selected, ".concat($r, ")"),
      ...
      primary: {
        default: {
          ...
          dark: "var(--ds-background-brand-bold, ".concat(Mu, ")"),
        },
        hover: {
      ...
      warning: {
        default: {
          light: "var(--ds-background-warning-bold, ".concat(Tu, ")"),
          dark: "var(--ds-background-warning-bold, ".concat(Tu, ")"),
        },
        hover: {
          light: "var(--ds-background-warning-bold-hovered, ".concat(Du, ")"),
          dark: "var(--ds-background-warning-bold-hovered, ".concat(Du, ")"),
        },
        active: {
          light: "var(--ds-background-warning-bold-pressed, ".concat(qr, ")"),
          dark: "var(--ds-background-warning-bold-pressed, ".concat(qr, ")"),
        },
        disabled: {
          light: "var(--ds-background-disabled, ".concat(Zn, ")"),
          dark: "var(--ds-background-disabled, ".concat(Qn, ")"),
      ...
      danger: {
        default: {
          light: "var(--ds-background-danger-bold, ".concat(ju, ")"),
          dark: "var(--ds-background-danger-bold, ".concat(ju, ")"),
        },
        hover: {
        ...
        active: {
          light: "var(--ds-background-danger-bold-pressed, ".concat(zr, ")"),
          dark: "var(--ds-background-danger-bold-pressed, ".concat(zr, ")"),
        },
        disabled: {
          light: "var(--ds-background-disabled, ".concat(Zn, ")"),
          dark: "var(--ds-background-disabled, ".concat(Qn, ")"),
      ...
      subtle: {
        ...
        hover: {
          light: "var(--ds-background-neutral-subtle-hovered, ".concat(Nu, ")"),
          dark: "var(--ds-background-neutral-subtle-hovered, ".concat(Bu, ")"),
        },
        active: {
          light: "var(--ds-background-neutral-subtle-pressed, ".concat(Zd, ")"),
...
var cr = 8,
  ...
  b1 = { default: Zs.default, compact: Zs.compact, none: "inherit" },
  _1 = {
  ...
  tf = { '&[data-has-overlay="true"]': { cursor: "default", textDecoration: "none" } };
function rf(e) {
  var t = e.group,
    r = e.key,
    n = e.mode,
...
function Yr(e) {
  var t = e.appearance,
    ...
    n = e.mode;
  return {
    background: rf({ group: Qd.background[t], key: r, mode: n }),
    color: "".concat(rf({ group: Qd.color[t], key: r, mode: n }), " !important"),
  };
}
function R1(e) {
  var t = e.appearance,
...
var j1 = {
  ...
  Ec = function (t) {
    return t && _.isValidElement(t) && t.type === _c;
  },
  D1 = [
    "analyticsContext",
    "appearance",
  ...
  af = function (t, r) {
    return !t || Ec(t) ? null : r;
  },
  L1 = function (t, r) {
    return Ec(t) ? t : t ? Yt("span", { css: r }, t) : null;
  },
    ...
    return (
      ...
      Yt(
        ...
        Yt(
          ...
          v ? Yt("span", { css: [Te, nf({ spacing: B }), af(l, M1)] }, v) : null,
          L1(l, [Te, A1({ spacing: B })]),
          h ? Yt("span", { css: [Te, nf({ spacing: B }), af(l, F1)] }, h) : null,
...
var z1 = [
  ...
  of = typeof navigator < "u" && navigator.userAgent.toLowerCase().indexOf("firefox") > -1,
  xc = O.memo(
    O.forwardRef(function (t, r) {
      var n = t.appearance,
        ...
        w = hk(),
        k = w.mode,
        m = B1({ children: o, iconBefore: i, iconAfter: c }),
        S = _.useState(!1),
        x = J(S, 2),
        A = x[0],
        D = x[1],
...
function $1(e) {
  ...
  return O.createElement(
    ...
    O.createElement(
      ...
      O.createElement(_c, null, "Skipped pages from ", n, " to ", a),
      "…",
    ),
  );
}
...
function Y1(e, t) {
  var r = e.components,
    ...
    G = function (N, j, _e) {
      ...
      return O.createElement(
        ko,
        { as: "li", xcss: Qs.paginationMenuItem, key: "page-".concat(S ? S(N, j) : j) },
        O.createElement(
          q1,
          {
            component: n.Page,
  ...
  return O.createElement(
    ...
    O.createElement(
      ...
      O.createElement(sf, {
        ...
        onClick: function (N) {
          return V({ event: N, selectedPageIndex: $ - 1 });
        },
        isDisabled: M || $ === 0,
        iconBefore: O.createElement(df, { chevronDirection: "left" }),
        "aria-label": f,
      ...
      O.createElement(
        ...
        H1(m, $, { max: y, ellipsis: A, transform: G }, R),
      ),
      O.createElement(sf, {
        key: "right-navigator",
        component: n.Next,
        ...
        isDisabled: M || $ === m.length - 1,
        iconBefore: O.createElement(df, { chevronDirection: "right" }),
        "aria-label": h,
...
var vf = "--local-dynamic-table-text-color",
  rO = function (t) {
    var r = t.isRanking,
      n = t.testId,
      a = te(t, eO);
  ...
  nO = _.forwardRef(function (e, t) {
    ...
    var c = e.style,
      ...
      u = ha(
        ...
        {},
        C({}, vf, "var(--ds-text-subtlest, #626F86)"),
      ),
      d = a === Rr,
      f = a === Uo,
      p = function () {
    ...
    return _.createElement(
      ...
      Z({ "aria-sort": p(), onClick: void 0, ref: t, "data-testid": s }, l, {
        ...
        style: ha(
          ha({}, u),
          {},
          { "--_17ckjys": ir("var(--ds-text-subtle, ".concat("var(".concat(vf, ")"), ")")) },
        ),
      }),
      n,
    );
...
function lO() {
  if (hf) return ba;
  ((hf = 1), Object.defineProperty(ba, "__esModule", { value: !0 }), (ba.default = void 0));
  var e = r(wt()),
    t = r(di);
  function r(a) {
    return a && a.__esModule ? a : { default: a };
...
var TO = function (t) {
  ...
  ma = "popper",
  NO = "reference",
  yf = Xa.reduce(function (e, t) {
    return e.concat([t + "-" + dn, t + "-" + Ua]);
  }, []),
  Lh = [].concat(Xa, [Cc]).reduce(function (e, t) {
    return e.concat([t, t + "-" + dn, t + "-" + Ua]);
  }, []),
  BO = "beforeRead",
  zO = "read",
  qO = "afterRead",
...
function bi(e) {
  return Lt(e) === "html" ? e : e.assignedSlot || e.parentNode || (Pc(e) ? e.host : null) || vr(e);
}
function wf(e) {
  return !ut(e) || Qt(e).position === "fixed" ? null : e.offsetParent;
}
function QO(e) {
  var t = /firefox/i.test(ec()),
    r = /Trident/i.test(ec());
  if (r && ut(e)) {
    var n = Qt(e);
...
function Za(e) {
  for (var t = Je(e), r = wf(e); r && ZO(r) && Qt(r).position === "static"; ) r = wf(r);
...
function jc(e) {
  return vn(vr(e)).left + Ic(e).scrollLeft;
}
function vS(e, t) {
  var r = Je(e),
    n = vr(e),
...
function Aa(e, t) {
  ...
  var n = $h(e),
    ...
    o = Je(n),
    i = a ? [o].concat(o.visualViewport || [], Dc(n) ? n : []) : n,
    c = t.concat(i);
...
function Sf(e, t, r) {
  return t === Fh ? tc(vS(e, r)) : Ar(t) ? hS(t, r) : tc(pS(vr(e)));
}
function gS(e) {
  var t = Aa(bi(e)),
...
function $a(e, t) {
  ...
  var r = t,
    ...
    v = r.padding,
    g = v === void 0 ? 0 : v,
    b = qh(typeof g != "number" ? g : Uh(g, Xa)),
    y = f === ma ? NO : ma,
    w = e.rects.popper,
    k = e.elements[h ? y : f],
...
function _S(e, t) {
  ...
  var p = f.reduce(function (h, v) {
    return ((h[v] = $a(e, { placement: v, boundary: a, rootBoundary: o, padding: i })[Tt(v)]), h);
  }, {});
  ...
  if (!t.modifiersData[n]._skip) {
    for (
      ...
      var M = k[R],
        ...
        $ = [ze, dt].indexOf(q) >= 0,
        U = $ ? "width" : "height",
        V = $a(t, { placement: M, boundary: u, rootBoundary: d, altBoundary: f, padding: l }),
        G = $ ? (B ? ft : qe) : B ? dt : ze;
      m[U] > S[U] && (G = Co(G));
      var H = Co(G),
        N = [];
...
function SS(e, t, r) {
  ...
  return (
    (i = i || 0),
    (c = (c || 0) * a),
    [qe, ft].indexOf(n) >= 0 ? { x: c, y: i } : { x: i, y: c }
  );
}
function ES(e) {
  var t = e.state,
...
function AS(e) {
  var t = e.state,
    ...
    h = r.tetherOffset,
    v = h === void 0 ? 0 : h,
    g = $a(t, { boundary: s, rootBoundary: l, padding: d, altBoundary: u }),
    b = Tt(t.placement),
    y = pn(t.placement),
    w = !y,
    k = Ac(b),
...
function MS(e, t, r) {
  ...
  return (
    (n || (!n && !r)) &&
      ((Lt(t) !== "body" || Dc(o)) && (c = DS(t)),
      ut(t) ? ((s = vn(t, !0)), (s.x += t.clientLeft), (s.y += t.clientTop)) : o && (s.x = jc(o))),
    {
    ...
    var u = {
      ...
      p = {
        ...
        setOptions: function (b) {
          ...
          var w = LS(BS([].concat(n, u.options.modifiers)));
          return (
...
var qS = [uS, PS, cS, XO, xS, wS, IS, aS, OS],
  US = zS({ defaultModifiers: qS }),
  ys,
  Rf;
function $S() {
  if (Rf) return ys;
  ...
  var t = e.children,
    ...
    b = _.useMemo(
      function () {
        var w = {
            name: "preventOverflow",
            options: { padding: rc, rootBoundary: p ? "viewport" : "document" },
          },
          k = { name: "offset", options: { offset: [v, g] } },
          m = p ? ZS({ viewportPadding: rc }) : [];
...
function mE(e) {
  ...
  function d() {
    ...
    ((t = "waiting-to-show"), Df(h, e.delay));
  }
  d();
  var f = {
    keep: i,
...
var Tf = {
  ...
  wE = function (t) {
    ...
    return _.createElement(
      "div",
      { className: P([Tf.shortcutSegmentsContainer]) },
      r.map(function (n, a) {
        return _.createElement(
          "kbd",
          { key: "".concat(n, "-").concat(a), className: P([Tf.shortcutSegment]) },
          n,
        );
      }),
    );
  ...
  Qh = _.forwardRef(function (t, r) {
    ...
    return _.createElement(
      Zh,
      {
        ref: r,
        style: n,
        className: P([Mf.base, i && Mf.truncate, a]),
        placement: c,
        testId: s,
        id: d,
        onMouseOut: l,
...
function EE(e) {
  var t = e.children,
    ...
    V = e.shortcut,
    G = n === "mouse" ? o : n,
    H = Cu(Xr({ fn: b, action: "displayed", analyticsData: D }, Nf)),
    N = Cu(Xr({ fn: w, action: "hidden", analyticsData: D }, Nf)),
    j = _.useRef(null),
    _e = _.useState("hide"),
    se = J(_e, 2),
    le = se[0],
  ...
  var re = _.useCallback(
    ...
    rr = _.useCallback(
      function (F) {
        try {
          if (!F.target.matches(":focus-visible") && ye("platform-tooltip-focus-visible-new"))
            return;
        } catch {}
        Le({ type: "keyboard" });
      },
    ...
    pt = le !== "hide" && !!i,
    eo = !U && pt,
    Mc = le !== "hide" && le !== "fade-out",
    ug = _.useCallback(function () {
      var F;
      (F = j.current) === null || F === void 0 || F.requestHide({ isImmediate: !0 });
    }, []);
  bO({ isOpen: pt && Mc, onClose: ug });
  var Fc = function () {
      var oe;
  ...
  return O.createElement(
    ...
    typeof t == "function"
      ...
      : O.createElement(Qa, Z({}, _i, { ref: Te, role: "presentation" }), t, Nc),
    pt
      ? O.createElement(
          gE,
          { zIndex: kE },
          O.createElement(rE, { placement: G, referenceElement: Fc(), strategy: M }, function (F) {
            var oe = F.ref,
              zt = F.style,
              mi = F.update,
              yi = F.placement,
                  ...
                  function (yn) {
                    ...
                    return O.createElement(
                      u,
                      {
                        ...
                        style: Xr(Xr({}, zt), B && { pointerEvents: "none" }),
                        truncate: s,
                        placement: G,
                        testId: Fc() ? p : p && "".concat(p, "--unresolved"),
                        onMouseOut: St,
                        onMouseOver: de,
                        shortcut: V,
                      },
  ...
  eg = function (t) {
    ...
    var o = t.innerRef,
      ...
      N = O.createElement(
        ...
        { xcss: Bf.headCellContainer, onMouseEnter: G, onMouseLeave: H, onFocus: U, onBlur: V },
        O.createElement(
          EE,
          { content: c === Rr ? f : h },
          O.createElement(
            ...
            O.createElement(
              Vo,
              { xcss: B ? ya.hideIconHeaderWrapper : ya.visibleHeaderWrapper },
              O.createElement("span", { className: P([Bf.text]) }, r),
            ),
            $ &&
              O.createElement(
                Vo,
                { xcss: q ? ya.sortIconVisibleWrapper : ya.sortIconHiddenWrapper },
                c === Rr
                  ? O.createElement(dO, {
                      label: "",
                      color: "var(--ds-text-subtle, #44546F)",
      ...
      be(t, [
        {
          ...
          value: function () {
            Bo(this.props.sortKey, this.props.head);
          },
        },
        {
          key: "UNSAFE_componentWillReceiveProps",
...
var LE = function (t) {
    ...
    var Oe = function (Se) {
      ...
      tr = function () {
        return H || (Ip(o || [], A, y).length > 2 ? $o : iy);
      },
      vt = function () {
    ...
    return O.createElement(
      ...
      !Ve &&
        Ie &&
        O.createElement(qp, { isLoading: h, spinnerSize: $o, testId: u, loadingLabel: s }, Ie),
    );
  },
  NE = _.lazy(function () {
    return Vm(
      () => import("./body-B0w9ruo0.js"),
      __vite__mapDeps([0, 1, 2, 3, 4]),
      import.meta.url,
    );
  }),
  BE = _.forwardRef(function (t, r) {
    var n = t.isRankable,
      a = n === void 0 ? !1 : n,
      o = t.isRanking,
      i = t.onRankStart,
...
var YE = [
  ...
  ZE = O.forwardRef(function (e, t) {
    var r = e.appearance,
      ...
      de =
        Mr && ye("platform-component-visual-refresh") ? "subtle" : r || re?.appearance || "default",
      rr = re?.spacing || S,
      tt = re?.isDisabled || i,
      Bt = !tt && !s,
      Qa = tt || s,
    ...
    return O.createElement(
      ...
      Z(
        ...
        eo,
        {
          ...
          xcss: ah(
            De.base,
            de === "default" &&
              (ye("platform-component-visual-refresh") ? Zr.rootRefreshed : Zr.root),
            de === "default" &&
              Bt &&
              (ye("platform-component-visual-refresh") ? Zr.interactiveRefreshed : Zr.interactive),
            de === "primary" && Uf.root,
            de === "primary" && Bt && Uf.interactive,
            de === "warning" && $f.root,
            de === "warning" && Bt && $f.interactive,
            de === "danger" && Vf.root,
            de === "danger" && Bt && Vf.interactive,
            de === "discovery" && Gf.root,
            de === "discovery" && Bt && Gf.interactive,
            de === "subtle" &&
              (ye("platform-component-visual-refresh") ? ho.rootRefreshed : ho.root),
            de === "subtle" &&
              Bt &&
              (ye("platform-component-visual-refresh") ? ho.interactiveRefreshed : ho.interactive),
            De.linkDecorationUnset,
            pt && (ye("platform-component-visual-refresh") ? kr.rootRefreshed : kr.root),
            ...
            tt && De.disabled,
            tt &&
              (!ye("platform-component-visual-refresh") || (de !== "default" && de !== "subtle")) &&
              De.sharedDisabled,
            tt &&
              de === "default" &&
              (ye("platform-component-visual-refresh") ? Zr.disabledRefreshed : Zr.disabled),
            h && !je && De.circle,
          ...
          isDisabled: Qa,
          "aria-label": s && x && !A ? "".concat(x, " ").concat(qf) : x,
      ...
      O.createElement(
        ...
        s && (A || !x) && O.createElement(_c, { id: Se }, qf),
      ),
    );
  }),
  Qr = {
...
var Kf = function (t) {
    var r = t.icon,
      ...
      a = {
        label: "",
        color: "currentColor",
        size: ye("platform_dst_button_chevron_sizing")
          ? function (o) {
    ...
    O.forwardRef(function (t, r) {
      ...
      return O.createElement(
        ...
        O.createElement(
          ...
          s && O.createElement(ks, { isLoading: h }, s),
          l &&
            O.createElement(
              ks,
