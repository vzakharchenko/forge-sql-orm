...
import { r as wt, a as To, c as Hh } from "./react-dom-vendor-DTSHKYJW.js";
import { g as ur, a as Vs, r as cr, s as nt } from "./client-core-vendor-DcgS9Lyj.js";
import { r as Wh } from "./lodash-vendor-BvHYc88w.js";
function Kh(e, t) {
...
var Ec;
function Jh() {
  return (Ec || ((Ec = 1), (si.exports = Yh())), si.exports);
}
var x = Jh(),
  b = wt();
const O = ur(b),
  Cc = Kh({ __proto__: null, default: O }, [b]);
var ci = {},
  ss = function (e, t) {
    return (
      (ss =
...
function kt() {
  if (Rc) return yn;
  ((Rc = 1), Object.defineProperty(yn, "__esModule", { value: !0 }), (yn.BridgeAPIError = void 0));
...
function ng() {
  return (
    Dc ||
      ((Dc = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), rr.__exportStar(rg(), e));
      })(li)),
    li
  );
}
...
function ag() {
  if (Mc) return wn;
  ((Mc = 1), Object.defineProperty(wn, "__esModule", { value: !0 }), (wn.invokeRemote = void 0));
  const e = ev(),
...
function og() {
  if (Nc) return kn;
  ((Nc = 1), Object.defineProperty(kn, "__esModule", { value: !0 }), (kn.invokeService = void 0));
  const e = ev(),
...
function sg() {
  if ($c) return Sn;
  (($c = 1), Object.defineProperty(Sn, "__esModule", { value: !0 }), (Sn.submit = void 0));
  const e = je(),
    t = kt(),
    r = (0, e.getCallBridge)(),
    n = async (a) => {
...
function cg() {
  if (Bc) return xn;
  ((Bc = 1), Object.defineProperty(xn, "__esModule", { value: !0 }), (xn.close = void 0));
  const e = je(),
    t = kt(),
    r = (0, e.getCallBridge)(),
    n = async (a) => {
...
function lg() {
  if (Fc) return En;
  ((Fc = 1), Object.defineProperty(En, "__esModule", { value: !0 }), (En.open = void 0));
  const e = je(),
    t = kt(),
    r = (0, e.getCallBridge)(),
    n = async () => {
...
function ug() {
  if (zc) return Cn;
  ((zc = 1), Object.defineProperty(Cn, "__esModule", { value: !0 }), (Cn.refresh = void 0));
  const e = je(),
    t = kt(),
    r = (0, e.getCallBridge)(),
    n = async (a) => {
...
function dg() {
  if (qc) return Pn;
  ((qc = 1), Object.defineProperty(Pn, "__esModule", { value: !0 }), (Pn.createHistory = void 0));
...
function vg() {
  if (Hc) return An;
  ((Hc = 1), Object.defineProperty(An, "__esModule", { value: !0 }), (An.Translator = void 0));
  const e = rv();
  class t {
    locale;
    translationsGetter;
...
function pg() {
  if (Wc) return jn;
  ((Wc = 1), Object.defineProperty(jn, "__esModule", { value: !0 }), (jn.ensureLocale = void 0));
  const e = tv(),
...
function bg() {
  if (Xc) return Rn;
  ((Xc = 1), Object.defineProperty(Rn, "__esModule", { value: !0 }), (Rn.getContext = void 0));
  const e = je(),
    t = nv(),
    r = (0, e.getCallBridge)(),
    n = async () => {
...
function yg() {
  if (Qc) return Dn;
  ((Qc = 1), Object.defineProperty(Dn, "__esModule", { value: !0 }), (Dn.theme = void 0));
  const t = (0, je().getCallBridge)();
...
function ov() {
  if (rl) return Mn;
  ((rl = 1), Object.defineProperty(Mn, "__esModule", { value: !0 }), (Mn.events = void 0));
  const e = je(),
    t = _g(),
    r = (0, e.getCallBridge)(),
    n = async (o, i) => {
...
function wg() {
  if (nl) return Tn;
  ((nl = 1), Object.defineProperty(Tn, "__esModule", { value: !0 }), (Tn.emitReadyEvent = void 0));
  const e = ov(),
    t = iv(),
    r = "EXTENSION_READY",
    n = async () => {
...
function iv() {
  if (al) return On;
  ((al = 1), Object.defineProperty(On, "__esModule", { value: !0 }), (On.view = void 0));
  const e = sg(),
    t = cg(),
    r = lg(),
    n = ug(),
...
function sv() {
  return (
    ol ||
      ((ol = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), rr.__exportStar(iv(), e));
      })(vi)),
    vi
  );
}
...
function kg() {
  if (il) return Nn;
  ((il = 1), Object.defineProperty(Nn, "__esModule", { value: !0 }), (Nn.router = void 0));
  const t = (0, je().getCallBridge)(),
    r = async (i) => {
...
function Sg() {
  if (cl) return Ln;
  ((cl = 1), Object.defineProperty(Ln, "__esModule", { value: !0 }), (Ln.Modal = void 0));
  const e = je(),
    t = kt(),
    r = (0, e.getCallBridge)(),
    n = () => {};
...
function xg() {
  return (
    ll ||
      ((ll = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), rr.__exportStar(Sg(), e));
      })(_i)),
    _i
  );
}
...
function Eg() {
  if (ul) return $n;
  ((ul = 1), Object.defineProperty($n, "__esModule", { value: !0 }), ($n.productFetchApi = void 0));
  const e = av(),
    t = async (a) => {
      const o = {};
...
function Pg() {
  if (fl) return Bn;
  ((fl = 1), Object.defineProperty(Bn, "__esModule", { value: !0 }), (Bn.showFlag = void 0));
  const e = je(),
    t = kt(),
    r = (0, e.getCallBridge)(),
    n = (a) => {
...
function Ag() {
  return (
    pl ||
      ((pl = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), rr.__exportStar(ov(), e));
      })(ki)),
    ki
  );
}
...
function jg() {
  if (hl) return Fn;
  ((hl = 1), Object.defineProperty(Fn, "__esModule", { value: !0 }), (Fn.realtime = void 0));
  const t = (0, je().getCallBridge)(),
...
function lr(e) {
  ...
  return typeof r == "function" && r.toString() === $g;
}
function fv(e) {
  var t = e?.constructor;
...
var pv = typeof Object.getOwnPropertySymbols < "u";
function Fg(e) {
  var t = Object.keys(e);
  if (!pv) return t;
...
function Ta(e, t, r) {
  (Qt(e, jt) || Bo(e, jt, Sr({}, e[jt])), Zg(r) || (e[jt][t] = r));
}
function Hg(e) {
  return (Qt(e, jt) || Bo(e, jt, Sr({}, e[jt])), e[jt]);
}
function Ma(e) {
...
function bv(e, t, r) {
  ...
  var n = new dr(e);
  return (t !== Jr && nm(n, t), r !== Jr && $v(n, r), n);
}
function Wg(e, t) {
  return Xv(e, t);
}
...
var bo = { structural: Wg, default: Kg };
function xr(e, t, r) {
  return qv(e)
    ? e
    : Array.isArray(e)
...
function mv(e, t, r, n, a) {
  var o, i, s, c, l, u, d;
  (a === void 0 && (a = I.safeDescriptors), rb(e, t, r, n));
  var f = n.value;
...
function nb(e, t, r, n) {
  ...
  var o = _v(e, this, t, r, !1, !1);
  return (It(n, t, o), 2);
}
function ab(e, t, r, n) {
  var a,
    o = _v(e, this, t, r, (a = this.options_) == null ? void 0 : a.bound);
...
var hb = "true",
  gb = wv();
function wv(e) {
  return { annotationType_: hb, options_: e, make_: bb, extend_: mb, decorate_20223_: yb };
}
function bb(e, t, r, n) {
  var a, o;
...
var _b = "observable",
  wb = "observable.ref",
  kb = "observable.shallow",
  Ob = "observable.struct",
  kv = { deep: !0, name: void 0, defaultDecorator: void 0, proxy: !0 };
Object.freeze(kv);
function Ua(e) {
  return e || kv;
}
var ds = qo(_b),
  Sb = qo(wb, { enhancer: zo }),
  xb = qo(kb, { enhancer: Yg }),
  Eb = qo(Ob, { enhancer: Jg }),
  Ov = Dt(ds);
function Va(e) {
  return e.deep === !0 ? xr : e.deep === !1 ? zo : Pb(e.defaultDecorator);
}
function Cb(e) {
  var t;
  return e ? ((t = e.defaultDecorator) != null ? t : wv(e)) : void 0;
}
function Pb(e) {
  var t, r;
...
var Rb = {
    ...
    array: function (t, r) {
      var n = Ua(r);
      return (I.useProxies === !1 || n.proxy === !1 ? Cm : bm)(t, Va(n), n.name);
    },
    map: function (t, r) {
      var n = Ua(r);
      return new Gv(t, Va(n), n.name);
    },
    set: function (t, r) {
      var n = Ua(r);
      return new Hv(t, Va(n), n.name);
    },
    object: function (t, r, n) {
      return Ir(function () {
        return sm(I.useProxies === !1 || n?.proxy === !1 ? fn({}, n) : pm({}, n), t, r);
      });
    },
    ref: Dt(Sb),
    shallow: Dt(xb),
...
var wl,
  ...
  Ib = 1,
  Db =
    (wl = (kl = go(function () {}, "name")) == null ? void 0 : kl.configurable) != null ? wl : !1,
  Ol = { value: "action", configurable: !0, writable: !1, enumerable: !1 };
function Er(e, t, r, n) {
  r === void 0 && (r = !1);
  function a() {
  ...
  _t = (function () {
    ...
    return (
      ...
      (t.computeValue_ = function (n) {
        ...
        var a = Vo(!1),
          o;
        if (n) o = Ev(this, this.derivation, this.scope_);
...
function Ev(e, t, r) {
  ...
  return (I.inBatch--, (I.trackingDerivation = a), $b(e), va(n), o);
}
function $b(e) {
  for (
    var t = e.observing_,
  ...
  for (; a--; ) {
    var l = r[a];
    l.diffValue === 1 && ((l.diffValue = 0), Fb(l, e));
  }
...
function Bb() {
  if (((I.pendingReactions.length || I.inBatch || I.isRunningReactions) && X(36), (Rv = !0), io)) {
    var e = No();
...
function Av(e, t) {
  (e.observers_.delete(t), e.observers_.size === 0 && jv(e));
}
function jv(e) {
...
function Iv(e) {
  ...
  return t !== null
    ? (t.runId_ !== e.lastAccessedBy_ &&
      ...
      e.isBeingObserved)
    : (e.observers_.size === 0 && I.inBatch > 0 && jv(e), !1);
}
function Dv(e) {
...
var Lt = (function () {
  ...
  return (
    ...
    (t.schedule_ = function () {
      this.isScheduled || ((this.isScheduled = !0), I.pendingReactions.push(this), Tv());
    }),
...
function Tv() {
  I.inBatch > 0 || I.isRunningReactions || hs(Vb);
}
function Vb() {
...
var Mv = "action",
  ...
  gs = Na(Mv),
  Jb = Na(Wb, { bound: !0 }),
  bs = Na(Nv, { autoAction: !0 }),
  Xb = Na(Kb, { autoAction: !0, bound: !0 });
function Lv(e) {
  var t = function (n, a) {
    if (yt(n)) return Er(n.name || Yb, n, e);
    if (yt(a)) return Er(n, a, e);
    if (Ma(a)) return (e ? bs : gs).decorate_20223_(n, a);
    if (Or(a)) return Ta(n, a, e ? bs : gs);
    if (Or(n)) return Dt(Na(e ? Nv : Mv, { name: n, autoAction: e }));
  };
  return t;
}
var ut = Lv(!1);
...
var am = "never",
  ...
  om = "observed";
function im(e) {
  e.isolateGlobalState === !0 && Bb();
  var t = e.useProxies,
    r = e.enforceActions;
  if (
    (t !== void 0 && (I.useProxies = t === Ga ? !0 : t === am ? !1 : typeof Proxy < "u"),
...
function Fv(e) {
  var t = { name: e.name_ };
  return (
    e.observing_ && e.observing_.length > 0 && (t.dependencies = lm(e.observing_).map(Fv)),
    t
  );
}
function lm(e) {
...
zv.prototype = Object.create(Error.prototype);
var xi = yv("flow"),
  dm = yv("flow.bound", { bound: !0 }),
...
function pm(e, t) {
  ...
  return (
    uv(),
    (e = fn(e, t)),
    (n = (r = e[L]).proxy_) != null ? n : (r.proxy_ = new Proxy(e, vm))
  );
}
function it(e) {
    ...
    return (
      ...
      (t.spliceWithArray_ = function (n, a, o) {
        ...
        if (
          ...
          var c = st(this, { object: this.proxy_, type: xl, index: n, removedCount: a, added: o });
          if (!c) return ls;
...
var mm = Rr("ObservableArrayAdministration", Ys);
function Wo(e) {
  return $o(e) && mm(e[L]);
}
var ym = {},
  ...
  Gv = (function () {
    function e(r, n, a) {
      ...
      (n === void 0 && (n = xr),
        ...
        yt(Map) || X(18),
        Ir(function () {
          ((o.keysAtom_ = bv("ObservableMap.keys()")),
            (o.data_ = new Map()),
            (o.hasMap_ = new Map()),
            r && o.merge(r));
        }));
    ...
    return (
      ...
      (t.replace = function (n) {
        ...
        return (
          Xt(function () {
            for (
              var o = _m(n), i = new Map(), s = !1, c = Xr(a.data_.keys()), l;
              !(l = c()).done;
  ...
  Hv = (function () {
    function e(r, n, a) {
      ...
      (n === void 0 && (n = xr),
        ...
        Ir(function () {
          ((o.atom_ = bv(o.name_)), r && o.replace(r));
        }));
    }
    var t = e.prototype;
    return (
...
var Pl = Object.create(null),
  ...
  Wv = (function () {
    ...
    return (
      ...
      (t.get_ = function (n) {
        return (I.trackingDerivation && !Qt(this.target_, n) && this.has_(n), this.target_[n]);
      }),
      ...
      (t.delete_ = function (n, a) {
        ...
        if (it(this)) {
          var o = st(this, { object: this.proxy_ || this.target_, name: n, type: Rl });
          if (!o) return null;
        }
        try {
          var i;
          ...
          if (
            (l && (this.values_.delete(n), l instanceof wr && (u = l.value_), Dv(l)),
...
function fn(e, t) {
  ...
  var n = (r = t?.name) != null ? r : "ObservableObject",
    a = new Wv(e, new Map(), String(n), Cb(t));
  return (Bo(e, L, a), e);
}
var km = Rr("ObservableObjectAdministration", Wv);
function Al(e) {
  return (
    Pl[e] ||
    (Pl[e] = {
    ...
    return (
      ...
      Ir(function () {
        ...
        ((c.proxy_ = s),
          ...
          Sm && Object.defineProperty(s, "0", Om));
      }),
      s
    );
  }
...
function Em(e) {
  It(Js.prototype, "" + e, Yv(e));
}
function Jv(e) {
  if (e > Ei) {
    for (var t = Ei; t < e + 100; t++) Em(t);
    Ei = e;
  }
}
Jv(1e3);
...
function Pm(e, t) {
  if ((e || X(29), Hs(e) || Ho(e) || wo(e) || jr(e) || At(e))) return e;
  if (e[L]) return e[L];
  X(24, e);
}
function ms(e, t) {
...
function Dl(e) {
  return Wo(e) ? e.slice() : un(e) || jr(e) || Jt(e) || At(e) ? Array.from(e.entries()) : e;
}
var Tl,
  Rm = ((Tl = No().Iterator) == null ? void 0 : Tl.prototype) || {};
function Xs(e) {
  return ((e[Symbol.iterator] = Am), Object.assign(Object.create(Rm), e));
}
function Am() {
  return this;
}
...
typeof __MOBX_DEVTOOLS_GLOBAL_HOOK__ == "object" &&
  __MOBX_DEVTOOLS_GLOBAL_HOOK__.injectMobx({ spy: Hb, extras: { getDebugName: ms }, $mobx: L });
...
var Tm = 1e4,
  ...
  Lm = typeof FinalizationRegistry < "u" ? FinalizationRegistry : Nm,
  xa = new Lm(function (e) {
    var t;
...
var Nl;
function Bm() {
  return (Nl || ((Nl = 1), (Ci.exports = $m())), Ci.exports);
}
var Fm = Bm();
function Ll(e) {
...
function zm(e, t) {
    ...
    var n = {
      ...
      subscribe: function (s) {
        return (
          xa.unregister(n),
          (n.onStoreChange = s),
          n.reaction || (Ll(n), (n.stateVersion = Symbol())),
          function () {
            var c;
  ...
  var a = r.current;
  (a.reaction || (Ll(a), xa.register(r, a, a)),
    O.useDebugValue(a.reaction, Dm),
...
function Um(e, t) {
  ...
  if ($l && e.$$typeof === $l && ((n = !0), (a = e.render), typeof a != "function"))
  ...
  return (
    ...
    qm && Object.defineProperty(i, "name", { value: e.name, writable: !0, configurable: !0 }),
...
var Vm = { $$typeof: !0, render: !0, compare: !0, type: !0, displayName: !0 };
function Gm(e, t) {
  Object.keys(e).forEach(function (r) {
    Vm[r] || Object.defineProperty(t, r, Object.getOwnPropertyDescriptor(e, r));
  });
}
var ji;
Im(To.unstable_batchedUpdates);
ji = xa.finalizeAllImmediately;
function Hm(e, t) {
  if (Fl(e, t)) return !0;
  ...
  for (var a = 0; a < r.length; a++)
    if (!Object.hasOwnProperty.call(t, r[a]) || !Fl(e[r[a]], t[r[a]])) return !1;
  return !0;
}
function Fl(e, t) {
  return e === t ? e !== 0 || 1 / e === 1 / t : e !== e && t !== t;
}
var zl = Symbol("patchMixins"),
  Qv = Symbol("patchedDefinition");
function Wm(e, t) {
  var r = (e[zl] = e[zl] || {}),
    n = (r[t] = r[t] || {});
...
function Ul(e, t) {
  var r = function () {
    for (var a = arguments.length, o = new Array(a), i = 0; i < a; i++) o[i] = arguments[i];
    ql.call.apply(ql, [this, e, t].concat(o));
  };
  return r;
}
function Km(e, t, r) {
...
var Vl = Symbol("ObserverAdministration"),
  Gl = Symbol("isMobXReactObserver");
function _s(e) {
  var t;
  return (t = e[Vl]) != null
    ? t
...
function Ym(e) {
  ...
  if (e.__proto__ !== b.PureComponent) {
    if (!t.shouldComponentUpdate) t.shouldComponentUpdate = Hl;
    else if (t.shouldComponentUpdate !== Hl)
      throw new Error(
  ...
  return (
    ...
    Km(t, "componentWillUnmount", function () {
      var i,
        s = _s(this);
...
function Jm(e) {
  var t = e.bind(this),
    r = _s(this);
  function n() {
    r.reaction || ((r.reaction = Xm(r)), r.mounted || xa.register(this, r, this));
    var a = void 0,
      o = void 0;
    if (
...
function Hl(e, t) {
  return this.state !== t ? !0 : !Hm(this.props, e);
}
function Yo(e, t) {
  return (
    e.isMobxInjector === !0 &&
...
function tp(e) {
  var t = e.children,
    ...
    a = O.useRef(ks({}, n, r)),
    o = a.current;
  return O.createElement(Wl.Provider, { value: o }, t);
}
tp.displayName = "MobXProvider";
O.version.split(".")[0];
...
var ey = Object.defineProperty,
  ...
  Ee = (e, t, r, n) => {
    for (var a = n > 1 ? void 0 : n ? ty(t, r) : t, o = e.length - 1, i; o >= 0; o--)
...
function Kl(e, t) {
  for (var r = 0; r < t.length; r++) {
    ...
    ((n.enumerable = n.enumerable || !1),
      (n.configurable = !0),
      "value" in n && (n.writable = !0),
      Object.defineProperty(e, np(n.key), n));
  }
}
function he(e, t, r) {
  return (
...
function my(e, t, r) {
  return (
    (t = J(t)),
    qe(e, lp() ? Reflect.construct(t, r || [], J(e).constructor) : t.apply(e, r))
  );
}
function lp() {
  try {
    ...
    he(t, [
      {
        key: "update",
        value: function (n) {
          return this.hasFired ? this : yy(t, "update", this, 3)([n]);
        },
      },
    ])
  );
...
function Py() {
  if (uu) return Ha;
  ((uu = 1), Object.defineProperty(Ha, "__esModule", { value: !0 }));
  const e = cr();
  let t = class {
    constructor(n) {
      ((this._sdkKey = n),
...
var Wa = "@all-features",
  Ly = (function () {
    function e() {
      (pe(this, e), C(this, "eventToValue", new Map()), (this.emitter = new Ny()));
    }
    return he(e, [
      {
        key: "onGateUpdated",
...
var Ka = function (t) {
    return xs({ perimeter: By() ? Ca.FEDRAMP_MODERATE : Ca.COMMERCIAL }, t);
  },
  Un = function (t, r) {
    if (!t && !r) return !0;
    if (!t || !r) return !1;
  ...
  qy = Object.entries(Qs).map(function (e) {
    var t = Z(e, 2),
      r = t[0],
      n = t[1];
...
function Cs(e) {
  ...
  return (
    (Cs = function (n) {
      ...
      function a() {
        return Vy(n, arguments, J(this).constructor);
      }
      return (
...
function Gy(e, t, r) {
  return (
    (t = J(t)),
    qe(e, mp() ? Reflect.construct(t, r || [], J(e).constructor) : t.apply(e, r))
  );
}
function mp() {
  try {
...
var Wy = 5e3,
  Ky = "https://api.atlassian.com/flags",
  Yy = "https://api.stg.atlassian.com/flags",
  Jy = "https://api.dev.atlassian.com/flags",
  Xy = "https://api.stg.atlassian-us-gov-mod.com/flags",
  Zy = "https://api.atlassian-us-gov-mod.com/flags",
  Qy = "https://atlassian-statsig-proxy-archetype.atl-paas.%s.atl-ic.net",
  e_ = "oasis-stg.com/flags",
  t_ = "atlassian-isolated.net/flags",
    ...
    return he(e, null, [
                ...
                for (;;)
                  switch ((s.prev = s.next)) {
                    ...
                    case 5:
                      ...
                      throw new Ou("Unexpected 204 response");
                    case 7:
                    case "end":
                      return s.stop();
                  }
      ...
      },
      {
        ...
        value: function (r) {
          ...
          if (n === void 0) return r ? Qy.replace("%s", r) : null;
          var a = n.protocol,
            o = n.hostname,
            i = o.match(/([^.]+)\.oasis-stg\.com$/);
          if (i) return "".concat(a, "//api.").concat(i[1], ".").concat(e_);
          var s = o.match(/([^.]+)\.atlassian-isolated\.net$/);
          return s ? "".concat(a, "//api.").concat(s[1], ".").concat(t_) : null;
        },
      },
      {
...
var o_ = (function (e) {
  function t() {
    ...
    return (
      pe(this, t),
      (r = n_(this, t, ["NoFetchDataAdapter", "nofetch"])),
...
var Wi = "LocalOverride:Recognized",
  c_ = "STATSIG_OVERRIDES",
  Pu = "STATSIG_JS_LITE_LOCAL_OVERRIDES",
  Br = function () {
  ...
  u_ = ["sdkKey", "environment", "updateUserCompletionCallback", "perimeter"];
function Ru(e, t) {
  var r = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e);
...
var Au = "client-default-key",
  d_ = "https://xp.atlassian.com/v1/rgstr",
  f_ = (function () {
    function e() {
      var t = this,
      ...
      (pe(this, e),
        ...
        C(this, "subscriptions", new Ly()),
        C(this, "dataAdapter", new o_()),
        C(this, "statsigValuesUpdated", function () {
          (t.user && t.statsigClient.updateUserSync(t.user, { disableBackgroundCacheRefresh: !0 }),
            t.subscriptions.anyUpdated());
        }),
        (this.overrideAdapter = o || new l_(a)));
    }
    return he(e, [
      {
        key: "initialize",
        ...
        value: function (r) {
          ...
          try {
            ...
            return (
              ...
              new wu(r, {}, "", { time: Date.now(), reason: Qs.Error })
            );
          }
        },
      },
                    ...
                    switch ((g.prev = g.next)) {
                      ...
                      case 19:
                        return (
                          ...
                          (this.statsigClient = new gt.StatsigClient(Au, this.user, p)),
                ...
                function (m) {
                  for (;;)
                    switch ((m.prev = m.next)) {
                      ...
                      case 4:
                        ((l = m.sent), (u = _u(o, l.customAttributesFromFetch)), (m.next = 13));
                        break;
                      case 8:
                        throw (
                          (m.prev = 8),
        ...
        value: function (r) {
          ...
          try {
            ...
            var a = n.fireLayerExposure,
              o = a === void 0 ? !0 : a;
            return ku.fromLayer(this.statsigClient.getLayer(r, { disableExposureLog: !o }));
          } catch (i) {
            return (
              ...
              ku.fromLayer(gt._makeLayer(r, { reason: "Error" }, null))
            );
          }
        },
      },
...
if (typeof window < "u")
  if (window.__FEATUREGATES_JS__ === void 0) window.__FEATUREGATES_JS__ = K;
    ...
    if (ju !== Zr) {
      var v_ = `Multiple versions of FeatureGateClients found on the current page.
...
var Fr,
  ...
  g_ = function () {
    var t;
    h_ && (t = console).debug.apply(t, arguments);
  },
  ec = {},
  b_ = "@atlaskit/platform-feature-flags",
  ha = "__PLATFORM_FEATURE_FLAGS__",
  _p = typeof process < "u" && typeof ec < "u",
  m_ = _p ? ec.ENABLE_PLATFORM_FF === "true" : !1,
  y_ = _p ? ec.STORYBOOK_ENABLE_PLATFORM_FF === "true" : !1,
  __ = m_ || y_,
...
function E_(e, t) {
  var r = b.useState(function () {
    ...
    n = b.useRef(!0),
    a = b.useRef(r),
    o = n.current || !!(t && a.current.inputs && x_(t, a.current.inputs)),
    ...
    f = b.useCallback(
      function (p) {
        var h = l({
          ...
          v = P_({ componentName: n, packageName: o, packageVersion: i }, u.current);
        h.context.push(v);
        var g = h.clone();
    ...
    d = b.useCallback(
      function () {
        var f = c({
          ...
          p = R_({ componentName: n, packageName: a, packageVersion: o }, l.current);
        f.context.push(p);
        var h = f.clone();
...
function R(e) {
  ...
  for (const n of e) {
    ...
    const a = n.split(" ");
    for (const o of a) {
      const i = o.startsWith("_") ? o.slice(0, j_) : o;
      t[i] = o;
    }
  }
  let r = "";
...
var Mu = "#FF5630",
  ...
  Wn = "#1B2638",
  Vr = "#0D1424",
  $_ = ["isFixedSize", "hasDataRow", "children", "testId", "isLoading"];
function Uu(e, t) {
  var r = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e);
    ...
    return b.createElement(
      ...
      W({ inert: i ? "" : void 0, ref: t }, s, {
        ...
        style: Vu(
          ...
          {},
          { "--_k02y3n": be("2px solid ".concat("var(--ds-border, ".concat(As, ")"))) },
        ),
      }),
      a,
    );
...
function W_(e) {
  var t = (function (r) {
    function n() {
      ...
      return ((a = G_(this, n, [].concat(i))), C(a, "state", { pageRows: [] }), a);
    }
    return (
      Ue(n, r),
      he(
        ...
        [
          {
            ...
            value: function (o, i) {
              ...
              var h, v;
              return (
                p ? ((h = s), (v = s)) : ((h = H_(c, s, l, u) || []), (v = ip(h, d, f))),
                Hu(Hu({}, i), {}, { pageRows: v })
              );
            },
          },
...
var K_ = "--local-dynamic-table-width",
  xp = function (t) {
    var r = t.width;
    return typeof r < "u" ? C({}, K_, "".concat(r, "%")) : void 0;
  },
  ...
  X_ = ["isHighlighted", "children", "style", "testId", "className"];
function Ku(e, t) {
  var r = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e);
...
var Z_ = b.forwardRef(function (e, t) {
...
var n0 = (function (e) {
    function t() {
      return (pe(this, t), r0(this, t, arguments));
    }
    return (
      Ue(t, e),
      he(t, [
  ...
  a0 = W_(
    O.forwardRef(function (e, t) {
      return O.createElement(n0, W({}, e, { forwardedRef: t }));
    }),
  );
function o0(e, t, r) {
  return (
...
var i0 = (function (e) {
  function t(r) {
    var n;
    return (pe(this, t), (n = o0(this, t, [r])), (n.state = { hasError: !1 }), n);
  }
  return (
    Ue(t, e),
    he(
...
var s0 = { xsmall: 12, small: 16, medium: 24, large: 48, xlarge: 96 };
function c0(e) {
  return e === "inherit"
...
var Ja = {
  ...
  l0 = typeof window > "u" ? b.useEffect : b.useLayoutEffect,
  rc = O.memo(
  ...
  d0 = function (t) {
    ...
    return b.createElement(
      "div",
      {
        ...
        style: Xu(Xu({}, C({}, Zu, n)), {}, { "--_cnddr8": be("var(".concat(Zu, ")")) }),
      },
      r,
    );
  },
...
var Rp = (function (e) {
  function t() {
    return (pe(this, t), v0(this, t, arguments));
  }
  return (
    Ue(t, e),
    he(t, [
      {
        ...
        value: function () {
          ...
          return O.createElement(
            u0,
            { testId: c },
            o ? O.createElement(d0, { contentsOpacity: s, testId: c }, a) : a,
            o &&
              O.createElement(
                f0,
                { testId: c },
...
function m0(e, t, r) {
  return (
    (t = J(t)),
    qe(e, Ap() ? Reflect.construct(t, r || [], J(e).constructor) : t.apply(e, r))
  );
}
function Ap() {
  try {
...
C(jp, "defaultProps", {
  isLoading: !0,
  spinnerSize: Ro,
  contentsOpacity: "var(--ds-opacity-loading, ".concat("".concat(kp), ")"),
  loadingLabel: "Loading table",
});
function y0(e) {
  var t =
...
var Kn = {},
  ...
  Qu = b.memo(function (t) {
    var r,
      ...
      m = n.name,
      _ = f ? { __html: f } : void 0;
    if (d && !ve("platform-visual-refresh-icons"))
    ...
    return b.createElement(
      ...
      b.createElement("svg", {
        ...
        className: R([
          ...
          p ? "_1bsb1kw7 _4t3i1kw7" : w === "utility" ? k0[g] : k === "small" ? w0[g] : _0[g],
        ]),
      }),
    );
  });
const x0 = Object.freeze(
    Object.defineProperty({ __proto__: null, Icon: Qu, default: Qu }, Symbol.toStringTag, {
      value: "Module",
    }),
  ),
  Xo = Vs(x0);
...
function E0() {
  if (ed) return Yn;
  ((ed = 1), Object.defineProperty(Yn, "__esModule", { value: !0 }), (Yn.default = void 0));
  var e = r(wt()),
    t = r(Xo);
  function r(a) {
...
const P0 = Object.freeze(
    Object.defineProperty({ __proto__: null, Icon: nd, default: nd }, Symbol.toStringTag, {
      value: "Module",
    }),
  ),
  Ip = Vs(P0);
...
function R0() {
  if (ad) return Jn;
  ((ad = 1), Object.defineProperty(Jn, "__esModule", { value: !0 }), (Jn.default = void 0));
  var e = r(wt()),
    t = Ip;
  function r(a) {
    return a && a.__esModule ? a : { default: a };
...
function A0() {
  if (od) return Kn;
  ((od = 1), Object.defineProperty(Kn, "__esModule", { value: !0 }), (Kn.default = void 0));
  var e = n(wt()),
    t = n(E0()),
    r = n(R0());
  function n(o) {
...
function D0() {
  if (id) return Zn;
  ((id = 1), Object.defineProperty(Zn, "__esModule", { value: !0 }), (Zn.default = void 0));
  var e = r(wt()),
    t = r(Xo);
  function r(a) {
    return a && a.__esModule ? a : { default: a };
...
function T0() {
  if (sd) return Qn;
  ((sd = 1), Object.defineProperty(Qn, "__esModule", { value: !0 }), (Qn.default = void 0));
  var e = r(wt()),
    t = Ip;
  function r(a) {
    return a && a.__esModule ? a : { default: a };
...
function M0() {
  if (cd) return Xn;
  ((cd = 1), Object.defineProperty(Xn, "__esModule", { value: !0 }), (Xn.default = void 0));
  var e = n(wt()),
    t = n(D0()),
    r = n(T0());
  function n(o) {
...
var K0 = W0(),
  ...
  X0 = { column: "_2lx21bp4", row: "_2lx2vrvc" },
  ...
  so = b.memo(
    b.forwardRef(function (e, t) {
      var r = e.as,
        ...
        g = e.children,
        m = Q(e, tw),
        _ = typeof f == "string" ? b.createElement(rw, null, f) : f,
        w = _
      ...
      return b.createElement(
        ...
        W({}, m, {
          ...
          rowGap: d,
          wrap: s ? "wrap" : void 0,
          xcss: Mp(l === "hug" && Is.hug, l === "fill" && Is.fill, p),
          testId: h,
          ref: t,
        }),
        w,
...
var nw = "Invariant failed";
function aw(e, t) {
  if (!e) throw new Error(nw);
}
var Np = b.createContext(!1),
  ow = function () {
    return b.useContext(Np);
  },
  iw = Np.Provider,
  sw = ["span", "p", "strong", "em"],
  cw = function (t, r) {
  ...
  uw = { bold: "_k48pmoej", medium: "_k48p1wq8", regular: "_k48pi7a9", semibold: "_k48p1pd9" },
  dw = {
  ...
  Lp = b.forwardRef(function (e, t) {
    ...
    return p ? v : b.createElement(iw, { value: !0 }, v);
  });
function fw() {
...
var vw = ["as", "children", "isInset", "testId", "style", "xcss"],
  pw = ["className"];
function fd(e, t) {
  var r = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
...
var ac = b.forwardRef(function (e, t) {
    ...
    return b.createElement(
      ...
      W({}, u, {
        ...
        style: vd(
          vd({}, s),
          {},
          { "--_12dc40g": be("calc(0px - ".concat("var(--ds-border-width-focused, 2px)", ")")) },
        ),
      }),
      a,
    );
  ...
  gw = ["className"],
  pd = { root: "_19itglyw _vchhusvi _r06hglyw _80omtlke", disabled: "_80om13gf" },
  $p = b.forwardRef(function (e, t) {
    ...
    return b.createElement(
      ac,
      W({ as: "button", tabIndex: h ?? (fw() && !n ? 0 : void 0), style: d }, w, {
        type: o,
        onClick: _,
        disabled: n,
        xcss: Tp(pd.root, n && pd.disabled, p),
        testId: f,
        ref: t,
      }),
      r,
...
function Bp() {
  if (hd) return ea;
  ((hd = 1), Object.defineProperty(ea, "__esModule", { value: !0 }), (ea.bind = void 0));
  function e(t, r) {
    var n = r.type,
      a = r.listener,
      o = r.options;
...
function qp() {
  return co && ve("platform-dst-react-18-use-id")
    ? ve("platform-dst-react-18-use-id-selector-safe")
      ? co().replace(/[:«»]/g, "_")
      : co()
    : "uid".concat(Pw());
}
function Aw() {
  if (co && ve("platform-dst-react-18-use-id")) {
    var e = qp();
    return function (t) {
...
function ta(e, t) {
  return qw(ri("", null, null, "", null, null, 0), e, { length: -e.length }, t);
}
function Hw() {
  return _e;
}
...
function Ye() {
  return ((_e = ze < Hp ? xe(vn, ze++) : 0), an++, _e === 10 && ((an = 1), ti++), _e);
}
function Mt() {
  return xe(vn, ze);
}
...
function Wp(e) {
  return ((ti = an = 1), (Hp = Pt((vn = e))), (ze = 0), []);
}
function Kp(e) {
  return ((vn = ""), e);
}
function uo(e) {
  return Gp(Ba(ze - 1, Ts(e === 91 ? e + 2 : e === 40 ? e + 1 : e)));
}
function Kw(e) {
  for (; (_e = Mt()) && _e < 33; ) Ye();
  ...
  for (
    ...
    switch (((h = _), (_ = Ye()))) {
        ...
        switch (_) {
          ...
          case 59 + u:
            (m == -1 && (E = re(E, /\f/g, "")),
              p > 0 &&
                Pt(E) - d &&
                Xa(p > 32 ? yd(E + ";", n, r, d - 1) : yd(re(E, " ", "") + ";", n, r, d - 2), c));
            break;
          case 59:
            E += ";";
          default:
            if ((Xa((S = md(E, t, r, l, u, a, s, w, (k = []), (y = []), d)), o), _ === 123))
                ...
                switch (f === 99 && xe(E, 3) === 110 ? 100 : f) {
                  ...
                  case 115:
                    fo(
                      ...
                      S,
                      S,
                      n && Xa(md(e, S, S, 0, 0, a, s, w, a, (k = []), d), y),
                      a,
                      y,
                      d,
                      s,
      ...
      default:
        if (v < 1) {
          if (_ == 123) --v;
          else if (_ == 125 && v++ == 0 && Ww() == 125) continue;
        }
        switch (((E += ei(_)), _ * v)) {
          case 38:
            m = u > 0 ? 1 : ((E += "\f"), -1);
          ...
          case 44:
            ...
            break;
          case 64:
            (Mt() === 45 && (E += uo(Ye())), (f = Mt()), (u = d = Pt((w = E += Xw(lo())))), _++);
            break;
          case 45:
            h === 45 && Pt(E) == 2 && (v = 0);
        }
...
function md(e, t, r, n, a, o, i, s, c, l, u) {
  for (var d = a - 1, f = a === 0 ? o : [""], p = cc(f), h = 0, v = 0, g = 0; h < n; ++h)
    for (var m = 0, _ = Pa(e, d + 1, (d = zw((v = i[h])))), w = e; m < p; ++m)
      (w = Gp(v > 0 ? f[m] + " " + _ : re(_, /&\f/g, f[m]))) && (c[g++] = w);
  return ri(e, t, r, a === 0 ? ic : s, c, l, u);
}
function Qw(e, t, r) {
  return ri(e, t, r, Up, ei(Hw()), Pa(e, 2, -2), 0);
}
function yd(e, t, r, n) {
  return ri(e, t, r, sc, Pa(e, 0, n), Pa(e, n + 1, -1), n);
}
function Qr(e, t) {
...
var ak = function (t, r, n) {
  ...
  ok = function (t, r) {
    ...
    do
      switch (Ra(a)) {
        case 0:
          (a === 38 && Mt() === 12 && (r[n] = 1), (t[n] += ak(ze - 1, r, n)));
          break;
        case 2:
          t[n] += uo(a);
          break;
  ...
  sk = function (t) {
    if (!(t.type !== "rule" || !t.parent || t.length < 1)) {
      ...
      if (!(t.props.length === 1 && r.charCodeAt(0) !== 58 && !_d.get(n)) && !a) {
        _d.set(t, !0);
        for (var o = [], i = ik(r, o), s = n.props, c = 0, l = 0; c < i.length; c++)
...
var kd;
function vk() {
  return (kd || ((kd = 1), (Qi.exports = fk())), Qi.exports);
}
var es, Od;
function pk() {
  if (Od) return es;
...
var lc = function (t, r, n) {
    var a = t.key + "-" + r.name;
    (n === !1 || hk === !1) && t.registered[a] === void 0 && (t.registered[a] = r.styles);
  },
  Xp = function (t, r, n) {
    lc(t, r, n);
    var a = t.key + "-" + r.name;
...
var bk = {
  ...
  ts = nk(function (e) {
    return Zp(e) ? e : e.replace(mk, "-$&").toLowerCase();
  }),
  xd = function (t, r) {
    switch (t) {
      case "animation":
      case "animationName":
        if (typeof r == "string")
          return r.replace(yk, function (n, a, o) {
            return ((Rt = { name: a, styles: o, next: Rt }), a);
          });
    }
    return bk[t] !== 1 && !Zp(t) && typeof r == "number" && r !== 0 ? r + "px" : r;
  };
function Aa(e, t, r) {
  if (r == null) return "";
  var n = r;
  ...
  if (Array.isArray(r)) for (var a = 0; a < r.length; a++) n += Aa(e, t, r[a]) + ";";
    ...
    for (var o in r) {
      ...
      if (typeof i != "object") {
        ...
        for (var c = 0; c < i.length; c++) Sd(i[c]) && (n += ts(o) + ":" + xd(o, i[c]) + ";");
      else {
        var l = Aa(e, t, i);
        switch (o) {
          case "animation":
...
function uc(e, t, r) {
  ...
  Ed.lastIndex = 0;
  for (var l = "", u; (u = Ed.exec(a)) !== null; ) l += "-" + u[1];
  var d = gk(a) + l;
...
var wk = function (t) {
  ...
  kk = Cc.useInsertionEffect ? Cc.useInsertionEffect : !1,
  Qp = kk || wk,
  eh = b.createContext(typeof HTMLElement < "u" ? dk({ key: "css" }) : null);
eh.Provider;
var th = function (t) {
  ...
  xk = th(function (e, t, r) {
    ...
    return (
      ...
      b.createElement(
        b.Fragment,
        null,
        b.createElement(Sk, { cache: t, serialized: s, isStringTag: typeof a == "string" }),
        b.createElement(a, c),
      )
    );
  }),
...
var Rk = function (t) {
  ...
  Ak = th(function (e, t) {
    ...
    return b.createElement(
      b.Fragment,
      null,
      b.createElement(Rk, { cache: t, serializedArr: r }),
      i,
    );
  });
function nh(e, t) {
    ...
    background: {
      default: {
        ...
        hover: {
          ...
          dark: "var(--ds-background-neutral-hovered, ".concat(qu, ")"),
        },
        active: {
      ...
      primary: {
        ...
        hover: {
          light: "var(--ds-background-brand-bold-hovered, ".concat(Fu, ")"),
      ...
      warning: {
        default: {
          light: "var(--ds-background-warning-bold, ".concat($u, ")"),
          dark: "var(--ds-background-warning-bold, ".concat($u, ")"),
        },
        hover: {
          light: "var(--ds-background-warning-bold-hovered, ".concat(Lu, ")"),
          dark: "var(--ds-background-warning-bold-hovered, ".concat(Lu, ")"),
        },
        active: {
      ...
      danger: {
        default: {
          light: "var(--ds-background-danger-bold, ".concat(Nu, ")"),
          dark: "var(--ds-background-danger-bold, ".concat(Nu, ")"),
        },
        hover: {
          light: "var(--ds-background-danger-bold-hovered, ".concat(Mu, ")"),
          dark: "var(--ds-background-danger-bold-hovered, ".concat(Mu, ")"),
        },
        active: {
      ...
      subtle: {
        ...
        hover: {
          ...
          dark: "var(--ds-background-neutral-subtle-hovered, ".concat(qu, ")"),
        },
        active: {
...
var sr = 8,
  ...
  Lk = { default: Bs.default, compact: Bs.compact, none: "inherit" },
  $k = {
    default: "0 ".concat(sr + sr / 4, "px"),
    compact: "0 ".concat(sr + sr / 4, "px"),
    none: "0",
  },
  Bk = { compact: "0 ".concat(sr / 4, "px"), default: "0 ".concat(sr / 4, "px"), none: "0" },
    ...
    se(
      se(
        se(
          ...
          !ve("platform-component-visual-refresh") && s,
        ),
        {},
        {
          cursor: "pointer",
        ...
        !ve("platform-component-visual-refresh") &&
          se(
            se(
              {
                "&:visited": se({}, s),
              ...
              se(
                se(
                  se(
                    se(
                      se(
                        se(se({}, t === "default" && zk), t === "primary" && qk),
                        t === "link" && Uk,
                      ),
                      t === "subtle" && Vk,
                    ),
...
var Zk = {
  ...
  n1 = function (t, r) {
    return fc(t) ? t : t ? Zt("span", { css: r }, t) : null;
  },
    ...
    return (
      ...
      Zt(
        ...
        Zt(
          ...
          v ? Zt("span", { css: [Te, Dd({ spacing: $ }), Td(l, t1)] }, v) : null,
          n1(l, [Te, Jk({ spacing: $ })]),
          h ? Zt("span", { css: [Te, Dd({ spacing: $ }), Td(l, r1)] }, h) : null,
          T ? Zt("span", { css: [Zk, Me] }, T) : null,
        ),
      )
    );
  });
  ...
  vc = O.memo(
    O.forwardRef(function (t, r) {
      var n = t.appearance,
        ...
        w = Mw(),
        k = w.mode,
        y = o1({ children: o, iconBefore: i, iconAfter: s }),
        S = b.useState(!1),
        E = Z(S, 2),
        A = E[0],
        D = E[1],
...
function s1(e) {
  return O.createElement(vc, W({}, e, { appearance: "subtle" }));
}
var c1 = { container: "_1e0c1txw _kqswh2mm" };
function l1(e) {
  var t = e.key,
    r = e.testId,
    n = e.from,
  ...
  return O.createElement(
    Zo,
    { as: "li", testId: r, key: t, xcss: c1.container, paddingInline: "space.100" },
    O.createElement(
      Lp,
      ...
      return O.createElement(
        ...
        O.createElement(
          s1,
          {
            component: n.Page,
            onClick: function (me) {
              return F({ event: me, selectedPageIndex: V });
            },
  ...
  return O.createElement(
    ...
    O.createElement(
      ...
      O.createElement(Nd, {
        ...
        isDisabled: T || q === 0,
        iconBefore: O.createElement(Fd, { chevronDirection: "left" }),
        "aria-label": f,
      ...
      O.createElement(
        ...
        v1(y, q, { max: _, ellipsis: A, transform: G }, P),
      ),
      O.createElement(Nd, {
        key: "right-navigator",
        component: n.Next,
        ...
        iconBefore: O.createElement(Fd, { chevronDirection: "right" }),
        "aria-label": h,
...
var qd = "--local-dynamic-table-text-color",
  ...
  ch = b.forwardRef(function (e, t) {
    var r = e.width,
      ...
      d = Q(e, w1),
      f = ra(
        ra(ra({}, l), r && xp({ width: r })),
        {},
        C({}, qd, "var(--ds-text-subtlest, ".concat(zu, ")")),
      ),
      p = o === Cr,
      h = o === Po,
      v = function () {
      ...
      g = n ? "th" : "td",
      m = ve("platform-component-visual-refresh");
    return b.createElement(
      g,
      W({ "aria-sort": v(), onClick: m ? void 0 : c, ref: t, "data-testid": u }, d, {
        ...
        style: ra(
          ...
          {
            "--_k02y3n": be("2px solid ".concat("var(--ds-border, ".concat(As, ")"))),
            "--_17ckjys": be("var(--ds-text-subtle, ".concat("var(".concat(qd, ")"), ")")),
            "--_jz8ahf": be("solid 2px ".concat("var(--ds-border-focused, ".concat(Ao, ")"))),
            "--_6j4ewu": be("var(--ds-background-neutral-hovered, ".concat(js, ")")),
            "--_1rdacuj": be("3px solid ".concat("var(--ds-icon-disabled, ".concat(As, ")"))),
            "--_1qca9zt": be("3px solid ".concat("var(--ds-icon-subtle, ".concat(zu, ")"))),
          },
        ),
      }),
      n,
...
function C1() {
  if (Vd) return aa;
  ((Vd = 1), Object.defineProperty(aa, "__esModule", { value: !0 }), (aa.default = void 0));
  var e = r(wt()),
    t = r(Xo);
  function r(a) {
    return a && a.__esModule ? a : { default: a };
...
function j1(e) {
  var t = e.onClose,
    ...
    a = b.useCallback(
      function (i) {
        r || n.current || i.key !== A1 || ((n.current = !0), t(i));
      },
      [t, r],
    ),
  ...
  b.useEffect(
    function () {
      if (!(r && ve("platform_only_attach_escape_handler_on_view")))
        return Qo.bindAll(
          document,
          [
...
var da = { none: 0, small: 100, medium: 350, large: 700 },
  ns = 0.5,
  N1 = { none: da.none, small: da.small * ns, medium: da.medium * ns, large: da.large * ns },
  L1 = function () {
  ...
  Gd = function (t) {
    ...
    return O.createElement(fh.Provider, { key: "".concat(t.key, "-provider"), value: r }, t);
  },
  Hd = function (t) {
    var r = [];
    return (
  ...
  z1 = function (t, r) {
    for (var n = r.concat([]), a = q1(r), o = 0; o < t.length; o++) {
      var i = t[o],
        s = !a[i.key];
      s && n.splice(o + 1, 0, i);
    }
...
var Z1 = function (t) {
  ...
  ia = "popper",
  rO = "reference",
  Yd = Fa.reduce(function (e, t) {
    return e.concat([t + "-" + on, t + "-" + ja]);
  }, []),
  hh = [].concat(Fa, [pc]).reduce(function (e, t) {
...
function za(e) {
  for (var t = Je(e), r = Jd(e); r && gO(r) && tr(r).position === "static"; ) r = Jd(r);
...
var OO = { top: "auto", right: "auto", bottom: "auto", left: "auto" };
function SO(e, t) {
  var r = e.x,
    n = e.y,
...
function Xd(e) {
  ...
  var T = Object.assign({ position: s }, l && OO),
    B = u === !0 ? SO({ x: p, y: v }, Je(r)) : { x: p, y: v };
  if (((p = B.x), (v = B.y), c)) {
    var $;
...
const EO = { name: "computeStyles", enabled: !0, phase: "beforeWrite", fn: xO, data: {} };
var Za = { passive: !0 };
function CO(e) {
  var t = e.state,
    r = e.instance,
...
function Qd(e, t, r) {
  return t === ph ? qs(jO(e, r)) : Pr(t) ? DO(t, r) : qs(IO(fr(e)));
}
function TO(e) {
  var t = ma(ni(e)),
...
function MO(e, t, r, n) {
  var a = t === "clippingParents" ? TO(e) : [].concat(t),
    o = [].concat(a, [r]),
    i = o[0],
    s = o.reduce(
      function (c, l) {
...
function Ia(e, t) {
  ...
  var r = t,
    ...
    v = r.padding,
    g = v === void 0 ? 0 : v,
    m = yh(typeof g != "number" ? g : _h(g, Fa)),
    _ = f === ia ? rO : ia,
    w = e.rects.popper,
    k = e.elements[h ? _ : f],
    y = MO(Pr(k) ? k : k.contextElement || fr(e.elements.popper), c, u, i),
  ...
  if (!t.modifiersData[n]._skip) {
    for (
      var a = r.mainAxis,
        ...
        _ = m === g,
        w = c || (_ || !h ? [vo(g)] : LO(g)),
        k = [g].concat(w).reduce(function (de, fe) {
          return de.concat(
            Nt(fe) === pc
              ? NO(t, {
                  placement: fe,
...
const VO = { name: "offset", enabled: !0, phase: "main", requires: ["popperOffsets"], fn: UO };
function GO(e) {
  var t = e.state,
    r = e.name;
...
const HO = { name: "popperOffsets", enabled: !0, phase: "read", fn: GO, data: {} };
function WO(e) {
  return e === "x" ? "y" : "x";
}
function KO(e) {
  ...
  if (S) {
    if (o) {
      var $,
        ...
        H = _ === on ? -A[F] : -E[F],
        we = t.elements.arrow,
        de = p && we ? gc(we) : { width: 0, height: 0 },
        ...
        Te = fe[U],
        ke = ba(0, E[F], de[F]),
        Me = w ? E[F] / 2 - V - ke - me - P.mainAxis : ge - ke - me - P.mainAxis,
    ...
    if (s) {
      var tt,
        ...
        Ft = [$e, Be].indexOf(m) !== -1,
        Dr = (tt = T?.[y]) != null ? tt : 0,
        ue = Ft ? Se : Ie - E[ne] - A[ne] - Dr + P.altAxis,
        nr = Ft ? Ie + E[ne] + A[ne] - Dr - P.altAxis : Pe,
        rt = p && Ft ? mO(ue, Ie, nr) : ba(p ? ue : Se, Ie, p ? nr : Pe);
      ((S[y] = rt), (B[y] = rt - Ie));
    }
    t.modifiersData[n] = B;
  }
    ...
    var u = {
      ...
      p = {
        ...
        setOptions: function (m) {
          ...
          var w = tS(nS([].concat(n, u.options.modifiers)));
          return (
        ...
        forceUpdate: function () {
          if (!f) {
            ...
            if (nf(_, w)) {
              ((u.rects = {
                reference: QO(_, za(w), u.options.strategy === "fixed"),
                popper: gc(w),
              }),
                (u.reset = !1),
...
var oS = [PO, HO, EO, hO, VO, BO, YO, kO, zO],
  iS = aS({ defaultModifiers: oS }),
  as,
  af;
function sS() {
  if (af) return as;
    ...
    var a = b.useRef(null),
      ...
      u = b.useMemo(
        function () {
          ...
          return lS(a.current, f) ? a.current || f : ((a.current = f), f);
        },
...
function _S(e) {
    ...
    m = b.useMemo(
      function () {
        var w = {
          ...
          y = p ? gS({ viewportPadding: Us }) : [];
        return [].concat(bS, [w, k], He(y));
      },
      [v, g, p],
    ),
    _ = b.useMemo(
  ...
  return O.createElement(hS, { modifiers: _, placement: i, strategy: d, referenceElement: c }, r);
}
...
var PS = function (t) {
  ...
  IS = function (t, r) {
    var n = { layer: jS(Number(r)), zIndex: r };
...
function TS(e) {
  ...
  return (
    DS(r),
    ve("platform_design_system_team_portal_logic_r18_fix")
      ? O.createElement(CS, { zIndex: r }, n)
      : i
...
function MS() {
  return Qo.bindAll(window, [
    { type: "dragstart", listener: cf },
    { type: "dragenter", listener: cf },
  ]);
}
var Qa = null;
function NS(e) {
...
function LS(e) {
  ...
  function d() {
    ...
    ((t = "waiting-to-show"), lf(h, e.delay));
  }
  d();
  var f = {
    keep: i,
    ...
    Ah,
    {
      ...
      style: df(
        ...
        {},
        {
          ...
          "--_ywovvi": be("var(--ds-text-inverse, ".concat(Yt, ")")),
        },
      ),
    },
    o,
...
function qS(e) {
  var t = e.children,
    ...
    U = q === void 0 ? !1 : q,
    F = n === "mouse" ? o : n,
    G = Tu(Wr({ fn: m, action: "displayed", analyticsData: D }, pf)),
    Y = Tu(Wr({ fn: w, action: "hidden", analyticsData: D }, pf)),
    j = b.useRef(null),
    V = b.useState("hide"),
    ge = Z(V, 2),
    H = ge[0],
  ...
  (j1({ onClose: pt, isDisabled: H === "hide" || H === "fade-out" }),
    b.useEffect(
      function () {
        if (H === "hide") return Ae;
  ...
  var Ie = b.useCallback(
    ...
    Se = b.useCallback(
      function (N) {
        if (!(fe.current && N.target === fe.current) && !N.defaultPrevented) {
          ...
          var ie =
            n === "mouse"
              ? { type: "mouse", mouse: ff({ left: N.clientX, top: N.clientY }) }
              : { type: "keyboard" };
          Ge(ie);
        }
      },
      ...
      n === "mouse"
        ? function (N) {
            ...
            (ie = j.current) !== null &&
              ie !== void 0 &&
              ie.isActive() &&
              (j.current.mousePosition = ff({ left: N.clientX, top: N.clientY }));
          }
        : void 0,
    ...
    ue = b.useCallback(
      function (N) {
        try {
          if (!N.target.matches(":focus-visible") && ve("platform-tooltip-focus-visible-new"))
            return;
        } catch {}
        Ge({ type: "keyboard" });
      },
  ...
  M1({ isOpen: Tr && qa, onClose: Vh });
  var kc = function () {
      var ie;
      if (n === "mouse" && (ie = j.current) !== null && ie !== void 0 && ie.mousePosition) {
        var qt;
        return (qt = j.current) === null || qt === void 0 ? void 0 : qt.mousePosition;
      }
  ...
  return O.createElement(
    ...
    typeof t == "function"
      ...
      : O.createElement(zt, W({}, ai, { ref: me, role: "presentation" }), t, Sc),
    Tr
      ? O.createElement(
          TS,
          { zIndex: BS },
          O.createElement(_S, { placement: F, referenceElement: kc(), strategy: T }, function (N) {
            var ie = N.ref,
              qt = N.style,
              oi = N.update,
              ii = N.placement,
              Mr = n === "mouse" ? void 0 : FS[zS(ii)];
            return O.createElement(
              vh,
              { appear: !0 },
              qa &&
...
var US = [
  ...
  hf = { headCellContainer: "_1e0c1txw _4cvr1h6o", text: "_11c81o8v _syaz1gjq _k48pmoej" },
  Ih = function (t) {
    var r = t.content,
      n = t.inlineStyles,
      a = t.testId;
    ...
    var o = t.innerRef,
      ...
      j = O.createElement(
        Zo,
        { xcss: hf.headCellContainer, onMouseEnter: G, onMouseLeave: Y, onFocus: U, onBlur: F },
        O.createElement(
          qS,
          { content: s === Cr ? f : h },
          O.createElement(
            ...
            O.createElement(
              ...
              O.createElement("span", { className: R([hf.text]) }, r),
            ),
            q &&
              O.createElement(
                jo,
...
var HS = (function (e) {
    function t() {
      return (pe(this, t), GS(this, t, arguments));
    }
    return (
      Ue(t, e),
      he(t, [
        {
          ...
          value: function () {
            ...
            var o = n.refWidth,
              i = Q(n, VS),
              s = sp(a, o);
            return O.createElement(Ih, W({ inlineStyles: s }, i));
          },
        },
      ])
    );
...
var XS = (function (e) {
    function t() {
      return (pe(this, t), JS(this, t, arguments));
    }
    return (
      Ue(t, e),
      he(t, [
        {
          ...
          value: function () {
            ...
            var o = n.refWidth,
              i = Q(n, YS),
              s = sp(a, o);
            return O.createElement(Th, W({ inlineStyles: s }, i));
          },
        },
      ])
    );
...
var rx = (function (e) {
    function t(r) {
      var n;
      return (pe(this, t), (n = tx(this, t, [r])), (n.state = { activeSortButtonId: null }), n);
    }
    return (
      Ue(t, e),
      he(t, [
            ...
            return O.createElement(
              ...
              O.createElement(
                ...
                g.map(function (_, w) {
                  ...
                  return ve("platform-component-visual-refresh")
                    ? O.createElement(
                        v,
                        W(
                          {
...
var ox = function (t) {
    ...
    var ke = function (Se) {
        return function () {
          ...
          if (Pe) {
            ...
            var Ft = Pe !== i ? Cr : ax(s);
            me && me({ key: Pe, item: Se, sortOrder: Ft });
          }
        };
      },
      Me = function (Se, Pe) {
      ...
      St = function () {
        return Y || (ip(o || [], A, _).length > 2 ? Ro : A_);
      },
      Ve = function () {
        return h ? O.createElement(q_, { testId: u }) : D && O.createElement(U_, { testId: u }, D);
      },
      Qe = o && o.length,
      Ce,
      et = !1;
    ...
    return O.createElement(
      ...
      !Ge &&
        Ie &&
        O.createElement(Rp, { isLoading: h, spinnerSize: Ro, testId: u, loadingLabel: c }, Ie),
    );
  },
  ix = b.lazy(function () {
    return fy(
      () => import("./body-Clu0bNhT.js"),
  ...
  sx = b.forwardRef(function (t, r) {
    ...
    var v = O.createElement(a0, W({ ref: r }, l));
    return u && p
      ? O.createElement(
          i0,
          { fallback: v },
...
var mx = [
  ...
  _x = O.forwardRef(function (e, t) {
    var r = e.appearance,
      ...
      ue =
        Dr && ve("platform-component-visual-refresh") ? "subtle" : r || ne?.appearance || "default",
      nr = ne?.spacing || S,
      rt = ne?.isDisabled || i,
      zt = !rt && !c,
      Tr = rt || c,
      ...
      W(
        ...
        qa,
        {
          ...
          xcss: Mp(
            De.base,
            ue === "default" &&
              (ve("platform-component-visual-refresh") ? Kr.rootRefreshed : Kr.root),
            ue === "default" &&
              zt &&
              (ve("platform-component-visual-refresh") ? Kr.interactiveRefreshed : Kr.interactive),
            ue === "primary" && mf.root,
            ue === "primary" && zt && mf.interactive,
            ue === "warning" && yf.root,
            ue === "warning" && zt && yf.interactive,
            ue === "danger" && _f.root,
            ue === "danger" && zt && _f.interactive,
            ue === "discovery" && wf.root,
            ue === "discovery" && zt && wf.interactive,
            ue === "subtle" &&
              (ve("platform-component-visual-refresh") ? eo.rootRefreshed : eo.root),
            ue === "subtle" &&
              zt &&
              (ve("platform-component-visual-refresh") ? eo.interactiveRefreshed : eo.interactive),
            De.linkDecorationUnset,
            xt && (ve("platform-component-visual-refresh") ? yr.rootRefreshed : yr.root),
            ...
            rt && De.disabled,
            rt &&
              (!ve("platform-component-visual-refresh") || (ue !== "default" && ue !== "subtle")) &&
              De.sharedDisabled,
            rt &&
              ue === "default" &&
              (ve("platform-component-visual-refresh") ? Kr.disabledRefreshed : Kr.disabled),
            h && !Pe && De.circle,
          ...
          isDisabled: Tr,
          "aria-label": c && E && !A ? "".concat(E, " ").concat(bf) : E,
      ...
      O.createElement(
        ...
        c &&
          O.createElement(
            ...
            bx({ spacing: nr, appearance: ue, isDisabled: rt, isSelected: xt, testId: Me }),
          ),
        c && (A || !E) && O.createElement(oc, { id: Se }, bf),
      ),
    );
  }),
  Yr = {
...
var kf = function (t) {
    var r = t.icon,
      ...
      a = {
        label: "",
        color: "currentColor",
        size: ve("platform_dst_button_chevron_sizing")
          ? function (o) {
...
var Ex = {
  ...
  Cx = function (t) {
    ...
    var y = b.useCallback(
      ...
      S = rn(xx({ fn: y, action: "clicked", analyticsData: c }, Ex)),
      E = n
        ? Sf({ tabPanel: w[v], index: v, isSelected: !0, tabsId: s })
        : Array.from(k.current).map(function (A) {
            return Sf({ tabPanel: w[A], index: A, isSelected: A === v, tabsId: s });
          });
    return b.createElement(
      "div",
      {
      ...
      b.createElement(zh.Provider, { value: { selected: v, onChange: S, tabsId: s } }, _),
  ...
  ro = b.forwardRef(function (t, r) {
    ...
    return O.createElement(
      ...
      O.createElement(Lp, { weight: "medium", color: "inherit", maxLines: 1 }, n),
    );
  }),
  jx = function (t) {
    var r = t.children,
    ...
    return b.createElement(
      "div",
      {
        ...
        style: {
          ...
          "--_y4kn7q": be("3px solid ".concat("var(--ds-border, transparent)")),
          "--_71dbsd": be("var(--ds-text, ".concat(Rs, ")")),
          "--_1hfkvbo": be("var(--ds-text-selected, ".concat(Ct, ")")),
          "--_1c11uqn": be("3px solid ".concat("var(--ds-border-selected, ".concat(Ct, ")"))),
          "--_lvpq93": be("var(--ds-border, ".concat(D_, ")")),
          "--_afs77": be(
...
const Ix = Object.keys(Uh).filter((e) => isNaN(Number(e))),
...
const Lx = Yo(Nx),
  ...
  Bx = Hh.createRoot($x),
  xf = () => {
    Bx.render(x.jsx(tp, { ...rp, children: x.jsx(Lx, {}) }));
  };
wa.view.theme
  .enable()
  .then(() => {
