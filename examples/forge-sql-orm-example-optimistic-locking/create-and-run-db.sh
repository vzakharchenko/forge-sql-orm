...
MYSQL_DATABASE="optimisticforgesqlorm"
...
CREATE TABLE IF NOT EXISTS test_data (
  ...
  test_date_column datetime DEFAULT NULL,
  test_name_column varchar(100) DEFAULT NULL,
  PRIMARY KEY (id) /*T![clustered_index] CLUSTERED */
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin AUTO_INCREMENT=30002;
CREATE TABLE IF NOT EXISTS test_data_optimistic_date (
  id int NOT NULL AUTO_INCREMENT,
  test_date_column datetime DEFAULT NULL,
  version datetime NOT NULL,
  test_name_column varchar(255) DEFAULT NULL,
  PRIMARY KEY (id) /*T![clustered_index] CLUSTERED */
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin AUTO_INCREMENT=30002;
CREATE TABLE IF NOT EXISTS test_data_optimistic_number (
  id int NOT NULL AUTO_INCREMENT,
  test_date_column datetime DEFAULT NULL,
  test_name_column varchar(100) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS test_data_optimistic_timestamp (
  id int NOT NULL AUTO_INCREMENT,
  test_date_column datetime DEFAULT NULL,
  test_name_column varchar(100) DEFAULT NULL,
