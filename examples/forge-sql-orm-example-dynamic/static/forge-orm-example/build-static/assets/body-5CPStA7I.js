import {
  ...
  u as dr,
  v as fn,
} from "./index-wyqFWLDp.js";
import { a as fe } from "./react-dom-vendor-mZoKt2nW.js";
import "./client-core-vendor-CC-5grB7.js";
import "./lodash-vendor-DZoGCnbE.js";
function vn(e, t, r) {
  return (t = re(t)), Pe(e, ur() ? Reflect.construct(t, [], re(e).constructor) : t.apply(e, r));
}
function ur() {
  try {
...
var bn = "Invariant failed",
  ot = (function (e) {
    function t(r) {
      var n;
      return Re(this, t), (n = vn(this, t)), (n.message = r), n;
    }
    return (
      Ee(t, e),
      Ae(t, [
...
function M(e, t) {
  if (!e) throw new ot(bn);
}
var cr = v.createContext(null);
function oe() {
  var e = v.useContext(cr);
  return M(e !== null), e;
}
function mn(e) {
  var t = e.children,
  ...
  return H.createElement(cr.Provider, { value: i }, t);
}
function yn(e) {
...
function vr(e) {
  ...
  return n instanceof HTMLElement ? vr(n) : null;
}
function br(e) {
  var t,
    r = e.element,
    n = e.mode;
  return n === "standard" ? r : (t = vr(r)) !== null && t !== void 0 ? t : r;
}
function mr() {
...
function It(e) {
  for (var t = 1; t < arguments.length; t++) {
    ...
    t % 2
      ? ht(Object(r), !0).forEach(function (n) {
          D(e, n, r[n]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
        : ht(Object(r)).forEach(function (n) {
  ...
  var r,
    ...
    c =
      (r =
        ...
        ? r
        : null;
  return It(It({}, e), {}, D({}, yr, c));
}
function hr(e) {
  var t;
  return (t = e[yr]) !== null && t !== void 0 ? t : null;
}
var Ir = Symbol("DraggableData");
function ve(e) {
  return e[Ir] === !0;
}
function xr(e) {
  ...
  return v.useMemo(
    function () {
      return D(
        D(
          D(D(D(D({}, Ir, !0), "draggableId", t), "droppableId", r), "getIndex", n),
          "contextId",
          a,
        ),
        "type",
...
function In(e) {
  ...
  return v.useMemo(
    function () {
      return D(D(D(D({}, Sr, !0), "contextId", t), "droppableId", r), "getIsDropDisabled", n);
    },
    [t, r, n],
  );
}
...
var Sn = ["droppableId", "getIndex"],
  wn = ["contextId", "droppableId"];
function On(e) {
  var t = e.droppableId,
    r = e.getIndex,
    n = De(e, Sn),
...
function En(e) {
  var t = e.contextId,
    r = e.droppableId,
    n = De(e, wn),
    a = xn({ contextId: t, droppableId: r });
...
function An(e) {
  ...
  var r = t[0];
  return ve(r.data) ? On(r.data) : wr(r.data) ? En(r.data) : null;
}
function ye(e, t) {
  return !(
    (e == null ? void 0 : e.droppableId) !== (t == null ? void 0 : t.droppableId) ||
    (e == null ? void 0 : e.index) !== (t == null ? void 0 : t.index)
  );
}
function Rn() {
  var e = new Map(),
...
var Or = "data-pdnd-honey-pot";
function Er(e) {
  return e instanceof Element && e.hasAttribute(Or);
}
function Ue(e) {
...
function Ln(e) {
  return { x: e.x - wt, y: e.y - wt };
}
function jn(e) {
  return { x: Math.max(e.x, 0), y: Math.max(e.y, 0) };
}
function Fn(e) {
  return { x: Math.min(e.x, window.innerWidth - we), y: Math.min(e.y, window.innerHeight - we) };
}
function Ot(e) {
  var t = e.client,
    r = Fn(jn(Ln(Cn(t))));
  return DOMRect.fromRect({ x: r.x, y: r.y, width: we, height: we });
}
function Et(e) {
  var t = e.clientRect;
  return {
...
function Mn(e) {
  ...
  var a = ne.bind(window, {
    ...
    listener: function (i) {
      ...
      (n = Ot({ client: l })), Object.assign(r.style, Et({ clientRect: n }));
    },
    options: { capture: !0 },
  });
  return function (i) {
    var l = i.current;
    if ((a(), kn({ client: l, clientRect: n }))) {
      r.remove();
      return;
    }
    function d() {
...
function Bn(e) {
  var t = e.dragLeave;
  return ct() ? t.hasOwnProperty(et.isLeavingWindow) : !1;
}
(function () {
  if (typeof window > "u" || !ct()) return;
  function t() {
...
function Vn(e) {
  var t = e.event,
    ...
    a = e.dispatchEvent;
  if (!Rr()) return;
  var o = Xn({ event: t, dragType: r, getDropTargetsOver: n });
  tt.isActive = !0;
  var i = { current: o };
  Ye({ event: t, current: o.dropTargets });
  var l = Yn({ source: r.payload, dispatchEvent: a, initial: o });
  function d(g) {
    var f = Gn({ current: i.current.dropTargets, next: g.dropTargets });
    (i.current = g), f && l.dragUpdate({ current: i.current });
  }
  function u(g) {
    var f = xe(g),
      m = Er(g.target) ? Ue({ x: f.clientX, y: f.clientY }) : g.target,
      y = n({ target: m, input: f, source: r.payload, current: i.current.dropTargets });
    y.length && (g.preventDefault(), Ye({ event: g, current: y })), d({ dropTargets: y, input: f });
  }
  function c() {
  ...
  var p = ne.bindAll(
    ...
    [
      ...
      },
      {
        ...
        listener: function (f) {
          if (
            ((i.current = { dropTargets: i.current.dropTargets, input: xe(f) }),
      ...
      },
      {
        type: "dragend",
        listener: function (f) {
          (i.current = { dropTargets: i.current.dropTargets, input: xe(f) }), c();
        },
      },
    ].concat(He(Ar({ onDragEnd: c }))),
    { capture: !0 },
  );
  l.start({ nativeSetDragImage: zn(t) });
}
function Ye(e) {
  var t,
    r = e.event,
...
function Jn(e) {
  ...
  function l(g) {
    return ge(Pr(g.element, { attribute: a, value: "true" }), i(g));
  }
  function d(g) {
    var f,
      m,
    ...
    var O = n.get(A);
    if (O == null) return h;
    var T = { input: S, source: x, element: O.element };
    if (O.canDrop && !O.canDrop(T))
      return d({ source: x, target: O.element.parentElement, input: S, result: h });
    var E =
        (f = (m = O.getData) === null || m === void 0 ? void 0 : m.call(O, T)) !== null &&
        f !== void 0
          ? f
          : {},
      j =
        (y = (b = O.getDropEffect) === null || b === void 0 ? void 0 : b.call(O, T)) !== null &&
        y !== void 0
          ? y
          : r,
      ...
      try {
        for (x.s(); !(I = x.n()).done; ) {
          ...
          var h = n.get(w.element),
            ...
            O = ie(ie({}, m), {}, { self: w });
          if (
            (h == null || (S = h.onDropTargetChange) === null || S === void 0 || S.call(h, O), !A)
          ) {
            var T;
            h == null || (T = h.onDragLeave) === null || T === void 0 || T.call(h, O);
          }
        }
      } catch (K) {
        x.e(K);
      ...
      try {
        for (E.s(); !(j = E.n()).done; ) {
          var N,
            ...
            C = j.value;
          if (!b.has(C.element)) {
            var P = ie(ie({}, m), {}, { self: C }),
              L = n.get(C.element);
            L == null || (N = L.onDropTargetChange) === null || N === void 0 || N.call(L, P),
              L == null || (R = L.onDragEnter) === null || R === void 0 || R.call(L, P);
          }
        }
      } catch (K) {
        E.e(K);
  ...
  function p(g) {
    ...
    for (var I = Ge(b), S = Ge(x), w = [], h = 0; h < I.length; h++) {
      ...
      var E = w[h - 1],
        j = I[h - 1];
      if ((E == null ? void 0 : E.element) !== (j == null ? void 0 : j.element)) break;
      var N = n.get(O.element);
      if (!N) break;
      var R = { input: y, source: f, element: N.element };
      if (
        (N.canDrop && !N.canDrop(R)) ||
        !((A = N.getIsSticky) !== null && A !== void 0 && A.call(N, R))
      )
        break;
...
function ta(e) {
  for (var t = 1; t < arguments.length; t++) {
    var r = arguments[t] != null ? arguments[t] : {};
    t % 2
      ? Ct(Object(r), !0).forEach(function (n) {
          D(e, n, r[n]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
        : Ct(Object(r)).forEach(function (n) {
            Object.defineProperty(e, n, Object.getOwnPropertyDescriptor(r, n));
          });
  }
  return e;
...
function na(e) {
  var t = e.typeKey,
    ...
    i = ra(),
    l = Jn({ typeKey: t, defaultDropEffect: o });
  function d(s) {
    n == null || n(s), l.dispatchEvent(s), i.dispatchEvent(s), a == null || a(s);
  }
  function u(s) {
    var p = s.event,
      g = s.dragType;
    At.start({ event: p, dragType: g, getDropTargetsOver: l.getIsOver, dispatchEvent: d });
  }
  function c() {
    function s() {
      var p = { canStart: At.canStart, start: u };
      return r(p);
    }
    return Qn({ typeKey: t, mount: s });
  }
...
var aa = ut(function () {
  ...
  oa = "pdnd:android-fallback",
  Lt = "text/plain",
  ia = "text/uri-list",
  la = "application/vnd.pdnd",
  je = new WeakMap();
function da(e) {
  return (
    je.set(e.element, e),
  ...
  st = na({
        ...
        ne.bind(document, {
          ...
          listener: function (n) {
            ...
            if (t.canStart(n) && !n.defaultPrevented && n.dataTransfer) {
              ...
              if (s.canDrag && !s.canDrag(g)) return n.preventDefault(), null;
              if (s.dragHandle) {
                var f = Ue({ x: p.clientX, y: p.clientY });
                if (!s.dragHandle.contains(f)) return n.preventDefault(), null;
              }
              var m =
                (o =
              ...
              aa() &&
                !n.dataTransfer.types.includes(Lt) &&
                !n.dataTransfer.types.includes(ia) &&
                n.dataTransfer.setData(Lt, oa),
                n.dataTransfer.setData(la, "");
              var w = {
                  element: s.element,
                  dragHandle: (l = s.dragHandle) !== null && l !== void 0 ? l : null,
                  data:
                    (d =
                      (u = s.getInitialData) === null || u === void 0 ? void 0 : u.call(s, g)) !==
                      null && d !== void 0
                      ? d
                      : {},
                },
    ...
    dispatchEventToSource: function (t) {
      var r,
        ...
        a = t.eventName,
        o = t.payload;
      (r = je.get(o.source.element)) === null ||
        r === void 0 ||
        (n = r[a]) === null ||
        n === void 0 ||
        n.call(r, o);
    },
    onPostDispatch: jt.getOnPostDispatch(),
  }),
  Tr = st.dropTarget,
  Be = st.monitor;
function ua(e) {
  return ge(st.registerUsage(), da(e), Pr(e.element, { attribute: "draggable", value: "true" }));
}
function ca(e, t, r) {
  return (
    (t = re(t)), Pe(e, Cr() ? Reflect.construct(t, r || [], re(e).constructor) : t.apply(e, r))
  );
}
function Cr() {
  try {
  ...
  var t = e.children,
    ...
    a = v.useCallback(
      function (o) {
        ...
        if (i.isDragging) {
          i.mode === "FLUID" && mr(), i.mode === "SNAP" && r.stopDrag({ reason: "CANCEL" });
          var l = o.error;
...
var ga = (function (e) {
  function t() {
    return Re(this, t), ca(this, t, arguments);
  }
  return (
    Ee(t, e),
    Ae(
...
function Ve(e) {
  for (var t = 1; t < arguments.length; t++) {
    var r = arguments[t] != null ? arguments[t] : {};
    t % 2
      ? Ft(Object(r), !0).forEach(function (n) {
          D(e, n, r[n]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
        : Ft(Object(r)).forEach(function (n) {
            Object.defineProperty(e, n, Object.getOwnPropertyDescriptor(r, n));
          });
  }
  return e;
    ...
    prev: function (t, r) {
      ...
      if (i && i.index !== 0) {
        var l = de(de({}, i), {}, { index: i.index - 1 }),
          d = Oe({ start: o, target: l });
        ye(o, d) && (l.index = i.index - 2), n.updateDrag({ targetLocation: l });
      }
    },
    next: function (t, r) {
      var n = r.dragController,
      ...
      if (l) {
        ...
        if (!(!u && !d)) {
          var c = de(de({}, l), {}, { index: l.index + 1 }),
            s = Oe({ start: i, target: c });
          ye(i, s) && (c.index = l.index + 2), n.updateDrag({ targetLocation: c });
        }
      }
    },
  },
...
var Ut = { PageUp: me, PageDown: me, Home: me, End: me, Enter: me, Tab: me },
  va = {
    vertical: de(
      de({}, Ut),
      {},
  ...
  var t = e.dragController,
    ...
    o = v.useCallback(
      function (i) {
        ...
        var p = c(),
          g = fr({ attribute: $.droppable.id, value: p.droppableId }),
...
var Lr = function (t) {
  ...
  Ur = function (t) {
    var r = t.max,
      ...
      i = Sa(a),
      l = wa({ max: o, current: n, change: i });
    return !l || (i.x !== 0 && l.x === 0) || (i.y !== 0 && l.y === 0);
  },
  Oa = function (t, r) {
    return Ur({ current: t.scroll.current, max: t.scroll.max, change: r });
  },
  Ea = function (t, r) {
    return Ur({ current: t.scroll.current, max: t.scroll.max, change: r });
  },
...
var ue = {
  ...
  Kt = ue.durationDampening.stopDampeningAt,
  Ra = function (t, r) {
    var n = r,
      a = Kt,
      o = Date.now(),
    ...
    if (i >= Kt) return t;
    if (i < $t) return ft;
    var l = Kr({ startOfRange: $t, endOfRange: a, current: i }),
      d = t * ue.ease(l);
    return Math.ceil(d);
  },
  Pa = function (t, r) {
    ...
    if (t === r.startScrollingFrom) return ft;
    var n = Kr({ startOfRange: r.maxScrollValueAt, endOfRange: r.startScrollingFrom, current: t }),
      a = 1 - n,
  ...
  Wt = function (t) {
    var r = t.distanceToEdge,
      ...
      i = Pa(r, n);
    return i === 0 ? 0 : o ? Math.max(Ra(i, a), ft) : i;
  };
const Nt = function (e) {
  var t = e.container,
    r = e.distanceToEdges,
    ...
    l = r[a.end] < r[a.start];
  return l
    ? Wt({ distanceToEdge: r[a.end], thresholds: i, dragStartTime: n, shouldUseTimeDampening: o })
    : -1 *
        Wt({
...
const Wr = function (e) {
  ...
  Ca = function (e) {
    var t = e.scrollable,
      ...
      n = e.dragStartTime,
      a = e.shouldUseTimeDampening,
      o = Wr({ dragStartTime: n, container: t.container, center: r, shouldUseTimeDampening: a });
    return o && Ea(t, o) ? o : null;
  },
  La = function (e) {
    var t = e.viewport,
      r = e.center,
  ...
  Ma = function () {
    var e = ka(),
      ...
      l = n + o,
      d = r + i,
      u = Fr({ top: r, left: n, right: l, bottom: d }),
...
var Ha = function (t) {
    var r = t.input,
      ...
      u = function () {
        var s = Ue({ x: r.clientX, y: r.clientY }),
          p = jr(s);
        if (!p) return !1;
        var g = ha({ closestScrollable: p }),
          f = Ca({
            dragStartTime: n,
            scrollable: g,
...
function Ka() {
  Ie(),
    (nt = ne.bindAll(
      window,
      [
        { type: "dragover", listener: Yt },
        { type: "dragenter", listener: Yt },
        {
          type: "drop",
          listener: function (t) {
            t.preventDefault(), Ie();
        ...
        { type: "dragend", listener: Ie },
      ].concat(He(Ar({ onDragEnd: Ie }))),
      { capture: !1 },
    ));
}
function Ie() {
...
var zt = { start: Ka, stop: Wa };
function Na(e) {
  var t = e.dragController,
    r = e.contextId,
    n = v.useCallback(
      function (a) {
        t.updateDrag({ targetLocation: An(a.current) });
      },
      [t],
    );
  v.useEffect(
    function () {
      return Be({
        ...
        onDragStart: function (o) {
          var i = o.location,
            l = o.source;
          Xe.start({ input: i.current.input }), zt.start();
          var d = l.data;
          M(ve(d));
          var u = d.draggableId,
            c = d.droppableId,
        ...
        onDrop: function () {
          Xe.stop(), zt.stop(), t.stopDrag({ reason: "DROP" });
        },
      });
    },
    [t, r, n],
...
var Nr = typeof window < "u" ? v.useLayoutEffect : v.useEffect,
  Ya = "data-rbd-style-context-id";
function za(e) {
  var t = e.selector,
    r = e.styles,
    n = Object.entries(r)
...
function Ga(e) {
  ...
  return za({ selector: t, styles: r });
}
function Va(e) {
  var t = e.contextId,
    r = e.nonce,
    n = document.createElement("style");
  return r && n.setAttribute("nonce", r), n.setAttribute(Ya, t), document.head.appendChild(n), n;
}
function Xa(e) {
  var t = e.contextId,
    r = e.nonce,
    n = Va({ contextId: t, nonce: r });
  return (
    (n.textContent = Ga(t)),
    function () {
      n.remove();
...
function ro(e) {
  ...
  return H.createElement(zr.Provider, { value: n }, t);
}
function $e() {
  var e = v.useContext(zr);
  return M(e !== null), e;
}
var qe = null,
  pe = "1px",
...
function ao() {
  ...
  return e.setAttribute("role", "alert"), Object.assign(e.style, no), document.body.append(e), e;
}
function oo() {
  return qe === null && (qe = ao()), qe;
}
function Qe(e) {
  var t = oo();
  t.textContent = e;
...
function vo(e) {
  ...
  var g = to(),
    ...
    S = v.useCallback(
      function (R) {
        for (
          var C = R.droppableId, P = I.getEntry({ droppableId: C });
          P !== null && P.isDropDisabled;

        ) {
          var L = P,
            K = L.parentDroppableId;
          P = K ? I.getEntry({ droppableId: K }) : null;
        }
        return P === null ? null : { droppableId: P.droppableId, index: 0 };
      },
      [I],
    );
  v.useEffect(
  ...
  var w = v.useCallback(
    ...
    h = v.useCallback(
      function (R) {
        var C = R.draggableId,
          P = R.type,
          L = R.getSourceLocation,
          K = R.sourceElement,
          q = R.mode;
        if (!b.current.isDragging) {
          var ee = { draggableId: C, mode: q };
          o == null || o(ee);
          var V = { mode: q, draggableId: C, type: P, source: L() },
            W = document,
            Y = W.activeElement,
            U =
          ...
          M(J),
            (b.current = {
              ...
              draggableInitialOffsetInSourceDroppable: fo({ element: K, mode: J.mode }),
            }),
            i == null || i(V),
            g.dispatch("onPendingDragStart", { start: V, droppable: J }),
            m(function () {
              var _ = { mode: q, draggableId: C, type: P, source: L() },
                F = Ze("onDragStart", _),
                k = F.provided,
                B = F.getMessage;
              l == null || l(_, k),
    ...
    O = v.useCallback(
      function (R) {
        var C = R.reason;
        if (b.current.isDragging) {
          A.runCleanupFn(), C === "CANCEL" && w({ targetLocation: null });
          var P = b.current,
            L = P.mode,
            K = P.restoreFocusTo,
            q = P.sourceLocation,
  ...
  Na({ dragController: T, contextId: p });
  var E = ba({
      dragController: T,
      droppableRegistry: I,
      contextId: p,
      setKeyboardCleanupFn: A.setCleanupFn,
    }),
    ...
    N = v.useCallback(
      function (R) {
        ...
        if (
          ...
          R.isDropDisabled &&
          R.droppableId ===
            ((C = P.targetLocation) === null || C === void 0 ? void 0 : C.droppableId)
        ) {
          var L = S({ droppableId: R.droppableId });
          w({ targetLocation: L });
        }
      },
      [S, w],
  ...
  return (
    ...
    qa({ contextId: p, nonce: a }),
    H.createElement(
      ga,
      { contextId: p, dragController: T },
      H.createElement(
        ro,
        { lifecycle: g },
        H.createElement(
...
var vt = v.createContext(null),
  mo = vt.Provider;
function qt() {
  var e = v.useContext(vt);
  return M(e), e;
}
function yo() {
  var e = v.useContext(vt);
...
function Vr() {
  return Te({ attribute: Z.dropIndicator });
}
function bt(e) {
  return Te({ attribute: $.placeholder.contextId, value: e });
}
function Xr(e) {
  var t = v.useRef(e);
  v.useEffect(
...
var Io = { transform: void 0, transition: void 0 },
  xo = {
    position: "fixed",
    top: 0,
    left: 0,
...
function qr(e) {
  ...
  return r.type !== "dragging" || !r.previewOffset || !t
    ? Io
    : So({ draggableDimensions: t, previewOffset: r.previewOffset });
}
var wo = {
  input: !0,
  button: !0,
...
function mt(e, t) {
  if (t == null) return !1;
  var r = !!wo[t.tagName.toLowerCase()];
  if (r) return !0;
  var n = t.getAttribute("contenteditable");
  return n === "true" || n === "" ? !0 : t === e ? !1 : mt(e, t.parentElement);
}
function Oo(e, t) {
  var r = t.target;
  return r instanceof HTMLElement ? mt(e, r) : !1;
}
function Jt(e, t) {
  var r = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
...
function te(e) {
  for (var t = 1; t < arguments.length; t++) {
    var r = arguments[t] != null ? arguments[t] : {};
    t % 2
      ? _t(Object(r), !0).forEach(function (n) {
          D(e, n, r[n]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
        : _t(Object(r)).forEach(function (n) {
            Object.defineProperty(e, n, Object.getOwnPropertyDescriptor(r, n));
          });
  }
  return e;
}
var Me = { type: "idle", draggingOver: null };
function Ao(e) {
...
function Ro(e, t) {
  ...
  var d = { droppable: a, draggableDimensions: o, placeholderRect: i, dropIndicatorRect: l },
    u = ye(n.source, (r = n.destination) !== null && r !== void 0 ? r : null),
...
function Zr(e, t) {
  if (t.type === "START_POINTER_DRAG")
    return er(e, te(te({}, t.payload), {}, { previewOffset: { x: 0, y: 0 } }));
  ...
  if (t.type === "UPDATE_KEYBOARD_PREVIEW") {
    ...
    var c = Ro(e, t.payload);
    return c;
  }
  return t.type === "DROP"
    ? (M(e.type === "dragging"), Me)
    : t.type === "START_HIDING"
      ? (M(e.type === "idle" || e.type === "hiding"), Ao(t.payload.mode))
      : t.type === "STOP_HIDING"
        ? (M(e.type === "hiding"), Me)
        : e;
}
...
function To(e) {
  var t = e.children,
    ...
    w = v.useCallback(
      function (F) {
        if ((y.current && S(), F)) {
          var k = gr(F, D(D({}, Z.draggable.droppableId, c), Z.draggable.index, String(n)));
          I(k);
        }
    ...
    h = Xr(n),
    A = v.useReducer(Zr, Me),
    O = X(A, 2),
    T = O[0],
    E = O[1],
    j = xr({ draggableId: r, droppableId: c, getIndex: h, contextId: f, type: s }),
    N = T.type === "dragging",
    R = T.type === "hiding",
    C = qt(),
    P = C.shouldRenderCloneWhileDragging,
    L = C.isDropDisabled,
    K = $e(),
    q = Do(),
          ...
          ne.bindAll(k, [
            {
              ...
              listener: function (Q) {
                if (Q.key === " ") {
                  if (Q.defaultPrevented || (!l && Oo(F, Q))) return;
                  Q.preventDefault(),
                    ee({
                      event: Q,
                      draggableId: r,
          ...
          return (
            ...
            ua({
              canDrag: function (Q) {
                ...
                if (!l) {
                  var be = Ue({ x: G.clientX, y: G.clientY });
                  return !mt(k, be);
                }
                return !N;
              },
  ...
  var V = T.type !== "idle" && p === "standard",
    W = v.useRef(null);
  Gr({ elementRef: V ? W : y, data: j, direction: u, contextId: f, isDropDisabled: L, type: s });
  var Y = v.useRef(!0);
  ...
  v.useEffect(
                ...
                j.draggableId === B.draggableId &&
                  ...
                  B.mode === "SNAP" &&
                    queueMicrotask(function () {
                      ...
                      if (G.isDragging) {
                        var be = bt(f),
                          nn = be ? be.getBoundingClientRect() : null,
                          yt = Vr(),
                          an = yt ? yt.getBoundingClientRect() : null;
                        E({
    ...
    [j.draggableId, j.contextId, K, P, u, f, U, m],
  );
  var z = v.useMemo(
      function () {
        return {
          draggableProps: D(
            ...
            "style",
            qr({ draggableDimensions: U, draggableState: T }),
          ),
          dragHandleProps: D(
            D(
              D(
                D(
                  D({ role: "button", "aria-describedby": gt(f) }, $.dragHandle.contextId, f),
    ...
    J = Jr({ draggingOver: T.draggingOver, isClone: !1, isDragging: N, mode: N ? T.mode : null }),
    _ = v.useMemo(
      function () {
...
function Lo(e) {
  var t = e.children,
        ...
        return {
          ...
          dragHandleProps: D(
            D(
              D(
                D(
                  D({ role: "button", "aria-describedby": gt(p) }, $.dragHandle.contextId, p),
                  $.dragHandle.draggableId,
                  a,
                ),
                "tabIndex",
    ...
    m = Jr({ draggingOver: i, isClone: !0, isDragging: !0, mode: c }),
    y = v.useMemo(
      function () {
...
function jo(e) {
  ...
  if (
                  ...
                  queueMicrotask(function () {
                    ...
                    if (I.isDragging) {
                      var S = bt(i),
                        ...
                        h = Vr(),
                        A = h ? h.getBoundingClientRect() : null;
                      p({
                        type: "UPDATE_KEYBOARD_PREVIEW",
                        payload: {
                          update: b,
    ...
    return null;
  var f = qr({ draggableDimensions: d, draggableState: s });
  return H.createElement(
    Lo,
    {
      droppableId: r,
...
function Uo(e) {
  var t = e.element,
    ...
    d = i + 1,
    u = r === "before",
    c = Fe(a, { droppableId: o, index: u ? l : d });
  if (c === null) {
  ...
  var y = ko({ direction: n, a: t.getBoundingClientRect(), b: c.getBoundingClientRect() });
  return y;
}
function Bo(e) {
  var t = e.element,
    ...
    n = e.direction,
    a = e.contextId,
    o = Uo({ element: t, where: r, direction: n, contextId: a });
...
function tr(e) {
  var t = e.element,
    ...
    l = i.mainAxis,
    d = i.crossAxis,
    u = br({ element: t, mode: n }),
    c = Bo({ element: t, where: r ? "after" : "before", direction: a, contextId: o }),
    s = u[l.offset] - Ke,
    p = r ? s + t[l.length] : s;
...
function Wo(e) {
  var t = e.droppableId,
    r = e.direction,
    n = fr({ attribute: $.droppable.id, value: t }),
    a = Ko({ element: n, direction: r });
...
function No(e) {
  ...
  if (r) {
    var i = bt(o);
    return i ? $o({ element: i, direction: n }) : null;
  }
  if (t.index === 0) {
    var l = Fe(o, t);
    return l
      ? tr({ element: l, isForwardEdge: !1, mode: a, direction: n, contextId: o })
      : Wo({ droppableId: t.droppableId, direction: n });
  }
  var d = Fe(o, { droppableId: t.droppableId, index: t.index - 1 });
  return d ? tr({ element: d, isForwardEdge: !0, mode: a, direction: n, contextId: o }) : null;
}
var rr = ke + 2 * Ke,
  Yo = Se({
    background: "var(--ds-border-brand, #0C66E4)",
    scrollMarginTop: rr,
    scrollMarginBottom: rr + Ke,
  }),
  zo = Se({ position: "absolute", top: 0, left: 0 }),
  Go = Se({ opacity: 0 }),
  Vo = {
    horizontal: Se({ width: ke, height: "100%", marginLeft: -2 }),
    vertical: Se({ width: "100%", height: ke, marginTop: -2 }),
  };
function Xo(e) {
  var t = e.direction,
    r = e.dimensions,
...
var qo = D({}, Z.dropIndicator, ""),
  Qo = function (t) {
    var r = t.direction,
      ...
      b = v.useCallback(
        function (h) {
          ...
          return (
            m(E),
            s(No({ targetLocation: A, isInHomeLocation: E, direction: r, mode: n, contextId: o }))
          );
        },
        [o, r, n],
      );
    v.useLayoutEffect(
      function () {
        ...
        if (h.isDragging) {
          var A = h.targetLocation,
            O = h.sourceLocation,
            T = Oe({ start: O, target: A });
          return (
            b({ targetLocation: A, destination: T, source: O }),
            y({
              onPrePendingDragUpdate: function (j) {
                var N = j.update,
                  ...
                  P = C === void 0 ? null : C,
                  L = N.source;
                b({ targetLocation: R, source: L, destination: P });
              },
            })
          );
        }
        ...
        function () {
          if (c !== null) {
            ...
            if (!(!h.isDragging || h.mode !== "SNAP")) {
              var A = l.current;
              M(A instanceof HTMLElement), A.scrollIntoView({ block: "nearest" });
            }
          }
        },
        [c, i],
    ...
    var x = ce[r].mainAxis,
      ...
      S = Xo({ direction: r, dimensions: c, indicatorOffset: I }),
      w = n === "virtual";
    return ln("div", se({ ref: l, css: [Yo, Vo[r], w && zo, f && Go], style: S }, qo));
  };
function nr(e, t) {
  var r = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
...
var _r = { draggingFromThisWith: null, draggingOverWith: null, isDraggingOver: !1 };
function Zo(e, t) {
  if (t.type === "DRAG_START") {
    var r = t.payload,
      ...
      u = i.droppableId === n,
      c = u ? o : null;
    return Le(Le({}, e), {}, { isDraggingOver: l, draggingFromThisWith: c, draggingOverWith: d });
  }
  if (t.type === "DRAG_UPDATE") {
    var s = t.payload,
      ...
      y = g.draggableId,
      b = g.source,
      x = (m == null ? void 0 : m.droppableId) === p,
      I = x ? y : null,
      S = b.droppableId === p,
      w = S ? y : null;
    return Le(Le({}, e), {}, { isDraggingOver: x, draggingFromThisWith: w, draggingOverWith: I });
  }
  return t.type === "DRAG_CLEAR" ? _r : e;
}
function Jo(e) {
  var t = e.draggableId,
    r = e.droppableId,
  ...
  var s = v.useCallback(
    ...
    p = xr({ draggableId: t, droppableId: r, getIndex: s, contextId: d, type: n });
  Gr({ elementRef: i, data: p, direction: a, contextId: d, isDropDisabled: o, type: n });
  var g = v.useMemo(
    function () {
      return {
        position: "absolute",
...
function _o(e) {
  var t = e.children,
    ...
    b = In({ contextId: m, droppableId: r, getIsDropDisabled: g }),
    x = v.useRef(null),
    I = v.useCallback(
      function (W) {
        W &&
    ...
    S = v.useReducer(Zo, _r),
    w = X(S, 2),
    h = w[0],
    A = w[1],
    O = h.draggingFromThisWith,
    T = h.draggingOverWith,
    E = h.isDraggingOver,
    j = yo();
  v.useEffect(
    function () {
      ...
      return N({
        onPendingDragStart: function (U) {
          ...
          W({ destination: z.source, type: z.type }) &&
            A({ type: "DRAG_START", payload: { droppableId: r, start: z } });
        },
        onPendingDragUpdate: function (U) {
          var z = U.update;
          W(z) && A({ type: "DRAG_UPDATE", payload: { droppableId: r, update: z } });
        },
  ...
  var R = v.useMemo(
      function () {
        return E ? H.createElement(Qo, { direction: i, mode: d }) : null;
      },
      [i, E, d],
    ),
    C = v.useMemo(
  ...
  return H.createElement(
    ...
    u && H.createElement(jo, { droppableId: r, type: a, getContainerForClone: c }, u),
  );
}
var ei = ["isRanking", "isRankingItem", "testId"],
  ti = v.forwardRef(function (e, t) {
    ...
    return v.createElement(
      ...
      se({ ref: t, testId: a }, o, {
        className: ir([
          r && "_1e0c1ule",
          n && "_2rkogqwt _bfhk1rd0 _16qs1dt4",
          "_12y3ssc3 _mizu1tqa _ra3xnqa1",
        ]),
        style: {
          "--_14yez9t": We("var(--ds-surface-overlay, ".concat(gn, ")")),
          "--_qzf6oc": We(
            "var(--ds-shadow-overlay, ".concat(
              "0 20px 32px -8px ".concat(cn, ", 0 0 1px ").concat(sn),
              ")",
            ),
          ),
          "--_9ksfq": We("var(--ds-border-focused, ".concat(un, ")")),
        },
      }),
    );
  }),
  ri = ["isRanking", "innerRef"],
  ni = function (t) {
    var r = t.isRanking,
      n = t.innerRef,
      a = De(t, ri);
    return v.createElement(pn, se({}, a, { innerRef: n, className: ir([r && "_vchhusvi"]) }));
  },
  ai = ["content", "testId"];
function oi(e, t, r) {
  return (
    (t = re(t)), Pe(e, en() ? Reflect.construct(t, r || [], re(e).constructor) : t.apply(e, r))
  );
}
function en() {
  try {
...
var ii = (function (e) {
  function t() {
    return Re(this, t), oi(this, t, arguments);
  }
  return (
    Ee(t, e),
    Ae(t, [
...
const li = lr(ii);
var di = ["cells", "testId", "key", "isHighlighted"];
function ar(e, t) {
  var r = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e);
...
function or(e) {
  for (var t = 1; t < arguments.length; t++) {
    var r = arguments[t] != null ? arguments[t] : {};
    t % 2
      ? ar(Object(r), !0).forEach(function (n) {
          D(e, n, r[n]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
...
function ui(e, t, r) {
  return (
    (t = re(t)), Pe(e, tn() ? Reflect.construct(t, r || [], re(e).constructor) : t.apply(e, r))
  );
}
function tn() {
  try {
            ...
            function (S, w) {
              ...
              return H.createElement(
                ...
                se({}, x, S.dragHandleProps, S.draggableProps, {
                  ...
                  style: or(or({}, S.draggableProps.style), I),
                  isHighlighted: p || b,
                  isRanking: d,
...
function gi(e, t, r) {
  return (
    (t = re(t)), Pe(e, rn() ? Reflect.construct(t, r || [], re(e).constructor) : t.apply(e, r))
  );
}
function rn() {
  try {
...
const Di = fn(
  H.forwardRef(function (e, t) {
    return H.createElement(fi, se({}, e, { forwardedRef: t }));
  }),
);
export { fi as RankableBody, Di as default };
