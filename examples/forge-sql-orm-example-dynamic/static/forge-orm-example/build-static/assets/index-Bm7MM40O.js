...
import { r as dt, a as _i, c as ph } from "./react-dom-vendor-BO7srUs7.js";
import { g as er, a as Ps, r as Zt, s as Ve } from "./client-core-vendor-B0uy4GXQ.js";
import { r as hh } from "./lodash-vendor-CUc-YdNV.js";
function gh(e, t) {
...
var uc;
function yh() {
  return (uc || ((uc = 1), (Ki.exports = bh())), Ki.exports);
}
var M = yh(),
  y = dt();
const S = er(y),
  lc = gh({ __proto__: null, default: S }, [y]);
var Yi = {},
  Go = function (e, t) {
    return (
      (Go =
...
function At() {
  if (fc) return sn;
  ((fc = 1), Object.defineProperty(sn, "__esModule", { value: !0 }), (sn.BridgeAPIError = void 0));
...
function ke() {
  if (vc) return on;
  ((vc = 1), Object.defineProperty(on, "__esModule", { value: !0 }), (on.getCallBridge = void 0));
  const e = At();
  function t(n) {
    return !!n?.callBridge;
  }
...
function Cf() {
  if (pc) return cn;
  ((pc = 1), Object.defineProperty(cn, "__esModule", { value: !0 }), (cn.withRateLimiter = void 0));
  const e = At(),
    t = (r, n, a, i) => {
      let o = Date.now(),
        s = 0;
...
function Sh() {
  if (hc) return an;
  ((hc = 1), Object.defineProperty(an, "__esModule", { value: !0 }), (an.invoke = void 0));
  const e = ke(),
    t = At(),
    r = Cf(),
    n = (0, e.getCallBridge)(),
...
function Eh() {
  return (
    gc ||
      ((gc = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), Rt.__exportStar(Sh(), e));
      })(Ji)),
    Ji
  );
}
...
function xh() {
  if (yc) return un;
  ((yc = 1), Object.defineProperty(un, "__esModule", { value: !0 }), (un.invokeRemote = void 0));
  const e = Pf(),
...
function Rh() {
  if (wc) return fn;
  ((wc = 1), Object.defineProperty(fn, "__esModule", { value: !0 }), (fn.submit = void 0));
  const e = ke(),
    t = At(),
    r = (0, e.getCallBridge)(),
    n = async (a) => {
...
function jh() {
  if (kc) return pn;
  ((kc = 1), Object.defineProperty(pn, "__esModule", { value: !0 }), (pn.refresh = void 0));
  const e = ke(),
    t = At(),
    r = (0, e.getCallBridge)(),
    n = async (a) => {
...
function Th() {
  if (Pc) return bn;
  ((Pc = 1), Object.defineProperty(bn, "__esModule", { value: !0 }), (bn.Translator = void 0));
  const e = Af();
  class t {
    locale;
    translationsGetter;
...
function Mh() {
  if (Rc) return yn;
  ((Rc = 1), Object.defineProperty(yn, "__esModule", { value: !0 }), (yn.ensureLocale = void 0));
  const e = Rf(),
...
function Bh() {
  if (Mc) return mn;
  ((Mc = 1), Object.defineProperty(mn, "__esModule", { value: !0 }), (mn.theme = void 0));
  const t = (0, ke().getCallBridge)();
...
function Df() {
  if (Nc) return On;
  ((Nc = 1), Object.defineProperty(On, "__esModule", { value: !0 }), (On.events = void 0));
  const e = ke(),
    t = zh(),
    r = (0, e.getCallBridge)(),
    n = async (i, o) => {
...
function qh() {
  if (Fc) return wn;
  ((Fc = 1), Object.defineProperty(wn, "__esModule", { value: !0 }), (wn.emitReadyEvent = void 0));
  const e = Df(),
    t = Tf(),
    r = "EXTENSION_READY",
    n = async () => {
...
function Mf() {
  return (
    zc ||
      ((zc = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), Rt.__exportStar(Tf(), e));
      })(Qi)),
    Qi
  );
}
...
function Uh() {
  if (qc) return kn;
  ((qc = 1), Object.defineProperty(kn, "__esModule", { value: !0 }), (kn.router = void 0));
  const t = (0, ke().getCallBridge)(),
    r = async (o) => {
...
function Hh() {
  return (
    Gc ||
      ((Gc = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), Rt.__exportStar(Gh(), e));
      })(oo)),
    oo
  );
}
...
function Xh() {
  return (
    Jc ||
      ((Jc = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), Rt.__exportStar(Df(), e));
      })(co)),
    co
  );
}
...
function Zh() {
  if (Xc) return Cn;
  ((Xc = 1), Object.defineProperty(Cn, "__esModule", { value: !0 }), (Cn.__realtime = void 0));
  const t = (0, ke().getCallBridge)(),
...
function tu(e, t) {
  for (var r = 0; r < t.length; r++) {
    ...
    ((n.enumerable = n.enumerable || !1),
      ...
      Object.defineProperty(e, Lf(n.key), n));
  }
}
function de(e, t, r) {
  return (
  ...
  return de(e, [
    {
      ...
      value: function (r) {
        return (
          ...
          Ae(r) === "object" && (this.payload = lo(lo({}, this.payload), r)),
          this
        );
      },
    },
...
function yg(e, t, r) {
  return (
    (t = W(t)),
    Ie(e, Bf() ? Reflect.construct(t, r || [], W(e).constructor) : t.apply(e, r))
  );
}
function Bf() {
  try {
    ...
    de(t, [
      {
        key: "update",
        value: function (n) {
          return this.hasFired ? this : _g(t, "update", this, 3)([n]);
        },
      },
    ])
  );
})(vg);
function iu(e, t, r, n, a, i, o) {
  try {
    var s = e[i](o),
      c = s.value;
  } catch (u) {
...
function Pg() {
  if (bu) return Ta;
  ((bu = 1), Object.defineProperty(Ta, "__esModule", { value: !0 }));
  const e = Zt();
  let t = class {
    constructor(n) {
      ((this._sdkKey = n),
...
var Lg = Wf.EventEmitter2 || Mg,
  Ma = "@all-features",
  $g = (function () {
    function e() {
      (le(this, e), x(this, "eventToValue", new Map()), (this.emitter = new Lg()));
    }
    return de(e, [
      {
        key: "onGateUpdated",
...
var La = function (t) {
    return Yo({ perimeter: Fg() ? ca.FEDRAMP_MODERATE : ca.COMMERCIAL }, t);
  },
  An = function (t, r) {
    if (!t && !r) return !0;
    if (!t || !r) return !1;
  ...
  qg = Object.entries(As).map(function (e) {
    var t = Z(e, 2),
      r = t[0],
      n = t[1];
...
function Xo(e) {
  ...
  return (
    (Xo = function (n) {
      ...
      function a() {
        return Vg(n, arguments, W(this).constructor);
      }
      return (
...
function Gg(e, t, r) {
  return (
    (t = W(t)),
    Ie(e, Jf() ? Reflect.construct(t, r || [], W(e).constructor) : t.apply(e, r))
  );
}
function Jf() {
  try {
...
var Wg = 5e3,
  Kg = "https://api.atlassian.com/flags",
  Yg = "https://api.stg.atlassian.com/flags",
  Jg = "https://api.dev.atlassian.com/flags",
  Xg = "https://api.stg.atlassian-us-gov-mod.com/flags",
  Zg = "https://api.atlassian-us-gov-mod.com/flags",
  Qg = "/gateway/api/flags",
  So = (function () {
    function e() {
      le(this, e);
    }
                ...
                for (;;)
                  switch ((s.prev = s.next)) {
                    ...
                    case 5:
                      ...
                      throw new Au("Unexpected 204 response");
                    case 7:
                    case "end":
                      return s.stop();
                  }
...
var rb = (function (e) {
  function t() {
    ...
    return (
      le(this, t),
      (r = eb(this, t, ["NoFetchDataAdapter", "nofetch"])),
...
var Eo = "LocalOverride:Recognized",
    ...
    return de(e, [
      ...
      },
      {
        ...
        value: function (r, n) {
          ...
          return i == null
            ? null
            : xe(xe({}, r), {}, { value: i, details: xe(xe({}, r.details), {}, { reason: Eo }) });
        },
      },
      {
          ...
          return i == null
            ...
            : xe(
                ...
                {},
                {
                  ...
                  details: xe(xe({}, r.details), {}, { reason: Eo }),
                },
              );
        },
      },
  ...
  sb = ["sdkKey", "environment", "updateUserCompletionCallback", "perimeter"];
function Lu(e, t) {
  var r = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e);
  ...
  ub = (function () {
    function e() {
      ...
      (le(this, e),
        ...
        x(this, "subscriptions", new $g()),
        x(this, "dataAdapter", new rb()),
        x(this, "statsigValuesUpdated", function () {
          (t.user && t.statsigClient.updateUserSync(t.user, { disableBackgroundCacheRefresh: !0 }),
            t.subscriptions.anyUpdated());
        }),
        (this.overrideAdapter = i || new ob(a)));
    }
    return de(e, [
      {
        key: "initialize",
        ...
        value: function (r) {
          ...
          try {
            ...
            return (
              ...
              new Pu(r, {}, "", { time: Date.now(), reason: As.Error })
            );
          }
        },
      },
                    ...
                    switch ((g.prev = g.next)) {
                      ...
                      case 19:
                        return (
                          ...
                          (this.statsigClient = new ot.StatsigClient($u, this.user, v)),
                ...
                function (b) {
                  for (;;)
                    switch ((b.prev = b.next)) {
                      ...
                      case 4:
                        ((u = b.sent), (l = Cu(i, u.customAttributesFromFetch)), (b.next = 13));
                        break;
                      case 8:
                        throw (
                          (b.prev = 8),
        ...
        value: function (r) {
          ...
          try {
            ...
            var a = n.fireLayerExposure,
              i = a === void 0 ? !0 : a;
            return Ru.fromLayer(this.statsigClient.getLayer(r, { disableExposureLog: !i }));
          } catch (o) {
            return (
              ...
              Ru.fromLayer(ot._makeLayer(r, { reason: "Error" }, null))
            );
          }
        },
      },
...
if (typeof window < "u")
  if (window.__FEATUREGATES_JS__ === void 0) window.__FEATUREGATES_JS__ = G;
    ...
    var Nu =
      (($a = Zo) === null || $a === void 0 || (xo = $a.getPackageVersion) === null || xo === void 0
        ? void 0
        : xo.call($a)) || "4.10.0 or earlier";
    if (Nu !== Fr) {
      var lb = `Multiple versions of FeatureGateClients found on the current page.
      The currently bound version is `
        .concat(Nu, " when module version ")
...
var Cr,
  ...
  js = {},
  pb = "@atlaskit/platform-feature-flags",
  Qn = "__PLATFORM_FEATURE_FLAGS__",
  Zf = typeof process < "u" && typeof js < "u",
  hb = Zf ? js.ENABLE_PLATFORM_FF === "true" : !1,
  gb = Zf ? js.STORYBOOK_ENABLE_PLATFORM_FF === "true" : !1,
  bb = hb || gb,
  yb = { booleanResolver: void 0 },
...
function kb(e, t) {
  var r = y.useState(function () {
    ...
    n = y.useRef(!0),
    a = y.useRef(r),
    i = n.current || !!(t && a.current.inputs && Ob(t, a.current.inputs)),
    ...
    f = y.useCallback(
      function (v) {
        var h = u({
          ...
          p = Eb({ componentName: n, packageName: i, packageVersion: o }, l.current);
        h.context.push(p);
        var g = h.clone();
    ...
    d = y.useCallback(
      function () {
        var f = c({
          ...
          v = xb({ componentName: n, packageName: a, packageVersion: i }, u.current);
        f.context.push(v);
        var h = f.clone();
...
var qu = "#FF5630",
  ...
  WS = "rgba(9, 30, 66, 0.25)",
  KS = "rgba(9, 30, 66, 0.31)",
  it = "#9FB0CC",
  Db = "#8C9CB8",
  Co = "#67758F",
  Dn = "#3B475C",
  ...
  Tn = "#1B2638",
  Ir = "#0D1424",
  Tb = ["isFixedSize", "hasDataRow", "children", "testId", "isLoading"];
function Xu(e, t) {
  var r = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e);
...
var Mb = y.forwardRef(function (e, t) {
    ...
    return y.createElement(
      ...
      H({ inert: o ? "" : void 0, ref: t }, s, {
        ...
        style: Zu(
          Zu(
            {},
            {
              "--local-dynamic-table-hover-bg":
                "var(--ds-background-neutral-subtle-hovered, ".concat(Rb, ")"),
          ...
          {},
          { "--_k02y3n": We("2px solid ".concat("var(--ds-border, ".concat(Qo, ")"))) },
        ),
      }),
      a,
    );
  ...
  Bb = ["rows", "head", "sortKey", "sortOrder", "rowsPerPage", "page", "forwardedRef"];
function Qu(e, t) {
  var r = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e);
...
function zb(e, t, r) {
  return (
    (t = W(t)),
    Ie(e, rv() ? Reflect.construct(t, r || [], W(e).constructor) : t.apply(e, r))
  );
}
function rv() {
  try {
...
function Ub(e) {
  var t = (function (r) {
    function n() {
      ...
      return ((a = zb(this, n, [].concat(o))), x(a, "state", { pageRows: [] }), a);
    }
    return (
      De(n, r),
      de(
        ...
        [
          {
            ...
            value: function (i, o) {
              ...
              var h, p;
              return (
                v ? ((h = s), (p = s)) : ((h = qb(c, s, u, l) || []), (p = Nf(h, d, f))),
                el(el({}, o), {}, { pageRows: p })
              );
            },
          },
...
var Kb = y.forwardRef(function (e, t) {
...
function Zb(e, t, r) {
  return (
    (t = W(t)),
    Ie(e, av() ? Reflect.construct(t, r || [], W(e).constructor) : t.apply(e, r))
  );
}
function av() {
  try {
...
var Qb = (function (e) {
    function t() {
      return (le(this, t), Zb(this, t, arguments));
    }
    return (
      De(t, e),
      de(t, [
  ...
  ey = Ub(
    S.forwardRef(function (e, t) {
      return S.createElement(Qb, H({}, e, { forwardedRef: t }));
    }),
  );
function ty(e, t, r) {
  return (
...
var ry = (function (e) {
  function t(r) {
    var n;
    return (le(this, t), (n = ty(this, t, [r])), (n.state = { hasError: !1 }), n);
  }
  return (
    De(t, e),
    de(
...
var ny = { xsmall: 8, small: 16, medium: 24, large: 48, xlarge: 96 };
function ay(e) {
  return e === "inherit"
...
var Na = {
  ...
  iy = typeof window > "u" ? y.useEffect : y.useLayoutEffect,
  ov = S.memo(
      ...
      return (
        ...
        S.createElement(
          "span",
          {
            ...
            className: R([Na.wrapperStyles, Na.rotateStyles]),
          },
          S.createElement(
            "svg",
            {
  ...
  sy = function (t) {
    ...
    return y.createElement(
      "div",
      {
        ...
        style: il(il({}, x({}, ol, n)), {}, { "--_cnddr8": We("var(".concat(ol, ")")) }),
      },
      r,
    );
  },
...
function uy(e, t, r) {
  return (
    (t = W(t)),
    Ie(e, sv() ? Reflect.construct(t, r || [], W(e).constructor) : t.apply(e, r))
  );
}
function sv() {
  try {
...
var cv = (function (e) {
  function t() {
    return (le(this, t), uy(this, t, arguments));
  }
  return (
    De(t, e),
    de(t, [
      {
        ...
        value: function () {
          ...
          return S.createElement(
            oy,
            { testId: c },
            i ? S.createElement(sy, { contentsOpacity: s, testId: c }, a) : a,
            i &&
              S.createElement(
                cy,
                { testId: c },
...
function py(e, t, r) {
  return (
    (t = W(t)),
    Ie(e, uv() ? Reflect.construct(t, r || [], W(e).constructor) : t.apply(e, r))
  );
}
function uv() {
  try {
    ...
    return y.createElement(
      ...
      y.createElement("svg", {
        ...
        className: R([
          ...
          v ? "_1bsb1kw7 _4t3i1kw7" : _ === "utility" ? yy[g] : O === "small" ? by[g] : gy[g],
        ]),
      }),
    );
  });
const wy = Object.freeze(
    Object.defineProperty({ __proto__: null, Icon: sl, default: sl }, Symbol.toStringTag, {
      value: "Module",
    }),
  ),
  wi = Ps(wy);
...
var Oy = {
  ...
  Sy = y.memo(function (t) {
    ...
    if (s && i && (o === "small" || o === "medium"))
      if (a.iconType === "utility") {
        ...
        return S.createElement(
          c,
          H({}, a, {
            spacing: Ze("platform-visual-refresh-icons-facade-button-fix") ? dl.utility[o] : "none",
    ...
    return S.createElement(ts, H({ dangerouslySetGlyph: r, size: n }, a));
  });
const Ey = Object.freeze(
    Object.defineProperty(
      { __proto__: null, Icon: ts, IconFacade: Sy, default: ts },
      Symbol.toStringTag,
      { value: "Module" },
    ),
  ),
...
function Cy() {
  if (vl) return Mn;
  ((vl = 1), Object.defineProperty(Mn, "__esModule", { value: !0 }), (Mn.default = void 0));
  var e = n(dt()),
    t = n(dv()),
    r = n(xy());
  function n(i) {
...
function vv() {
  if (pl) return Fn;
  ((pl = 1), Object.defineProperty(Fn, "__esModule", { value: !0 }), (Fn.default = void 0));
  var e = r(dt()),
    t = r(wi);
  function r(a) {
    return a && a.__esModule ? a : { default: a };
...
function Ay() {
  if (hl) return Bn;
  ((hl = 1), Object.defineProperty(Bn, "__esModule", { value: !0 }), (Bn.default = void 0));
  var e = n(dt()),
    t = fv,
    r = n(vv());
  function n(i) {
...
var Vy = Uy(),
  ...
  Ky = { wrap: "_1n261g80", nowrap: "_1n261q9c" },
  Yy = {
    start: "_4cvrv2br",
    center: "_4cvr1h6o",
    baseline: "_4cvr1q9y",
...
var rs = {
  ...
  Xy = function (t) {
    var r = t.children;
    return y.createElement("span", { className: R([rs.separator]) }, r);
  },
  Ga = y.memo(
    y.forwardRef(function (e, t) {
      var r = e.as,
        ...
        p = e.role,
        g = e.children,
        b = typeof f == "string" ? y.createElement(Xy, null, f) : f,
        _ = b
      ...
      return y.createElement(
        si,
        {
          ...
          rowGap: d,
          wrap: s ? "wrap" : void 0,
          xcss: Gy(u === "hug" && rs.hug, u === "fill" && rs.fill, v),
          testId: h,
          ref: t,
        },
        _,
...
var gv = y.createContext(!1),
  e_ = function () {
    return y.useContext(gv);
  },
  t_ = gv.Provider,
  r_ = ["span", "p", "strong", "em"],
  n_ = function (t, r) {
    ...
    if (t !== "inherit") {
      if (t) return t;
      if (!r) return _l.hasOwnProperty(n) ? _l[n] : "color.text";
    }
  },
  Dr = {
  ...
  a_ = { medium: "_11c82smr", UNSAFE_small: "_11c8dcr7", large: "_11c81ixg", small: "_11c81o8v" },
  i_ = { bold: "_k48pmoej", medium: "_k48p1wq8", regular: "_k48pi7a9", semibold: "_k48p1pd9" },
  o_ = {
  ...
  s_ = y.forwardRef(function (e, t) {
    ...
    return v ? p : y.createElement(t_, { value: !0 }, p);
  });
function c_() {
...
var u_ = ["as", "children", "isInset", "testId", "style", "xcss"],
  l_ = ["className"];
function ml(e, t) {
  var r = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
...
var d_ = y.forwardRef(function (e, t) {
  ...
  p_ = y.forwardRef(function (e, t) {
    ...
    return y.createElement(
      d_,
      H({ as: "button", tabIndex: h ?? (c_() && !n ? 0 : void 0), style: d }, O, {
        type: i,
        onClick: _,
        disabled: n,
        xcss: hv(Ol.root, n && Ol.disabled, v),
        testId: f,
        ref: t,
      }),
      r,
...
var ki = g_(),
  ...
  yv = function (e) {
    return (e === void 0 && (e = ""), { value: 1, prefix: e, uid: b_() });
  },
  y_ = yv(),
  __ = y.createContext(yv()),
  m_ = function (e) {
    return e.value++;
  },
  w_ = function (e) {
  ...
  Ao,
  xl = (Ao = S.useId) !== null && Ao !== void 0 ? Ao : void 0;
function E_() {
  if (xl && Ze("platform-dst-react-18-use-id")) {
    var e = xl();
    return function (t) {
...
var T_ = (function () {
    ...
    return (
      ...
      (t.insert = function (n) {
        this.ctr % (this.isSpeedy ? 65e3 : 1) === 0 && this._insertTag(D_(this));
...
function qn(e, t) {
  return N_(xi("", null, null, "", null, null, 0), e, { length: -e.length }, t);
}
function q_() {
  return pe;
}
...
function Ne() {
  return ((pe = je < kv ? ye(Kr, je++) : 0), qr++, pe === 10 && ((qr = 1), Ei++), pe);
}
function Ot() {
  return ye(Kr, je);
}
...
function Sv(e) {
  return ((Ei = qr = 1), (kv = yt((Kr = e))), (je = 0), []);
}
function Ev(e) {
  return ((Kr = ""), e);
}
function Wa(e) {
  return Ov(wa(je - 1, as(e === 91 ? e + 2 : e === 40 ? e + 1 : e)));
}
function V_(e) {
  for (; (pe = Ot()) && pe < 33; ) Ne();
...
function G_(e, t) {
  ...
  return wa(e, Ha() + (t < 6 && Ot() == 32 && Ne() == 32));
}
function as(e) {
  for (; Ne(); )
    switch (pe) {
...
function H_(e, t) {
  for (; Ne() && e + pe !== 57; ) if (e + pe === 84 && Ot() === 47) break;
...
function K_(e) {
  return Ev(Ka("", null, null, null, [""], (e = Sv(e)), 0, [0], e));
}
  ...
  for (
    ...
    switch (((h = _), (_ = Ne()))) {
        ...
        switch (_) {
          ...
          case 59 + l:
            (b == -1 && (E = te(E, /\f/g, "")),
              v > 0 &&
                yt(E) - d &&
                Fa(v > 32 ? Pl(E + ";", n, r, d - 1) : Pl(te(E, " ", "") + ";", n, r, d - 2), c));
            break;
          case 59:
            E += ";";
          default:
            if ((Fa((k = Cl(E, t, r, u, l, a, s, O, (w = []), (m = []), d)), i), _ === 123))
              if (l === 0) Ka(E, t, k, k, w, i, d, s, m);
              else
                switch (f === 99 && ye(E, 3) === 110 ? 100 : f) {
                  ...
                  case 115:
                    Ka(
                      ...
                      k,
                      k,
                      n && Fa(Cl(e, k, k, 0, 0, a, s, O, a, (w = []), d), m),
                      a,
                      m,
                      d,
                      s,
      ...
      default:
        if (p < 1) {
          if (_ == 123) --p;
          else if (_ == 125 && p++ == 0 && U_() == 125) continue;
        }
        switch (((E += Si(_)), _ * p)) {
          case 38:
            b = l > 0 ? 1 : ((E += "\f"), -1);
          ...
          case 44:
            ...
            break;
          case 64:
            (Ot() === 45 && (E += Wa(Ne())), (f = Ot()), (l = d = yt((O = E += W_(Ha())))), _++);
            break;
          case 45:
            h === 45 && yt(E) == 2 && (p = 0);
        }
...
function Cl(e, t, r, n, a, i, o, s, c, u, l) {
  for (var d = a - 1, f = a === 0 ? i : [""], v = Ls(f), h = 0, p = 0, g = 0; h < n; ++h)
    for (var b = 0, _ = da(e, d + 1, (d = $_((p = o[h])))), O = e; b < v; ++b)
      (O = Ov(p > 0 ? f[b] + " " + _ : te(_, /&\f/g, f[b]))) && (c[g++] = O);
  return xi(e, t, r, a === 0 ? Ts : s, c, u, l);
}
function Y_(e, t, r) {
  return xi(e, t, r, mv, Si(q_()), da(e, 2, -2), 0);
}
function Pl(e, t, r, n) {
...
var em = function (t, r, n) {
    for (var a = 0, i = 0; (a = i), (i = Ot()), a === 38 && i === 12 && (r[n] = 1), !fa(i); ) Ne();
    return wa(t, je);
  },
  tm = function (t, r) {
    var n = -1,
    ...
    do
      switch (fa(a)) {
        case 0:
          (a === 38 && Ot() === 12 && (r[n] = 1), (t[n] += em(je - 1, r, n)));
          break;
        case 2:
          t[n] += Wa(a);
          break;
  ...
  nm = function (t) {
    if (!(t.type !== "rule" || !t.parent || t.length < 1)) {
      ...
      if (!(t.props.length === 1 && r.charCodeAt(0) !== 58 && !Rl.get(n)) && !a) {
        Rl.set(t, !0);
        for (var i = [], o = rm(r, i), s = n.props, c = 0, u = 0; c < o.length; c++)
    ...
    case 4765:
      if (yt(e) - 1 - t > 6)
        switch (ye(e, t + 1)) {
          ...
          case 115:
            return ~ns(e, "stretch") ? xv(te(e, "stretch", "fill-available"), t) + e : e;
        }
      break;
    case 4949:
...
var im = function (t, r, n, a) {
    if (t.length > -1 && !t.return)
      switch (t.type) {
        ...
        case Ts:
          if (t.length)
            return z_(t.props, function (i) {
              switch (B_(i, /(::plac\w+|:read-\w+)/)) {
                case ":read-only":
                case ":read-write":
...
var jl;
function um() {
  return (jl || ((jl = 1), (jo.exports = cm())), jo.exports);
}
var Io, Il;
function lm() {
  if (Il) return Io;
...
var $s = function (t, r, n) {
    var a = t.key + "-" + r.name;
    (n === !1 || dm === !1) && t.registered[a] === void 0 && (t.registered[a] = r.styles);
  },
  Pv = function (t, r, n) {
    $s(t, r, n);
    var a = t.key + "-" + r.name;
...
var vm = {
  ...
  Do = Q_(function (e) {
    return Rv(e) ? e : e.replace(pm, "-$&").toLowerCase();
  }),
  Tl = function (t, r) {
    switch (t) {
      case "animation":
      case "animationName":
        if (typeof r == "string")
          return r.replace(hm, function (n, a, i) {
            return ((_t = { name: a, styles: i, next: _t }), a);
          });
    }
    return vm[t] !== 1 && !Rv(t) && typeof r == "number" && r !== 0 ? r + "px" : r;
  };
function va(e, t, r) {
  if (r == null) return "";
  var n = r;
  ...
  if (Array.isArray(r)) for (var a = 0; a < r.length; a++) n += va(e, t, r[a]) + ";";
    ...
    for (var i in r) {
      ...
      if (typeof o != "object") {
        ...
        for (var c = 0; c < o.length; c++) Dl(o[c]) && (n += Do(i) + ":" + Tl(i, o[c]) + ";");
      else {
        var u = va(e, t, o);
        switch (i) {
          case "animation":
...
function Ns(e, t, r) {
  ...
  Ml.lastIndex = 0;
  for (var u = "", l; (l = Ml.exec(a)) !== null; ) u += "-" + l[1];
  var d = fm(a) + u;
...
var bm = function (t) {
  ...
  ym = lc.useInsertionEffect ? lc.useInsertionEffect : !1,
  Av = ym || bm,
  jv = y.createContext(typeof HTMLElement < "u" ? sm({ key: "css" }) : null);
jv.Provider;
var Iv = function (t) {
    return y.forwardRef(function (r, n) {
      var a = y.useContext(jv);
      return t(r, a, n);
    });
  },
  Dv = y.createContext({}),
  ...
  wm = Iv(function (e, t, r) {
    ...
    typeof e.className == "string"
      ? (o = Cv(t.registered, i, e.className))
      : e.className != null && (o = e.className + " ");
    var s = Ns(i, void 0, y.useContext(Dv));
    o += t.key + "-" + s.name;
    var c = {};
    for (var u in e) Fs.call(e, u) && u !== "css" && u !== is && (c[u] = e[u]);
    return (
      (c.className = o),
      r && (c.ref = r),
      y.createElement(
        y.Fragment,
        null,
        y.createElement(mm, { cache: t, serialized: s, isStringTag: typeof a == "string" }),
        y.createElement(a, c),
      )
    );
  }),
...
var Em = function (t) {
    ...
    return (
      Av(function () {
        for (var a = 0; a < n.length; a++) Pv(r, n[a], !1);
      }),
      null
    );
  },
  xm = Iv(function (e, t) {
    var r = [],
      n = function () {
        ...
        var d = Ns(u, t.registered);
        return (r.push(d), $s(t, d, !1), t.key + "-" + d.name);
      },
      a = function () {
        for (var c = arguments.length, u = new Array(c), l = 0; l < c; l++) u[l] = arguments[l];
        return Sm(t.registered, n, km(u));
      },
      i = { css: n, cx: a, theme: y.useContext(Dv) },
      o = e.children(i);
    return y.createElement(
      y.Fragment,
      null,
      y.createElement(Em, { cache: t, serializedArr: r }),
      o,
    );
  });
function Cm(e, t) {
  ...
  Nl = {
    background: {
      default: {
        ...
        hover: {
          ...
          dark: "var(--ds-background-neutral-hovered, ".concat(Ju, ")"),
        },
        active: {
          light: "var(--ds-background-neutral-pressed, ".concat($l, ")"),
      ...
      primary: {
        ...
        hover: {
          light: "var(--ds-background-brand-bold-hovered, ".concat(Wu, ")"),
          dark: "var(--ds-background-brand-bold-hovered, ".concat(Jn, ")"),
        },
        active: {
          light: "var(--ds-background-brand-bold-pressed, ".concat(Ku, ")"),
      ...
      danger: {
        default: {
          light: "var(--ds-background-danger-bold, ".concat(Uu, ")"),
          dark: "var(--ds-background-danger-bold, ".concat(Uu, ")"),
        },
        hover: {
          light: "var(--ds-background-danger-bold-hovered, ".concat(qu, ")"),
          dark: "var(--ds-background-danger-bold-hovered, ".concat(qu, ")"),
        },
        active: {
      ...
      subtle: {
        ...
        hover: {
          ...
          dark: "var(--ds-background-neutral-subtle-hovered, ".concat(Ju, ")"),
        },
        active: {
          light: "var(--ds-background-neutral-subtle-pressed, ".concat($l, ")"),
    ...
    color: {
      ...
      link: {
        ...
        hover: {
          light: "var(--ds-link, ".concat(Wu, ")"),
          dark: "var(--ds-link, ".concat(Jn, ")"),
        },
        active: {
          light: "var(--ds-link-pressed, ".concat(Ku, ")"),
      ...
      "subtle-link": {
        ...
        hover: {
          light: "var(--ds-text-subtle, ".concat(Ab, ")"),
          dark: "var(--ds-text-subtle, ".concat(tv, ")"),
        },
        active: {
          light: "var(--ds-text, ".concat(Ib, ")"),
          dark: "var(--ds-text, ".concat(Db, ")"),
        },
        disabled: {
          light: "var(--ds-text-disabled, ".concat(cr, ")"),
          dark: "var(--ds-text-disabled, ".concat(Co, ")"),
...
var Jt = x_(),
  ...
  us = { default: "".concat(32 / 14, "em"), compact: "".concat(24 / 14, "em"), none: "auto" },
  Tm = { default: us.default, compact: us.compact, none: "inherit" },
  Mm = {
    default: "0 ".concat(Jt + Jt / 4, "px"),
    compact: "0 ".concat(Jt + Jt / 4, "px"),
    none: "0",
  },
  Lm = { compact: "0 ".concat(Jt / 4, "px"), default: "0 ".concat(Jt / 4, "px"), none: "0" },
  $m = { default: "middle", compact: "middle", none: "baseline" },
  Mv = { content: "0 ".concat(Jt / 4, "px"), icon: "0 ".concat(Jt / 4, "px") },
  Lv = {
  ...
  Bl = { '&[data-has-overlay="true"]': { cursor: "default", textDecoration: "none" } };
function zl(e) {
  var t = e.group,
    r = e.key,
    n = e.mode,
...
function Tr(e) {
  var t = e.appearance,
    ...
    n = e.mode;
  return {
    background: zl({ group: Nl.background[t], key: r, mode: n }),
    color: "".concat(zl({ group: Nl.color[t], key: r, mode: n }), " !important"),
  };
}
function Hm(e) {
  var t = e.appearance,
              ...
              ne(
                ne(
                  ne(
                    ne(
                      ne(
                        ne(ne({}, t === "default" && Nm), t === "primary" && Fm),
                        t === "link" && Bm,
                      ),
                      t === "subtle" && zm,
                    ),
...
var Ym = {
  ...
  Bs = function (t) {
    return t && y.isValidElement(t) && t.type === _v;
  },
  Jm = [
    "analyticsContext",
    "appearance",
    ...
    return (
      ...
      Ft(
        ...
        Ft(
          ...
          p ? Ft("span", { css: [ze, ql({ spacing: F }), Ul(u, Zm)] }, p) : null,
          e0(u, [ze, Wm({ spacing: F })]),
          h ? Ft("span", { css: [ze, ql({ spacing: F }), Ul(u, Qm)] }, h) : null,
          T ? Ft("span", { css: [Ym, rt] }, T) : null,
        ),
      )
    );
  });
...
var n0 = [
  ...
  Vl = typeof navigator < "u" && navigator.userAgent.toLowerCase().indexOf("firefox") > -1,
  zs = S.memo(
    S.forwardRef(function (t, r) {
      var n = t.appearance,
        ...
        O = j_(),
        w = O.mode,
        m = r0({ children: i, iconBefore: o, iconAfter: s }),
        k = y.useState(!1),
        E = Z(k, 2),
        j = E[0],
        I = E[1],
...
function a0(e) {
  return S.createElement(zs, H({}, e, { appearance: "subtle" }));
}
...
function o0(e) {
  ...
  return S.createElement(
    ...
    S.createElement(
      ...
      S.createElement(_v, null, "Skipped pages from ", n, " to ", a),
      "…",
    ),
  );
}
...
function c0(e, t) {
  if (e.length !== t.length) return !1;
  for (var r = 0; r < e.length; r++) if (!s0(e[r], t[r])) return !1;
  return !0;
}
function u0(e, t) {
  t === void 0 && (t = c0);
...
function v0(e, t) {
  var r = e.components,
    ...
    V = function (A, q, he) {
      ...
      return S.createElement(
        Ga,
        { as: "li", xcss: ls.paginationMenuItem, key: "page-".concat(k ? k(A, q) : q) },
        S.createElement(
          a0,
          {
            component: n.Page,
  ...
  return S.createElement(
    ...
    S.createElement(
      ...
      S.createElement(Gl, {
        ...
        isDisabled: T || U === 0,
        iconBefore: S.createElement(Yl, { chevronDirection: "left" }),
        "aria-label": f,
      ...
      S.createElement(
        ...
        l0(m, U, { max: _, ellipsis: j, transform: V }, C),
      ),
      S.createElement(Gl, {
        key: "right-navigator",
        component: n.Next,
        ...
        iconBefore: S.createElement(Yl, { chevronDirection: "right" }),
        "aria-label": h,
...
var p0 = y.memo(y.forwardRef(v0));
function h0(e, t, r) {
  return (
    (t = W(t)),
    Ie(e, $v() ? Reflect.construct(t, r || [], W(e).constructor) : t.apply(e, r))
  );
}
function $v() {
  try {
...
var Xl = "--local-dynamic-table-text-color",
  _0 = function (t) {
    var r = t.isRanking,
      n = t.testId,
      a = ae(t, b0);
  ...
  Nv = y.forwardRef(function (e, t) {
    var r = e.width,
      ...
      d = ae(e, y0),
      f = Un(
        Un(Un({}, u), r && nv({ width: r })),
        {},
        x({}, Xl, "var(--ds-text-subtlest, ".concat(Yu, ")")),
      ),
      v = i === vr,
      h = i === ai,
      p = function () {
    ...
    return y.createElement(
      ...
      H({ "aria-sort": p(), onClick: b ? void 0 : c, ref: t, "data-testid": l }, d, {
        ...
        style: Un(
          ...
          {
            "--_k02y3n": We("2px solid ".concat("var(--ds-border, ".concat(Qo, ")"))),
            "--_17ckjys": We("var(--ds-text-subtle, ".concat("var(".concat(Xl, ")"), ")")),
            "--_jz8ahf": We("solid 2px ".concat("var(--ds-border-focused, ".concat(oi, ")"))),
            "--_6j4ewu": We("var(--ds-background-neutral-hovered, ".concat(es, ")")),
            "--_1rdacuj": We("3px solid ".concat("var(--ds-icon-disabled, ".concat(Qo, ")"))),
...
function m0(e, t, r) {
  return (
    (t = W(t)),
    Ie(e, Fv() ? Reflect.construct(t, r || [], W(e).constructor) : t.apply(e, r))
  );
}
function Fv() {
  try {
...
function w0() {
  if (Zl) return Vn;
  ((Zl = 1), Object.defineProperty(Vn, "__esModule", { value: !0 }), (Vn.default = void 0));
  var e = r(dt()),
    t = r(wi);
  function r(a) {
    return a && a.__esModule ? a : { default: a };
...
function S0() {
  if (Ql) return Gn;
  ((Ql = 1), Object.defineProperty(Gn, "__esModule", { value: !0 }), (Gn.default = void 0));
  var e = r(dt()),
    t = r(wi);
  function r(a) {
    return a && a.__esModule ? a : { default: a };
...
function P0(e) {
  var t = e.onClose,
    ...
    a = y.useCallback(
      function (o) {
        r || n.current || o.key !== C0 || ((n.current = !0), t(o));
      },
      [t, r],
    ),
...
var R0 = y.createContext(null),
  A0 = y.createContext(null);
function j0() {
  var e = y.useContext(A0);
  return e;
}
function I0(e) {
  var t = e.isOpen,
...
var Xn = { none: 0, small: 100, medium: 350, large: 700 },
  Mo = 0.5,
  D0 = { none: Xn.none, small: Xn.small * Mo, medium: Xn.medium * Mo, large: Xn.large * Mo },
  T0 = function () {
  ...
  qv = y.createContext(zv),
  ed = function (t) {
    var r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : zv;
    return S.createElement(qv.Provider, { key: "".concat(t.key, "-provider"), value: r }, t);
  },
  td = function (t) {
    var r = [];
    return (
  ...
  N0 = function (t, r) {
    for (var n = r.concat([]), a = F0(r), i = 0; i < t.length; i++) {
      var o = t[i],
        s = !a[o.key];
      s && n.splice(i + 1, 0, o);
    }
...
Uv.displayName = "ExitingPersistence";
function q0() {
  var e = y.useRef("");
  return (
    e.current ||
...
var U0 = y.createContext(function () {
  ...
  H0 = { top: "bottom", bottom: "top", left: "right", right: "left" },
  W0 = function (t) {
    var r = t.children,
      n = t.duration,
      a = n === void 0 ? "large" : n,
...
var Y0 = function (t) {
  ...
  X0 = function (t, r) {
    if (typeof t == "function") return J0(t, r);
    t != null && (t.current = r);
  },
  rd = function (t) {
    return t.reduce(function (r, n) {
  ...
  Wn = "popper",
  Q0 = "reference",
  ad = Oa.reduce(function (e, t) {
    return e.concat([t + "-" + Ur, t + "-" + pa]);
  }, []),
  Gv = [].concat(Oa, [qs]).reduce(function (e, t) {
...
function Ci(e) {
  return Ct(e) === "html" ? e : e.assignedSlot || e.parentNode || (Us(e) ? e.host : null) || tr(e);
}
function id(e) {
...
function pw(e) {
  ...
  var a = Ci(e);
  for (Us(a) && (a = a.host); Qe(a) && ["html", "body"].indexOf(Ct(a)) < 0; ) {
    var i = Gt(a);
    if (
      i.transform !== "none" ||
      i.perspective !== "none" ||
...
function ka(e) {
  for (var t = Fe(e), r = id(e); r && vw(r) && Gt(r).position === "static"; ) r = id(r);
...
function yw(e) {
  ...
  a != null &&
    ((typeof a == "string" && ((a = t.elements.popper.querySelector(a)), !a)) ||
      (Wv(t.elements.popper, a) && (t.elements.arrow = a)));
}
const _w = {
  name: "arrow",
  enabled: !0,
...
var mw = { top: "auto", right: "auto", bottom: "auto", left: "auto" };
function ww(e, t) {
  var r = e.x,
    n = e.y,
...
function od(e) {
  ...
  var T = Object.assign({ position: s }, u && mw),
    B = l === !0 ? ww({ x: v, y: p }, Fe(r)) : { x: v, y: p };
  if (((v = B.x), (p = B.y), c)) {
    var F;
...
const kw = { name: "computeStyles", enabled: !0, phase: "beforeWrite", fn: Ow, data: {} };
var Ba = { passive: !0 };
function Sw(e) {
  var t = e.state,
    r = e.instance,
...
function Pw(e, t) {
  ...
  return { width: i, height: o, x: s + Ws(e), y: c };
}
function Rw(e) {
  var t,
    r = tr(e),
...
function cd(e, t, r) {
  return t === Vv ? fs(Pw(e, r)) : pr(t) ? Aw(t, r) : fs(Rw(tr(e)));
}
function jw(e) {
  var t = ra(Ci(e)),
  ...
  return pr(n)
    ? t.filter(function (a) {
        return pr(a) && Wv(a, n) && Ct(a) !== "body";
      })
    : [];
}
function Iw(e, t, r, n) {
  var a = t === "clippingParents" ? jw(e) : [].concat(t),
    i = [].concat(a, [r]),
    o = i[0],
    s = i.reduce(
      function (c, u) {
...
function ha(e, t) {
  ...
  var r = t,
    ...
    p = r.padding,
    g = p === void 0 ? 0 : p,
    b = Yv(typeof g != "number" ? g : Jv(g, Oa)),
    _ = f === Wn ? Q0 : Wn,
    O = e.rects.popper,
    w = e.elements[h ? _ : f],
    m = Iw(pr(w) ? w : w.contextElement || tr(e.elements.popper), c, l, o),
    k = Gr(e.elements.reference),
    E = Zv({ reference: k, element: O, placement: a }),
    j = fs(Object.assign({}, O, E)),
    I = f === Wn ? j : k,
    C = {
...
function Dw(e, t) {
  ...
  var v = f.reduce(function (h, p) {
    return ((h[p] = ha(e, { placement: p, boundary: a, rootBoundary: i, padding: o })[kt(p)]), h);
  }, {});
  ...
  if (!t.modifiersData[n]._skip) {
    for (
      ...
      var T = w[C],
        ...
        U = [Pe, et].indexOf(B) >= 0,
        Q = U ? "width" : "height",
        z = ha(t, { placement: T, boundary: l, rootBoundary: d, altBoundary: f, padding: u }),
        V = U ? (F ? tt : Re) : F ? et : Pe;
      m[Q] > k[Q] && (V = Ya(V));
      var J = Ya(V),
        A = [];
...
function Bw(e) {
  var t = e.state,
    ...
    a = r.offset,
    i = a === void 0 ? [0, 0] : a,
    o = Gv.reduce(function (l, d) {
      return ((l[d] = Fw(d, t.rects, i)), l);
    }, {}),
    s = o[t.placement],
    c = s.x,
    u = s.y;
...
const zw = { name: "offset", enabled: !0, phase: "main", requires: ["popperOffsets"], fn: Bw };
function qw(e) {
  var t = e.state,
    r = e.name;
...
const Uw = { name: "popperOffsets", enabled: !0, phase: "read", fn: qw, data: {} };
function Vw(e) {
  return e === "x" ? "y" : "x";
}
function Gw(e) {
  ...
  if (k) {
    if (i) {
      var F,
        ...
        K = _ === Ur ? -j[z] : -E[z],
        be = t.elements.arrow,
        ce = v && be ? Vs(be) : { width: 0, height: 0 },
    ...
    if (s) {
      var gt,
        ...
        Aa = (gt = T?.[m]) != null ? gt : 0,
        ja = nr ? Ee : qe - E[Te] - j[Te] - Aa + C.altAxis,
        Ia = nr ? qe + E[Te] + j[Te] - Aa - C.altAxis : Ue,
        Da = v && nr ? hw(ja, qe, Ia) : ta(v ? ja : Ee, qe, v ? Ia : Ue);
      ((k[m] = Da), (B[m] = Da - qe));
    }
    t.modifiersData[n] = B;
  }
...
function Jw(e, t, r) {
  ...
  return (
    (n || (!n && !r)) &&
      ((Ct(t) !== "body" || Ks(i)) && (s = Kw(t)),
      Qe(t) ? ((c = Gr(t, !0)), (c.x += t.clientLeft), (c.y += t.clientTop)) : i && (c.x = Ws(i))),
    {
    ...
    var l = {
      ...
      v = {
        ...
        setOptions: function (b) {
          ...
          var O = Zw(e1([].concat(n, l.options.modifiers)));
          return (
        ...
        forceUpdate: function () {
          if (!f) {
            ...
            if (fd(_, O)) {
              ((l.rects = {
                reference: Jw(_, ka(O), l.options.strategy === "fixed"),
                popper: Vs(O),
              }),
                (l.reset = !1),
...
var r1 = [Ew, Uw, kw, fw, zw, Lw, Hw, _w, Nw],
  n1 = t1({ defaultModifiers: r1 }),
  Lo,
  vd;
function a1() {
  if (vd) return Lo;
    ...
    var a = y.useRef(null),
      ...
      l = y.useMemo(
        function () {
          ...
          return o1(a.current, f) ? a.current || f : ((a.current = f), f);
        },
...
function b1(e) {
    ...
    b = y.useMemo(
      function () {
        var O = {
          ...
          m = v ? v1({ viewportPadding: vs }) : [];
        return [].concat(p1, [O, w], Me(m));
      },
      [p, g, v],
    ),
    _ = y.useMemo(
  ...
  return S.createElement(f1, { modifiers: _, placement: o, strategy: d, referenceElement: c }, r);
}
var Qv = "atlaskit-portal-container",
  ep = "body > .atlaskit-portal-container",
  tp = "atlaskit-portal",
  y1 = function (t) {
    var r = document.createElement("div");
    return ((r.className = tp), (r.style.zIndex = "".concat(t)), r);
  },
  rp = function () {
    return document.body;
  },
  np = function () {
    var t = document.querySelector(ep);
    if (!t) {
      var r,
      ...
      return (
        ...
        (r = rp()) === null || r === void 0 || r.appendChild(n),
        n
      );
    }
    return t;
  ...
  m1 = function (t) {
    t.parentElement || np().appendChild(t);
  },
  ap = function () {
...
var ip = typeof window < "u" ? y.useLayoutEffect : y.useEffect;
function S1(e) {
  var t = e.zIndex,
    r = e.children,
    n = y.useState(null),
...
var E1 = function (t) {
    var r = y.useState(!1),
      ...
      o = y.useState(function () {
        return t === "layoutEffect" ? ip : y.useEffect;
      }),
      s = Z(o, 1),
      c = s[0];
    return (
  ...
  R1 = function (t, r) {
    var n = { layer: P1(Number(r)), zIndex: r };
...
function j1(e) {
  ...
  return (
    ...
    Ze("platform_design_system_team_portal_logic_r18_fix")
      ? S.createElement(S1, { zIndex: r }, n)
      : o
        ? S.createElement(k1, { zIndex: r }, n)
        : null
  );
}
var na = new Set(),
...
function I1() {
  return ki.bindAll(window, [
    { type: "dragstart", listener: gd },
    { type: "dragenter", listener: gd },
  ]);
}
var za = null;
function D1(e) {
...
var op = y.forwardRef(function (t, r) {
  var n = t.style,
    a = t.className,
    i = t.children,
    o = t.placement,
...
sp.displayName = "TooltipContainer";
function md(e) {
...
var L1 = C_.tooltip(),
  Od = { componentName: "tooltip", packageName: "@atlaskit/tooltip", packageVersion: "20.3.1" },
  $1 = { top: "bottom", bottom: "top", left: "right", right: "left" },
  N1 = function (t) {
    return t.split("-")[0];
  };
function cp(e) {
  var t = e.children,
    ...
    Q = U === void 0 ? !1 : U,
    z = n === "mouse" ? i : n,
    V = zu(Mr({ fn: b, action: "displayed", analyticsData: I }, Od)),
    J = zu(Mr({ fn: O, action: "hidden", analyticsData: I }, Od)),
    A = y.useRef(null),
    q = y.useState("hide"),
    he = Z(q, 2),
    K = he[0],
  ...
  (P0({ onClose: Qr, isDisabled: K === "hide" || K === "fade-out" }),
    y.useEffect(
      function () {
        if (K === "hide") return we;
  ...
  var qe = y.useCallback(
    ...
    Vi = K !== "hide" && !!o,
    nc = !Q && Vi,
    ac = K !== "hide" && K !== "fade-out",
    fh = y.useCallback(function () {
      var L;
      (L = A.current) === null || L === void 0 || L.requestHide({ isImmediate: !0 });
    }, []);
  I0({ isOpen: Vi && ac, onClose: fh });
  var ic = function () {
      var ie;
  ...
  return S.createElement(
    ...
    typeof t == "function"
      ...
      : S.createElement(dh, H({}, Gi, { ref: ge, role: "presentation" }), t, sc),
    Vi
      ? S.createElement(
          j1,
          { zIndex: L1 },
          S.createElement(b1, { placement: z, referenceElement: ic(), strategy: T }, function (L) {
            var ie = L.ref,
              Dt = L.style,
              Hi = L.update,
              Wi = L.placement,
              kr = n === "mouse" ? void 0 : $1[N1(Wi)];
            return S.createElement(
              Uv,
              { appear: !0 },
              ac &&
                  ...
                  function (tn) {
                    ...
                    return S.createElement(
                      l,
                      {
                        ...
                        truncate: c,
                        placement: z,
                        testId: ic() ? v : v && "".concat(v, "--unresolved"),
                        onMouseOut: Ue,
                        onMouseOver: Aa,
                      },
...
var F1 = [
  ...
  up = function (t) {
    ...
    var i = t.innerRef,
      ...
      A = S.createElement(
        Oi,
        { xcss: kd.headCellContainer, onMouseEnter: V, onMouseLeave: J, onFocus: Q, onBlur: z },
        S.createElement(
          cp,
          { content: s === vr ? f : h },
          S.createElement(
            ...
            S.createElement(
              ...
              S.createElement("span", { className: R([kd.text]) }, r),
            ),
            U &&
              S.createElement(
                si,
...
var q1 = (function (e) {
  ...
  U1 = Bv(q1),
  V1 = ["content", "inlineStyles", "testId", "isRanking", "innerRef", "isSortable", "onClick"],
  dp = function (t) {
    var r = t.content,
      n = t.inlineStyles,
      a = t.testId;
  ...
  G1 = ["isRanking", "refHeight", "refWidth"];
function H1(e, t, r) {
  return (
    (t = W(t)),
...
var W1 = (function (e) {
    function t() {
      return (le(this, t), H1(this, t, arguments));
    }
    return (
      De(t, e),
      de(t, [
        {
          ...
          value: function () {
            ...
            var i = n.refWidth,
              o = ae(n, G1),
              s = Ff(a, i);
            return S.createElement(dp, H({ inlineStyles: s }, o));
          },
        },
      ])
    );
...
var Z1 = (function (e) {
    function t(r) {
      var n;
      return (le(this, t), (n = X1(this, t, [r])), (n.state = { activeSortButtonId: null }), n);
    }
    return (
      De(t, e),
      de(t, [
  ...
  Q1 = ["isRankable", "isRanking", "onRankStart", "onRankEnd", "isRankingDisabled"];
function eO(e) {
  switch (e) {
    case ai:
      return vr;
...
var tO = function (t) {
    ...
    var _e = function (Ee) {
      ...
      Wt = function () {
        return J || (Nf(i || [], j, _).length > 2 ? ii : Cb);
      },
      nt = function () {
        return h ? S.createElement(Nb, { testId: l }) : I && S.createElement(Fb, { testId: l }, I);
      },
      pt = i && i.length,
      Se,
      ht = !1;
    (d && Number.isInteger(d) && _ && pt && pt <= d
      ? ((Se = Math.ceil(d / _)), (ht = !0))
      : (Se = pt && _ ? Math.ceil(pt / _) : 0),
      (Se = Se < 1 ? 1 : Se));
    var gt = j > Se ? Se : j,
      at = !!pt,
      Qr = Wt(),
    ...
    return S.createElement(
      ...
      !at &&
        qe &&
        S.createElement(cv, { isLoading: h, spinnerSize: ii, testId: l, loadingLabel: c }, qe),
    );
  },
  rO = y.lazy(function () {
    return dg(
      () => import("./body-EGDLqu6y.js"),
      __vite__mapDeps([0, 1, 2, 3, 4]),
      import.meta.url,
    );
  }),
  nO = y.forwardRef(function (t, r) {
    var n = t.isRankable,
      a = n === void 0 ? !1 : n,
      i = t.isRanking,
      o = t.onRankStart,
    ...
    var p = S.createElement(ey, H({ ref: r }, u));
    return l && v
      ? S.createElement(
          ry,
          { fallback: p },
...
var bp = {};
Object.freeze(bp);
var sO = typeof Proxy < "u",
  cO = Object.toString();
function yp() {
  sO || Y("Proxy not available");
}
function _p(e) {
  var t = !1;
  return function () {
...
function Sa(e, t, r) {
  (Ut(e, wt) || ji(e, wt, gr({}, e[wt])), OO(r) || (e[wt][t] = r));
}
function gO(e) {
...
function Ep(e, t, r) {
  ...
  var n = new rr(e);
  return (t !== $r && Ck(n, t), r !== $r && Hp(n, r), n);
}
function bO(e, t) {
  return ah(e, t);
}
...
var di = { structural: bO, default: yO };
function br(e, t, r) {
  return Jp(e)
    ? e
    : Array.isArray(e)
...
function xp(e, t, r, n, a) {
  var i, o, s, c, u, l, d;
  (a === void 0 && (a = P.safeDescriptors), xO(e, t, r, n));
  var f = n.value;
...
function Pp(e, t, r, n, a, i) {
  (i === void 0 && (i = P.safeDescriptors), AO(e, t, r, n));
  var o = n.value;
  if ((_a(o) || (o = Wr(o)), a)) {
    var s;
...
var FO = "true",
  BO = Rp();
function Rp(e) {
  return { annotationType_: FO, options_: e, make_: zO, extend_: qO, decorate_20223_: UO };
}
function zO(e, t, r, n) {
  var a, i;
...
var VO = "observable",
  GO = "observable.ref",
  HO = "observable.shallow",
  WO = "observable.struct",
...
var gs = Ti(VO),
  KO = Ti(GO, { enhancer: Di }),
  YO = Ti(HO, { enhancer: _O }),
  JO = Ti(WO, { enhancer: mO }),
  jp = Et(gs);
function Ua(e) {
  return e.deep === !0 ? br : e.deep === !1 ? Di : ZO(e.defaultDecorator);
}
function XO(e) {
  var t;
...
var QO = {
    ...
    array: function (t, r) {
      var n = qa(r);
      return (P.useProxies === !1 || n.proxy === !1 ? Xk : zk)(t, Ua(n), n.name);
    },
    map: function (t, r) {
      var n = qa(r);
    ...
    object: function (t, r, n) {
      return Or(function () {
        return jk(P.useProxies === !1 || n?.proxy === !1 ? Xr({}, n) : Nk({}, n), t, r);
      });
    },
    ref: Et(KO),
    shallow: Et(YO),
...
var Ed,
  ...
  rk = 1,
  nk =
    (Ed = (xd = li(function () {}, "name")) == null ? void 0 : xd.configurable) != null ? Ed : !1,
...
var fr = (function (e) {
    ...
    return (
      ...
      (r.prepareNewValue_ = function (a) {
        if (Ke(this)) {
          var i = Ye(this, { object: this, type: xt, newValue: a });
...
function Tp(e, t, r) {
  ...
  return (P.inBatch--, (P.trackingDerivation = a), ck(e), ia(n), i);
}
function ck(e) {
  for (
    var t = e.observing_,
  ...
  for (; a--; ) {
    var u = r[a];
    u.diffValue === 1 && ((u.diffValue = 0), lk(u, e));
  }
...
function uk() {
  if (((P.pendingReactions.length || P.inBatch || P.isRunningReactions) && Y(36), ($p = !0), Za)) {
    var e = Pi();
...
function Bp(e) {
  ...
  return t !== null
    ? (t.runId_ !== e.lastAccessedBy_ &&
      ...
      e.isBeingObserved)
    : (e.observers_.size === 0 && P.inBatch > 0 && Fp(e), !1);
}
function zp(e) {
...
var Pt = (function () {
  ...
  return (
    ...
    (t.schedule_ = function () {
      this.isScheduled || ((this.isScheduled = !0), P.pendingReactions.push(this), qp());
    }),
    (t.runReaction_ = function () {
      if (!this.isDisposed) {
        (Je(), (this.isScheduled = !1));
        var n = P.trackingContext;
        if (((P.trackingContext = this), ys(this))) {
...
var Up = "action",
  ...
  ws = xa(Up),
  mk = xa(bk, { bound: !0 }),
  Os = xa(Vp, { autoAction: !0 }),
  wk = xa(yk, { autoAction: !0, bound: !0 });
function Gp(e) {
  var t = function (n, a) {
    if (ut(n)) return yr(n.name || _k, n, e);
    if (ut(a)) return yr(n, a, e);
    if (Ea(a)) return (e ? Os : ws).decorate_20223_(n, a);
    if (hr(a)) return Sa(n, a, e ? Os : ws);
    if (hr(n)) return Et(xa(e ? Vp : Up, { name: n, autoAction: e }));
  };
  return t;
}
var Oe = Gp(!1);
...
var Pk = "never",
  ...
  Rk = "observed";
function Ak(e) {
  e.isolateGlobalState === !0 && uk();
  var t = e.useProxies,
    r = e.enforceActions;
  if (
    (t !== void 0 && (P.useProxies = t === Va ? !0 : t === Pk ? !1 : typeof Proxy < "u"),
  ...
  ([
    ...
    e.reactionScheduler && hk(e.reactionScheduler));
}
function jk(e, t, r, n) {
  var a = dO(t);
  return (
...
function Kp(e) {
  var t = { name: e.name_ };
  return (
    e.observing_ && e.observing_.length > 0 && (t.dependencies = Dk(e.observing_).map(Kp)),
    t
  );
}
function Dk(e) {
...
var No = Cp("flow"),
  Mk = Cp("flow.bound", { bound: !0 }),
  Wr = Object.assign(function (t, r) {
    if (Ea(r)) return No.decorate_20223_(t, r);
    if (hr(r)) return Sa(t, r, No);
    var n = t,
      ...
      i = function () {
        var s = this,
          c = arguments,
          u = ++Tk,
          l = Oe(a + " - runid: " + u + " - init", n).apply(s, c),
          d,
          f = void 0,
          v = new Promise(function (h, p) {
            ...
            function b(w) {
              ...
              var m;
              try {
                m = Oe(a + " - runid: " + u + " - yield " + g++, l.next).call(l, w);
              } catch (k) {
                return p(k);
              }
              O(m);
            ...
            function _(w) {
              ...
              var m;
              try {
                m = Oe(a + " - runid: " + u + " - yield " + g++, l.throw).call(l, w);
              } catch (k) {
                return p(k);
              }
              O(m);
        ...
        return (
          (v.cancel = Oe(a + " - runid: " + u + " - cancel", function () {
            try {
              f && Pd(f);
              var h = l.return(void 0),
                p = Promise.resolve(h.value);
              (p.then($r, $r), Pd(p), d(new Yp()));
            } catch (g) {
              d(g);
            }
          })),
...
function Nk(e, t) {
  ...
  return (
    yp(),
    (e = Xr(e, t)),
    (n = (r = e[$]).proxy_) != null ? n : (r.proxy_ = new Proxy(e, $k))
  );
}
function Ke(e) {
    ...
    return (
      ...
      (t.spliceWithArray_ = function (n, a, i) {
        ...
        if (
          ...
          var c = Ye(this, { object: this.proxy_, type: Rd, index: n, removedCount: a, added: i });
          if (!c) return ps;
      ...
      (t.set_ = function (n, a) {
        ...
        if ((this.legacyMode_ && n > i.length && Y(17, n, i.length), n < i.length)) {
          ...
          var o = i[n];
          if (Ke(this)) {
            var s = Ye(this, { type: xt, object: this.proxy_, index: n, newValue: a });
            if (!s) return;
            a = s.newValue;
          }
...
var qk = _r("ObservableArrayAdministration", Qs);
function Bi(e) {
  return Ai(e) && qk(e[$]);
}
var Uk = {},
  ...
  Zp = (function () {
    ...
    return (
      ...
      (t.set = function (n, a) {
        var i = this.has_(n);
        if (Ke(this)) {
          var o = Ye(this, { type: i ? xt : Xt, object: this, newValue: a, name: n });
          if (!o) return this;
          a = o.newValue;
        }
      ...
      (t.replace = function (n) {
        ...
        return (
          zt(function () {
            for (
              var i = Vk(n), o = new Map(), s = !1, c = Nr(a.data_.keys()), u;
              !(u = c()).done;
...
function Ad(e) {
  return ((e[Symbol.toStringTag] = "MapIterator"), tc(e));
}
function Vk(e) {
...
var Gk = {},
  ...
  mt = _r("ObservableSet", Qp);
function jd(e) {
  return ((e[Symbol.toStringTag] = "SetIterator"), tc(e));
}
  ...
  eh = (function () {
    ...
    return (
      ...
      (t.setObservablePropValue_ = function (n, a) {
        ...
        if (Ke(this)) {
          var o = Ye(this, { type: xt, object: this.proxy_ || this.target_, name: n, newValue: a });
          if (!o) return null;
          a = o.newValue;
        }
        if (((a = i.prepareNewValue_(a)), a !== P.UNCHANGED)) {
      ...
      (t.delete_ = function (n, a) {
        ...
        if (Ke(this)) {
          var i = Ye(this, { object: this.proxy_ || this.target_, name: n, type: Dd });
          if (!i) return null;
        }
        try {
          var o;
...
function Xr(e, t) {
  ...
  var n = (r = t?.name) != null ? r : "ObservableObject",
    a = new eh(e, new Map(), String(n), XO(t));
  return (ji(e, $, a), e);
}
var Hk = _r("ObservableObjectAdministration", eh);
function Td(e) {
  return (
    Id[e] ||
    (Id[e] = {
...
var ec = (function (e) {
  function t(n, a, i, o) {
    ...
    return (
      ...
      (s = e.call(this) || this),
      Or(function () {
        var c = new Qs(i, a, o, !0);
        ((c.proxy_ = s),
          wp(s, $, c),
          n && n.length && s.spliceWithArray(0, 0, n),
          Kk && Object.defineProperty(s, "0", Wk));
      }),
      s
    );
  }
...
function Jk(e) {
  St(ec.prototype, "" + e, rh(e));
}
function nh(e) {
  if (e > Fo) {
    for (var t = Fo; t < e + 100; t++) Jk(t);
    Fo = e;
  }
}
nh(1e3);
...
function yi(e, t) {
  if (typeof e == "object" && e !== null) {
    ...
    if (wr(e)) {
      ...
      return (r || Y(25, t, ks(e)), r);
    }
    if (zi(e)) {
      if (!t) return Y(26);
      var n = e[$].values_.get(t);
      return (n || Y(27, t, ks(e)), n);
    }
...
function Zk(e, t) {
  if ((e || Y(29), Js(e) || Ni(e) || hi(e) || wr(e) || mt(e))) return e;
  if (e[$]) return e[$];
  Y(24, e);
}
function ks(e, t) {
...
var Nd,
  Qk = ((Nd = Pi().Iterator) == null ? void 0 : Nd.prototype) || {};
function tc(e) {
  return ((e[Symbol.iterator] = eS), Object.assign(Object.create(Qk), e));
}
function eS() {
  return this;
}
...
typeof __MOBX_DEVTOOLS_GLOBAL_HOOK__ == "object" &&
  __MOBX_DEVTOOLS_GLOBAL_HOOK__.injectMobx({ spy: gk, extras: { getDebugName: ks }, $mobx: $ });
...
var aS = 1e4,
  ...
  sS = typeof FinalizationRegistry < "u" ? FinalizationRegistry : oS,
  ma = new sS(function (e) {
    var t;
...
var Bd;
function uS() {
  return (Bd || ((Bd = 1), (Bo.exports = cS())), Bo.exports);
}
var lS = uS();
function zd(e) {
...
function dS(e, t) {
    ...
    var n = {
      ...
      subscribe: function (s) {
        return (
          ma.unregister(n),
          (n.onStoreChange = s),
          n.reaction || (zd(n), (n.stateVersion = Symbol())),
          function () {
            var c;
  ...
  var a = r.current;
  (a.reaction || (zd(a), ma.register(r, a, a)),
    S.useDebugValue(a.reaction, nS),
...
function vS(e, t) {
  ...
  if (qd && e.$$typeof === qd && ((n = !0), (a = e.render), typeof a != "function"))
  ...
  return (
    ...
    fS && Object.defineProperty(o, "name", { value: e.name, writable: !0, configurable: !0 }),
...
var pS = { $$typeof: !0, render: !0, compare: !0, type: !0, displayName: !0 };
function hS(e, t) {
  Object.keys(e).forEach(function (r) {
    pS[r] || Object.defineProperty(t, r, Object.getOwnPropertyDescriptor(e, r));
  });
}
var Vo;
rS(_i.unstable_batchedUpdates);
Vo = ma.finalizeAllImmediately;
function gS(e, t) {
  if (Vd(e, t)) return !0;
  ...
  for (var a = 0; a < r.length; a++)
    if (!Object.hasOwnProperty.call(t, r[a]) || !Vd(e[r[a]], t[r[a]])) return !1;
  return !0;
}
function Vd(e, t) {
  return e === t ? e !== 0 || 1 / e === 1 / t : e !== e && t !== t;
}
var Gd = Symbol("patchMixins"),
...
function Wd(e, t) {
  var r = function () {
    for (var a = arguments.length, i = new Array(a), o = 0; o < a; o++) i[o] = arguments[o];
    Hd.call.apply(Hd, [this, e, t].concat(i));
  };
  return r;
}
function yS(e, t, r) {
...
var Kd = Symbol("ObserverAdministration"),
  Yd = Symbol("isMobXReactObserver");
function Es(e) {
  var t;
  return (t = e[Kd]) != null
    ? t
...
function _S(e) {
  ...
  if (e.__proto__ !== y.PureComponent) {
    if (!t.shouldComponentUpdate) t.shouldComponentUpdate = Jd;
    else if (t.shouldComponentUpdate !== Jd)
      throw new Error(
  ...
  return (
    ...
    yS(t, "componentWillUnmount", function () {
      var o,
        s = Es(this);
...
function mS(e) {
  var t = e.bind(this),
    r = Es(this);
  function n() {
    r.reaction || ((r.reaction = wS(r)), r.mounted || ma.register(this, r, this));
    var a = void 0,
      i = void 0;
    if (
...
function Jd(e, t) {
  return this.state !== t ? !0 : !gS(this.props, e);
}
function qi(e, t) {
  return (
    e.isMobxInjector === !0 &&
...
function ch(e) {
  var t = e.children,
    ...
    a = S.useRef(Cs({}, n, r)),
    i = a.current;
  return S.createElement(Xd.Provider, { value: i }, t);
}
...
Ht([Oe.bound], It.prototype, "saveUsers", 1);
Ht([Oe.bound], It.prototype, "saveSort", 1);
Ht([Oe.bound], It.prototype, "saveDuplicates", 1);
Ht([Oe], It.prototype, "loading", 1);
Ht([Oe], It.prototype, "stopLoading", 1);
const xS = new It();
...
Ra([Oe.bound], Zr.prototype, "saveMetadata", 1);
Ra([Oe], Zr.prototype, "loading", 1);
Ra([Oe], Zr.prototype, "stopLoading", 1);
const RS = new Zr();
...
uh([se], rc.prototype, "state", 2);
uh([Oe.bound], rc.prototype, "saveState", 1);
const IS = new rc();
class DS {
  constructor() {
    ((this.usersStore = xS), (this.usersMetadata = RS), (this.stateStore = IS));
  }
}
const lh = new DS(),
  TS = y.createContext(lh),
  Ui = () => y.useContext(TS),
  MS = qi(() => {
        ...
        children: [
          Object.keys(e.metadata.user.properties).map((s) => {
            ...
            return M.jsxs(
              ...
              {
                children: [
                  M.jsx("label", { htmlFor: s, children: s }),
                  M.jsx("br", {}),
                  M.jsx("input", {
...
function NS() {
  ...
  if (
    ...
    return "loading....";
  if (!t.metadata) return M.jsx("div", { children: "Loading Error" });
  switch (r.state) {
    case "ROOT":
      return M.jsx("div", {
        children: M.jsxs("div", {
          children: [
            M.jsx("button", { onClick: () => r.saveState("ADD_USER"), children: "Add a new User" }),
            M.jsx("br", {}),
            M.jsx("br", {}),
            M.jsx(MS, {}),
          ],
    ...
    case "DUPLICATE":
      return M.jsx("div", {
        children: M.jsxs("div", {
          children: [
            M.jsx("button", { onClick: () => r.saveState("ROOT"), children: "back" }),
            M.jsx("br", {}),
            M.jsx("br", {}),
            M.jsx($S, {}),
          ],
    ...
    default:
      return M.jsxs("div", { children: ["ERROR: unsupprted state $", r.state] });
  }
}
const FS = qi(NS),
  BS = document.getElementById("root"),
  zS = ph.createRoot(BS),
  Zd = () => {
    zS.render(M.jsx(ch, { ...lh, children: M.jsx(FS, {}) }));
  };
qt.view.theme
  .enable()
  .then(() => {
