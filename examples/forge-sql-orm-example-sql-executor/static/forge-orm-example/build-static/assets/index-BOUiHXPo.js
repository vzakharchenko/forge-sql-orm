import { r as Or, c as ct } from "./react-dom-vendor-DUDfcWRj.js";
import { g as lt, r as dt } from "./lodash-vendor-CHXXAK2W.js";
(function () {
...
function ft() {
  ...
  return ((q.Fragment = o), (q.jsx = a), (q.jsxs = a), q);
}
var Ce;
function ht() {
  return (Ce || ((Ce = 1), (se.exports = ft())), se.exports);
}
var v = ht(),
  I = Or(),
  ue = {},
...
function jr(e, r, o, n) {
  ...
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
    ...
    for (var u = e.length - 1; u >= 0; u--)
      (a = e[u]) && (i = (t < 3 ? a(i) : t > 3 ? a(r, o, i) : a(r, o)) || i);
...
function Tr(e, r, o, n, t, i) {
  ...
  for (
    var u = n.kind,
      ...
      s = !r && e ? (n.static ? e : e.prototype) : null,
      l = r || (s ? Object.getOwnPropertyDescriptor(s, n.name) : {}),
      d,
      h = !1,
      f = o.length - 1;
    f >= 0;
    ...
    if (u === "accessor") {
      ...
      ((d = a(_.get)) && (l.get = d),
        (d = a(_.set)) && (l.set = d),
        (d = a(_.init)) && t.unshift(d));
    } else (d = a(_)) && (u === "field" ? t.unshift(d) : (l[c] = d));
  }
  (s && Object.defineProperty(s, n.name, l), (h = !0));
}
function Cr(e, r, o) {
    ...
    for (; a && ((a = 0), s[0] && (o = 0)), o; )
      try {
        if (
          ...
          t &&
            (i =
              s[0] & 2 ? t.return : s[0] ? t.throw || ((i = t.return) && i.call(t), 0) : t.next) &&
            !(i = i.call(t, s[1])).done)
        )
          return i;
...
function Mr(e, r) {
  for (var o in e) o !== "default" && !Object.prototype.hasOwnProperty.call(r, o) && ae(r, e, o);
}
function ie(e) {
...
function kr() {
  for (var e = [], r = 0; r < arguments.length; r++) e = e.concat(Ie(arguments[r]));
  return e;
}
function Ar() {
  for (var e = 0, r = 0, o = arguments.length; r < o; r++) e += arguments[r].length;
  for (var n = Array(e), t = 0, r = 0; r < o; r++)
    for (var i = arguments[r], a = 0, u = i.length; a < u; a++, t++) n[t] = i[a];
  return n;
}
function Lr(e, r, o) {
...
function Nr(e) {
  ...
  function n(t, i) {
    r[t] = e[t]
      ? function (a) {
          return (o = !o) ? { value: B(e[t](a)), done: !1 } : i ? i(a) : a;
        }
      : i;
  }
}
...
function Ur(e) {
  ...
  var r = {};
  if (e != null) for (var o = je(e), n = 0; n < o.length; n++) o[n] !== "default" && ae(r, e, o[n]);
  return (vt(r, e), r);
}
function Vr(e) {
...
function zr(e) {
  function r(i) {
    ((e.error = e.hasError ? new yt(i, e.error, "An error was suppressed during disposal.") : i),
      (e.hasError = !0));
  }
  var o,
    n = 0;
      ...
      try {
        ...
        if (o.dispose) {
          ...
          if (o.async)
            return (
              (n |= 2),
              Promise.resolve(i).then(t, function (a) {
                return (r(a), t());
              })
            );
        } else n |= 1;
...
function Qr(e, r) {
  return typeof e == "string" && /^\.\.?\//.test(e)
    ? e.replace(/\.(tsx)$|((?:\.d)?)((?:\.[^./]+?)?)\.([cm]?)ts$/i, function (o, n, t, i, a) {
        return n
          ? r
            ? ".jsx"
            : ".js"
...
const pt = {
    ...
    __disposeResources: zr,
    __rewriteRelativeImportExtension: Qr,
  },
  bt = Object.freeze(
...
function E() {
  if (Se) return M;
  ((Se = 1), Object.defineProperty(M, "__esModule", { value: !0 }), (M.BridgeAPIError = void 0));
...
function g() {
  if (qe) return F;
  ((qe = 1), Object.defineProperty(F, "__esModule", { value: !0 }), (F.getCallBridge = void 0));
  const e = E();
  function r(n) {
    return !!n?.callBridge;
  }
      ...
      (function (e) {
        ...
        const r = g(),
          ...
          a = (c, s) => {
            ...
            return (i(s), t("invoke", { functionKey: c, payload: s }));
          };
...
function mt() {
  return (
    Me ||
      ((Me = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), j.__exportStar(gt(), e));
      })(ce)),
    ce
  );
}
...
function wt() {
  if (Ae) return A;
  ((Ae = 1), Object.defineProperty(A, "__esModule", { value: !0 }), (A.invokeRemote = void 0));
  const e = Yr(),
...
function Et() {
  if (Le) return L;
  ((Le = 1), Object.defineProperty(L, "__esModule", { value: !0 }), (L.invokeService = void 0));
  const e = Yr(),
  ...
  return (
    De ||
      ...
      (function (e) {
        Object.defineProperty(e, "__esModule", { value: !0 });
        const r = j;
        (r.__exportStar(wt(), e), r.__exportStar(Et(), e));
      })(de)),
    de
  );
}
...
function Pt() {
  if (Ne) return N;
  ((Ne = 1), Object.defineProperty(N, "__esModule", { value: !0 }), (N.submit = void 0));
  const e = g(),
    r = E(),
    o = (0, e.getCallBridge)(),
    n = async (t) => {
...
function Rt() {
  if ($e) return $;
  (($e = 1), Object.defineProperty($, "__esModule", { value: !0 }), ($.close = void 0));
  const e = g(),
    r = E(),
    o = (0, e.getCallBridge)(),
    n = async (t) => {
...
function It() {
  if (Ue) return U;
  ((Ue = 1), Object.defineProperty(U, "__esModule", { value: !0 }), (U.refresh = void 0));
  const e = g(),
    r = E(),
    o = (0, e.getCallBridge)(),
    n = async (t) => {
...
function Tt() {
  if (Ve) return V;
  ((Ve = 1), Object.defineProperty(V, "__esModule", { value: !0 }), (V.createHistory = void 0));
  ...
  class o {
    ...
    async getTranslations(t, i = { fallback: !0 }) {
      ...
      if (!u) {
        let c;
        return (
          a.locales.includes(t) && (c = await this.getTranslationResource(t)),
          { translations: c ?? null, locale: t }
        );
      }
      for (const c of this.getLocaleLookupOrder(t, a)) {
    ...
    async getTranslationsByLocaleLookupOrder(t) {
      const i = await this.getI18nInfoConfig(),
        a = this.getLocaleLookupOrder(t, i);
    ...
    async getTranslationResource(t) {
      ...
      if (!i)
        try {
          ...
          throw a instanceof r ? a : new r(`Failed to get translation resource for locale: ${t}`);
        }
      return i;
    }
...
function St() {
  if (ze) return J;
  ((ze = 1), Object.defineProperty(J, "__esModule", { value: !0 }), (J.ensureLocale = void 0));
  const e = Zr(),
  ...
  const e = g(),
    ...
    n = async () => {
      ...
      const i = await o("getContext"),
        a = i?.locale;
      return (a && (i.locale = (t = (0, r.ensureLocale)(a)) !== null && t !== void 0 ? t : a), i);
    };
...
function Mt() {
  if (er) return K;
  ((er = 1), Object.defineProperty(K, "__esModule", { value: !0 }), (K.changeWindowTitle = void 0));
  const e = g(),
    r = E(),
    o = (0, e.getCallBridge)(),
    n = async (t) => {
  ...
  return ((K.changeWindowTitle = n), K);
}
var z = {},
  rr;
function kt() {
  if (rr) return z;
  ((rr = 1), Object.defineProperty(z, "__esModule", { value: !0 }), (z.theme = void 0));
  const r = (0, g().getCallBridge)();
    ...
    nr ||
      ...
      (function (e) {
        ...
        const r = tt(),
          ...
          n = async (s) => ({ data: await (0, r.blobToBase64)(s), type: s.type }),
          t = (s) => (0, r.base64ToBlob)(s.data, s.type),
          i = async (s) => {
        ...
        const a = (s) => {
          ...
          if (s && o(s)) {
            const l = {};
            for (const [d, h] of Object.entries(s)) l[d] = (0, e.deserialiseBlobsInPayload)(h);
            return l;
          }
          return s;
        };
...
function nt() {
  if (or) return X;
  ((or = 1), Object.defineProperty(X, "__esModule", { value: !0 }), (X.events = void 0));
  const e = g(),
    r = At(),
    o = (0, e.getCallBridge)(),
    n = async (i, a) => {
      let u = a;
      return (
        (0, r.containsBlobs)(a) && (u = await (0, r.serialiseBlobsInPayload)(a)),
    ...
    t = (i, a) =>
      o("on", {
        ...
        callback: (c) => {
          let s = c;
          return (
            (0, r.containsSerialisedBlobs)(c) && (s = (0, r.deserialiseBlobsInPayload)(c)),
            a(s)
          );
        },
      });
...
function Lt() {
  if (ir) return Q;
  ((ir = 1), Object.defineProperty(Q, "__esModule", { value: !0 }), (Q.emitReadyEvent = void 0));
  const e = nt(),
    r = ot(),
    o = "EXTENSION_READY",
    n = async () => {
...
function ot() {
  if (ar) return D;
  ((ar = 1), Object.defineProperty(D, "__esModule", { value: !0 }), (D.view = void 0));
  const e = Pt(),
    r = Rt(),
    o = jt(),
    n = It(),
...
function it() {
  return (
    sr ||
      ((sr = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), j.__exportStar(ot(), e));
      })(he)),
    he
  );
}
...
function Dt() {
  if (ur) return Y;
  ((ur = 1), Object.defineProperty(Y, "__esModule", { value: !0 }), (Y.router = void 0));
  const r = (0, g().getCallBridge)(),
    o = async (a) => {
      if (!a?.target) throw new Error("target is required for getUrl");
      const u = await r("getUrl", a);
    ...
    n = (a) => {
      if (typeof a == "string") return r("navigate", { url: a, type: "same-tab" });
      if (!a?.target) throw new Error("target is required for navigation");
      return r("navigate", { ...a, type: "same-tab" });
    },
    t = (a) => {
      if (typeof a == "string") return r("navigate", { url: a, type: "new-tab" });
      if (!a?.target) throw new Error("target is required for navigation");
      return r("navigate", { ...a, type: "new-tab" });
    },
    i = async () => r("reload");
...
function Nt() {
  return (
    cr ||
      ((cr = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), j.__exportStar(Dt(), e));
      })(ge)),
    ge
  );
}
...
function $t() {
  if (lr) return Z;
  ((lr = 1), Object.defineProperty(Z, "__esModule", { value: !0 }), (Z.Modal = void 0));
  const e = g(),
    r = E(),
    o = (0, e.getCallBridge)(),
    n = () => {};
...
function Gt() {
  return (
    dr ||
      ((dr = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), j.__exportStar($t(), e));
      })(me)),
    me
  );
}
...
function Ut() {
  if (fr) return ee;
  ((fr = 1), Object.defineProperty(ee, "__esModule", { value: !0 }), (ee.productFetchApi = void 0));
  const e = tt(),
    r = async (t) => {
      const i = {};
    ...
    o = async (t) => {
      const i = t?.body instanceof FormData,
        a = i ? await r(t?.body) : t?.body,
        u = new Request("", { body: a, method: t?.method, headers: t?.headers }),
    ...
    n = (t) => {
      const i = async (a, u, c) => {
        const { body: s, headers: l, isMultipartFormData: d } = await o(c);
...
function Vt() {
  ...
  const r = g();
  return (
    (e = (0, Ut().productFetchApi)((0, r.getCallBridge)())),
...
function Ht() {
  if (vr) return re;
  ((vr = 1), Object.defineProperty(re, "__esModule", { value: !0 }), (re.showFlag = void 0));
  const e = g(),
    r = E(),
    o = (0, e.getCallBridge)(),
    n = (t) => {
      ...
      const a = o("showFlag", { ...t, type: (i = t.type) !== null && i !== void 0 ? i : "info" });
      return { close: async () => (await a, o("closeFlag", { id: t.id })) };
    };
...
function Jt() {
  return (
    pr ||
      ((pr = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), j.__exportStar(nt(), e));
      })(Ee)),
    Ee
  );
}
...
function Kt() {
  if (br) return te;
  ((br = 1), Object.defineProperty(te, "__esModule", { value: !0 }), (te.realtime = void 0));
  const r = (0, g().getCallBridge)(),
    o = (a, u, c) => r("publishRealtimeChannel", { channelName: a, eventPayload: u, options: c }),
    n = (a, u, c) => r("subscribeRealtimeChannel", { channelName: a, onEvent: u, options: c }),
    t = (a, u, c) =>
      r("publishRealtimeChannel", { channelName: a, eventPayload: u, options: c, isGlobal: !0 }),
    i = (a, u, c) =>
      r("subscribeRealtimeChannel", { channelName: a, onEvent: u, options: c, isGlobal: !0 });
...
function Xt() {
  ...
  R.resetTranslationsCache = t;
  const i = async (u = null, c = { fallback: !0 }) => {
    let s = u;
    return (s || (s = (await r.view.getContext()).locale), await n.getTranslations(s, c));
  };
  R.getTranslations = i;
  const a = async (u = null) => {
    let c = u;
    c || (c = (await r.view.getContext()).locale);
    const s = new e.Translator(c, n);
    return (
      await s.init(),
      (l, d) => {
        var h, f;
        return (f = (h = s.translate(l)) !== null && h !== void 0 ? h : d) !== null && f !== void 0
          ? f
          : l;
      }
    );
...
function Zt() {
  const [e, r] = I.useState(""),
    ...
    [h, f] = I.useState([]),
    p = (y, at, st) => {
      f((ut) => [{ id: Date.now(), query: y, result: at, timestamp: new Date(), type: st }, ...ut]);
    },
    b = async () => {
      try {
        (i(""), u(!0));
          ...
          v.jsxs("div", {
            ...
            children: [
              v.jsx("button", {
                ...
                style: {
                  padding: "10px 20px",
                  backgroundColor: a ? "#0052CC80" : "#0052CC",
                  color: "white",
                  border: "none",
                  borderRadius: "3px",
