import { r as mr, c as at } from "./react-dom-vendor-CewBCt5Y.js";
import { g as ut, r as ct } from "./lodash-vendor-SQX3M4kY.js";
(function () {
...
var Ie;
function dt() {
  return (Ie || ((Ie = 1), (ue.exports = lt())), ue.exports);
}
var p = dt(),
  T = mr(),
  ce = {},
...
function jr(e, r, o, n, t, i) {
  ...
  for (
    ...
    var g = (0, o[f])(u === "accessor" ? { get: l.get, set: l.set } : l[c], v);
    if (u === "accessor") {
    ...
    } else (d = s(g)) && (u === "field" ? t.unshift(d) : (l[c] = d));
  }
...
function $r(e) {
  ...
  var r = {};
  if (e != null) for (var o = Pe(e), n = 0; n < o.length; n++) o[n] !== "default" && ae(r, e, o[n]);
  return (ft(r, e), r);
}
function Gr(e) {
...
function E() {
  if (Be) return k;
  ((Be = 1), Object.defineProperty(k, "__esModule", { value: !0 }), (k.BridgeAPIError = void 0));
...
function zr() {
  if (Se) return A;
  ((Se = 1), Object.defineProperty(A, "__esModule", { value: !0 }), (A.withRateLimiter = void 0));
  const e = E(),
    r = (o, n, t, i) => {
      let s = Date.now(),
        u = 0;
...
function _t() {
  if (qe) return F;
  ((qe = 1), Object.defineProperty(F, "__esModule", { value: !0 }), (F.invoke = void 0));
  const e = b(),
    r = E(),
    o = zr(),
    n = (0, e.getCallBridge)(),
...
function bt() {
  if (ke) return L;
  ((ke = 1), Object.defineProperty(L, "__esModule", { value: !0 }), (L.invokeRemote = void 0));
  const e = Qr(),
...
function wt() {
  if (Ae) return D;
  ((Ae = 1), Object.defineProperty(D, "__esModule", { value: !0 }), (D.invokeService = void 0));
  const e = Qr(),
  ...
  return (
    Le ||
      ...
      (function (e) {
        Object.defineProperty(e, "__esModule", { value: !0 });
        const r = O;
        (r.__exportStar(bt(), e), r.__exportStar(wt(), e));
      })(de)),
    de
  );
}
...
function Et() {
  if (De) return $;
  ((De = 1), Object.defineProperty($, "__esModule", { value: !0 }), ($.submit = void 0));
  const e = b(),
    r = E(),
    o = (0, e.getCallBridge)(),
    n = async (t) => {
...
function Ot() {
  if (Ne) return G;
  ((Ne = 1), Object.defineProperty(G, "__esModule", { value: !0 }), (G.close = void 0));
  const e = b(),
    r = E(),
    o = (0, e.getCallBridge)(),
    n = async (t) => {
...
function Rt() {
  if ($e) return U;
  (($e = 1), Object.defineProperty(U, "__esModule", { value: !0 }), (U.open = void 0));
  const e = b(),
    r = E(),
    o = (0, e.getCallBridge)(),
    n = async () => {
...
function Pt() {
  if (Ge) return V;
  ((Ge = 1), Object.defineProperty(V, "__esModule", { value: !0 }), (V.refresh = void 0));
  const e = b(),
    r = E(),
    o = (0, e.getCallBridge)(),
    n = async (t) => {
...
function jt() {
  if (Ue) return H;
  ((Ue = 1), Object.defineProperty(H, "__esModule", { value: !0 }), (H.createHistory = void 0));
...
function It() {
  if (Ke) return K;
  ((Ke = 1), Object.defineProperty(K, "__esModule", { value: !0 }), (K.Translator = void 0));
  const e = Yr();
  class r {
    locale;
    translationsGetter;
  ...
  return ((K.Translator = r), K);
}
var J = {},
  Je;
function Ct() {
  if (Je) return J;
  ((Je = 1), Object.defineProperty(J, "__esModule", { value: !0 }), (J.ensureLocale = void 0));
  const e = Xr(),
...
function St() {
  if (Ye) return W;
  ((Ye = 1), Object.defineProperty(W, "__esModule", { value: !0 }), (W.getContext = void 0));
  const e = b(),
    r = Zr(),
    o = (0, e.getCallBridge)(),
    n = async () => {
...
function qt() {
  if (Ze) return z;
  ((Ze = 1), Object.defineProperty(z, "__esModule", { value: !0 }), (z.changeWindowTitle = void 0));
  const e = b(),
    r = E(),
    o = (0, e.getCallBridge)(),
    n = async (t) => {
  ...
  return ((z.changeWindowTitle = n), z);
}
var Q = {},
  er;
function Ft() {
  if (er) return Q;
  ((er = 1), Object.defineProperty(Q, "__esModule", { value: !0 }), (Q.theme = void 0));
  const r = (0, b().getCallBridge)();
  return ((Q.theme = { enable: () => r("enableTheming") }), Q);
}
var X = {},
  Y = {},
  ge = {},
...
function rt() {
  if (nr) return Y;
  ((nr = 1), Object.defineProperty(Y, "__esModule", { value: !0 }), (Y.events = void 0));
  const e = b(),
    r = Mt(),
    o = (0, e.getCallBridge)(),
    n = async (i, s) => {
  ...
  return ((Y.events = { emit: n, on: t }), Y);
}
var or;
function kt() {
  if (or) return X;
  ((or = 1), Object.defineProperty(X, "__esModule", { value: !0 }), (X.emitReadyEvent = void 0));
  const e = rt(),
    r = tt(),
    o = "EXTENSION_READY",
    n = async () => {
  ...
  return ((X.emitReadyEvent = n), X);
}
var ir;
function tt() {
  if (ir) return N;
  ((ir = 1), Object.defineProperty(N, "__esModule", { value: !0 }), (N.view = void 0));
  const e = Et(),
    r = Ot(),
    o = Rt(),
    n = Pt(),
...
function At() {
  if (ar) return Z;
  ((ar = 1), Object.defineProperty(Z, "__esModule", { value: !0 }), (Z.router = void 0));
  const r = (0, b().getCallBridge)(),
    o = async (s) => {
    ...
    i = async () => r("reload");
  return ((Z.router = { getUrl: o, navigate: n, open: t, reload: i }), Z);
}
var ur;
function Lt() {
  return (
...
function Dt() {
  if (cr) return ee;
  ((cr = 1), Object.defineProperty(ee, "__esModule", { value: !0 }), (ee.Modal = void 0));
  const e = b(),
    r = E(),
    o = (0, e.getCallBridge)(),
    n = () => {};
...
function $t() {
  if (dr) return re;
  ((dr = 1), Object.defineProperty(re, "__esModule", { value: !0 }), (re.productFetchApi = void 0));
  const e = et(),
    r = async (t) => {
      const i = {};
    ...
    n = (t) => {
      const i = async (s, u, c) => {
        ...
        const h = {
          ...
          m = w ? (0, e.base64ToBlob)(f, v["content-type"]) : f;
        return new Response(m || null, { headers: v, status: g, statusText: _ });
      };
      return {
...
function Ut() {
  if (hr) return te;
  ((hr = 1), Object.defineProperty(te, "__esModule", { value: !0 }), (te.showFlag = void 0));
  const e = b(),
    r = E(),
    o = (0, e.getCallBridge)(),
    n = (t) => {
...
function Wt() {
  if (vr) return ne;
  ((vr = 1), Object.defineProperty(ne, "__esModule", { value: !0 }), (ne.__realtime = void 0));
  const r = (0, b().getCallBridge)(),
...
function Qt() {
  const [e, r] = T.useState(""),
    ...
    _ = async () => {
      try {
        (i(""), u(!0));
        const y = await oe.invoke("execute", { query: e });
        (n(y), v(e, y, "SQL"));
      } catch (y) {
    ...
    g = async () => {
      try {
        (i(""), a(!0));
        const y = await oe.invoke("executeDDL", { query: e });
        (n(y), v(e, y, "DDL"));
      } catch (y) {
        (i(y instanceof Error ? y.message : "An error occurred"), n(""));
      } finally {
    ...
    w = async () => {
      try {
        (i(""), d(!0));
        const y = await oe.invoke("executeCommand", { command: e });
        (n(y), v(e, y, "COMMAND"));
      } catch (y) {
        (i(y instanceof Error ? y.message : "An error occurred"), n(""));
      } finally {
                    ...
                    children: [
                      p.jsxs("div", {
                        ...
                        children: [
                          ...
                          p.jsx("span", { children: m(y.timestamp) }),
                        ],
                      }),
                      p.jsxs("div", {
                        style: { padding: "15px" },
