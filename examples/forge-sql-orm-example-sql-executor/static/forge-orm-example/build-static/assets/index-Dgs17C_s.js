import { r as br, c as it } from "./react-dom-vendor-CewBCt5Y.js";
import { g as st, r as at } from "./lodash-vendor-SQX3M4kY.js";
(function () {
...
function ut() {
  ...
  function s(u, l, a) {
    ...
    if (u && u.defaultProps) for (c in ((l = u.defaultProps), l)) d[c] === void 0 && (d[c] = l[c]);
    return { $$typeof: r, type: u, key: h, ref: f, props: d, _owner: t.current };
  }
  return ((S.Fragment = o), (S.jsx = s), (S.jsxs = s), S);
}
var Te;
function ct() {
  return (Te || ((Te = 1), (ae.exports = ut())), ae.exports);
}
var y = ct(),
  T = br(),
  ue = {},
...
function Rr(e, r, o, n, t, i) {
  ...
  for (
    var u = n.kind,
      ...
      c = r || (a ? Object.getOwnPropertyDescriptor(a, n.name) : {}),
      d,
      h = !1,
      f = o.length - 1;
    f >= 0;
    ...
    var g = (0, o[f])(u === "accessor" ? { get: c.get, set: c.set } : c[l], p);
    if (u === "accessor") {
      if (g === void 0) continue;
      if (g === null || typeof g != "object") throw new TypeError("Object expected");
      ((d = s(g.get)) && (c.get = d),
        (d = s(g.set)) && (c.set = d),
        (d = s(g.init)) && t.unshift(d));
    } else (d = s(g)) && (u === "field" ? t.unshift(d) : (c[l] = d));
  }
...
function Cr(e, r, o, n) {
  ...
  return new (o || (o = Promise))(function (i, s) {
    ...
    function a(c) {
      c.done ? i(c.value) : t(c.value).then(u, l);
    }
...
function Sr() {
  for (var e = [], r = 0; r < arguments.length; r++) e = e.concat(Pe(arguments[r]));
  return e;
}
function qr() {
...
function Mr(e, r, o) {
  ...
  function a(f) {
    f.value instanceof x ? Promise.resolve(f.value.v).then(c, d) : h(i[0][2], f);
  }
  function c(f) {
    l("next", f);
  }
...
function kr(e) {
  ...
  function n(t, i) {
    r[t] = e[t]
      ? function (s) {
          return (o = !o) ? { value: x(e[t](s)), done: !1 } : i ? i(s) : s;
        }
      : i;
  }
}
...
function Dr(e) {
  ...
  var r = {};
  if (e != null) for (var o = Re(e), n = 0; n < o.length; n++) o[n] !== "default" && se(r, e, o[n]);
  return (lt(r, e), r);
}
function Nr(e) {
...
function Hr(e) {
  function r(i) {
    ((e.error = e.hasError ? new dt(i, e.error, "An error was suppressed during disposal.") : i),
      (e.hasError = !0));
  }
  var o,
    n = 0;
...
const ft = {
    ...
    __classPrivateFieldSet: Gr,
    __classPrivateFieldIn: Ur,
    __addDisposableResource: Vr,
    __disposeResources: Hr,
...
function O() {
  if (Ce) return k;
  ((Ce = 1), Object.defineProperty(k, "__esModule", { value: !0 }), (k.BridgeAPIError = void 0));
...
function m() {
  if (xe) return M;
  ((xe = 1), Object.defineProperty(M, "__esModule", { value: !0 }), (M.getCallBridge = void 0));
  const e = O();
  function r(n) {
    return !!n?.callBridge;
  }
  ...
  return ((M.getCallBridge = o), M);
}
var A = {},
  Be;
function Kr() {
  if (Be) return A;
  ((Be = 1), Object.defineProperty(A, "__esModule", { value: !0 }), (A.withRateLimiter = void 0));
  const e = O(),
    r = (o, n, t, i) => {
      let s = Date.now(),
        u = 0;
...
function vt() {
  if (Se) return F;
  ((Se = 1), Object.defineProperty(F, "__esModule", { value: !0 }), (F.invoke = void 0));
  const e = m(),
    r = O(),
    o = Kr(),
    n = (0, e.getCallBridge)(),
    ...
    i = (s, u) => {
      ...
      return (t(u), n("invoke", { functionKey: s, payload: u }));
    };
  return (
        ...
        const u = (0, r.getCallBridge)(),
          ...
          a = (d) => async (h) => {
            ...
            const f = { ...h, invokeType: `ui-${d.toLowerCase()}-fetch` },
              p = await u("invoke", f),
              { success: _, payload: g, error: b } = p ?? {},
              w = { ...(_ ? g : b) };
            if (w && w.headers)
              for (const B in w.headers)
                Array.isArray(w.headers[B]) && (w.headers[B] = w.headers[B].join(","));
            return w;
          },
          c = (d) => {
            const h = a(d);
...
function _t() {
  if (Me) return L;
  ((Me = 1), Object.defineProperty(L, "__esModule", { value: !0 }), (L.invokeRemote = void 0));
  const e = Jr(),
...
function gt() {
  if (ke) return D;
  ((ke = 1), Object.defineProperty(D, "__esModule", { value: !0 }), (D.invokeService = void 0));
  const e = Jr(),
  ...
  return (
    Ae ||
      ...
      (function (e) {
        Object.defineProperty(e, "__esModule", { value: !0 });
        const r = E;
        (r.__exportStar(_t(), e), r.__exportStar(gt(), e));
      })(le)),
    le
  );
}
...
function mt() {
  if (Le) return $;
  ((Le = 1), Object.defineProperty($, "__esModule", { value: !0 }), ($.submit = void 0));
  const e = m(),
    r = O(),
    o = (0, e.getCallBridge)(),
    n = async (t) => {
...
function Et() {
  if (Ne) return U;
  ((Ne = 1), Object.defineProperty(U, "__esModule", { value: !0 }), (U.refresh = void 0));
  const e = m(),
    r = O(),
    o = (0, e.getCallBridge)(),
    n = async (t) => {
...
function Ot() {
  if ($e) return V;
  (($e = 1), Object.defineProperty(V, "__esModule", { value: !0 }), (V.createHistory = void 0));
  const r = (0, m().getCallBridge)(),
    o = async () => {
...
function Rt() {
  ...
  class o {
    ...
    async getTranslations(t, i = { fallback: !0 }) {
      ...
      if (!u) {
        let l;
        return (
          s.locales.includes(t) && (l = await this.getTranslationResource(t)),
          { translations: l ?? null, locale: t }
        );
      }
      for (const l of this.getLocaleLookupOrder(t, s)) {
  ...
  return ((I.TranslationsGetter = o), I);
}
var W = {},
  ye = {},
  Ve;
...
function Pt() {
  if (He) return W;
  ((He = 1), Object.defineProperty(W, "__esModule", { value: !0 }), (W.Translator = void 0));
  const e = Qr();
  class r {
    locale;
    translationsGetter;
...
function jt() {
  if (We) return K;
  ((We = 1), Object.defineProperty(K, "__esModule", { value: !0 }), (K.ensureLocale = void 0));
  const e = zr(),
    ...
    Ke ||
      ...
      (function (e) {
        ...
        const r = (a) => typeof a == "object" && a !== null && !Array.isArray(a),
          ...
          s = (a) =>
            Object.entries(a).flatMap(([c, d]) =>
              !n(c) && !t(c) && d && Array.isArray(d) && d.length > 0 ? d.map((h) => [h, c]) : [],
            );
        ...
        const l = (a) => {
          ...
          for (const d of (0, e.getI18nSupportedModuleEntries)(a)) {
            const h = i(d[0]);
            for (const f of h) c.push({ moduleName: d[1], ...f });
          }
          return c;
        };
...
var pe = {},
  Je;
function It() {
  return (Je || ((Je = 1), Object.defineProperty(pe, "__esModule", { value: !0 })), pe);
}
var ze;
function Xr() {
  return (
...
function Ct() {
  if (Qe) return H;
  ((Qe = 1), Object.defineProperty(H, "__esModule", { value: !0 }), (H.getContext = void 0));
  const e = m(),
    r = Xr(),
    o = (0, e.getCallBridge)(),
    n = async () => {
...
function xt() {
  if (Xe) return J;
  ((Xe = 1), Object.defineProperty(J, "__esModule", { value: !0 }), (J.changeWindowTitle = void 0));
  const e = m(),
    r = O(),
    o = (0, e.getCallBridge)(),
    n = async (t) => {
...
function Bt() {
  if (Ye) return z;
  ((Ye = 1), Object.defineProperty(z, "__esModule", { value: !0 }), (z.theme = void 0));
  const r = (0, m().getCallBridge)();
      ...
      (function (e) {
        ...
        const r = Yr(),
          o = (a) => {
            ...
            if (c === null) return !0;
            const d = Object.prototype.hasOwnProperty.call(c, "constructor") && c.constructor;
            return (
              typeof d == "function" &&
              d instanceof d &&
        ...
        const s = (a) => {
          ...
          if (a && o(a)) {
            const c = {};
            for (const [d, h] of Object.entries(a)) c[d] = (0, e.deserialiseBlobsInPayload)(h);
            return c;
          }
          return a;
        };
...
function Zr() {
  if (rr) return X;
  ((rr = 1), Object.defineProperty(X, "__esModule", { value: !0 }), (X.events = void 0));
  const e = m(),
    r = St(),
    o = (0, e.getCallBridge)(),
    n = async (i, s) => {
    ...
    t = (i, s) =>
      o("on", {
        ...
        callback: (l) => {
          let a = l;
          return (
            (0, r.containsSerialisedBlobs)(l) && (a = (0, r.deserialiseBlobsInPayload)(l)),
            s(a)
          );
        },
      });
...
function qt() {
  if (tr) return Q;
  ((tr = 1), Object.defineProperty(Q, "__esModule", { value: !0 }), (Q.emitReadyEvent = void 0));
  const e = Zr(),
    r = et(),
    o = "EXTENSION_READY",
    n = async () => {
...
function et() {
  if (nr) return N;
  ((nr = 1), Object.defineProperty(N, "__esModule", { value: !0 }), (N.view = void 0));
  const e = mt(),
    r = wt(),
    o = Et(),
    n = Ot(),
...
function rt() {
  return (
    or ||
      ((or = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), E.__exportStar(et(), e));
      })(fe)),
    fe
  );
}
...
function Ft() {
  if (ir) return Y;
  ((ir = 1), Object.defineProperty(Y, "__esModule", { value: !0 }), (Y.router = void 0));
  const r = (0, m().getCallBridge)(),
    o = async (s) => {
...
function Mt() {
  return (
    sr ||
      ((sr = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), E.__exportStar(Ft(), e));
      })(ge)),
    ge
  );
}
...
function kt() {
  if (ar) return Z;
  ((ar = 1), Object.defineProperty(Z, "__esModule", { value: !0 }), (Z.Modal = void 0));
  const e = m(),
    r = O(),
    o = (0, e.getCallBridge)(),
    n = () => {};
...
function At() {
  return (
    ur ||
      ((ur = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), E.__exportStar(kt(), e));
      })(be)),
    be
  );
}
...
function Lt() {
  if (cr) return ee;
  ((cr = 1), Object.defineProperty(ee, "__esModule", { value: !0 }), (ee.productFetchApi = void 0));
  const e = Yr(),
    r = async (t) => {
      const i = {};
      for (const [s, u] of t.entries())
        if (s === "file") {
          const l = u.name,
            a = u.type;
          ((i.file = await (0, e.blobToBase64)(u)), (i.__fileName = l), (i.__fileType = a));
        } else i[s] = u;
    ...
    n = (t) => {
      const i = async (s, u, l) => {
        const { body: a, headers: c, isMultipartFormData: d } = await o(l);
        c.has("X-Atlassian-Token") || c.set("X-Atlassian-Token", "no-check");
        const h = {
            product: s,
            restPath: u,
            fetchRequestInit: { ...l, body: a, headers: [...c.entries()] },
          ...
          w = b ? (0, e.base64ToBlob)(f, p["content-type"]) : f;
        return new Response(w || null, { headers: p, status: g, statusText: _ });
      };
      return {
...
function Dt() {
  ...
  const r = m();
  return (
    (e = (0, Lt().productFetchApi)((0, r.getCallBridge)())),
...
function Nt() {
  if (dr) return re;
  ((dr = 1), Object.defineProperty(re, "__esModule", { value: !0 }), (re.showFlag = void 0));
  const e = m(),
    r = O(),
    o = (0, e.getCallBridge)(),
    n = (t) => {
...
function Ut() {
  if (yr) return te;
  ((yr = 1), Object.defineProperty(te, "__esModule", { value: !0 }), (te.__realtime = void 0));
  const r = (0, m().getCallBridge)(),
    o = (t, i) => r("publishRealtimeChannel", { channelName: t, eventPayload: i }),
    n = (t, i) => r("subscribeRealtimeChannel", { channelName: t, onEvent: i });
  return ((te.__realtime = { publish: o, subscribe: n }), te);
}
var vr;
function Vt() {
  return (
    vr ||
      ((vr = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), E.__exportStar(Ut(), e));
      })(Ee)),
    Ee
  );
}
...
function Ht() {
  ...
  const i = async (u = null, l = { fallback: !0 }) => {
    let a = u;
    return (a || (a = (await r.view.getContext()).locale), await n.getTranslations(a, l));
  };
  j.getTranslations = i;
  const s = async (u = null) => {
    ...
    return (
      ...
      (c, d) => {
        var h, f;
        return (f = (h = a.translate(c)) !== null && h !== void 0 ? h : d) !== null && f !== void 0
          ? f
          : c;
      }
    );
...
function Kt() {
  const [e, r] = T.useState(""),
    ...
    [h, f] = T.useState([]),
    p = (v, tt, nt) => {
      f((ot) => [{ id: Date.now(), query: v, result: tt, timestamp: new Date(), type: nt }, ...ot]);
    },
    _ = async () => {
      try {
        (i(""), u(!0));
        const v = await ne.invoke("execute", { query: e });
        (n(v), p(e, v, "SQL"));
      } catch (v) {
        (i(v instanceof Error ? v.message : "An error occurred"), n(""));
      } finally {
        u(!1);
      }
    },
    g = async () => {
      try {
        (i(""), a(!0));
        const v = await ne.invoke("executeDDL", { query: e });
        (n(v), p(e, v, "DDL"));
      } catch (v) {
        (i(v instanceof Error ? v.message : "An error occurred"), n(""));
      } finally {
    ...
    b = async () => {
      try {
        (i(""), d(!0));
        const v = await ne.invoke("executeCommand", { command: e });
        (n(v), p(e, v, "COMMAND"));
      } catch (v) {
        (i(v instanceof Error ? v.message : "An error occurred"), n(""));
      } finally {
  ...
  return y.jsxs("div", {
    ...
    children: [
      y.jsx("h1", { children: "SQL Query Executor" }),
      y.jsxs("div", {
      ...
      h.length > 0 &&
        y.jsxs("div", {
          ...
          children: [
            y.jsx("h2", { children: "Query History" }),
            y.jsx("div", {
                      ...
                      y.jsxs("div", {
                        ...
                        children: [
                          y.jsxs("span", {
                            ...
                            children: [v.type, " Query"],
                          }),
                          y.jsx("span", { children: w(v.timestamp) }),
                        ],
                      }),
                      y.jsxs("div", {
                        style: { padding: "15px" },
                        children: [
                          y.jsxs("div", {
                            ...
                            children: [
                              y.jsx("h4", { style: { margin: "0 0 5px 0" }, children: "Query:" }),
                              y.jsx("pre", {
                                style: {
                                  backgroundColor: "#F4F5F7",
                                  padding: "10px",
                          ...
                          y.jsxs("div", {
                            children: [
                              y.jsx("h4", { style: { margin: "0 0 5px 0" }, children: "Result:" }),
                              y.jsx("pre", {
                                style: {
                                  backgroundColor: "#F4F5F7",
                                  padding: "10px",
