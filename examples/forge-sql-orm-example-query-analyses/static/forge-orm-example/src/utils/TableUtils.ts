...
const getCells = (withWidth: boolean, deleteCell: boolean, type: "SLOW_QUERY" | "PLAN" |"HISTORY") => {
  const columns: {
    key: string;
    content: any;
    isSortable: boolean;
...
export const createHead = (withWidth: boolean, deleteCell: boolean, type: "SLOW_QUERY" | "PLAN"| "HISTORY") => {
  return {
