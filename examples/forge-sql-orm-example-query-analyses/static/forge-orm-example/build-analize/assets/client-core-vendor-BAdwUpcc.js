  ...
  var e =
    ...
    function (w, d, h, D) {
      ...
      return new (h || (h = Promise))(function (C, L) {
        ...
        function G(N) {
          N.done ? C(N.value) : k(N.value).then(U, B);
        }
        G((D = D.apply(w, d || [])).next());
      });
    };
              ...
              (c.Log.warn(`Caught error in ${o}`, { error: i }),
                m(this, void 0, void 0, function* () {
                  ...
                  const L = y.SDKType._get(this._sdkKey),
                    ...
                    B = D ? h.stack : f(h),
                    G = Object.assign(
                      { tag: o, exception: k, info: B, statsigOptions: u(this._options) },
  ...
  var e =
    ...
    function (O, p, I, T) {
      ...
      return new (I || (I = Promise))(function (M, P) {
        ...
        function F(A) {
          A.done ? M(A.value) : R(A.value).then($, q);
        }
  ...
  class h {
    ...
    _sendRequest(p) {
      return e(this, void 0, void 0, function* () {
        ...
        const { method: P, body: $, retries: q, attempt: F } = p,
        ...
        try {
          ...
          if (
            ...
            !q || j > q || !d.has((T = Z?.status) !== null && T !== void 0 ? T : 500))
          ) {
            ...
            const de = `A networking error occurred during ${P} request to ${K}.`;
            return (
              y.Log.error(de, ee, z),
        ...
        if (!(typeof T != "string" || !C(p, this._options)))
          try {
            ...
            const A = q.reduce((J, K) => J + K.length, 0),
              j = new Uint8Array(A);
            let V = 0;
            for (const J of q) (j.set(J, V), (V += J.length));
            ((p.body = j),
              (p.params = Object.assign(
                Object.assign({}, (I = p.params) !== null && I !== void 0 ? I : {}),
...
function ni() {
  ...
  Y._createLayerParameterExposure = f;
  const l = (u, r) => (
    (r.reason = u.reason),
    u.lcut && (r.lcut = String(u.lcut)),
    u.receivedAt && (r.receivedAt = String(u.receivedAt)),
        ...
        try {
          ...
          if (
            ((K = yield Promise.race([
              ...
              new Promise((de, _e) => {
                Fe = setTimeout(() => {
                  ((V = !0), _e(new Error(`Timeout of ${this._timeout}ms expired.`)));
                }, this._timeout);
              }),
            ])),
            !K.ok)
          ...
          if (
            ...
            (yield this._fallbackResolver.tryFetchUpdatedFallbackInfo(
              ...
              (p.fallbackUrl = this._fallbackResolver.getActiveFallbackUrl(p.sdkKey, p.urlConfig)),
            !q || j > q || !d.has((T = K?.status) !== null && T !== void 0 ? T : 500))
          ) {
            (R = this._emitter) === null ||
              R === void 0 ||
              R.call(this, {
            ...
            const te = `A networking error occurred during ${P} request to ${J}.`;
            return (
              y.Log.error(te, z, se),
