...
import { r as pt, a as ji, c as Th } from "./react-dom-vendor-CLnqZT57.js";
import { g as Us, r as er, a as rr, b as Rt, s as He } from "./client-core-vendor-hW6L3Q7d.js";
...
var vr = (function (e) {
    ...
    return (
      ...
      (r.setNewValue_ = function (a) {
        ...
        ((this.value_ = a),
          this.reportChanged(),
          ct(this) && lt(this, { type: Et, object: this, newValue: a, oldValue: i }));
      }),
      (r.get = function () {
...
var Pt = (function () {
  ...
  return (
    ...
    (t.dispose = function () {
      this.isDisposed || ((this.isDisposed = !0), this.isRunning || (Qe(), bs(this), Ze()));
    }),
    ...
    return (
      ...
      (t.spliceWithArray_ = function (n, a, i) {
        ...
        if (
          ...
          var s = Xe(this, { object: this.proxy_, type: Fc, index: n, removedCount: a, added: i });
          if (!s) return fs;
...
Qs([et.bound], Ki.prototype, "saveState", 1);
const Zs = new Ki();
class ay {
  constructor() {
...
function Zy(e, t, r) {
  return (
    (t = Y(t)),
    Be(e, vp() ? Reflect.construct(t, r || [], Y(e).constructor) : t.apply(e, r))
  );
}
function vp() {
  try {
...
function hm(e, t, r) {
  return (
    (t = Y(t)),
    Be(e, gp() ? Reflect.construct(t, r || [], Y(e).constructor) : t.apply(e, r))
  );
}
function gp() {
  try {
                    ...
                    switch ((g.prev = g.next)) {
                      ...
                      case 19:
                        return (
                          ...
                          (this.statsigClient = new ut.StatsigClient(ld, this.user, h)),
        ...
        value: function (r) {
          ...
          try {
            ...
            return (
              ...
              rd.fromLayer(ut._makeLayer(r, { reason: "Error" }, null))
            );
          }
        },
      },
...
var x0 = {
  ...
  fd = _.memo(function (t) {
    var r,
      ...
      b = n.name,
      m = f ? { __html: f } : void 0;
    if (d && !dt("platform-visual-refresh-icons"))
...
function Fw() {
  return si && dt("platform-dst-react-18-use-id")
    ? dt("platform-dst-react-18-use-id-selector-safe")
      ? si().replace(/[:«»]/g, "_")
      : si()
    : "uid".concat(Mw());
}
function Nw() {
  if (si && dt("platform-dst-react-18-use-id")) {
    var e = Fw();
    return function (t) {
...
function n1(e, t) {
  ...
  return Fa(e, ui() + (t < 6 && xt() == 32 && Fe() == 32));
}
function Ts(e) {
  for (; Fe(); )
    switch (he) {
      ...
      default:
        ...
        switch (((C += Zi(m)), m * p)) {
          ...
          case 44:
            ...
            break;
          case 64:
            (xt() === 45 && (C += ci(Fe())), (f = xt()), (l = d = yt((w = C += i1(ui())))), m++);
            break;
          case 45:
            v === 45 && yt(C) == 2 && (p = 0);
        }
...
var f1 = function (t, r, n) {
    for (var a = 0, i = 0; (a = i), (i = xt()), a === 38 && i === 12 && (r[n] = 1), !Ca(i); ) Fe();
    return Fa(t, Ie);
  },
  v1 = function (t, r) {
    var n = -1,
    ...
    ne(
      ne(
        ne(
          ...
          !dt("platform-component-visual-refresh") && u,
        ),
        {},
        {
          cursor: "pointer",
        ...
        !dt("platform-component-visual-refresh") &&
          ne(
            ne(
              {
                "&:visited": ne({}, u),
    ...
    return (
      ...
      Bt(
        ...
        Bt(
          ...
          p ? Bt("span", { css: [Ue, Vd({ spacing: z }), Gd(c, lk)] }, p) : null,
          fk(c, [Ue, ik({ spacing: z })]),
          v ? Bt("span", { css: [Ue, Vd({ spacing: z }), Gd(c, dk)] }, v) : null,
          M ? Bt("span", { css: [sk, at] }, M) : null,
        ),
      )
    );
  });
...
function Ck(e, t, r) {
  return (
    (t = Y(t)),
    Be(e, nh() ? Reflect.construct(t, r || [], Y(e).constructor) : t.apply(e, r))
  );
}
function nh() {
  try {
...
function Dk(e, t, r) {
  return (
    (t = Y(t)),
    Be(e, ah() ? Reflect.construct(t, r || [], Y(e).constructor) : t.apply(e, r))
  );
}
function ah() {
  try {
...
function RO(e) {
  ...
  var a = ro(e);
  for (vu(a) && (a = a.host); tt(a) && ["html", "body"].indexOf(At(a)) < 0; ) {
    var i = Vt(a);
    if (
      i.transform !== "none" ||
      i.perspective !== "none" ||
...
function $a(e) {
  for (var t = Ne(e), r = uf(e); r && CO(r) && Vt(r).position === "static"; ) r = uf(r);
  ...
  if (S) {
    if (i) {
      var z,
        ...
        Ve = t.elements.arrow && $a(t.elements.arrow),
    ...
    if (u) {
      var bt,
        ...
        za = (bt = M?.[y]) != null ? bt : 0,
        Ba = Kt ? Ee : Ge - C[De] - I[De] - za + P.altAxis,
        qa = Kt ? Ge + C[De] + I[De] - za - P.altAxis : ot,
        Ua = h && Kt ? PO(Ba, Ge, qa) : ha(h ? Ba : Ee, Ge, h ? qa : ot);
      ((S[y] = Ua), (B[y] = Ua - Ge));
    }
    t.modifiersData[n] = B;
  }
...
function lS(e, t, r) {
  ...
  return (
    (n || (!n && !r)) &&
      ...
      tt(t) ? ((s = Zr(t, !0)), (s.x += t.clientLeft), (s.y += t.clientTop)) : i && (s.x = bu(i))),
    {
...
function GS(e) {
  ...
  return (
    VS(r),
    dt("platform_design_system_team_portal_logic_r18_fix")
  ...
  Sh = _.forwardRef(function (t, r) {
    ...
    return _.createElement(
      ...
      _.createElement(
        ...
        i,
        d && dt("platform-dst-tooltip-shortcuts") && _.createElement(JS, { shortcut: d }),
      ),
    );
  });
  ...
  Eh = _.forwardRef(function (t, r) {
    ...
    return _.createElement(
      Sh,
      {
        ...
        className: R([
          cs.base,
          dt("platform-dst-tooltip-shortcuts") && cs.baseRefreshedPadding,
          o && cs.truncate,
          a,
        ]),
        placement: u,
...
function eE(e) {
  ...
  (qk({ onClose: Ge, isDisabled: ue === "hide" || ue === "fade-out" }),
    _.useEffect(
      function () {
  ...
  var De = _.useCallback(
    ...
    qa = _.useCallback(
      function (L) {
        try {
          if (!L.target.matches(":focus-visible") && dt("platform-tooltip-focus-visible-new"))
            return;
        } catch {}
        Wt({ type: "keyboard" });
      },
  ...
  return O.createElement(
    ...
    typeof t == "function"
      ...
      : O.createElement(jh, te({}, io, { ref: Ue, role: "presentation" }), t, Su),
    ao
      ? O.createElement(
          GS,
          { zIndex: XS },
