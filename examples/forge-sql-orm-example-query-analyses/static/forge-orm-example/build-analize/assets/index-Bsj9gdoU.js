...
import { g as Ls, r as Yt, a as Xt, b as Et, s as Ge } from "./client-core-vendor-XcWlv0SX.js";
...
var mu;
function Ch() {
  return (mu || ((mu = 1), (Za.exports = xh())), Za.exports);
}
var x = Ch(),
  eo = {},
  rs = function (e, t) {
...
function Mf(e) {
  ...
  var t = {};
  if (e != null) for (var r = ns(e), n = 0; n < r.length; n++) r[n] !== "default" && Oa(t, e, r[n]);
  return (Rh(t, e), t);
}
function Lf(e) {
...
function be() {
  if (Ou) return Zr;
  ((Ou = 1), Object.defineProperty(Zr, "__esModule", { value: !0 }), (Zr.BridgeAPIError = void 0));
...
function ce() {
  if (Su) return Qr;
  ((Su = 1), Object.defineProperty(Qr, "__esModule", { value: !0 }), (Qr.getCallBridge = void 0));
  const e = be();
  function t(n) {
    return !!n?.callBridge;
  }
...
function $h() {
  if (zu) return dn;
  ((zu = 1), Object.defineProperty(dn, "__esModule", { value: !0 }), (dn.Translator = void 0));
  const e = Gf();
  class t {
    locale;
    translationsGetter;
...
function Vh() {
  if (Bu) return fn;
  ((Bu = 1), Object.defineProperty(fn, "__esModule", { value: !0 }), (fn.ensureLocale = void 0));
  const e = Vf(),
...
var co = {},
  Uu;
function Hh() {
  return (Uu || ((Uu = 1), Object.defineProperty(co, "__esModule", { value: !0 })), co);
}
var $u;
function Hf() {
  return (
...
function Kf() {
  if (Yu) return gn;
  ((Yu = 1), Object.defineProperty(gn, "__esModule", { value: !0 }), (gn.events = void 0));
  const e = ce(),
    t = Jh(),
    r = (0, e.getCallBridge)(),
    n = async (a, o) => {
...
function Xh() {
  if (Ju) return hn;
  ((Ju = 1), Object.defineProperty(hn, "__esModule", { value: !0 }), (hn.emitReadyEvent = void 0));
  const e = Kf(),
    t = Yf(),
    r = "EXTENSION_READY",
    n = async () => {
...
function Qh() {
  if (Zu) return _n;
  ((Zu = 1), Object.defineProperty(_n, "__esModule", { value: !0 }), (_n.router = void 0));
  const t = (0, ce().getCallBridge)(),
    r = async (o) => {
...
function _g() {
  if (mc) return Mi;
  ((mc = 1), Object.defineProperty(Mi, "__esModule", { value: !0 }));
  const e = Yt();
  class t {
    constructor(n) {
      ((this._sdkKey = n),
...
function hv(e, t, r) {
  if (Ei(t)) return os.decorate_20223_(e, t);
  if (cr(t)) {
    Si(e, t, os);
    return;
  }
...
var O_ = {
  ...
  S_ = "computed.struct",
  ss = Bs(gv),
  E_ = Bs(S_, { equals: aa.structural }),
  Ia = function (t, r) {
    if (Ei(r)) return ss.decorate_20223_(t, r);
    if (cr(r)) return Si(t, r, ss);
    if (Jt(t)) return mt(Bs(gv, t));
    var n = Jt(r) ? r : {};
...
var Mc,
  ...
  k_ = 1,
  x_ =
    (Mc = (Lc = ia(function () {}, "name")) == null ? void 0 : Lc.configurable) != null ? Mc : !1,
...
function us(e) {
  switch (e.dependenciesState_) {
    ...
    case W.POSSIBLY_STALE_: {
      for (var t = qs(!0), r = gr(), n = e.observing_, i = n.length, a = 0; a < i; a++) {
        var o = n[a];
        if (Ma(o)) {
  ...
  return (
    ...
    (t.runReaction_ = function () {
      if (!this.isDisposed) {
        ...
        var n = A.trackingContext;
        if (((A.trackingContext = this), us(this))) {
...
function kv() {
  A.inBatch > 0 || A.isRunningReactions || ls(F_);
}
function F_() {
...
var xv = "action",
  ...
  ds = ki(xv),
  $_ = ki(B_, { bound: !0 }),
  fs = ki(Cv, { autoAction: !0 }),
  V_ = ki(q_, { autoAction: !0, bound: !0 });
function Rv(e) {
  var t = function (n, i) {
    if (ut(n)) return fr(n.name || U_, n, e);
    if (ut(i)) return fr(n, i, e);
    if (Ei(i)) return (e ? fs : ds).decorate_20223_(n, i);
    if (cr(i)) return Si(n, i, e ? fs : ds);
...
function ab(e, t) {
  return e ? Fa(e) || !!e[F] || zs(e) || ca(e) || Ma(e) : !1;
}
function Dv(e) {
  return ab(e);
}
    ...
    return (
      ...
      (t.spliceWithArray_ = function (n, i, a) {
        ...
        if (
          ...
          var s = Ye(this, { object: this.proxy_, type: zc, index: n, removedCount: i, added: a });
          if (!s) return is;
...
var db = hr("ObservableArrayAdministration", $s);
function La(e) {
  return Ca(e) && db(e[F]);
}
var fb = {},
          ...
          Ft(function () {
            ...
            if (!u)
              if (i.data_.size !== o.size) i.keysAtom_.reportChanged();
                ...
                for (var O = i.data_.keys(), m = o.keys(), S = O.next(), k = m.next(); !S.done; ) {
                  if (S.value !== k.value) {
...
function Bc(e) {
  return ((e[Symbol.toStringTag] = "MapIterator"), Gs(e));
}
function vb(e) {
...
function qc(e) {
  return ((e[Symbol.toStringTag] = "SetIterator"), Gs(e));
}
  ...
  Fv = (function () {
    ...
    return (
      ...
      (t.delete_ = function (n, i) {
        ...
        if (Ke(this)) {
          var a = Ye(this, { object: this.proxy_ || this.target_, name: n, type: $c });
          if (!a) return null;
        }
        try {
          var o;
...
function fa(e, t) {
  if (typeof e == "object" && e !== null) {
    ...
    if (_r(e)) {
      ...
      return (r || H(25, t, vs(e)), r);
    }
    if (Fa(e)) {
      if (!t) return H(26);
      var n = e[F].values_.get(t);
      return (n || H(27, t, vs(e)), n);
    }
    if (zs(e) || Ma(e) || ca(e)) return e;
  } else if (ut(e) && ca(e[F])) return e[F];
  H(28);
}
function wb(e, t) {
  if ((e || H(29), zs(e) || Ma(e) || ca(e) || _r(e) || _t(e))) return e;
  if (e[F]) return e[F];
  H(24, e);
}
function vs(e, t) {
...
function ps(e, t, r, n, i) {
  ...
  if ((n.push(e), i.push(t), u)) {
    ...
    for (; l--; ) if (!ps(e[l], t[l], r - 1, n, i)) return !1;
  } else {
    var d = Object.keys(e),
      f = d.length;
    ...
    for (var h = 0; h < f; h++) {
      var v = d[h];
      if (!(zt(t, v) && ps(e[v], t[v], r - 1, n, i))) return !1;
    }
  }
...
var Kc,
  Ob = ((Kc = ka().Iterator) == null ? void 0 : Kc.prototype) || {};
function Gs(e) {
...
typeof __MOBX_DEVTOOLS_GLOBAL_HOOK__ == "object" &&
  __MOBX_DEVTOOLS_GLOBAL_HOOK__.injectMobx({ spy: z_, extras: { getDebugName: vs }, $mobx: F });
var b = lt();
const E = Xt(b),
  Yc = kh({ __proto__: null, default: E }, [b]);
if (!b.useState) throw new Error("mobx-react-lite requires React with Hooks support");
if (!Us) throw new Error("mobx-react-lite@3 requires mobx at least version 6 to be available");
function Eb(e) {
  e();
}
function kb(e) {
...
var Xc;
function Ib() {
  return (Xc || ((Xc = 1), (ko.exports = jb())), ko.exports);
}
var Db = Ib();
function Qc(e) {
...
function Tb(e, t) {
    ...
    var n = {
      ...
      subscribe: function (u) {
        return (
          ...
          (n.onStoreChange = u),
          n.reaction || (Qc(n), (n.stateVersion = Symbol())),
          function () {
            var s;
  ...
  var i = r.current;
  (i.reaction || (Qc(i), fi.register(r, i, i)),
...
function Lb(e, t) {
  ...
  if (Zc && e.$$typeof === Zc && ((n = !0), (i = e.render), typeof i != "function"))
...
function zb(e, t) {
  ...
  for (var i = 0; i < r.length; i++)
    if (!Object.hasOwnProperty.call(t, r[i]) || !tl(e[r[i]], t[r[i]])) return !1;
  return !0;
}
function tl(e, t) {
  return e === t ? e !== 0 || 1 / e === 1 / t : e !== e && t !== t;
}
var rl = Symbol("patchMixins"),
...
function il(e, t) {
  var r = function () {
    for (var i = arguments.length, a = new Array(i), o = 0; o < i; o++) a[o] = arguments[o];
    nl.call.apply(nl, [this, e, t].concat(a));
  };
  return r;
}
function qb(e, t, r) {
...
var al = Symbol("ObserverAdministration"),
  ol = Symbol("isMobXReactObserver");
function hs(e) {
  var t;
  return (t = e[al]) != null
    ? t
...
function Ub(e) {
  ...
  if (e.__proto__ !== b.PureComponent) {
    if (!t.shouldComponentUpdate) t.shouldComponentUpdate = sl;
    else if (t.shouldComponentUpdate !== sl)
      throw new Error(
...
function Gv(e) {
  var t = e.children,
    ...
    i = E.useRef(_s({}, n, r)),
    a = i.current;
  return E.createElement(ul.Provider, { value: a }, t);
}
...
class za {
  constructor() {
    ((this.state = "ROOT"), (this.lastState = "ROOT"), Us(this));
  }
  saveState(t) {
    ((this.lastState = this.state), (this.state = t));
  }
}
Hs([oe], za.prototype, "state", 2);
Hs([oe], za.prototype, "lastState", 2);
Hs([Qe.bound], za.prototype, "saveState", 1);
const Ws = new za();
class Qb {
  constructor() {
    ((this.usersStore = Yb), (this.stateStore = Ws));
  }
}
const Hv = new Qb(),
...
function Ny(e) {
  var t = (function (r) {
    function n() {
      ...
      return ((i = Ly(this, n, [].concat(o))), C(i, "state", { pageRows: [] }), i);
    }
    return (
      qe(n, r),
      ve(
...
var zy = "--local-dynamic-table-width",
  tp = function (t) {
    var r = t.width;
    return typeof r < "u" ? C({}, zy, "".concat(r, "%")) : void 0;
  },
  ...
  nm = function (t) {
    ...
    return b.createElement(
      "div",
      {
        ...
        style: ml(ml({}, C({}, wl, n)), {}, { "--_cnddr8": Zv("var(".concat(wl, ")")) }),
      },
      r,
    );
  },
...
var up = (function (e) {
  function t() {
    ...
    return (
      ...
      C(r, "spinnerRef", E.createRef()),
      C(r, "containerRef", E.createRef()),
      ...
      C(r, "isVerticallyVisible", function (o, u) {
        var s = o.top,
          c = o.bottom;
        return c <= 0 ? !1 : s < u;
      }),
      C(r, "isFullyVerticallyVisible", function (o, u) {
        var s = o.top,
          c = o.bottom;
        return s >= 0 && c <= u;
      }),
      ...
      C(r, "translateSpinner", function (o, u, s) {
                          ...
                          if ((P || ($ = "next"), (i = I[$]))) {
                            ...
                            (P === 1 && (i = I.return) && i.call(I),
                              P < 2 &&
                                ...
                                (P = 1)));
                          I = n;
                        } else if ((i = (V = J.n < 0) ? M : S.call(k, J)) !== c) break;
                      } catch (j) {
                        ((I = n), (P = 1), (M = j));
                      } finally {
                        q = 1;
...
function km() {
  ...
  const t = Et(),
    ...
    i = Sm(),
    a = Em();
  let o = class ms extends t.StatsigClientBase {
    static instance(s) {
      const c = (0, t._getStatsigGlobal)().instance(s);
      return c instanceof ms
        ? c
        : (t.Log.warn(
            (0, t._isServerEnv)()
              ? "StatsigClient.instance is not supported in server environments"
...
var qi = "@all-features",
  Am = (function () {
    function e() {
      (fe(this, e), C(this, "eventToValue", new Map()), (this.emitter = new Pm()));
    }
    return ve(e, [
      {
        key: "onGateUpdated",
...
var Ui = function (t) {
    return ws({ perimeter: Im() ? hi.FEDRAMP_MODERATE : hi.COMMERCIAL }, t);
  },
  zn = function (t, r) {
    if (!t && !r) return !0;
    if (!t || !r) return !1;
  ...
  Mm = Object.entries(Ys).map(function (e) {
    var t = K(e, 2),
      r = t[0],
      n = t[1];
      ...
      },
      {
        ...
        value: function () {
          ...
          for (var o = 0, u = i; o < u.length; o++) {
            ...
            for (
              var m = 0, S = Object.entries((k = s.layers) !== null && k !== void 0 ? k : {});
              m < S.length;
              m++
            ) {
              var k,
  ...
  a0 = (function () {
    function e() {
      ...
      (fe(this, e),
        ...
        C(this, "subscriptions", new Am()),
        C(this, "dataAdapter", new Qm()),
        ...
        value: function (r) {
          ...
          try {
            ...
            return (
              ...
              new Wl(r, {}, "", { time: Date.now(), reason: Ys.Error })
            );
          }
        },
      },
                    ...
                    switch ((g.prev = g.next)) {
                      ...
                      case 19:
                        return (
                          ...
                          (this.statsigClient = new at.StatsigClient(rd, this.user, h)),
        ...
        value: function (r) {
          ...
          try {
            ...
            var i = n.fireLayerExposure,
              a = i === void 0 ? !0 : i;
            return Kl.fromLayer(this.statsigClient.getLayer(r, { disableExposureLog: !a }));
          } catch (o) {
            return (
              ...
              Kl.fromLayer(at._makeLayer(r, { reason: "Error" }, null))
            );
          }
        },
      },
...
C(U, "initializeCalled", T.client.initializeCalled.bind(T.client));
C(U, "initializeCompleted", T.client.initializeCompleted.bind(T.client));
C(U, "waitUntilInitializeCompleted", T.client.waitUntilInitializeCompleted.bind(T.client));
C(U, "initialize", T.client.initialize.bind(T.client));
C(U, "initializeWithProvider", T.client.initializeWithProvider.bind(T.client));
C(U, "initializeFromValues", T.client.initializeFromValues.bind(T.client));
C(U, "manuallyLogGateExposure", T.client.manuallyLogGateExposure.bind(T.client));
C(U, "getExperiment", T.client.getExperiment.bind(T.client));
C(U, "manuallyLogExperimentExposure", T.client.manuallyLogExperimentExposure.bind(T.client));
C(U, "manuallyLogLayerExposure", T.client.manuallyLogLayerExposure.bind(T.client));
C(U, "shutdownStatsig", T.client.shutdownStatsig.bind(T.client));
C(U, "overrideGate", T.client.overrideGate.bind(T.client));
C(U, "clearGateOverride", T.client.clearGateOverride.bind(T.client));
C(U, "overrideConfig", T.client.overrideConfig.bind(T.client));
C(U, "clearConfigOverride", T.client.clearConfigOverride.bind(T.client));
C(U, "setOverrides", T.client.setOverrides.bind(T.client));
C(U, "getOverrides", T.client.getOverrides.bind(T.client));
C(U, "clearAllOverrides", T.client.clearAllOverrides.bind(T.client));
C(U, "isCurrentUser", T.client.isCurrentUser.bind(T.client));
C(U, "onGateUpdated", T.client.onGateUpdated.bind(T.client));
C(U, "onExperimentValueUpdated", T.client.onExperimentValueUpdated.bind(T.client));
C(U, "onAnyUpdated", T.client.onAnyUpdated.bind(T.client));
C(U, "updateUser", T.client.updateUser.bind(T.client));
C(U, "updateUserWithProvider", T.client.updateUserWithProvider.bind(T.client));
C(U, "updateUserWithValues", T.client.updateUserWithValues.bind(T.client));
C(U, "getPackageVersion", T.client.getPackageVersion.bind(T.client));
C(U, "getLayer", T.client.getLayer.bind(T.client));
C(U, "getLayerValue", T.client.getLayerValue.bind(T.client));
var Es = U;
if (typeof window < "u")
  if (window.__FEATUREGATES_JS__ === void 0) window.__FEATUREGATES_JS__ = U;
    ...
    var nd =
      (($i = Es) === null || $i === void 0 || (Go = $i.getPackageVersion) === null || Go === void 0
        ? void 0
...
var Cr,
  ...
  yp = typeof process < "u" && typeof Js < "u",
  d0 = yp ? Js.ENABLE_PLATFORM_FF === "true" : !1,
  f0 = yp ? Js.STORYBOOK_ENABLE_PLATFORM_FF === "true" : !1,
  v0 = d0 || f0,
...
var g0 = {
  ...
  id = b.memo(function (t) {
    var r,
      ...
      _ = n.name,
      y = f ? { __html: f } : void 0;
    if (d && !Nr("platform-visual-refresh-icons"))
    ...
    return b.createElement(
      ...
      b.createElement("svg", {
        ...
        className: R([
          ...
          h ? "_1bsb1kw7 _4t3i1kw7" : w === "utility" ? b0[g] : O === "small" ? _0[g] : g0[g],
        ]),
      }),
    );
  });
const w0 = Object.freeze(
    Object.defineProperty({ __proto__: null, Icon: id, default: id }, Symbol.toStringTag, {
      value: "Module",
    }),
  ),
  qa = Ls(w0);
...
function O0() {
  if (ad) return Tn;
  ((ad = 1), Object.defineProperty(Tn, "__esModule", { value: !0 }), (Tn.default = void 0));
  var e = r(lt()),
    t = r(qa);
  function r(i) {
...
function x0() {
  if (ld) return Dn;
  ((ld = 1), Object.defineProperty(Dn, "__esModule", { value: !0 }), (Dn.default = void 0));
  var e = n(lt()),
    t = n(O0()),
    r = n(k0());
  function n(a) {
...
function P0() {
  if (dd) return $n;
  ((dd = 1), Object.defineProperty($n, "__esModule", { value: !0 }), ($n.default = void 0));
  var e = r(lt()),
    t = r(qa);
  function r(i) {
    return i && i.__esModule ? i : { default: i };
...
function A0() {
  if (fd) return Vn;
  ((fd = 1), Object.defineProperty(Vn, "__esModule", { value: !0 }), (Vn.default = void 0));
  var e = r(lt()),
    t = mp;
  function r(i) {
    return i && i.__esModule ? i : { default: i };
...
var I0 = j0();
const D0 = Xt(I0);
var Xs = b.createContext("elevation.surface"),
  T0 = function () {
    return b.useContext(Xs);
  };
Xs.displayName = "SurfaceProvider";
var M0 = [
    "as",
    "children",
    "backgroundColor",
  ...
  Ua = b.forwardRef(function (e, t) {
    ...
    return a ? b.createElement(Xs.Provider, { value: a }, D) : D;
  });
function U0(e) {
  return e in wp;
}
...
var Q0 = [
  ...
  Z0 = function (t) {
    var r = t.children;
    return b.createElement("span", { className: R([ks.separator]) }, r);
  },
  Ji = b.memo(
    b.forwardRef(function (e, t) {
      var r = e.as,
        ...
        g = e.children,
        _ = ne(e, Q0),
        y = typeof f == "string" ? b.createElement(Z0, null, f) : f,
        w = y
      ...
      return b.createElement(
        ...
        te({}, _, {
          ...
          rowGap: d,
          wrap: u ? "wrap" : void 0,
          xcss: G0(c === "hug" && ks.hug, c === "fill" && ks.fill, h),
          testId: v,
          ref: t,
        }),
        w,
...
var Sp = b.createContext(!1),
  ...
  cw = b.forwardRef(function (e, t) {
    ...
    return h ? p : b.createElement(nw, { value: !0 }, p);
  });
function lw() {
...
var dw = ["as", "children", "isInset", "testId", "style", "xcss"],
  ...
  hw = ["className"],
  _d = { root: "_19itglyw _vchhusvi _r06hglyw _80omtlke", disabled: "_80om13gf" },
  gw = b.forwardRef(function (e, t) {
    ...
    return b.createElement(
      vw,
      te({ as: "button", tabIndex: v ?? (lw() && !n ? 0 : void 0), style: d }, w, {
        type: a,
        onClick: y,
        disabled: n,
        xcss: Op(_d.root, n && _d.disabled, h),
        testId: f,
        ref: t,
      }),
      r,
...
function Ep() {
  if (bd) return Gn;
  ((bd = 1), Object.defineProperty(Gn, "__esModule", { value: !0 }), (Gn.bind = void 0));
  function e(t, r) {
    var n = r.type,
      i = r.listener,
      a = r.options;
...
function Hn(e, t) {
  return Bw(Ha("", null, null, "", null, null, 0), e, { length: -e.length }, t);
}
function Vw() {
  return he;
}
...
function Zi(e) {
  return Ap(Ri(Ie - 1, Cs(e === 91 ? e + 2 : e === 40 ? e + 1 : e)));
}
function Hw(e) {
  for (; (he = Ot()) && he < 33; ) Fe();
...
function ea(e, t, r, n, i, a, o, u, s) {
  for (
    ...
    switch (((v = y), (y = Fe()))) {
      case 40:
        if (v != 108 && ye(k, d - 1) == 58) {
          xs((k += Z(Zi(y), "&", "&\f")), "&\f") != -1 && (_ = -1);
          break;
        }
      case 34:
      case 39:
        ...
        switch (y) {
          ...
          case 59 + l:
            (_ == -1 && (k = Z(k, /\f/g, "")),
              h > 0 &&
                ht(k) - d &&
                Vi(h > 32 ? Od(k + ";", n, r, d - 1) : Od(Z(k, " ", "") + ";", n, r, d - 2), s));
            break;
          case 59:
            k += ";";
          default:
            if ((Vi((S = wd(k, t, r, c, l, i, u, w, (O = []), (m = []), d)), a), y === 123))
              if (l === 0) ea(k, t, S, S, O, a, d, u, m);
              else
                switch (f === 99 && ye(k, 3) === 110 ? 100 : f) {
                  case 100:
                  case 108:
                  case 109:
                  case 115:
                    ea(
                      ...
                      S,
                      S,
                      n && Vi(wd(e, S, S, 0, 0, i, u, w, i, (O = []), d), m),
                      i,
                      m,
                      d,
                      u,
      ...
      default:
        if (p < 1) {
          if (y == 123) --p;
          else if (y == 125 && p++ == 0 && Gw() == 125) continue;
        }
        switch (((k += Va(y)), y * p)) {
          case 38:
            _ = l > 0 ? 1 : ((k += "\f"), -1);
          ...
          case 44:
            ...
            break;
          case 64:
            (Ot() === 45 && (k += Zi(Fe())), (f = Ot()), (l = d = ht((w = k += Yw(Qi())))), y++);
            break;
          case 45:
            v === 45 && ht(k) == 2 && (p = 0);
        }
...
function wd(e, t, r, n, i, a, o, u, s, c, l) {
  for (var d = i - 1, f = i === 0 ? a : [""], h = eu(f), v = 0, p = 0, g = 0; v < n; ++v)
    for (var _ = 0, y = gi(e, d + 1, (d = zw((p = o[v])))), w = e; _ < h; ++_)
      (w = Ap(p > 0 ? f[_] + " " + y : Z(y, /&\f/g, f[_]))) && (s[g++] = w);
  return Ha(e, t, r, i === 0 ? Qs : u, s, c, l);
}
function Xw(e, t, r) {
  return Ha(e, t, r, Rp, Va(Vw()), gi(e, 2, -2), 0);
}
function Od(e, t, r, n) {
  return Ha(e, t, r, Zs, gi(e, 0, n), gi(e, n + 1, -1), n);
}
function Tr(e, t) {
  for (var r = "", n = eu(e), i = 0; i < n; i++) r += t(e[i], i, e, t) || "";
  return r;
}
function Qw(e, t, r, n) {
  switch (e.type) {
...
var rO = function (t, r, n) {
  ...
  nO = function (t, r) {
    ...
    do
      switch (_i(i)) {
        case 0:
          (i === 38 && Ot() === 12 && (r[n] = 1), (t[n] += rO(Ie - 1, r, n)));
          break;
        case 2:
          t[n] += Zi(i);
          break;
  ...
  aO = function (t) {
    if (!(t.type !== "rule" || !t.parent || t.length < 1)) {
      ...
      if (!(t.props.length === 1 && r.charCodeAt(0) !== 58 && !Sd.get(n)) && !i) {
        Sd.set(t, !0);
        for (var a = [], o = iO(r, a), u = n.props, s = 0, c = 0; s < o.length; s++)
    ...
    case 4765:
      if (ht(e) - 1 - t > 6)
        switch (ye(e, t + 1)) {
          ...
          case 115:
            return ~xs(e, "stretch") ? Tp(Z(e, "stretch", "fill-available"), t) + e : e;
        }
      break;
    case 4949:
      if (ye(e, t + 1) !== 115) break;
    case 6444:
      switch (ye(e, ht(e) - 3 - (~xs(e, "!important") && 10))) {
        case 107:
          return Z(e, ":", ":" + Q) + e;
        case 101:
          return (
...
var kd;
function dO() {
  return (kd || ((kd = 1), (Yo.exports = lO())), Yo.exports);
}
var Jo, xd;
function fO() {
  if (xd) return Jo;
...
var tu = function (t, r, n) {
    var i = t.key + "-" + r.name;
    (n === !1 || vO === !1) && t.registered[i] === void 0 && (t.registered[i] = r.styles);
  },
  Lp = function (t, r, n) {
    tu(t, r, n);
    var i = t.key + "-" + r.name;
...
var hO = {
  ...
  Xo = tO(function (e) {
    return Fp(e) ? e : e.replace(gO, "-$&").toLowerCase();
  }),
  Rd = function (t, r) {
    switch (t) {
      case "animation":
      case "animationName":
        if (typeof r == "string")
          return r.replace(_O, function (n, i, a) {
            return ((gt = { name: i, styles: a, next: gt }), i);
          });
    }
    return hO[t] !== 1 && !Fp(t) && typeof r == "number" && r !== 0 ? r + "px" : r;
  };
function bi(e, t, r) {
  if (r == null) return "";
  var n = r;
  ...
  if (Array.isArray(r)) for (var i = 0; i < r.length; i++) n += bi(e, t, r[i]) + ";";
    ...
    for (var a in r) {
      ...
      if (typeof o != "object") {
        ...
        for (var s = 0; s < o.length; s++) Cd(o[s]) && (n += Xo(a) + ":" + Rd(a, o[s]) + ";");
      else {
        var c = bi(e, t, o);
        switch (a) {
          case "animation":
...
function ru(e, t, r) {
  ...
  Pd.lastIndex = 0;
  for (var c = "", l; (l = Pd.exec(i)) !== null; ) c += "-" + l[1];
  var d = pO(i) + c;
...
var yO = function (t) {
  ...
  mO = Yc.useInsertionEffect ? Yc.useInsertionEffect : !1,
  Np = mO || yO,
  zp = b.createContext(typeof HTMLElement < "u" ? cO({ key: "css" }) : null);
zp.Provider;
var Bp = function (t) {
  ...
  wO = function (t, r) {
    var n = {};
    for (var i in r) nu.call(r, i) && (n[i] = r[i]);
    return ((n[Rs] = t), n);
  },
  OO = function (t) {
    var r = t.cache,
  ...
  SO = Bp(function (e, t, r) {
    ...
    var u = ru(a, void 0, b.useContext(qp));
    o += t.key + "-" + u.name;
    var s = {};
    for (var c in e) nu.call(e, c) && c !== "css" && c !== Rs && (s[c] = e[c]);
    return (
      (s.className = o),
      r && (s.ref = r),
      b.createElement(
        b.Fragment,
        null,
        b.createElement(OO, { cache: t, serialized: u, isStringTag: typeof i == "string" }),
        b.createElement(i, s),
      )
    );
  }),
  ...
  Nt = function (t, r) {
    var n = arguments;
    if (r == null || !nu.call(r, "css")) return b.createElement.apply(void 0, n);
    var i = n.length,
      a = new Array(i);
    ((a[0] = EO), (a[1] = wO(t, r)));
...
var CO = function (t) {
  ...
  RO = Bp(function (e, t) {
    ...
    return b.createElement(
      b.Fragment,
      null,
      b.createElement(CO, { cache: t, serializedArr: r }),
      o,
    );
  });
function PO(e, t) {
...
var Kt = 8,
  ...
  LO = { default: js.default, compact: js.compact, none: "inherit" },
  FO = {
    default: "0 ".concat(Kt + Kt / 4, "px"),
    compact: "0 ".concat(Kt + Kt / 4, "px"),
    none: "0",
  },
  NO = { compact: "0 ".concat(Kt / 4, "px"), default: "0 ".concat(Kt / 4, "px"), none: "0" },
  zO = { default: "middle", compact: "middle", none: "baseline" },
  ...
  KO = { '&[data-has-overlay="true"]': { cursor: "default", textDecoration: "none" } };
function YO(e) {
  var t = e.appearance,
    r = e.spacing,
    n = e.isSelected,
            ...
            Re(
              Re(
                Re(
                  Re(
                    Re(
                      Re(Re({}, t === "default" && BO), t === "primary" && qO),
                      t === "link" && UO,
                    ),
                    t === "subtle" && $O,
                  ),
...
var QO = {
  ...
  Dd = function (t, r) {
    return !t || iu(t) ? null : r;
  },
  n1 = function (t, r) {
    return iu(t) ? t : t ? Nt("span", { css: r }, t) : null;
  },
  i1 = E.forwardRef(function (t, r) {
    ...
    PO(j, u);
    var ae = b.useContext(Ks),
      se = b.useCallback(
        function (pe, $e) {
          (ae && ae.tracePress(g, pe.timeStamp), k(pe, $e));
        },
        [k, ae, g],
      ),
      le = pi({
    ...
    return (
        ...
        (rt = {
          "[data-theme] & circle": {
            stroke: "".concat(
              O || y
                ? "var(--ds-icon-subtle, ".concat(ys, ")")
                : "var(--ds-icon-warning-inverse, ".concat(ys, ")"),
              " !important",
            ),
          },
        }),
      Nt(
        ...
        Nt(
          ...
          p ? Nt("span", { css: [Ue, Id({ spacing: B }), Dd(c, t1)] }, p) : null,
          n1(c, [Ue, JO({ spacing: B })]),
          v ? Nt("span", { css: [Ue, Id({ spacing: B }), Dd(c, r1)] }, v) : null,
          M ? Nt("span", { css: [QO, rt] }, M) : null,
        ),
      )
    );
  });
  ...
  au = E.memo(
    E.forwardRef(function (t, r) {
      var n = t.appearance,
        ...
        w = Dw(),
        O = w.mode,
        m = a1({ children: a, iconBefore: o, iconAfter: u }),
        S = b.useState(!1),
        k = K(S, 2),
        D = k[0],
        I = k[1],
...
var u1 = { container: "_1e0c1txw _kqswh2mm" };
function c1(e) {
  var t = e.key,
    r = e.testId,
    n = e.from,
  ...
  return E.createElement(
    Ua,
    { as: "li", testId: r, key: t, xcss: u1.container, paddingInline: "space.100" },
    E.createElement(
      cw,
...
function g1(e, t) {
  var r = e.components,
    ...
    $ = function (N, j, _e) {
      ...
      return E.createElement(
        Ji,
        { as: "li", xcss: Is.paginationMenuItem, key: "page-".concat(S ? S(N, j) : j) },
        E.createElement(
          s1,
          {
            component: n.Page,
  ...
  return E.createElement(
    ...
    E.createElement(
      ...
      E.createElement(
        ...
        v1(m, V, { max: y, ellipsis: D, transform: $ }, P),
      ),
      E.createElement(Md, {
        key: "right-navigator",
        component: n.Next,
...
var y1 = (function (e) {
    function t() {
      ...
      for (var n = arguments.length, i = new Array(n), a = 0; a < n; a++) i[a] = arguments[a];
      return (
        (r = b1(this, t, [].concat(i))),
        C(r, "onChange", function (o, u, s) {
  ...
  S1 = b.forwardRef(function (e, t) {
    ...
    var u = e.style,
      ...
      l = Wn(
        ...
        {},
        C({}, qd, "var(--ds-text-subtlest, #6B6E76)"),
      ),
      d = i === vr,
      f = i === ga,
      h = function () {
    ...
    return b.createElement(
      ...
      te({ "aria-sort": h(), onClick: void 0, ref: t, "data-testid": s }, c, {
        ...
        style: Wn(
          Wn({}, l),
          {},
          { "--_17ckjys": Zv("var(--ds-text-subtle, ".concat("var(".concat(qd, ")"), ")")) },
        ),
      }),
      n,
    );
...
function k1(e) {
  return (function (t) {
    function r() {
      ...
      for (var i = arguments.length, a = new Array(i), o = 0; o < i; o++) a[o] = arguments[o];
      return (
        (n = E1(this, r, [].concat(a))),
        C(n, "state", { refWidth: 0, refHeight: 0 }),
        C(n, "innerRef", function (u) {
...
function x1() {
  if (Ud) return Kn;
  ((Ud = 1), Object.defineProperty(Kn, "__esModule", { value: !0 }), (Kn.default = void 0));
  var e = r(lt()),
    t = r(qa);
  function r(i) {
    return i && i.__esModule ? i : { default: i };
...
function P1() {
  if ($d) return Yn;
  (($d = 1), Object.defineProperty(Yn, "__esModule", { value: !0 }), (Yn.default = void 0));
  var e = r(lt()),
    t = r(qa);
  function r(i) {
    return i && i.__esModule ? i : { default: i };
...
function D1(e) {
  var t = e.onClose,
    ...
    i = b.useCallback(
      function (o) {
        r || n.current || o.key !== I1 || ((n.current = !0), t(o));
      },
      [t, r],
    ),
...
var T1 = b.createContext(null),
  M1 = b.createContext(null);
function L1() {
  var e = b.useContext(M1);
  return e;
}
function F1(e) {
  var t = e.isOpen,
...
var ei = { none: 0, small: 100, medium: 350, large: 700 },
  Zo = 0.5,
  N1 = { none: ei.none, small: ei.small * Zo, medium: ei.medium * Zo, large: ei.large * Zo },
  z1 = function () {
  ...
  $1 = function (t, r) {
    for (var n = r.concat([]), i = V1(r), a = 0; a < t.length; a++) {
      var o = t[a],
        u = !i[o.key];
      u && n.splice(a + 1, 0, o);
    }
...
var K1 = b.createContext(function () {
  ...
  X1 = { top: "bottom", bottom: "top", left: "right", right: "left" },
  Q1 = function (t) {
    var r = t.children,
      n = t.duration,
      i = n === void 0 ? "large" : n,
...
var eS = function (t) {
  ...
  rS = function (t, r) {
    if (typeof t == "function") return tS(t, r);
    t != null && (t.current = r);
  },
  Hd = function (t) {
    return t.reduce(function (r, n) {
  ...
  Xn = "popper",
  iS = "reference",
  Kd = Pi.reduce(function (e, t) {
    return e.concat([t + "-" + Br, t + "-" + yi]);
  }, []),
  Qp = [].concat(Pi, [ou]).reduce(function (e, t) {
...
function Wa(e) {
  return xt(e) === "html" ? e : e.assignedSlot || e.parentNode || (su(e) ? e.host : null) || Zt(e);
}
function Yd(e) {
...
function yS(e) {
  ...
  var i = Wa(e);
  for (su(i) && (i = i.host); Ze(i) && ["html", "body"].indexOf(xt(i)) < 0; ) {
    var a = qt(i);
    if (
      a.transform !== "none" ||
      a.perspective !== "none" ||
...
function Ai(e) {
  for (var t = Ne(e), r = Yd(e); r && bS(r) && qt(r).position === "static"; ) r = Yd(r);
...
function Jd(e) {
  ...
  if (c) {
    ...
    if (
      ...
      O = et;
      var I = d && S === m && m.visualViewport ? m.visualViewport.height : S[k];
      ((p -= I - n.height), (p *= s ? 1 : -1));
    }
    if (i === Ae || ((i === Pe || i === et) && a === yi)) {
      w = tt;
      var P = d && S === m && m.visualViewport ? m.visualViewport.width : S[D];
      ((h -= P - n.width), (h *= s ? 1 : -1));
    }
  }
  var M = Object.assign({ position: u }, c && kS),
    q = l === !0 ? xS({ x: h, y: p }, Ne(r)) : { x: h, y: p };
  if (((h = q.x), (p = q.y), s)) {
    var B;
...
const RS = { name: "computeStyles", enabled: !0, phase: "beforeWrite", fn: CS, data: {} };
var Gi = { passive: !0 };
function PS(e) {
  var t = e.state,
    r = e.instance,
...
function du(e) {
  return Ur(Zt(e)).left + lu(e).scrollLeft;
}
function DS(e, t) {
  var r = Ne(e),
    n = Zt(e),
...
function si(e, t) {
  ...
  var n = ih(e),
    ...
    a = Ne(n),
    o = i ? [a].concat(a.visualViewport || [], fu(n) ? n : []) : n,
    u = t.concat(o);
...
function Qd(e, t, r) {
  return t === Xp ? Ts(DS(e, r)) : pr(t) ? MS(t, r) : Ts(TS(Zt(e)));
}
function LS(e) {
  var t = si(Wa(e)),
...
function FS(e, t, r, n) {
  var i = t === "clippingParents" ? LS(e) : [].concat(t),
    a = [].concat(i, [r]),
    o = a[0],
    u = a.reduce(
      function (s, c) {
...
function mi(e, t) {
  ...
  var r = t,
    ...
    w = e.rects.popper,
    O = e.elements[v ? y : f],
    m = FS(pr(O) ? O : O.contextElement || Zt(e.elements.popper), s, l, o),
    S = Ur(e.elements.reference),
    k = ah({ reference: S, element: w, placement: i }),
    D = Ts(Object.assign({}, w, k)),
    I = f === Xn ? D : S,
    P = {
...
const HS = { name: "offset", enabled: !0, phase: "main", requires: ["popperOffsets"], fn: GS };
function WS(e) {
  var t = e.state,
    r = e.name;
  ...
  if (S) {
    if (a) {
      var B,
        ...
        ae = y === Br ? -D[G] : -k[G],
        se = t.elements.arrow,
        le = h && se ? uu(se) : { width: 0, height: 0 },
        ...
        Ue = ge[J],
        Oe = oi(0, k[G], le[G]),
        rt = w ? k[G] / 2 - j - Oe - ue - P.mainAxis : _e - Oe - ue - P.mainAxis,
        pe = w ? -k[G] / 2 + j + Oe + Ue + P.mainAxis : ae + Oe + Ue + P.mainAxis,
    ...
    if (u) {
      var vt,
        ...
        ji = (vt = M?.[m]) != null ? vt : 0,
        Ii = Vt ? ke : Ve - k[De] - D[De] - ji + P.altAxis,
        Di = Vt ? Ve + k[De] + D[De] - ji - P.altAxis : it,
        Ti = h && Vt ? mS(Ii, Ve, Di) : oi(h ? Ii : ke, Ve, h ? Di : it);
      ((S[m] = Ti), (q[m] = Ti - Ve));
    }
    t.modifiersData[n] = q;
  }
...
function tE(e, t, r) {
  ...
  return (
    (n || (!n && !r)) &&
      ((xt(t) !== "body" || fu(a)) && (u = ZS(t)),
      Ze(t) ? ((s = Ur(t, !0)), (s.x += t.clientLeft), (s.y += t.clientTop)) : a && (s.x = du(a))),
    {
    ...
    var l = {
      ...
      h = {
        ...
        setOptions: function (_) {
          ...
          var w = nE(aE([].concat(n, l.options.modifiers)));
          return (
        ...
        forceUpdate: function () {
          if (!f) {
            ...
            if (rf(y, w)) {
              ((l.rects = {
                reference: tE(y, Ai(w), l.options.strategy === "fixed"),
                popper: uu(w),
              }),
                (l.reset = !1),
              ...
              for (var O = 0; O < l.orderedModifiers.length; O++) {
                ...
                var m = l.orderedModifiers[O],
                  ...
                  I = m.name;
                typeof S == "function" &&
                  (l = S({ state: l, options: D, name: I, instance: h }) || l);
              }
            }
          }
        },
...
var sE = [AS, KS, RS, _S, HS, qS, XS, ES, $S],
  uE = oE({ defaultModifiers: sE }),
  es,
  nf;
function cE() {
  if (nf) return es;
    ...
    var i = b.useRef(null),
      ...
      l = b.useMemo(
        function () {
          ...
          return dE(i.current, f) ? i.current || f : ((i.current = f), f);
        },
...
function OE(e) {
  var t = e.children,
    ...
    _ = b.useMemo(
      function () {
        var w = {
            name: "preventOverflow",
            options: { padding: Ms, rootBoundary: h ? "viewport" : "document" },
          },
          O = { name: "offset", options: { offset: [p, g] } },
          m = h ? bE({ viewportPadding: Ms }) : [];
        return [].concat(yE, [w, O], Te(m));
      },
      [p, g, h],
    ),
    y = b.useMemo(
  ...
  return E.createElement(_E, { modifiers: y, placement: o, strategy: d, referenceElement: s }, r);
}
...
function LE(e) {
  ...
  return (
    ...
    Nr("platform_design_system_team_portal_logic_r18_fix")
      ? E.createElement(PE, { zIndex: r }, n)
      : o
        ? E.createElement(RE, { zIndex: r }, n)
        : null
  );
}
var ui = new Set(),
...
function zE(e) {
  ...
  function d() {
    ...
    ((t = "waiting-to-show"), uf(v, e.delay));
  }
  d();
  var f = {
    keep: o,
...
var cf = {
  ...
  qE = function (t) {
    ...
    return b.createElement(
      "div",
      { className: R([cf.shortcutSegmentsContainer]) },
      r.map(function (n, i) {
        return b.createElement(
          "kbd",
          { key: "".concat(n, "-").concat(i), className: R([cf.shortcutSegment]) },
          n,
        );
      }),
    );
  ...
  vh = b.forwardRef(function (t, r) {
    ...
    return b.createElement(
      ...
      b.createElement(
        ...
        a,
        d && b.createElement(qE, { shortcut: d }),
      ),
    );
  });
...
function GE(e) {
  var t = e.children,
    ...
    G = e.shortcut,
    $ = n === "mouse" ? a : n,
    X = hl(Ar({ fn: _, action: "displayed", analyticsData: I }, vf)),
    N = hl(Ar({ fn: w, action: "hidden", analyticsData: I }, vf)),
    j = b.useRef(null),
    _e = b.useState("hide"),
    ae = K(_e, 2),
    se = ae[0],
  ...
  (D1({ onClose: Ve, isDisabled: se === "hide" || se === "fade-out" }),
    b.useEffect(
      function () {
  ...
  var De = b.useCallback(
      function () {
        D && j.current && j.current.requestHide({ isImmediate: !0 });
      },
      [D],
    ),
    ke = b.useCallback(
    ...
    Di = b.useCallback(
      function (L) {
        try {
          if (!L.target.matches(":focus-visible") && Nr("platform-tooltip-focus-visible-new"))
            return;
        } catch {}
        $t({ type: "keyboard" });
      },
    ...
    Ya = se !== "hide" && !!o,
    pu = !J && Ya,
    hu = se !== "hide" && se !== "fade-out",
    wh = b.useCallback(function () {
      var L;
      (L = j.current) === null || L === void 0 || L.requestHide({ isImmediate: !0 });
    }, []);
  F1({ isOpen: Ya && hu, onClose: wh });
  var gu = function () {
      var re;
  ...
  return E.createElement(
    ...
    typeof t == "function"
      ...
      : E.createElement(mh, te({}, Ja, { ref: Ue, role: "presentation" }), t, bu),
    Ya
      ? E.createElement(
          LE,
          { zIndex: UE },
          E.createElement(OE, { placement: $, referenceElement: gu(), strategy: M }, function (L) {
            var re = L.ref,
              jt = L.style,
              Xa = L.update,
              Qa = L.placement,
              mr = n === "mouse" ? void 0 : $E[VE(Qa)];
            return E.createElement(
              Jp,
              { appear: !0 },
              hu &&
                  ...
                  function (Yr) {
                    ...
                    return E.createElement(
                      l,
                      {
                        ...
                        truncate: s,
                        placement: $,
                        testId: gu() ? h : h && "".concat(h, "--unresolved"),
                        onMouseOut: Vt,
                        onMouseOver: Ii,
                        shortcut: G,
                      },
...
var HE = [
  ...
  WE = ["isRanking", "refHeight", "refWidth"];
function KE(e, t, r) {
  return (
    (t = Y(t)),
...
var YE = (function (e) {
    function t() {
      return (fe(this, t), KE(this, t, arguments));
    }
    return (
      qe(t, e),
      ve(t, [
...
var ek = (function (e) {
    function t(r) {
      var n;
      return (fe(this, t), (n = ZE(this, t, [r])), (n.state = { activeSortButtonId: null }), n);
    }
    return (
      qe(t, e),
      ve(t, [
  ...
  tk = ["isRankable", "isRanking", "onRankStart", "onRankEnd", "isRankingDisabled"];
function rk(e) {
  switch (e) {
    case ga:
      return vr;
...
var nk = function (t) {
    ...
    var Oe = function (ke) {
      ...
      yr = function () {
        return X || (Yv(a || [], D, y).length > 2 ? _a : Cy);
      },
      At = function () {
...
var Ka = (function (e) {
  function t() {
    ...
    return (
      ...
      C(r, "onSetPageHandler", function (o, u) {
        var s = r.props.onSetPage;
        s && (s(o, u), r.setState({ page: o }));
      }),
      C(r, "onSortHandler", function (o, u) {
        var s = o.key,
          c = o.item,
          l = o.sortOrder,
          d = r.props.onSort;
                      ...
                      content: n.parsedPlan
                        ? x.jsx(x.Fragment, {
                            children: x.jsx("button", {
                              onClick: () => {
                                n.parsedPlan &&
                                  (e.showPlan(n.parsedPlan, n.plan), Ws.saveState("PLAN"));
                              },
                              children: "Show Plan",
                            }),
                          })
        ...
        children: [
              ...
              x.jsx("div", {
                ...
                children: x.jsxs("div", {
                  ...
                  children: [
                    ...
                    x.jsx("button", { onClick: i, children: "3. Explain Analyze" }),
                  ],
                }),
              }),
            ],
            ...
            children: [
              ...
              x.jsx("div", {
                ...
                children: x.jsxs("div", {
                  className: "button-row",
                  children: [
                    x.jsx("button", { onClick: s, children: "4. Add optimization indexes" }),
                    x.jsx("button", { onClick: o, children: "5. Execute SQL" }),
                    x.jsx("button", { onClick: r, children: "6. Explain (optional) " }),
                    x.jsx("button", { onClick: i, children: "7. Explain Analyze" }),
                  ],
                }),
              }),
            ],
            ...
            children: [
              ...
              x.jsx("div", {
                ...
                children: x.jsxs("div", {
                  className: "button-row",
                  children: [
                    x.jsx("button", { onClick: u, children: "8. Execute CTE" }),
                    x.jsx("button", { onClick: n, children: "9. Explain CTE (optional)" }),
                    x.jsx("button", { onClick: a, children: "10. Explain Analyze CTE" }),
                  ],
                }),
              }),
            ],
              ...
              x.jsx("div", {
                ...
                children: x.jsxs("div", {
                  ...
                  children: [
                    ...
                    x.jsx("button", { onClick: u, children: "10. Execute CTE" }),
                    x.jsx("button", { onClick: n, children: "11. Explain CTE (optional)" }),
                    x.jsx("button", { onClick: a, children: "12. Explain Analyze CTE" }),
                  ],
                }),
              }),
            ],
          ...
          x.jsxs("section", {
            ...
            children: [
              ...
              x.jsx("div", {
                className: "button-group",
                children: x.jsx("button", { onClick: h, children: "Analyze Slow Queries" }),
              }),
            ],
          }),
        ],
...
const fk = Na(dk),
  ...
  pk = Sh.createRoot(vk),
  hf = () => {
    pk.render(x.jsx(Gv, { ...Hv, children: x.jsx(fk, {}) }));
  };
Ce.view.theme
  .enable()
  .then(() => {
