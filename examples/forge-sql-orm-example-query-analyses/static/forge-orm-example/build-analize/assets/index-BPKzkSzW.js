const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      ...
      "./client-core-vendor-2StmuKnE.js",
      "./lodash-vendor-BOrht4Rl.js",
      "./body-BBWlFbG-.css",
    ]),
) => i.map((i) => d[i]);
var Mp = Object.defineProperty;
var Np = (e, t, r) =>
  t in e ? Mp(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (e[t] = r);
var Yt = (e, t, r) => Np(e, typeof t != "symbol" ? t + "" : t, r);
import { r as vt, a as bi, c as Fp } from "./react-dom-vendor-mZoKt2nW.js";
import { g as vs, a as _r, r as er, s as Ge } from "./client-core-vendor-2StmuKnE.js";
import { r as $p } from "./lodash-vendor-BOrht4Rl.js";
function zp(e, t) {
...
var Js;
function qp() {
  return Js || ((Js = 1), (Wi.exports = Bp())), Wi.exports;
}
var P = qp(),
  Ki = {},
  Do = function (e, t) {
...
function Bd() {
  for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(ps(arguments[t]));
  return e;
}
function qd() {
...
function Vd(e, t, r) {
  ...
  function u(v) {
    v.value instanceof Ur ? Promise.resolve(v.value.v).then(l, d) : f(i[0][2], v);
  }
  function l(v) {
    s("next", v);
  }
...
function Kd(e) {
  ...
  var t = {};
  if (e != null) for (var r = To(e), n = 0; n < r.length; n++) r[n] !== "default" && yi(t, e, r[n]);
  return Up(t, e), t;
}
function Yd(e) {
...
function ef(e) {
  function t(i) {
    (e.error = e.hasError ? new Vp(i, e.error, "An error was suppressed during disposal.") : i),
      (e.hasError = !0);
  }
  var r,
    n = 0;
...
const Gp = {
    ...
    __classPrivateFieldIn: Qd,
    __addDisposableResource: Zd,
...
function Tt() {
  if (Qs) return cn;
  (Qs = 1), Object.defineProperty(cn, "__esModule", { value: !0 }), (cn.BridgeAPIError = void 0);
...
function De() {
  if (Zs) return sn;
  (Zs = 1), Object.defineProperty(sn, "__esModule", { value: !0 }), (sn.getCallBridge = void 0);
  const e = Tt();
  function t(n) {
...
function rf() {
  if (ec) return un;
  (ec = 1), Object.defineProperty(un, "__esModule", { value: !0 }), (un.withRateLimiter = void 0);
  const e = Tt(),
    t = (r, n, a, i) => {
      let o = Date.now(),
        c = 0;
...
function Kp() {
  if (tc) return on;
  (tc = 1), Object.defineProperty(on, "__esModule", { value: !0 }), (on.invoke = void 0);
  const e = De(),
    t = Tt(),
    r = rf(),
    n = (0, e.getCallBridge)(),
...
function Yp() {
  return (
    rc ||
      ((rc = 1),
      (function (e) {
        Object.defineProperty(e, "__esModule", { value: !0 }), Wt.__exportStar(Kp(), e);
      })(Yi)),
    Yi
  );
}
...
function Jp() {
  if (nc) return ln;
  (nc = 1), Object.defineProperty(ln, "__esModule", { value: !0 }), (ln.invokeRemote = void 0);
  const e = De(),
    t = Tt(),
    r = rf(),
    n = 500,
  ...
  return (
    (ln.invokeRemote = (0, r.withRateLimiter)(
      c,
      n,
      a,
...
function Xp() {
  return (
    ac ||
      ((ac = 1),
      (function (e) {
        Object.defineProperty(e, "__esModule", { value: !0 }), Wt.__exportStar(Jp(), e);
      })(Ji)),
    Ji
  );
}
...
function Qp() {
  if (ic) return fn;
  (ic = 1), Object.defineProperty(fn, "__esModule", { value: !0 }), (fn.submit = void 0);
  const e = De(),
    t = Tt(),
    r = (0, e.getCallBridge)(),
    n = async (a) => {
...
function Zp() {
  if (oc) return vn;
  (oc = 1), Object.defineProperty(vn, "__esModule", { value: !0 }), (vn.close = void 0);
  const e = De(),
    t = Tt(),
    r = (0, e.getCallBridge)(),
    n = async (a) => {
...
function eh() {
  if (sc) return pn;
  (sc = 1), Object.defineProperty(pn, "__esModule", { value: !0 }), (pn.refresh = void 0);
  const e = De(),
    t = Tt(),
    r = (0, e.getCallBridge)(),
    n = async (a) => {
...
function nf() {
  return (
    uc ||
      ...
      (Nt.FORGE_SUPPORTED_LOCALE_CODES =
        Nt.I18N_BUNDLE_FOLDER_NAME =
        Nt.I18N_INFO_FILE_NAME =
          void 0),
      (Nt.I18N_INFO_FILE_NAME = "i18n-info.json"),
      (Nt.I18N_BUNDLE_FOLDER_NAME = "__LOCALES__"),
      (Nt.FORGE_SUPPORTED_LOCALE_CODES = [
        "zh-CN",
        "zh-TW",
        "cs-CZ",
...
function rh() {
  ...
  class r {
    constructor(a) {
      Yt(this, "resourcesAccessor");
      Yt(this, "i18nInfoConfig", null);
      Yt(this, "translationResources", new Map());
...
function nh() {
  if (fc) return bn;
  (fc = 1), Object.defineProperty(bn, "__esModule", { value: !0 }), (bn.Translator = void 0);
  const e = af();
  class t {
    constructor(n, a) {
      Yt(this, "locale");
      Yt(this, "translationsGetter");
      Yt(this, "localeLookupOrderedTranslations", null);
      Yt(this, "cache", new Map());
...
function ah() {
  if (vc) return yn;
  (vc = 1), Object.defineProperty(yn, "__esModule", { value: !0 }), (yn.ensureLocale = void 0);
  const e = nf(),
...
var to = {},
  hc;
function oh() {
  return hc || ((hc = 1), Object.defineProperty(to, "__esModule", { value: !0 })), to;
}
var gc;
function of() {
  return (
...
function sh() {
  if (bc) return gn;
  (bc = 1), Object.defineProperty(gn, "__esModule", { value: !0 }), (gn.getContext = void 0);
  const e = De(),
    t = of(),
    r = (0, e.getCallBridge)(),
    n = async () => {
...
function ch() {
  if (yc) return mn;
  (yc = 1), Object.defineProperty(mn, "__esModule", { value: !0 }), (mn.changeWindowTitle = void 0);
  const e = De(),
    t = Tt(),
    r = (0, e.getCallBridge)(),
    n = async (a) => {
...
function lh() {
  if (_c) return dn;
  (_c = 1), Object.defineProperty(dn, "__esModule", { value: !0 }), (dn.view = void 0);
  const e = Qp(),
    t = Zp(),
    r = eh(),
    n = th(),
...
function sf() {
  return (
    wc ||
      ((wc = 1),
      (function (e) {
        Object.defineProperty(e, "__esModule", { value: !0 }), Wt.__exportStar(lh(), e);
      })(Xi)),
    Xi
  );
}
...
function dh() {
  if (Oc) return wn;
  (Oc = 1), Object.defineProperty(wn, "__esModule", { value: !0 }), (wn.router = void 0);
  const t = (0, De().getCallBridge)(),
    r = async (i) => {
    ...
    a = async () => t("reload");
  return (wn.router = { navigate: r, open: n, reload: a }), wn;
}
var kc;
function fh() {
  return (
    kc ||
      ((kc = 1),
      (function (e) {
        Object.defineProperty(e, "__esModule", { value: !0 }), Wt.__exportStar(dh(), e);
      })(ro)),
    ro
  );
}
...
function vh() {
  if (Sc) return On;
  (Sc = 1), Object.defineProperty(On, "__esModule", { value: !0 }), (On.Modal = void 0);
  const e = De(),
    t = Tt(),
    r = (0, e.getCallBridge)(),
    n = () => {};
...
function gh() {
  if (Cc) return kn;
  (Cc = 1), Object.defineProperty(kn, "__esModule", { value: !0 }), (kn.productFetchApi = void 0);
  const e = hh(),
    t = async (a) => {
      const i = {};
  ...
  return (kn.productFetchApi = n), kn;
}
var Pc;
function bh() {
  if (Pc) return Ft;
...
function yh() {
  if (Rc) return Sn;
  (Rc = 1), Object.defineProperty(Sn, "__esModule", { value: !0 }), (Sn.showFlag = void 0);
  const e = De(),
    t = Tt(),
    r = (0, e.getCallBridge)(),
    n = (a) => {
...
function _h() {
  if (jc) return En;
  (jc = 1), Object.defineProperty(En, "__esModule", { value: !0 }), (En.events = void 0);
  const t = (0, De().getCallBridge)(),
    r = (a, i) => t("emit", { event: a, payload: i }),
    n = (a, i) => t("on", { event: a, callback: i });
  return (En.events = { emit: r, on: n }), En;
}
var Ic;
function wh() {
  return (
    Ic ||
      ((Ic = 1),
      (function (e) {
        Object.defineProperty(e, "__esModule", { value: !0 }), Wt.__exportStar(_h(), e);
      })(io)),
    io
  );
}
...
var uf = {};
Object.freeze(uf);
var Eh = typeof Proxy < "u",
  xh = Object.toString();
function lf() {
  Eh || Z("Proxy not available");
}
function df(e) {
  var t = !1;
  return function () {
...
function tr(e) {
  ...
  return typeof r == "function" && r.toString() === xh;
}
function ff(e) {
...
function Oi(e, t, r) {
  Ct(e, t, { enumerable: !1, writable: !0, configurable: !0, value: r });
}
function vf(e, t, r) {
  Ct(e, t, { enumerable: !1, writable: !1, configurable: !0, value: r });
}
function wr(e, t) {
  var r = "isMobX" + e;
  return (
...
var pf = typeof Object.getOwnPropertySymbols < "u";
function Ph(e) {
  var t = Object.keys(e);
  if (!pf) return t;
...
function Ah(e, t) {
  for (var r = 0; r < t.length; r++) {
    ...
    (n.enumerable = n.enumerable || !1),
      ...
      Object.defineProperty(e, Ih(n.key), n);
  }
}
function Xr(e, t, r) {
...
var xt = Symbol("mobx-stored-annotations");
function Pt(e) {
  function t(r, n) {
...
function ma(e, t, r) {
  Vt(e, xt) || Oi(e, xt, hr({}, e[xt])), zh(r) || (e[xt][t] = r);
}
function Th(e) {
  return Vt(e, xt) || Oi(e, xt, hr({}, e[xt])), e[xt];
}
function _a(e) {
...
function bf(e, t, r) {
  ...
  var n = new rr(e);
  return t !== $r && Gg(n, t), r !== $r && Ff(n, r), n;
}
function Lh(e, t) {
  return Jf(e, t);
}
...
var Za = { structural: Lh, default: Mh };
function gr(e, t, r) {
  return qf(e)
    ? e
    : Array.isArray(e)
...
function Nh(e, t, r) {
  if (e == null || ji(e) || Ai(e) || kr(e) || Et(e)) return e;
  if (Array.isArray(e)) return le.array(e, { name: r, deep: !1 });
  if (tr(e)) return le.object(e, void 0, { name: r, deep: !1 });
  if (Jr(e)) return le.map(e, { name: r, deep: !1 });
  if (qt(e)) return le.set(e, { name: r, deep: !1 });
}
function Si(e) {
  return e;
}
...
function wa(e, t) {
  return { annotationType_: e, options_: t, make_: Bh, extend_: qh, decorate_20223_: Uh };
}
function Bh(e, t, r, n) {
  var a;
...
function yf(e, t, r, n, a) {
  var i, o, c, s, u, l, d;
  a === void 0 && (a = j.safeDescriptors), Vh(e, t, r, n);
  var f = n.value;
...
function mf(e, t) {
  return { annotationType_: e, options_: t, make_: Gh, extend_: Hh, decorate_20223_: Wh };
}
function Gh(e, t, r, n) {
  var a;
  if (n === e.target_) return this.extend_(e, t, r, !1) === null ? 0 : 2;
  if (
    ...
    a.bound &&
    (!Vt(e.target_, t) || !sa(e.target_[t])) &&
    this.extend_(e, t, r, !1) === null
  )
    return 0;
  if (sa(r.value)) return 1;
  var i = _f(e, this, t, r, !1, !1);
  return Ct(n, t, i), 2;
}
function Hh(e, t, r, n) {
  var a,
    i = _f(e, this, t, r, (a = this.options_) == null ? void 0 : a.bound);
...
function _f(e, t, r, n, a, i) {
  i === void 0 && (i = j.safeDescriptors), Kh(e, t, r, n);
  var o = n.value;
  if ((sa(o) || (o = Vr(o)), a)) {
    var c;
...
function gs(e, t) {
  return { annotationType_: e, options_: t, make_: Yh, extend_: Jh, decorate_20223_: Xh };
}
function Yh(e, t, r) {
...
function Ei(e, t) {
  return { annotationType_: e, options_: t, make_: Zh, extend_: eg, decorate_20223_: tg };
}
function Zh(e, t, r) {
  return this.extend_(e, t, r, !1) === null ? 0 : 1;
}
...
var ng = "true",
  ag = wf();
function wf(e) {
  return { annotationType_: ng, options_: e, make_: ig, extend_: og, decorate_20223_: sg };
}
function ig(e, t, r, n) {
  var a, i;
  ...
  if (r.set) {
    ...
    return n === e.target_
      ? e.defineProperty_(t, {
        ...
        ? 0
        : 2
      : (Ct(n, t, { configurable: !0, set: o }), 2);
  }
  if (n !== e.target_ && typeof r.value == "function") {
    var c;
    if (ff(r.value)) {
      var s,
        u = (s = this.options_) != null && s.autoBind ? Vr.bound : Vr;
      return u.make_(e, t, r, n);
    }
    var l = (c = this.options_) != null && c.autoBind ? ia.bound : ia;
...
function og(e, t, r, n) {
  ...
  if (r.set)
    return e.defineProperty_(
      t,
      { configurable: j.safeDescriptors ? e.isPlainObject_ : !0, set: br(t.toString(), r.set) },
      n,
    );
  ...
  var c = ((i = this.options_) == null ? void 0 : i.deep) === !1 ? le.ref : le;
...
var cg = "observable",
  ug = "observable.ref",
  lg = "observable.shallow",
  dg = "observable.struct",
  Of = { deep: !0, name: void 0, defaultDecorator: void 0, proxy: !0 };
Object.freeze(Of);
function ja(e) {
  return e || Of;
}
var No = Ei(cg),
  fg = Ei(ug, { enhancer: Si }),
  vg = Ei(lg, { enhancer: Nh }),
  pg = Ei(dg, { enhancer: Fh }),
  kf = Pt(No);
function Ia(e) {
  return e.deep === !0 ? gr : e.deep === !1 ? Si : gg(e.defaultDecorator);
}
function hg(e) {
  var t;
  return e ? ((t = e.defaultDecorator) != null ? t : wf(e)) : void 0;
}
function gg(e) {
  var t, r;
...
function Sf(e, t, r) {
  if (_a(t)) return No.decorate_20223_(e, t);
  if (pr(t)) {
    ma(e, t, No);
    return;
  }
...
var bg = {
    box: function (t, r) {
      var n = ja(r);
      return new fr(t, Ia(n), n.name, !0, n.equals);
    },
    array: function (t, r) {
      var n = ja(r);
      return (j.useProxies === !1 || n.proxy === !1 ? hb : ib)(t, Ia(n), n.name);
    },
    map: function (t, r) {
      var n = ja(r);
      return new Vf(t, Ia(n), n.name);
    },
    set: function (t, r) {
      var n = ja(r);
      return new Gf(t, Ia(n), n.name);
    },
    object: function (t, r, n) {
      return Sr(function () {
        return Yg(
          j.useProxies === !1 || (n == null ? void 0 : n.proxy) === !1 ? Qr({}, n) : rb({}, n),
          t,
          r,
        );
      });
  ...
  yg = "computed.struct",
  Fo = gs(Ef),
  mg = gs(yg, { equals: Za.structural }),
  xi = function (t, r) {
    if (_a(r)) return Fo.decorate_20223_(t, r);
    if (pr(r)) return ma(t, r, Fo);
    if (tr(t)) return Pt(gs(Ef, t));
    var n = tr(r) ? r : {};
...
var Mc,
  ...
  _g = 1,
  wg =
    (Mc = (Nc = Qa(function () {}, "name")) == null ? void 0 : Nc.configurable) != null ? Mc : !1,
  Fc = { value: "action", configurable: !0, writable: !1, enumerable: !1 };
function br(e, t, r, n) {
  r === void 0 && (r = !1);
  function a() {
    return Og(e, r, t, n || this, arguments);
  }
  return (
    (a.isMobxAction = !0),
    (a.toString = function () {
...
var fr = (function (e) {
    ...
    return (
      ...
      (r.prepareNewValue_ = function (a) {
        if (Je(this)) {
          var i = Xe(this, { object: this, type: Rt, newValue: a });
          if (!i) return j.UNCHANGED;
          a = i.newValue;
        }
        return (
      ...
      (r.setNewValue_ = function (a) {
        ...
        (this.value_ = a),
          this.reportChanged(),
          ut(this) && lt(this, { type: Rt, object: this, newValue: a, oldValue: i });
      }),
      (r.get = function () {
  ...
  ft = (function () {
    function e(r) {
      (this.dependenciesState_ = ee.NOT_TRACKING_),
        ...
        (this.equals_ = r.equals || (r.compareStructural || r.struct ? Za.structural : Za.default)),
    ...
    return (
      ...
      (t.get = function () {
        ...
        else if ((If(this), $o(this))) {
          var n = j.trackingContext;
          this.keepAlive_ && !n && (j.trackingContext = this),
            this.trackAndCompute() && Rg(this),
            (j.trackingContext = n);
        }
        var a = this.value_;
        if (qa(a)) throw a.cause;
        return a;
      }),
      (t.set = function (n) {
        if (this.setter_) {
      ...
      (t.trackAndCompute = function () {
        var n = this.value_,
          ...
          o = a || qa(n) || qa(i) || !this.equals_(n, i);
      ...
      (t.computeValue_ = function (n) {
        ...
        var a = Ci(!1),
          i;
        if (n) i = xf(this, this.derivation, this.scope_);
        ...
        return Pi(a), (this.isComputing = !1), i;
      }),
      (t.suspend_ = function () {
        this.keepAlive_ || (zo(this), (this.value_ = void 0));
      }),
...
function $o(e) {
  switch (e.dependenciesState_) {
    ...
    case ee.POSSIBLY_STALE_: {
      for (var t = bs(!0), r = Or(), n = e.observing_, a = n.length, i = 0; i < a; i++) {
        var o = n[i];
        if (Ri(o)) {
          if (j.disableErrorBoundaries) o.get();
          else
            try {
              o.get();
            } catch {
          ...
          if (e.dependenciesState_ === ee.STALE_) return Gt(r), Xn(t), !0;
        }
      }
      return Pf(e), Gt(r), Xn(t), !1;
    }
  }
}
function xf(e, t, r) {
  ...
  var i;
  if (j.disableErrorBoundaries === !0) i = t.call(r);
  else
    try {
      i = t.call(r);
    } catch (o) {
  ...
  return j.inBatch--, (j.trackingDerivation = a), xg(e), Xn(n), i;
}
function xg(e) {
  for (
    var t = e.observing_,
  ...
  for (r.length = a, e.newObserving_ = null, i = t.length; i--; ) {
    var s = t[i];
    s.diffValue === 0 && Af(s, e), (s.diffValue = 0);
  }
  for (; a--; ) {
    var u = r[a];
    u.diffValue === 1 && ((u.diffValue = 0), Pg(u, e));
  }
...
var Ua = function () {
  ...
  j = (function () {
    ...
    return (
      ...
      e.__mobxGlobals && e.__mobxGlobals.version !== new Ua().version && (Va = !1),
      Va
        ? e.__mobxGlobals
...
function Cg() {
  if (((j.pendingReactions.length || j.inBatch || j.isRunningReactions) && Z(36), (Rf = !0), Va)) {
    var e = mi();
    --e.__mobxInstanceCount === 0 && (e.__mobxGlobals = void 0), (j = new Ua());
  }
}
function Pg(e, t) {
  e.observers_.add(t),
...
function Af(e, t) {
  e.observers_.delete(t), e.observers_.size === 0 && jf(e);
}
function jf(e) {
...
function If(e) {
  ...
  return t !== null
    ? (t.runId_ !== e.lastAccessedBy_ &&
      ...
      e.isBeingObserved)
    : (e.observers_.size === 0 && j.inBatch > 0 && jf(e), !1);
}
function Df(e) {
...
var It = (function () {
  ...
  return (
    ...
    (t.schedule_ = function () {
      this.isScheduled || ((this.isScheduled = !0), j.pendingReactions.push(this), Tf());
    }),
    (t.runReaction_ = function () {
      if (!this.isDisposed) {
        Qe(), (this.isScheduled = !1);
        var n = j.trackingContext;
        if (((j.trackingContext = this), $o(this))) {
    ...
    (t.track = function (n) {
      if (!this.isDisposed) {
        ...
        var i = xf(this, n, void 0);
        (j.trackingContext = a),
          (this.isRunning = !1),
          (this.isTrackPending = !1),
          this.isDisposed && zo(this),
          qa(i) && this.reportExceptionInDerivation_(i.cause),
          Ze();
      }
    }),
    (t.reportExceptionInDerivation_ = function (n) {
      ...
      j.suppressReactionErrors || console.error(i, n),
        j.globalReactionErrorHandlers.forEach(function (o) {
          return o(n, a);
        });
    }),
    (t.dispose = function () {
      this.isDisposed || ((this.isDisposed = !0), this.isRunning || (Qe(), zo(this), Ze()));
    }),
...
var Lf = "action",
  ...
  qo = wa(Lf),
  Fg = wa(Lg, { bound: !0 }),
  Uo = wa(Mf, { autoAction: !0 }),
  $g = wa(Mg, { autoAction: !0, bound: !0 });
function Nf(e) {
  var t = function (n, a) {
    if (dt(n)) return br(n.name || Ng, n, e);
    if (dt(a)) return br(n, a, e);
    if (_a(a)) return (e ? Uo : qo).decorate_20223_(n, a);
    if (pr(a)) return ma(n, a, e ? Uo : qo);
    if (pr(n)) return Pt(wa(e ? Mf : Lf, { name: n, autoAction: e }));
  };
  return t;
}
var et = Nf(!1);
...
var Hg = "never",
  ...
  Wg = "observed";
function Kg(e) {
  e.isolateGlobalState === !0 && Cg();
  var t = e.useProxies,
    r = e.enforceActions;
  if (
    (t !== void 0 && (j.useProxies = t === Da ? !0 : t === Hg ? !1 : typeof Proxy < "u"),
    t === "ifavailable" && (j.verifyProxies = !0),
    r !== void 0)
  ) {
    var n = r === Da ? Da : r === Wg;
    (j.enforceActions = n), (j.allowStateChanges = !(n === !0 || n === Da));
  }
  [
    ...
    e.reactionScheduler && Dg(e.reactionScheduler);
}
function Yg(e, t, r, n) {
  var a = Rh(t);
  return (
...
function zf(e) {
  var t = { name: e.name_ };
  return e.observing_ && e.observing_.length > 0 && (t.dependencies = Xg(e.observing_).map(zf)), t;
}
function Xg(e) {
...
var oo = mf("flow"),
  Zg = mf("flow.bound", { bound: !0 }),
  Vr = Object.assign(function (t, r) {
    if (_a(r)) return oo.decorate_20223_(t, r);
    if (pr(r)) return ma(t, r, oo);
    var n = t,
      ...
      i = function () {
        var c = this,
          s = arguments,
          u = ++Qg,
          l = et(a + " - runid: " + u + " - init", n).apply(c, s),
          d,
          f = void 0,
          v = new Promise(function (h, p) {
            ...
            function b(w) {
              ...
              var _;
              try {
                _ = et(a + " - runid: " + u + " - yield " + g++, l.next).call(l, w);
              } catch (k) {
                return p(k);
              }
              O(_);
            ...
            function m(w) {
              ...
              var _;
              try {
                _ = et(a + " - runid: " + u + " - yield " + g++, l.throw).call(l, w);
              } catch (k) {
                return p(k);
              }
              O(_);
        ...
        return (
          (v.cancel = et(a + " - runid: " + u + " - cancel", function () {
            try {
              f && $c(f);
              var h = l.return(void 0),
                p = Promise.resolve(h.value);
              p.then($r, $r), $c(p), d(new Bf());
            } catch (g) {
              d(g);
            }
          })),
...
function eb(e, t) {
  return e ? ji(e) || !!e[V] || hs(e) || ni(e) || Ri(e) : !1;
}
function qf(e) {
  return eb(e);
}
...
var tb = {
  ...
  set: function (t, r, n) {
    var a;
    return pr(r) ? ((a = xr(t).set_(r, n, !0)) != null ? a : !0) : !1;
  },
  deleteProperty: function (t, r) {
    var n;
    return pr(r) ? ((n = xr(t).delete_(r, !0)) != null ? n : !0) : !1;
  },
  defineProperty: function (t, r, n) {
    var a;
    return (a = xr(t).defineProperty_(r, n)) != null ? a : !0;
  },
  ownKeys: function (t) {
...
function rb(e, t) {
  var r, n;
  return lf(), (e = Qr(e, t)), (n = (r = e[V]).proxy_) != null ? n : (r.proxy_ = new Proxy(e, tb));
}
function Je(e) {
    ...
    return (
      ...
      (t.spliceWithArray_ = function (n, a, i) {
        ...
        if (
          ...
          var s = Xe(this, { object: this.proxy_, type: zc, index: n, removedCount: a, added: i });
          if (!s) return Lo;
        ...
        var o = !this.owned_ && Qn(),
          ...
          s =
            c || o
              ...
              : null;
        this.atom_.reportChanged(), c && lt(this, s);
      }),
      ...
      (t.set_ = function (n, a) {
        var i = this.values_;
        if ((this.legacyMode_ && n > i.length && Z(17, n, i.length), n < i.length)) {
          this.atom_;
          var o = i[n];
          if (Je(this)) {
            var c = Xe(this, { type: Rt, object: this.proxy_, index: n, newValue: a });
            if (!c) return;
            a = c.newValue;
          }
...
var ai = {
  ...
  reverse: function () {
    return j.trackingDerivation && Z(37, "reverse"), this.replace(this.slice().reverse()), this;
  },
  sort: function () {
    j.trackingDerivation && Z(37, "sort");
    var t = this.slice();
...
ue("reduceRight", Uf);
function ue(e, t) {
  typeof Array.prototype[e] == "function" && (ai[e] = t(e));
}
function qe(e) {
  return function () {
    var t = this[V];
...
var ob = wr("ObservableArrayAdministration", ms);
function Ai(e) {
  return wi(e) && ob(e[V]);
}
var sb = {},
  ...
  Vf = (function () {
    ...
    return (
      ...
      (t.has = function (n) {
        ...
        if (!i) {
          var o = (i = new fr(this.has_(n), Si, "ObservableMap.key?", !1));
      ...
      (t.set = function (n, a) {
        var i = this.has_(n);
        if (Je(this)) {
          var o = Xe(this, { type: i ? Rt : Qt, object: this, newValue: a, name: n });
          if (!o) return this;
          a = o.newValue;
        }
      ...
      (t.delete = function (n) {
        ...
        if ((this.keysAtom_, Je(this))) {
          var i = Xe(this, { type: ii, object: this, name: n });
          if (!i) return !1;
        }
        if (this.has_(n)) {
          var o = Qn(),
      ...
      (t.replace = function (n) {
        ...
        return (
          Ut(function () {
            for (
              var i = cb(n), o = new Map(), c = !1, s = zr(a.data_.keys()), u;
              !(u = s()).done;
            ...
            for (var v = zr(i.entries()), h; !(h = v()).done; ) {
              var p = h.value,
                g = p[0],
                b = p[1],
                m = a.data_.has(g);
  ...
  Gf = (function () {
    ...
    return (
      ...
      (t.delete = function (n) {
        var a = this;
        if (Je(this)) {
          var i = Xe(this, { type: ii, object: this, oldValue: n });
          if (!i) return !1;
        }
        if (this.has(n)) {
          var o = !1,
  ...
  Hf = (function () {
    ...
    return (
      ...
      (t.setObservablePropValue_ = function (n, a) {
        ...
        if (Je(this)) {
          var o = Xe(this, { type: Rt, object: this.proxy_ || this.target_, name: n, newValue: a });
          if (!o) return null;
          a = o.newValue;
        }
        if (((a = i.prepareNewValue_(a)), a !== j.UNCHANGED)) {
          var c = ut(this),
            ...
            u =
              c || s
                ...
                : null;
          i.setNewValue_(a), c && lt(this, u);
        }
        return !0;
      }),
      (t.get_ = function (n) {
        return j.trackingDerivation && !Vt(this.target_, n) && this.has_(n), this.target_[n];
      }),
      ...
      (t.has_ = function (n) {
        ...
        return (
          a ||
            ((a = new fr(n in this.target_, Si, "ObservableObject.key?", !1)),
      ...
      (t.make_ = function (n, a) {
        if ((a === !0 && (a = this.defaultAnnotation_), a !== !1)) {
          if (!(n in this.target_)) {
            var i;
            if ((i = this.target_[xt]) != null && i[n]) return;
      ...
      (t.delete_ = function (n, a) {
        ...
        if (Je(this)) {
          var i = Xe(this, { object: this.proxy_ || this.target_, name: n, type: Vc });
          if (!i) return null;
        }
        try {
          var o;
          ...
          if (!u && (c || s)) {
            var d;
            l = (d = Qa(this.target_, n)) == null ? void 0 : d.value;
          }
          if (a) {
            if (!Reflect.deleteProperty(this.target_, n)) return !1;
          } else delete this.target_[n];
          if (
            (u && (this.values_.delete(n), u instanceof fr && (l = u.value_), Df(u)),
...
function Qr(e, t) {
  ...
  var n = (r = t == null ? void 0 : t.name) != null ? r : "ObservableObject",
    a = new Hf(e, new Map(), String(n), hg(t));
  return Oi(e, V, a), e;
}
var lb = wr("ObservableObjectAdministration", Hf);
function Gc(e) {
  return (
    Uc[e] ||
    (Uc[e] = {
...
function ji(e) {
  return wi(e) ? lb(e[V]) : !1;
}
function Hc(e, t, r) {
  var n;
  (n = e.target_[xt]) == null || delete n[r];
}
var db = Kf(0),
  fb = (function () {
    var e = !1,
    ...
    return (
      ...
      Sr(function () {
        ...
        (s.proxy_ = c),
          ...
          fb && Object.defineProperty(c, "0", db);
      }),
      c
    );
  }
...
Object.entries(ai).forEach(function (e) {
  var t = e[0],
    r = e[1];
  t !== "concat" && Oi(_s.prototype, t, r);
});
function Kf(e) {
  return {
    enumerable: !1,
...
function pb(e) {
  Ct(_s.prototype, "" + e, Kf(e));
}
function Yf(e) {
  if (e > so) {
    for (var t = so; t < e + 100; t++) pb(t);
    so = e;
  }
}
Yf(1e3);
...
function oi(e, t) {
  if (typeof e == "object" && e !== null) {
    if (Ai(e)) return t !== void 0 && Z(23), e[V].atom_;
    if (Et(e)) return e.atom_;
    if (kr(e)) {
      if (t === void 0) return e.keysAtom_;
      var r = e.data_.get(t) || e.hasMap_.get(t);
      return r || Z(25, t, Vo(e)), r;
    }
    if (ji(e)) {
      if (!t) return Z(26);
      var n = e[V].values_.get(t);
      return n || Z(27, t, Vo(e)), n;
    }
    if (hs(e) || Ri(e) || ni(e)) return e;
  } else if (dt(e) && ni(e[V])) return e[V];
  Z(28);
}
function gb(e, t) {
  if ((e || Z(29), hs(e) || Ri(e) || ni(e) || kr(e) || Et(e))) return e;
  if (e[V]) return e[V];
  Z(24, e);
}
function Vo(e, t) {
  var r;
  if (t !== void 0) r = oi(e, t);
  else {
    if (oa(e)) return e.name;
    ji(e) || kr(e) || Et(e) ? (r = gb(e)) : (r = oi(e));
  }
  return r.name_;
}
function Sr(e) {
...
function Go(e, t, r, n, a) {
  ...
  if (!c) {
    ...
    if (
      s !== u &&
      !(dt(s) && s instanceof s && dt(u) && u instanceof u) &&
      "constructor" in e &&
      "constructor" in t
    )
      return !1;
  ...
  if ((n.push(e), a.push(t), c)) {
    ...
    for (; l--; ) if (!Go(e[l], t[l], r - 1, n, a)) return !1;
  } else {
    var d = Object.keys(e),
      f = d.length;
    ...
    for (var v = 0; v < f; v++) {
      var h = d[v];
      if (!(Vt(t, h) && Go(e[h], t[h], r - 1, n, a))) return !1;
    }
  }
  return n.pop(), a.pop(), !0;
}
function Kc(e) {
  return Ai(e) ? e.slice() : Jr(e) || kr(e) || qt(e) || Et(e) ? Array.from(e.entries()) : e;
}
var Yc,
  bb = ((Yc = mi().Iterator) == null ? void 0 : Yc.prototype) || {};
function ws(e) {
  return (e[Symbol.iterator] = yb), Object.assign(Object.create(bb), e);
}
function yb() {
  return this;
}
...
typeof __MOBX_DEVTOOLS_GLOBAL_HOOK__ == "object" &&
  __MOBX_DEVTOOLS_GLOBAL_HOOK__.injectMobx({ spy: Tg, extras: { getDebugName: Vo }, $mobx: V });
var y = vt();
const S = _r(y),
  Jc = zp({ __proto__: null, default: S }, [y]);
if (!y.useState) throw new Error("mobx-react-lite requires React with Hooks support");
if (!ys) throw new Error("mobx-react-lite@3 requires mobx at least version 6 to be available");
function mb(e) {
  e();
}
function _b(e) {
  e || (e = mb), Kg({ reactionScheduler: e });
}
function wb(e) {
  return Jg(e);
}
  ...
  Sb = (function () {
    function e(t) {
      ...
      Object.defineProperty(this, "finalize", {
        ...
        Object.defineProperty(this, "sweep", {
          ...
          writable: !0,
          value: function (n) {
            n === void 0 && (n = Ob), clearTimeout(r.sweepTimeout), (r.sweepTimeout = void 0);
            var a = Date.now();
    ...
    return (
      ...
      Object.defineProperty(e.prototype, "scheduleSweep", {
        ...
        writable: !0,
        value: function () {
          this.sweepTimeout === void 0 && (this.sweepTimeout = setTimeout(this.sweep, kb));
        },
      }),
      e
    );
  })(),
  Eb = typeof FinalizationRegistry < "u" ? FinalizationRegistry : Sb,
  ca = new Eb(function (e) {
    var t;
...
function xb() {
  ...
  var l =
    ...
    typeof window.document.createElement > "u"
      ...
      : c;
  return (
    (uo.useSyncExternalStore = e.useSyncExternalStore !== void 0 ? e.useSyncExternalStore : l), uo
  );
}
var Qc;
function Cb() {
  return Qc || ((Qc = 1), (co.exports = xb())), co.exports;
}
var Pb = Cb();
function Zc(e) {
...
function Rb(e, t) {
  ...
  var a = r.current;
  a.reaction || (Zc(a), ca.register(r, a, a)),
    S.useDebugValue(a.reaction, wb),
    Pb.useSyncExternalStore(a.subscribe, a.getSnapshot, a.getSnapshot);
  var i, o;
  if (
...
var lo,
  fo,
  Xf = typeof Symbol == "function" && Symbol.for,
  Ab =
    (fo =
      (lo = Object.getOwnPropertyDescriptor(function () {}, "name")) === null || lo === void 0
        ? void 0
        : lo.configurable) !== null && fo !== void 0
      ? fo
      : !1,
  eu = Xf
...
function jb(e, t) {
  ...
  return (
    ...
    Ab && Object.defineProperty(o, "name", { value: e.name, writable: !0, configurable: !0 }),
...
var Ib = { $$typeof: !0, render: !0, compare: !0, type: !0, displayName: !0 };
function Db(e, t) {
  Object.keys(e).forEach(function (r) {
    Ib[r] || Object.defineProperty(t, r, Object.getOwnPropertyDescriptor(e, r));
  });
}
var vo;
_b(bi.unstable_batchedUpdates);
vo = ca.finalizeAllImmediately;
function Tb(e, t) {
  if (ru(e, t)) return !0;
  ...
  for (var a = 0; a < r.length; a++)
    if (!Object.hasOwnProperty.call(t, r[a]) || !ru(e[r[a]], t[r[a]])) return !1;
  return !0;
}
function ru(e, t) {
  return e === t ? e !== 0 || 1 / e === 1 / t : e !== e && t !== t;
}
var nu = Symbol("patchMixins"),
  Qf = Symbol("patchedDefinition");
function Lb(e, t) {
  var r = (e[nu] = e[nu] || {}),
    n = (r[t] = r[t] || {});
...
function iu(e, t) {
  var r = function () {
    for (var a = arguments.length, i = new Array(a), o = 0; o < a; o++) i[o] = arguments[o];
    au.call.apply(au, [this, e, t].concat(i));
  };
  return r;
}
function Mb(e, t, r) {
  ...
  if (!(a && a[Qf])) {
    var i = e[t],
      o = Zf(e, t, a ? a.enumerable : void 0, n, i);
...
var ou = Symbol("ObserverAdministration"),
  su = Symbol("isMobXReactObserver");
function Ho(e) {
  var t;
  return (t = e[ou]) != null
    ? t
...
function Nb(e) {
  ...
  if (e.__proto__ !== y.PureComponent) {
    if (!t.shouldComponentUpdate) t.shouldComponentUpdate = cu;
    else if (t.shouldComponentUpdate !== cu)
      throw new Error(
  ...
  return (
    ...
    Mb(t, "componentWillUnmount", function () {
      var o,
        c = Ho(this);
...
function Fb(e) {
  var t = e.bind(this),
    r = Ho(this);
  function n() {
    r.reaction || ((r.reaction = $b(r)), r.mounted || ca.register(this, r, this));
    var a = void 0,
      i = void 0;
    if (
...
function cu(e, t) {
  return this.state !== t ? !0 : !Tb(this.props, e);
}
function Ii(e, t) {
  return (
    e.isMobxInjector === !0 &&
...
function ev(e) {
  var t = e.children,
    ...
    a = S.useRef(Ko({}, n, r)),
    i = a.current;
  return S.createElement(uu.Provider, { value: i }, t);
}
ev.displayName = "MobXProvider";
S.version.split(".")[0];
...
var qb = Object.defineProperty,
  ...
  Lt = (e, t, r, n) => {
    for (var a = n > 1 ? void 0 : n ? Ub(t, r) : t, i = e.length - 1, o; i >= 0; i--)
      (o = e[i]) && (a = (n ? o(t, r, a) : o(a)) || a);
    return n && a && qb(t, r, a), a;
  };
class ht {
  constructor() {
    (this.isLoading = !1), ys(this);
  }
  showPlan(t, r) {
...
Lt([le], ht.prototype, "isLoading", 2);
Lt([le], ht.prototype, "plan", 2);
Lt([le], ht.prototype, "planString", 2);
Lt([le], ht.prototype, "slowQueries", 2);
Lt([le], ht.prototype, "history", 2);
Lt([et.bound], ht.prototype, "showPlan", 1);
Lt([et.bound], ht.prototype, "saveSlowQuery", 1);
Lt([et.bound], ht.prototype, "saveHistory", 1);
Lt([et], ht.prototype, "loading", 1);
Lt([et], ht.prototype, "stopLoading", 1);
const Vb = new ht();
var Gb = Object.defineProperty,
  Hb = Object.getOwnPropertyDescriptor,
  Os = (e, t, r, n) => {
    for (var a = n > 1 ? void 0 : n ? Hb(t, r) : t, i = e.length - 1, o; i >= 0; i--)
      (o = e[i]) && (a = (n ? o(t, r, a) : o(a)) || a);
    return n && a && Gb(t, r, a), a;
  };
class Di {
  constructor() {
    (this.state = "ROOT"), (this.lastState = "ROOT"), ys(this);
  }
  saveState(t) {
    (this.lastState = this.state), (this.state = t);
  }
}
Os([le], Di.prototype, "state", 2);
Os([le], Di.prototype, "lastState", 2);
Os([et.bound], Di.prototype, "saveState", 1);
const ks = new Di();
class Wb {
  constructor() {
    (this.usersStore = Vb), (this.stateStore = ks);
  }
}
const tv = new Wb(),
  Kb = y.createContext(tv),
  Ti = () => y.useContext(Kb);
function pe(e, t) {
...
function dy(e, t, r) {
  return (t = X(t)), Te(e, ov() ? Reflect.construct(t, r || [], X(e).constructor) : t.apply(e, r));
}
function ov() {
  try {
    ...
    he(t, [
      {
        key: "update",
        value: function (n) {
          return this.hasFired ? this : fy(t, "update", this, 3)([n]);
        },
      },
    ])
  );
})(oy);
function pu(e, t, r, n, a, i, o) {
  try {
    var c = e[i](o),
      s = c.value;
  } catch (u) {
    ...
    gu ||
      ...
      (function (e) {
        ...
        function r() {
          ...
          function v(R, E, D) {
            try {
              return { type: "normal", arg: R.call(E, D) };
            } catch (I) {
          ...
          function M(R, E) {
            ...
            if (I === n)
              return (
                ...
                (D === "throw" &&
                  R.i.return &&
                  ((E.method = "return"), (E.arg = n), M(R, E), E.method === "throw")) ||
                  (D !== "return" &&
                    ((E.method = "throw"),
                    (E.arg = new TypeError("The iterator does not provide a '" + D + "' method")))),
                h
              );
            var N = v(I, R.i, E.arg);
            if (N.type === "throw")
            ...
            if (R != null) {
              ...
              if (!isNaN(R.length)) {
                var D = -1,
                  I = function N() {
                    for (; ++D < R.length; )
                      if (o.call(R, D)) return (N.value = R[D]), (N.done = !1), N;
          ...
          return (
            ...
            (a.mark = function (R) {
              return (
                Object.setPrototypeOf
                  ...
                  : ((R.__proto__ = b), d(R, l, "GeneratorFunction")),
            ...
            (a.AsyncIterator = x),
            (a.async = function (R, E, D, I, N) {
              N === void 0 && (N = Promise);
              var z = new x(f(R, E, D, I), N);
              return a.isGeneratorFunction(E)
                ? z
                : z.next().then(function (A) {
                    return A.done ? A.value : z.next();
                  });
            }),
            k(_),
            d(_, l, "Generator"),
            ...
            (a.keys = function (R) {
              var E = Object(R),
                D = [];
              for (var I in E) D.unshift(I);
              return function N() {
                for (; D.length; ) if ((I = D.pop()) in E) return (N.value = I), (N.done = !1), N;
                return (N.done = !0), N;
              };
            }),
            (a.values = W),
            (B.prototype = {
              ...
              reset: function (E) {
                if (
                  ...
                  for (var D in this)
                    D.charAt(0) === "t" && o.call(this, D) && !isNaN(+D.slice(1)) && (this[D] = n);
              },
              stop: function () {
                this.done = !0;
              ...
              dispatchException: function (E) {
                ...
                var D = this;
                function I(ie) {
                  (A.type = "throw"), (A.arg = E), (D.next = ie);
                }
                for (var N = D.tryEntries.length - 1; N >= 0; --N) {
                  var z = this.tryEntries[N],
                    A = z[4],
                    K = this.prev,
                    q = z[1],
                    G = z[2];
                  if (z[0] === -1) return I("end"), !1;
                  if (!q && !G) throw Error("try statement without catch or finally");
                  if (z[0] != null && z[0] <= K) {
                    if (K < q) return (this.method = "next"), (this.arg = n), I(q), !0;
                    if (K < G) return I(G), !1;
                  }
                }
              },
              abrupt: function (E, D) {
                ...
                z && (E === "break" || E === "continue") && z[0] <= D && D <= z[2] && (z = null);
                var A = z ? z[4] : {};
                return (
                  (A.type = E),
                  (A.arg = D),
                  z ? ((this.method = "next"), (this.next = z[2]), h) : this.complete(A)
                );
              },
                  ...
                  E.type === "break" || E.type === "continue"
                    ...
                    : E.type === "return"
                      ? ((this.rval = this.arg = E.arg),
                        (this.method = "return"),
                        (this.next = "end"))
                      : E.type === "normal" && D && (this.next = D),
                  h
                );
              },
              finish: function (E) {
                for (var D = this.tryEntries.length - 1; D >= 0; --D) {
                  var I = this.tryEntries[D];
                  if (I[2] === E) return this.complete(I[4], I[3]), L(I), h;
                }
              },
              catch: function (E) {
                for (var D = this.tryEntries.length - 1; D >= 0; --D) {
              ...
              delegateYield: function (E, D, I) {
                return (
                  (this.delegate = { i: W(E), r: D, n: I }),
...
function yy() {
  if (yu) return Ta;
  (yu = 1), Object.defineProperty(Ta, "__esModule", { value: !0 });
  const e = er();
  let t = class {
    constructor(n) {
      (this._sdkKey = n),
...
function my() {
  ...
  (mu = 1),
    ...
    (xn._resolveDeltasResponse = void 0);
  const e = er(),
    t = 2;
  function r(o, c) {
...
function _y() {
  ...
  (wu = 1),
    ...
    (Cn._makeParamStoreGetter = void 0);
  const e = er(),
  ...
  return (Cn._makeParamStoreGetter = u), Cn;
}
var cr = {},
  Ou;
function wy() {
                ...
                if (k !== r) {
                  ...
                  for (var M in x) {
                    ...
                    L instanceof Function ||
                      typeof L != "object" ||
                      L === null ||
                      (Object.keys(L).length > 0 && _(k[$]),
                      Object.keys(L).length === 0 && delete k[$]);
                  }
                }
              }
...
var La = "@all-features",
  xy = (function () {
    function e() {
      pe(this, e), C(this, "eventToValue", new Map()), (this.emitter = new Ey.EventEmitter2());
    }
    return he(e, [
      {
        key: "onGateUpdated",
        value: function (r, n, a, i) {
          var o = this,
            c = a(r, Jt(Jt({}, i), {}, { fireGateExposure: !1 }));
          this.eventToValue.get(n) === void 0 && this.eventToValue.set(n, c);
          var s = function () {
            var l = a(r, Jt(Jt({}, i), {}, { fireGateExposure: !1 })),
      ...
      },
      {
        ...
        value: function (r, n, a, i, o, c) {
          var s = this,
            u = "".concat(r, ".").concat(n),
            l = o(r, n, a, Jt(Jt({}, c), {}, { fireExperimentExposure: !1 }));
          this.eventToValue.get(i) === void 0 && this.eventToValue.set(i, l);
          var d = function () {
            var v = o(r, n, a, Jt(Jt({}, c), {}, { fireExperimentExposure: !1 })),
...
var Ma = function (t) {
    return ui({ perimeter: Py() ? la.FEDRAMP_MODERATE : la.COMMERCIAL }, t);
  },
  Pn = function (t, r) {
    if (!t && !r) return !0;
    if (!t || !r) return !1;
  ...
  Pu = function (t, r, n) {
    var a = {
      customIDs: !(r != null && r.stableID) && n ? ui({ stableID: Ot.StableID.get(n) }, t) : t,
      custom: r,
    };
  ...
  jy = Object.entries(Ss).map(function (e) {
    var t = te(e, 2),
      r = t[0],
      n = t[1];
...
function Dy(e, t, r) {
  if (uv()) return Reflect.construct.apply(null, arguments);
  var n = [null];
  n.push.apply(n, t);
...
function Xo(e) {
  ...
  return (
    (Xo = function (n) {
      ...
      function a() {
        return Dy(n, arguments, X(this).constructor);
      }
      return (
...
function Ty(e, t, r) {
  return (t = X(t)), Te(e, lv() ? Reflect.construct(t, r || [], X(e).constructor) : t.apply(e, r));
}
function lv() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
...
var My = 5e3,
  ...
  Fy = "https://api.stg.atlassian.com/flags",
  $y = "https://api.dev.atlassian.com/flags",
  zy = "https://api.stg.atlassian-us-gov-mod.com/flags",
  By = "https://api.atlassian-us-gov-mod.com/flags",
                ...
                for (;;)
                  switch ((c.prev = c.next)) {
                    ...
                    case 5:
                      ...
                      throw new ju("Unexpected 204 response");
                    case 7:
                    case "end":
                      return c.stop();
                  }
...
function Uy(e, t, r) {
  return (t = X(t)), Te(e, dv() ? Reflect.construct(t, r || [], X(e).constructor) : t.apply(e, r));
}
function dv() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
...
var Gy = (function (e) {
  function t() {
    ...
    return (
      pe(this, t),
      (r = Uy(this, t, ["NoFetchDataAdapter", "nofetch"])),
    ...
    he(t, [
      ...
      },
      {
        ...
        value: function (n) {
          return (
            this.bootstrapResult &&
            Rn(Rn({}, this.bootstrapResult), {}, { fullUserHash: Ot._getFullUserHash(n) })
          );
        },
      },
      {
...
var _o = "LocalOverride:Recognized",
  Ky = "STATSIG_OVERRIDES",
  Mu = "STATSIG_JS_LITE_LOCAL_OVERRIDES",
  Rr = function () {
    ...
    return he(e, [
          ...
          for (var a = 0, i = Object.entries(n); a < i.length; a++)
            for (
              ...
              var d = te(l[u], 2),
                f = d[0],
                v = d[1];
              this._djb2Map.set(He(Ge._DJB2(f), c), v);
            }
          this._overrides = n;
        },
      },
      ...
      },
      {
        ...
        value: function (r, n) {
          ...
          return i == null
            ? null
            : xe(xe({}, r), {}, { value: i, details: xe(xe({}, r.details), {}, { reason: _o }) });
        },
      },
      {
          ...
          return i == null
            ...
            : xe(
                ...
                {},
                {
                  ...
                  details: xe(xe({}, r.details), {}, { reason: _o }),
                },
              );
        },
      },
  ...
  Jy = ["sdkKey", "environment", "updateUserCompletionCallback", "perimeter"];
function Nu(e, t) {
  var r = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e);
...
var Fu = "client-default-key",
  Xy = "https://xp.atlassian.com/v1/rgstr",
  Qy = (function () {
    function e() {
      var t = this,
      ...
      pe(this, e),
        ...
        C(this, "dataAdapter", new Gy()),
        C(this, "statsigValuesUpdated", function () {
          t.user && t.statsigClient.updateUserSync(t.user, { disableBackgroundCacheRefresh: !0 }),
            t.subscriptions.anyUpdated();
        }),
        (this.overrideAdapter = i || new Yy(a));
    }
    return he(e, [
      {
        key: "initialize",
                ...
                function (d) {
                  for (;;)
                    switch ((d.prev = d.next)) {
                      case 0:
                        if (((s = Ma(a)), !this.initPromise)) {
                          d.next = 4;
                          break;
                        }
                        return (
                          Pn(s, this.initOptions) ||
                            console.warn(
        ...
        value: function (r, n, a, i) {
          ...
          (o = this.initOptions.analyticsWebClient) === null ||
            ...
            o
              ...
              .catch(function (u) {
                c.initOptions.environment !== Wn.Production &&
                    ...
                    switch ((l.prev = l.next)) {
                      case 0:
                        return (
                          ...
                          (c = Ma(a)),
                          (s = function () {
                            return mo.fetchExperimentValues(c, i, o).then(function (f) {
        ...
        value: function (r) {
          ...
          try {
            ...
            return (
              ...
              new Ru(r, {}, "", { time: Date.now(), reason: Ss.Error })
            );
          }
        },
      },
                ...
                function (b) {
                  for (;;)
                    switch ((b.prev = b.next)) {
                      case 0:
                        return (
                          (s = Xt(Xt({}, a), {}, { disableCurrentPageLogging: !0 })),
                          (b.prev = 1),
                          (b.next = 4),
                          i.setProfile(a, o, c)
                        );
                    ...
                    switch ((g.prev = g.next)) {
                      case 0:
                        return (
                          ...
                          (g.prev = 12),
                          (this.statsigClient = new Ot.StatsigClient(l, this.user, v)),
                      ...
                      case 19:
                        return (
                          ...
                          (this.statsigClient = new Ot.StatsigClient(Fu, this.user, v)),
                ...
                function (b) {
                  for (;;)
                    switch ((b.prev = b.next)) {
                      ...
                      case 4:
                        (u = b.sent),
                          (l = Pu(i, u.customAttributesFromFetch, this.sdkKey)),
                          (b.next = 13);
                        break;
                      case 8:
                        throw (
        ...
        value: function (r) {
          ...
          try {
            ...
            var a = n.fireLayerExposure,
              i = a === void 0 ? !0 : a;
            return Au.fromLayer(this.statsigClient.getLayer(r, { disableExposureLog: !i }));
          } catch (o) {
            return (
              ...
              Au.fromLayer(Ot._makeLayer(r, { reason: "Error" }, null))
            );
          }
        },
      },
...
C(Y, "initializeCalled", F.client.initializeCalled.bind(F.client));
C(Y, "initializeCompleted", F.client.initializeCompleted.bind(F.client));
C(Y, "initialize", F.client.initialize.bind(F.client));
C(Y, "initializeWithProvider", F.client.initializeWithProvider.bind(F.client));
C(Y, "initializeFromValues", F.client.initializeFromValues.bind(F.client));
C(Y, "manuallyLogGateExposure", F.client.manuallyLogGateExposure.bind(F.client));
C(Y, "getExperiment", F.client.getExperiment.bind(F.client));
C(Y, "manuallyLogExperimentExposure", F.client.manuallyLogExperimentExposure.bind(F.client));
C(Y, "manuallyLogLayerExposure", F.client.manuallyLogLayerExposure.bind(F.client));
C(Y, "shutdownStatsig", F.client.shutdownStatsig.bind(F.client));
C(Y, "overrideGate", F.client.overrideGate.bind(F.client));
C(Y, "clearGateOverride", F.client.clearGateOverride.bind(F.client));
C(Y, "overrideConfig", F.client.overrideConfig.bind(F.client));
C(Y, "clearConfigOverride", F.client.clearConfigOverride.bind(F.client));
C(Y, "setOverrides", F.client.setOverrides.bind(F.client));
C(Y, "getOverrides", F.client.getOverrides.bind(F.client));
C(Y, "clearAllOverrides", F.client.clearAllOverrides.bind(F.client));
C(Y, "isCurrentUser", F.client.isCurrentUser.bind(F.client));
C(Y, "onGateUpdated", F.client.onGateUpdated.bind(F.client));
C(Y, "onExperimentValueUpdated", F.client.onExperimentValueUpdated.bind(F.client));
C(Y, "onAnyUpdated", F.client.onAnyUpdated.bind(F.client));
C(Y, "updateUser", F.client.updateUser.bind(F.client));
C(Y, "updateUserWithProvider", F.client.updateUserWithProvider.bind(F.client));
C(Y, "updateUserWithValues", F.client.updateUserWithValues.bind(F.client));
C(Y, "getPackageVersion", F.client.getPackageVersion.bind(F.client));
C(Y, "getLayer", F.client.getLayer.bind(F.client));
C(Y, "getLayerValue", F.client.getLayerValue.bind(F.client));
var Qo = Y;
if (typeof window < "u")
  if (window.__FEATUREGATES_JS__ === void 0) window.__FEATUREGATES_JS__ = Y;
    ...
    var $u =
      ((Na = Qo) === null || Na === void 0 || (wo = Na.getPackageVersion) === null || wo === void 0
        ? void 0
        : wo.call(Na)) || "4.10.0 or earlier";
    if ($u !== Br) {
      var Zy = `Multiple versions of FeatureGateClients found on the current page.
      The currently bound version is `
        .concat($u, " when module version ")
...
var Ar,
  ...
  rm = function () {
    var t;
    tm && (t = console).debug.apply(t, arguments);
  },
  Es = {},
  nm = "@atlaskit/platform-feature-flags",
  Zn = "__PLATFORM_FEATURE_FLAGS__",
  fv = typeof process < "u" && typeof Es < "u",
  am = fv ? Es.ENABLE_PLATFORM_FF === "true" : !1,
  im = fv ? Es.STORYBOOK_ENABLE_PLATFORM_FF === "true" : !1,
  om = am || im,
  sm = { booleanResolver: void 0 },
...
function cm(e) {
  ...
  try {
    var t, r, n;
    if (
      ((t = ea[Zn]) === null || t === void 0 ? void 0 : t.booleanResolver) === void 0 ||
      ((r = ea[Zn]) === null || r === void 0 ? void 0 : r.booleanResolver) === null
    )
      return Qo.checkGate(e);
    var a = (n = ea[Zn]) === null || n === void 0 ? void 0 : n.booleanResolver(e);
...
function fm(e, t) {
  var r = y.useState(function () {
    ...
    n = y.useRef(!0),
    a = y.useRef(r),
    i = n.current || !!(t && a.current.inputs && dm(t, a.current.inputs)),
    ...
    f = y.useCallback(
      function (v) {
        var h = u({
          ...
          p = pm({ componentName: n, packageName: i, packageVersion: o }, l.current);
        h.context.push(p);
        var g = h.clone();
    ...
    d = y.useCallback(
      function () {
        var f = s({
          ...
          v = hm({ componentName: n, packageName: a, packageVersion: i }, u.current);
        f.context.push(v);
        var h = f.clone();
...
function T(e) {
  ...
  for (const n of e) {
    ...
    const a = n.split(" ");
    for (const i of a) {
      const o = i.startsWith("_") ? i.slice(0, bm) : i;
      t[o] = i;
    }
  }
  let r = "";
...
var Uu = "#FF5630",
  ...
  We = "#253858",
  dr = "#172B4D",
  An = "rgba(9, 30, 66, 0.04)",
  es = "rgba(9, 30, 66, 0.08)",
  iS = "rgba(9, 30, 66, 0.25)",
  oS = "rgba(9, 30, 66, 0.31)",
  st = "#9FB0CC",
  Om = "#8C9CB8",
  Oo = "#67758F",
  jn = "#3B475C",
  ...
  In = "#1B2638",
  Lr = "#0D1424",
  km = ["isFixedSize", "hasDataRow", "children", "testId", "isLoading"];
function Qu(e, t) {
  var r = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e);
...
var Sm = y.forwardRef(function (e, t) {
    var r = e.isFixedSize,
      n = e.hasDataRow,
      a = e.children,
      i = e.testId,
    ...
    return y.createElement(
      ...
      J({ inert: o ? "" : void 0, ref: t }, c, {
        ...
        style: Zu(
          ...
          {},
          { "--_k02y3n": Ye("2px solid ".concat("var(--ds-border, ".concat(Zo, ")"))) },
        ),
      }),
      a,
    );
  ...
  Rm = ["rows", "head", "sortKey", "sortOrder", "rowsPerPage", "page", "forwardedRef"];
function el(e, t) {
  var r = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e);
...
function Am(e, t, r) {
  return (t = X(t)), Te(e, gv() ? Reflect.construct(t, r || [], X(e).constructor) : t.apply(e, r));
}
function gv() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
...
function Im(e) {
  var t = (function (r) {
    function n() {
      ...
      return (a = Am(this, n, [].concat(o))), C(a, "state", { pageRows: [] }), a;
    }
    return (
      Le(n, r),
      he(
        ...
        [
          {
            ...
            value: function (i, o) {
              ...
              var h, p;
              return (
                v ? ((h = c), (p = c)) : ((h = jm(s, c, u, l) || []), (p = av(h, d, f))),
                tl(tl({}, o), {}, { pageRows: p })
              );
            },
          },
...
var Dm = "--local-dynamic-table-width",
  bv = function (t) {
    var r = t.width;
    return typeof r < "u" ? C({}, Dm, "".concat(r, "%")) : void 0;
  },
  Tm = ["width", "isFixedSize", "shouldTruncate", "innerRef"],
  Lm = function (t) {
    var r = t.width,
      n = t.isFixedSize,
      a = t.shouldTruncate,
  ...
  Mm = ["isHighlighted", "children", "style", "testId", "className"];
function nl(e, t) {
  var r = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e);
...
var Nm = y.forwardRef(function (e, t) {
...
function Bm(e, t, r) {
  return (t = X(t)), Te(e, yv() ? Reflect.construct(t, r || [], X(e).constructor) : t.apply(e, r));
}
function yv() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
...
var qm = (function (e) {
    function t() {
      return pe(this, t), Bm(this, t, arguments);
    }
    return (
      Le(t, e),
      he(t, [
  ...
  Um = Im(
    S.forwardRef(function (e, t) {
      return S.createElement(qm, J({}, e, { forwardedRef: t }));
    }),
  );
function Vm(e, t, r) {
  return (t = X(t)), Te(e, mv() ? Reflect.construct(t, r || [], X(e).constructor) : t.apply(e, r));
}
function mv() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
...
var Gm = (function (e) {
  function t(r) {
    var n;
    return pe(this, t), (n = Vm(this, t, [r])), (n.state = { hasError: !1 }), n;
  }
  return (
    Le(t, e),
    he(
...
const xs = y.createContext(null);
var Hm = { xsmall: 8, small: 16, medium: 24, large: 48, xlarge: 96 };
function Wm(e) {
  return e === "inherit"
...
var Fa = {
  ...
  Km = typeof window > "u" ? y.useEffect : y.useLayoutEffect,
  _v = S.memo(
      ...
      return (
        ...
        S.createElement(
          "span",
          {
            ...
            className: T([Fa.wrapperStyles, Fa.rotateStyles]),
          },
          S.createElement(
            "svg",
            {
  ...
  Jm = function (t) {
    ...
    return y.createElement(
      "div",
      {
        ...
        style: ol(ol({}, C({}, sl, n)), {}, { "--_cnddr8": Ye("var(".concat(sl, ")")) }),
      },
      r,
    );
  },
...
function Qm(e, t, r) {
  return (t = X(t)), Te(e, wv() ? Reflect.construct(t, r || [], X(e).constructor) : t.apply(e, r));
}
function wv() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
...
var Ov = (function (e) {
  function t() {
    return pe(this, t), Qm(this, t, arguments);
  }
  return (
    Le(t, e),
    he(t, [
      {
        ...
        value: function () {
          ...
          return S.createElement(
            Ym,
            { testId: s },
            i ? S.createElement(Jm, { contentsOpacity: c, testId: s }, a) : a,
            i &&
              S.createElement(
                Xm,
                { testId: s },
...
var Zm = ["children", "testId"],
  e_ = y.forwardRef(function (e, t) {
    var r = e.children,
      n = e.testId,
      a = se(e, Zm);
    return y.createElement(
      "div",
      J({}, a, { "data-testid": n, ref: t, className: T(["_kqswh2mm _6rth1ejb"]) }),
      r,
    );
  }),
  t_ = function (t) {
  ...
  r_ = y.forwardRef(function (e, t) {
    var r = e.children;
    return y.createElement("div", { ref: t, className: T(["_kqswh2mm _152tidpf"]) }, r);
  });
function n_(e, t, r) {
  return (t = X(t)), Te(e, kv() ? Reflect.construct(t, r || [], X(e).constructor) : t.apply(e, r));
}
function kv() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
...
C(Sv, "defaultProps", {
  isLoading: !0,
  spinnerSize: fi,
  contentsOpacity: "var(--ds-opacity-loading, ".concat("".concat(pv), ")"),
  loadingLabel: "Loading table",
});
function a_(e) {
  var t =
...
var Dn = {},
  Tn = {},
  i_ = { none: "_1bsbpxbi _4t3ipxbi", compact: "", spacious: "_1bsb1ejb _4t3i1ejb" },
  o_ = {
    none: "_1bsbutpp _4t3iutpp",
    compact: "_1bsbpxbi _4t3ipxbi",
    spacious: "_1bsb1ejb _4t3i1ejb",
  },
  s_ = { core: 16, utility: 12 },
  cl = { core: { none: 0, spacious: 4 }, utility: { none: 0, compact: 2, spacious: 6 } },
  ul = y.memo(function (t) {
    ...
    var m = s_[(r = t.type) !== null && r !== void 0 ? r : "core"],
      O;
    if (t.type === "utility") {
      var w;
      O = cl[t.type][(w = t.spacing) !== null && w !== void 0 ? w : "none"];
    } else {
      var _;
      O = cl.core[(_ = t.spacing) !== null && _ !== void 0 ? _ : "none"];
    }
    var k = m + 2 * O;
    return y.createElement(
      "span",
      ...
      y.createElement("svg", {
        ...
        className: T([
          ...
          p
            ? "_1bsb1kw7 _4t3i1kw7"
            : t.type === "utility"
              ? o_[(n = t.spacing) !== null && n !== void 0 ? n : "none"]
              : i_[(a = t.spacing) !== null && a !== void 0 ? a : "none"],
        ]),
      }),
    );
  });
...
function Ev() {
  if (ll) return Tn;
  (ll = 1), Object.defineProperty(Tn, "__esModule", { value: !0 }), (Tn.default = void 0);
  var e = r(vt()),
    t = r(Li);
  function r(a) {
...
var u_ = {
  ...
  d_ = y.memo(function (t) {
    ...
    if (c && i && (o === "small" || o === "medium"))
      if (a.iconType === "utility") {
        ...
        return S.createElement(
          s,
          J({}, a, {
            spacing: me("platform-visual-refresh-icons-facade-button-fix") ? vl.utility[o] : "none",
    ...
    return S.createElement(ts, J({ dangerouslySetGlyph: n }, a));
  });
const f_ = Object.freeze(
    Object.defineProperty(
      { __proto__: null, Icon: ts, IconFacade: d_, default: ts },
      Symbol.toStringTag,
      { value: "Module" },
    ),
  ),
...
function v_() {
  if (pl) return Ln;
  (pl = 1), Object.defineProperty(Ln, "__esModule", { value: !0 }), (Ln.default = void 0);
  var e = n(vt()),
    t = xv,
    r = n(Ev());
  function n(i) {
  ...
  return (a.displayName = "ChevronLeftLargeIcon"), (Ln.default = a), Ln;
}
var hl;
function p_() {
  if (hl) return Dn;
  (hl = 1), Object.defineProperty(Dn, "__esModule", { value: !0 }), (Dn.default = void 0);
  var e = n(vt()),
    t = n(Ev()),
    r = n(v_());
  function n(i) {
  ...
  return (a.Name = "ChevronLeftIconMigration"), (Dn.default = a), Dn;
}
var h_ = p_();
const g_ = _r(h_);
var Mn = {},
...
function b_() {
  if (bl) return Fn;
  (bl = 1), Object.defineProperty(Fn, "__esModule", { value: !0 }), (Fn.default = void 0);
  var e = n(vt()),
    t = xv,
    r = n(Cv());
  function n(i) {
  ...
  return (a.displayName = "ChevronRightLargeIcon"), (Fn.default = a), Fn;
}
var yl;
function y_() {
  if (yl) return Mn;
  (yl = 1), Object.defineProperty(Mn, "__esModule", { value: !0 }), (Mn.default = void 0);
  var e = n(vt()),
    t = n(Cv()),
    r = n(b_());
  function n(i) {
  ...
  const a = (i) =>
    e.default.createElement(t.default, Object.assign({ LEGACY_fallbackIcon: r.default }, i));
  return (a.Name = "ChevronRightIconMigration"), (Mn.default = a), Mn;
}
var m_ = y_();
const __ = _r(m_);
var Cs = y.createContext("elevation.surface"),
  w_ = function () {
    return y.useContext(Cs);
  };
Cs.displayName = "SurfaceProvider";
var O_ = [
    "as",
    "children",
    "backgroundColor",
  ...
  Mi = y.forwardRef(function (e, t) {
    ...
    return i ? y.createElement(Cs.Provider, { value: i }, M) : M;
  });
function R_(e) {
  return e in Pv;
}
...
var j_ = A_(),
  ...
  T_ = { column: "_2lx21bp4", row: "_2lx2vrvc" },
  L_ = { wrap: "_1n261g80", nowrap: "_1n261q9c" },
  M_ = {
    start: "_4cvrv2br",
    center: "_4cvr1h6o",
    baseline: "_4cvr1q9y",
...
var rs = {
  ...
  F_ = function (t) {
    var r = t.children;
    return y.createElement("span", { className: T([rs.separator]) }, r);
  },
  Ga = y.memo(
    y.forwardRef(function (e, t) {
      var r = e.as,
        ...
        p = e.role,
        g = e.children,
        b = typeof f == "string" ? y.createElement(F_, null, f) : f,
        m = b
      ...
      return y.createElement(
        pi,
        {
          ...
          rowGap: d,
          wrap: c ? "wrap" : void 0,
          xcss: I_(u === "hug" && rs.hug, u === "fill" && rs.fill, v),
          testId: h,
          ref: t,
        },
        m,
...
var Av = y.createContext(!1),
  B_ = function () {
    return y.useContext(Av);
  },
  q_ = Av.Provider,
  U_ = ["span", "p", "strong", "em"],
  V_ = function (t, r) {
  ...
  G_ = { medium: "_11c82smr", UNSAFE_small: "_11c8dcr7", large: "_11c81ixg", small: "_11c81o8v" },
  H_ = { bold: "_k48pmoej", medium: "_k48p1wq8", regular: "_k48pi7a9", semibold: "_k48p1pd9" },
  W_ = {
  ...
  jv = y.forwardRef(function (e, t) {
    ...
    return v ? p : y.createElement(q_, { value: !0 }, p);
  });
function K_() {
...
var Y_ = ["as", "children", "isInset", "testId", "style", "xcss"],
  J_ = ["className"];
function Ol(e, t) {
  var r = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
...
var X_ = y.forwardRef(function (e, t) {
    var r = e.as,
      n = r === void 0 ? "button" : r,
      a = e.children,
      i = e.isInset,
  ...
  Z_ = ["className"],
  Sl = { root: "_19itglyw _vchhusvi _r06hglyw _80omtlke", disabled: "_80om13gf" },
  e0 = y.forwardRef(function (e, t) {
    ...
    return y.createElement(
      X_,
      J({ as: "button", tabIndex: h ?? (K_() && !n ? 0 : void 0), style: d }, O, {
        type: i,
        onClick: m,
        disabled: n,
        xcss: Rv(Sl.root, n && Sl.disabled, v),
        testId: f,
        ref: t,
      }),
      r,
...
function Iv() {
  if (El) return $n;
  (El = 1), Object.defineProperty($n, "__esModule", { value: !0 }), ($n.bind = void 0);
  function e(t, r) {
    var n = r.type,
      a = r.listener,
      i = r.options;
...
var Ni = r0(),
  ...
  Eo,
  Pl = (Eo = S.useId) !== null && Eo !== void 0 ? Eo : void 0;
function d0() {
  if (Pl && me("platform-dst-react-18-use-id")) {
    var e = Pl();
    return function (t) {
...
var m0 = (function () {
    ...
    return (
      ...
      (t.insert = function (n) {
        this.ctr % (this.isSpeedy ? 65e3 : 1) === 0 && this._insertTag(y0(this));
...
function zn(e, t) {
  return k0(zi("", null, null, "", null, null, 0), e, { length: -e.length }, t);
}
function C0() {
  return be;
}
function P0() {
  return (be = Ie > 0 ? _e(Zr, --Ie) : 0), Gr--, be === 10 && ((Gr = 1), $i--), be;
}
function ze() {
  return (be = Ie < $v ? _e(Zr, Ie++) : 0), Gr++, be === 10 && ((Gr = 1), $i++), be;
}
function At() {
  return _e(Zr, Ie);
}
...
function zv(e) {
  return ($i = Gr = 1), ($v = kt((Zr = e))), (Ie = 0), [];
}
function Bv(e) {
  return (Zr = ""), e;
}
function Wa(e) {
  return Fv(Sa(Ie - 1, as(e === 91 ? e + 2 : e === 40 ? e + 1 : e)));
}
function R0(e) {
  for (; (be = At()) && be < 33; ) ze();
  return pa(e) > 2 || pa(be) > 3 ? "" : " ";
}
function A0(e, t) {
  for (; --t && ze() && !(be < 48 || be > 102 || (be > 57 && be < 65) || (be > 70 && be < 97)); );
  return Sa(e, Ha() + (t < 6 && At() == 32 && ze() == 32));
}
function as(e) {
  for (; ze(); )
    switch (be) {
...
function j0(e, t) {
  for (; ze() && e + be !== 57; ) if (e + be === 84 && At() === 47) break;
  return "/*" + Sa(t, Ie - 1) + "*" + Fi(e === 47 ? e : ze());
}
function I0(e) {
  for (; !pa(At()); ) ze();
  return Sa(e, Ie);
...
function D0(e) {
  return Bv(Ka("", null, null, null, [""], (e = zv(e)), 0, [0], e));
}
function Ka(e, t, r, n, a, i, o, c, s) {
  for (
    var u = 0,
      l = 0,
      d = o,
    ...
    switch (((h = m), (m = ze()))) {
        ...
        switch (m) {
          ...
          case 59 + l:
            b == -1 && (x = ne(x, /\f/g, "")),
              v > 0 &&
                kt(x) - d &&
                $a(v > 32 ? Al(x + ";", n, r, d - 1) : Al(ne(x, " ", "") + ";", n, r, d - 2), s);
            break;
          case 59:
            x += ";";
          default:
            if (($a((k = Rl(x, t, r, u, l, a, c, O, (w = []), (_ = []), d)), i), m === 123))
              if (l === 0) Ka(x, t, k, k, w, i, d, c, _);
              else
                switch (f === 99 && _e(x, 3) === 110 ? 100 : f) {
                  ...
                  case 115:
                    Ka(
                      ...
                      k,
                      k,
                      n && $a(Rl(e, k, k, 0, 0, a, c, O, a, (w = []), d), _),
                      a,
                      _,
                      d,
                      c,
      ...
      default:
        if (p < 1) {
          if (m == 123) --p;
          else if (m == 125 && p++ == 0 && P0() == 125) continue;
        }
        switch (((x += Fi(m)), m * p)) {
          case 38:
            b = l > 0 ? 1 : ((x += "\f"), -1);
          ...
          case 44:
            ...
            break;
          case 64:
            At() === 45 && (x += Wa(ze())), (f = At()), (l = d = kt((O = x += I0(Ha())))), m++;
            break;
          case 45:
            h === 45 && kt(x) == 2 && (p = 0);
        }
...
function Rl(e, t, r, n, a, i, o, c, s, u, l) {
  for (var d = a - 1, f = a === 0 ? i : [""], v = As(f), h = 0, p = 0, g = 0; h < n; ++h)
    for (var b = 0, m = va(e, d + 1, (d = O0((p = o[h])))), O = e; b < v; ++b)
      (O = Fv(p > 0 ? f[b] + " " + m : ne(m, /&\f/g, f[b]))) && (s[g++] = O);
  return zi(e, t, r, a === 0 ? Ps : c, s, u, l);
}
function T0(e, t, r) {
  return zi(e, t, r, Mv, Fi(C0()), va(e, 2, -2), 0);
}
function Al(e, t, r, n) {
  return zi(e, t, r, Rs, va(e, 0, n), va(e, n + 1, -1), n);
}
function qr(e, t) {
  for (var r = "", n = As(e), a = 0; a < n; a++) r += t(e[a], a, e, t) || "";
  return r;
}
function L0(e, t, r, n) {
  switch (e.type) {
  ...
  return kt((r = qr(e.children, n))) ? (e.return = e.value + "{" + r + "}") : "";
}
function M0(e) {
  var t = As(e);
...
var $0 = function (t, r, n) {
    for (var a = 0, i = 0; (a = i), (i = At()), a === 38 && i === 12 && (r[n] = 1), !pa(i); ) ze();
    return Sa(t, Ie);
  },
  z0 = function (t, r) {
    var n = -1,
    ...
    do
      switch (pa(a)) {
        case 0:
          a === 38 && At() === 12 && (r[n] = 1), (t[n] += $0(Ie - 1, r, n));
          break;
        case 2:
          t[n] += Wa(a);
          break;
  ...
  q0 = function (t) {
    if (!(t.type !== "rule" || !t.parent || t.length < 1)) {
      ...
      if (!(t.props.length === 1 && r.charCodeAt(0) !== 58 && !jl.get(n)) && !a) {
        jl.set(t, !0);
        for (var i = [], o = B0(r, i), c = n.props, s = 0, u = 0; s < o.length; s++)
          ...
          case 102:
            return (
              ne(
                e,
                /(.+:)(.+)-([^]+)/,
                "$1" + re + "$2-$3$1" + hi + (_e(e, t + 3) == 108 ? "$3" : "$2-$3"),
              ) + e
            );
          case 115:
            return ~ns(e, "stretch") ? qv(ne(e, "stretch", "fill-available"), t) + e : e;
        }
      break;
    case 4949:
      if (_e(e, t + 1) !== 115) break;
    case 6444:
      switch (_e(e, kt(e) - 3 - (~ns(e, "!important") && 10))) {
        case 107:
          return ne(e, ":", ":" + re) + e;
        case 101:
          return (
    ...
    if (t.length > -1 && !t.return)
      switch (t.type) {
        case Rs:
          ...
          break;
        case Nv:
          return qr([zn(t, { value: ne(t.value, "@", "@" + re) })], a);
        case Ps:
          if (t.length)
            return x0(t.props, function (i) {
              switch (E0(i, /(::plac\w+|:read-\w+)/)) {
                case ":read-only":
                case ":read-write":
                  return qr([zn(t, { props: [ne(i, /:(read-\w+)/, ":" + hi + "$1")] })], a);
                case "::placeholder":
                  return qr(
                    [
                      zn(t, { props: [ne(i, /:(plac\w+)/, ":" + re + "input-$1")] }),
                      zn(t, { props: [ne(i, /:(plac\w+)/, ":" + hi + "$1")] }),
                      zn(t, { props: [ne(i, /:(plac\w+)/, Oe + "input-$1")] }),
                    ],
                    a,
                  );
              }
...
var Dl;
function K0() {
  return Dl || ((Dl = 1), (xo.exports = W0())), xo.exports;
}
var Co, Tl;
function Y0() {
  if (Tl) return Co;
...
var js = function (t, r, n) {
    var a = t.key + "-" + r.name;
    (n === !1 || J0 === !1) && t.registered[a] === void 0 && (t.registered[a] = r.styles);
  },
  Vv = function (t, r, n) {
    js(t, r, n);
    var a = t.key + "-" + r.name;
...
var Q0 = {
  ...
  Po = F0(function (e) {
    return Gv(e) ? e : e.replace(Z0, "-$&").toLowerCase();
  }),
  Ml = function (t, r) {
    switch (t) {
      case "animation":
      case "animationName":
        if (typeof r == "string")
          return r.replace(ew, function (n, a, i) {
            return (St = { name: a, styles: i, next: St }), a;
          });
    }
    return Q0[t] !== 1 && !Gv(t) && typeof r == "number" && r !== 0 ? r + "px" : r;
  };
function ha(e, t, r) {
  if (r == null) return "";
  var n = r;
  ...
  switch (typeof r) {
    ...
    case "object": {
      var a = r;
      if (a.anim === 1) return (St = { name: a.name, styles: a.styles, next: St }), a.name;
      var i = r;
      if (i.styles !== void 0) {
        var o = i.next;
        if (o !== void 0)
          for (; o !== void 0; ) (St = { name: o.name, styles: o.styles, next: St }), (o = o.next);
        var c = i.styles + ";";
        return c;
      }
      return tw(e, t, r);
  ...
  if (Array.isArray(r)) for (var a = 0; a < r.length; a++) n += ha(e, t, r[a]) + ";";
    ...
    for (var i in r) {
      ...
      if (typeof o != "object") {
        ...
        for (var s = 0; s < o.length; s++) Ll(o[s]) && (n += Po(i) + ":" + Ml(i, o[s]) + ";");
      else {
        var u = ha(e, t, o);
        switch (i) {
          case "animation":
...
function Is(e, t, r) {
  ...
  Nl.lastIndex = 0;
  for (var u = "", l; (l = Nl.exec(a)) !== null; ) u += "-" + l[1];
  var d = X0(a) + u;
  return { name: d, styles: a, next: St };
}
var rw = function (t) {
    return t();
  },
  nw = Jc.useInsertionEffect ? Jc.useInsertionEffect : !1,
  Hv = nw || rw,
  Wv = y.createContext(typeof HTMLElement < "u" ? H0({ key: "css" }) : null);
Wv.Provider;
var Kv = function (t) {
  ...
  aw = function (t, r) {
    var n = {};
    for (var a in r) Ds.call(r, a) && (n[a] = r[a]);
    return (n[is] = t), n;
  },
  iw = function (t) {
    var r = t.cache,
  ...
  ow = Kv(function (e, t, r) {
    ...
    typeof e.className == "string"
      ? (o = Uv(t.registered, i, e.className))
      : e.className != null && (o = e.className + " ");
    var c = Is(i, void 0, y.useContext(Yv));
    o += t.key + "-" + c.name;
    var s = {};
    for (var u in e) Ds.call(e, u) && u !== "css" && u !== is && (s[u] = e[u]);
    return (
      (s.className = o),
      r && (s.ref = r),
      y.createElement(
        y.Fragment,
        null,
        y.createElement(iw, { cache: t, serialized: c, isStringTag: typeof a == "string" }),
        y.createElement(a, s),
      )
    );
  }),
  ...
  ct = function (t, r) {
    var n = arguments;
    if (r == null || !Ds.call(r, "css")) return y.createElement.apply(void 0, n);
    var a = n.length,
      i = new Array(a);
    (i[0] = sw), (i[1] = aw(t, r));
...
var lw = function (t) {
    ...
    return (
      Hv(function () {
        for (var a = 0; a < n.length; a++) Vv(r, n[a], !1);
      }),
      null
    );
  },
  dw = Kv(function (e, t) {
    var r = [],
      n = function () {
        ...
        var d = Is(u, t.registered);
        return r.push(d), js(t, d, !1), t.key + "-" + d.name;
      },
      a = function () {
        for (var s = arguments.length, u = new Array(s), l = 0; l < s; l++) u[l] = arguments[l];
        return uw(t.registered, n, cw(u));
      },
      i = { css: n, cx: a, theme: y.useContext(Yv) },
      o = e.children(i);
    return y.createElement(
      y.Fragment,
      null,
      y.createElement(lw, { cache: t, serializedArr: r }),
      o,
    );
  });
function fw(e, t) {
...
var Fl = 2,
  os = gt({
    outline: "".concat(Fl, "px solid ", "var(--ds-border-focused, #2684FF)"),
    outlineOffset: Fl,
  }),
  ss = gt({
...
var zl = "rgba(179, 212, 255, 0.6)",
  Bl = {
    background: {
      default: {
        default: {
          light: "var(--ds-background-neutral, ".concat(An, ")"),
          dark: "var(--ds-background-neutral, ".concat(jn, ")"),
        },
        hover: {
          light: "var(--ds-background-neutral-hovered, ".concat(es, ")"),
          dark: "var(--ds-background-neutral-hovered, ".concat(Xu, ")"),
        },
        active: {
          light: "var(--ds-background-neutral-pressed, ".concat(zl, ")"),
          dark: "var(--ds-background-neutral-pressed, ".concat(Kn, ")"),
        },
        disabled: {
          light: "var(--ds-background-disabled, ".concat(An, ")"),
          dark: "var(--ds-background-disabled, ".concat(jn, ")"),
        },
        selected: {
          light: "var(--ds-background-selected, ".concat(We, ")"),
          dark: "var(--ds-background-selected, ".concat(Lr, ")"),
        },
        focusSelected: {
          light: "var(--ds-background-selected, ".concat(We, ")"),
          dark: "var(--ds-background-selected, ".concat(Lr, ")"),
      ...
      primary: {
        default: {
          light: "var(--ds-background-brand-bold, ".concat(Tr, ")"),
          dark: "var(--ds-background-brand-bold, ".concat(vi, ")"),
        },
        hover: {
          light: "var(--ds-background-brand-bold-hovered, ".concat(Ku, ")"),
          dark: "var(--ds-background-brand-bold-hovered, ".concat(Kn, ")"),
        },
        active: {
          light: "var(--ds-background-brand-bold-pressed, ".concat(Yu, ")"),
          dark: "var(--ds-background-brand-bold-pressed, ".concat(Wu, ")"),
        },
        disabled: {
          light: "var(--ds-background-disabled, ".concat(An, ")"),
          dark: "var(--ds-background-disabled, ".concat(jn, ")"),
      ...
      warning: {
        default: {
          light: "var(--ds-background-warning-bold, ".concat(Hu, ")"),
          dark: "var(--ds-background-warning-bold, ".concat(Hu, ")"),
        },
        hover: {
          light: "var(--ds-background-warning-bold-hovered, ".concat(Gu, ")"),
          dark: "var(--ds-background-warning-bold-hovered, ".concat(Gu, ")"),
        },
        active: {
          light: "var(--ds-background-warning-bold-pressed, ".concat(Dr, ")"),
          dark: "var(--ds-background-warning-bold-pressed, ".concat(Dr, ")"),
        },
        disabled: {
          light: "var(--ds-background-disabled, ".concat(An, ")"),
          dark: "var(--ds-background-disabled, ".concat(jn, ")"),
        ...
        selected: {
          light: "var(--ds-background-selected, ".concat(Dr, ")"),
      ...
      danger: {
        default: {
          light: "var(--ds-background-danger-bold, ".concat(Vu, ")"),
          dark: "var(--ds-background-danger-bold, ".concat(Vu, ")"),
        },
        hover: {
          light: "var(--ds-background-danger-bold-hovered, ".concat(Uu, ")"),
          dark: "var(--ds-background-danger-bold-hovered, ".concat(Uu, ")"),
        },
        active: {
          light: "var(--ds-background-danger-bold-pressed, ".concat(Ir, ")"),
          dark: "var(--ds-background-danger-bold-pressed, ".concat(Ir, ")"),
        },
        disabled: {
          light: "var(--ds-background-disabled, ".concat(An, ")"),
          dark: "var(--ds-background-disabled, ".concat(jn, ")"),
      ...
      subtle: {
        ...
        hover: {
          ...
          dark: "var(--ds-background-neutral-subtle-hovered, ".concat(Xu, ")"),
        },
        active: {
          light: "var(--ds-background-neutral-subtle-pressed, ".concat(zl, ")"),
          dark: "var(--ds-background-neutral-subtle-pressed, ".concat(Kn, ")"),
        },
        disabled: {
          light: "var(--ds-background-neutral-subtle, none)",
          dark: "var(--ds-background-neutral-subtle, none)",
    ...
    color: {
      default: {
        ...
        active: {
          light: "var(--ds-text, ".concat(Tr, ")"),
          dark: "var(--ds-text, ".concat(Tr, ")"),
        },
        disabled: {
          light: "var(--ds-text-disabled, ".concat(ur, ")"),
          dark: "var(--ds-text-disabled, ".concat(In, ")"),
        },
        selected: {
      ...
      primary: {
        default: {
          ...
          dark: "var(--ds-text-inverse, ".concat(In, ")"),
        },
        disabled: {
          light: "var(--ds-text-disabled, ".concat(ur, ")"),
          dark: "var(--ds-text-disabled, ".concat(In, ")"),
      ...
      link: {
        default: {
          light: "var(--ds-link, ".concat(Tr, ")"),
          dark: "var(--ds-link, ".concat(vi, ")"),
        },
        hover: {
          light: "var(--ds-link, ".concat(Ku, ")"),
          dark: "var(--ds-link, ".concat(Kn, ")"),
        },
        active: {
          light: "var(--ds-link-pressed, ".concat(Yu, ")"),
          dark: "var(--ds-link-pressed, ".concat(Wu, ")"),
        },
        disabled: {
          light: "var(--ds-text-disabled, ".concat(ur, ")"),
      ...
      "subtle-link": {
        default: {
          light: "var(--ds-text-subtle, ".concat(_m, ")"),
          dark: "var(--ds-text-subtle, ".concat(st, ")"),
        },
        hover: {
          light: "var(--ds-text-subtle, ".concat(mm, ")"),
          dark: "var(--ds-text-subtle, ".concat(hv, ")"),
        },
        active: {
          light: "var(--ds-text, ".concat(wm, ")"),
          dark: "var(--ds-text, ".concat(Om, ")"),
        },
        disabled: {
          light: "var(--ds-text-disabled, ".concat(ur, ")"),
          dark: "var(--ds-text-disabled, ".concat(Oo, ")"),
...
var Zt = f0(),
  Ro = ["default", "primary", "danger", "warning"],
  cs = { default: "".concat(32 / 14, "em"), compact: "".concat(24 / 14, "em"), none: "auto" },
  mw = { default: cs.default, compact: cs.compact, none: "inherit" },
  _w = {
    default: "0 ".concat(Zt + Zt / 4, "px"),
    compact: "0 ".concat(Zt + Zt / 4, "px"),
    none: "0",
  },
  ww = { compact: "0 ".concat(Zt / 4, "px"), default: "0 ".concat(Zt / 4, "px"), none: "0" },
  Ow = { default: "middle", compact: "middle", none: "baseline" },
  Xv = { content: "0 ".concat(Zt / 4, "px"), icon: "0 ".concat(Zt / 4, "px") },
  Qv = {
  ...
  Ul = { '&[data-has-overlay="true"]': { cursor: "default", textDecoration: "none" } };
function Vl(e) {
  var t = e.group,
    r = e.key,
    n = e.mode,
...
function Nr(e) {
  var t = e.appearance,
    ...
    n = e.mode;
  return {
    background: Vl({ group: Bl.background[t], key: r, mode: n }),
    color: "".concat(Vl({ group: Bl.color[t], key: r, mode: n }), " !important"),
  };
}
function jw(e) {
  var t = e.appearance,
    ...
    c = Nr({ appearance: t, key: a ? "selected" : "default", mode: n });
  return oe(
    oe(
      oe(
        oe(
          ...
          oe(
            oe(
              {
                "&:visited": oe({}, c),
                "&:hover": oe(
                  oe({}, Nr({ appearance: t, key: a ? "selected" : "hover", mode: n })),
                  {},
                  {
                    textDecoration:
                ...
                "&:active": oe(
                  oe({}, Nr({ appearance: t, key: a ? "selected" : "active", mode: n })),
                  {},
                ...
                "&[disabled]": oe(
                  oe({}, Nr({ appearance: t, key: "disabled", mode: n })),
                  {},
            ...
            {},
            {
              '&[data-has-overlay="true"]:not([disabled]):hover, &[data-has-overlay="true"]:not([disabled]):active':
                oe({}, Nr({ appearance: t, key: a ? "selected" : "default", mode: n })),
            },
          ),
      ),
      me("platform-component-visual-refresh") &&
              ...
              oe(
                oe(
                  oe(
                    oe(
                      oe(
                        oe(oe({}, t === "default" && kw), t === "primary" && Sw),
                        t === "link" && Ew,
                      ),
                      t === "subtle" && xw,
                    ),
...
function Dw(e) {
  var t = e.hasOverlay;
  return gt({ opacity: t ? 0 : 1, transition: "opacity 0.3s" });
}
var Tw = {
    position: "absolute",
    left: 0,
  ...
  Ts = function (t) {
    return t && y.isValidElement(t) && t.type === Tv;
  },
  Lw = [
    "analyticsContext",
    "appearance",
  ...
  Hl = function (t, r) {
    return !t || Ts(t) ? null : r;
  },
  $w = function (t, r) {
    return Ts(t) ? t : t ? ct("span", { css: r }, t) : null;
  },
  zw = S.forwardRef(function (t, r) {
    ...
    var W = t.spacing,
      R = W === void 0 ? "default" : W,
      E = t.tabIndex,
      D = E === void 0 ? 0 : E,
      I = t.type,
      N = I === void 0 ? (d ? void 0 : "button") : I,
      z = t.testId,
      A = se(t, Lw),
      K = y.useRef(),
      q = y.useCallback(
    ...
    fw(K, c);
    var G = y.useContext(xs),
      ie = y.useCallback(
        function (ve, bt) {
          G && G.tracePress(g, ve.timeStamp), x(ve, bt);
        },
        [x, G, g],
      ),
      Q = da({
    ...
    return (
      ...
      ct(
        ...
        ct(
          ...
          p ? ct("span", { css: [ye, Gl({ spacing: R }), Hl(u, Nw)] }, p) : null,
          $w(u, [ye, Iw({ spacing: R })]),
          h ? ct("span", { css: [ye, Gl({ spacing: R }), Hl(u, Fw)] }, h) : null,
          B ? ct("span", { css: [Tw, at] }, B) : null,
        ),
      )
    );
  });
...
var qw = [
  ...
  Wl = typeof navigator < "u" && navigator.userAgent.toLowerCase().indexOf("firefox") > -1,
  Ls = S.memo(
    S.forwardRef(function (t, r) {
      var n = t.appearance,
        ...
        O = g0(),
        w = O.mode,
        _ = Bw({ children: i, iconBefore: o, iconAfter: c }),
        k = y.useState(!1),
        x = te(k, 2),
        M = x[0],
        $ = x[1],
      ...
      return S.createElement(
        ...
        J({}, m, {
          ...
          buttonCss: W,
          children: i,
          "data-firefox-is-active": M ? !0 : void 0,
          iconAfter: c,
          iconBefore: o,
          isSelected: u,
          onMouseDown: L,
...
function Uw(e) {
  return S.createElement(Ls, J({}, e, { appearance: "subtle" }));
}
var Vw = { container: "_1e0c1txw _kqswh2mm" };
function Gw(e) {
  var t = e.key,
    r = e.testId,
    n = e.from,
  ...
  return S.createElement(
    Mi,
    { as: "li", testId: r, key: t, xcss: Vw.container, paddingInline: "space.100" },
    S.createElement(
      jv,
      { testId: r && "".concat(r, "-text") },
      S.createElement(Tv, null, "Skipped pages from ", n, " to ", a),
      "…",
    ),
  );
}
...
function Ww(e, t) {
  if (e.length !== t.length) return !1;
  for (var r = 0; r < e.length; r++) if (!Hw(e[r], t[r])) return !1;
  return !0;
}
function Kw(e, t) {
  t === void 0 && (t = Ww);
...
function Qw(e, t) {
  var r = e.components,
      ...
      Jw(
        {
          fn: function (A, K) {
            var q = A.event,
              G = A.selectedPageIndex;
            o === void 0 && D(G), w && w(q, _[G], K);
          },
          action: "changed",
    ...
    N = function (A, K, q) {
      var G = _[E],
        ie = "".concat(l, " ").concat(k ? k(A, K) : A),
        Q = A === G;
      return S.createElement(
        Ga,
        { as: "li", xcss: us.paginationMenuItem, key: "page-".concat(k ? k(A, K) : K) },
        S.createElement(
          Uw,
          {
            component: n.Page,
            onClick: function (fe) {
              return I({ event: fe, selectedPageIndex: K });
            },
            "aria-current": Q ? "page" : void 0,
            "aria-label": ie,
            isSelected: Q,
            isDisabled: B,
            page: A,
  ...
  return S.createElement(
    Mi,
    { testId: L, style: g, ref: t, "aria-label": s, as: "nav" },
    S.createElement(
      Ga,
      ...
      S.createElement(Kl, {
        ...
        onClick: function (A) {
          return I({ event: A, selectedPageIndex: E - 1 });
        },
        isDisabled: B || E === 0,
        iconBefore: S.createElement(Ql, { chevronDirection: "left" }),
        "aria-label": f,
        testId: L && "".concat(L, "--left-navigator"),
      }),
      S.createElement(
        Ga,
        { space: "space.0", alignBlock: "baseline", as: "ul", xcss: us.paginationMenu },
        Yw(_, E, { max: m, ellipsis: M, transform: N }, L),
      ),
      S.createElement(Kl, {
        key: "right-navigator",
        component: n.Next,
        ...
        iconBefore: S.createElement(Ql, { chevronDirection: "right" }),
        "aria-label": h,
        testId: L && "".concat(L, "--right-navigator"),
      }),
    ),
  );
}
var Zw = y.memo(y.forwardRef(Qw));
function e1(e, t, r) {
  return (t = X(t)), Te(e, Zv() ? Reflect.construct(t, r || [], X(e).constructor) : t.apply(e, r));
}
function Zv() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
      ...
      he(t, [
        {
          ...
          value: function () {
            var n = this.props,
              ...
              s = n.testId,
              u = n.isDisabled,
              l = Ne(Array(a)).map(function (f, v) {
                return v + 1;
              }),
              d = o - 1;
            return S.createElement(Zw, {
              selectedIndex: d,
              isDisabled: u,
...
var ed = "--local-dynamic-table-text-color",
  a1 = function (t) {
    var r = t.isRanking,
      n = t.testId,
      a = se(t, r1);
    return y.createElement(
      "thead",
      J({ "data-testid": n }, a, { className: T(["_179rglyw", r && "_1e0c1ule"]) }),
    );
  },
  ep = y.forwardRef(function (e, t) {
    var r = e.width,
      n = e.children,
      a = e.isSortable,
      i = e.sortOrder,
      ...
      d = se(e, n1),
      f = Bn(
        Bn(Bn({}, u), r && bv({ width: r })),
        {},
        C({}, ed, "var(--ds-text-subtlest, ".concat(Ju, ")")),
      ),
      v = i === yr,
      h = i === di,
      p = function () {
    ...
    return y.createElement(
      ...
      J({ "aria-sort": p(), onClick: b ? void 0 : s, ref: t, "data-testid": l }, d, {
        ...
        style: Bn(
          ...
          {
            "--_k02y3n": Ye("2px solid ".concat("var(--ds-border, ".concat(Zo, ")"))),
            "--_17ckjys": Ye("var(--ds-text-subtle, ".concat("var(".concat(ed, ")"), ")")),
            "--_jz8ahf": Ye("solid 2px ".concat("var(--ds-border-focused, ".concat(vi, ")"))),
            "--_6j4ewu": Ye("var(--ds-background-neutral-hovered, ".concat(es, ")")),
            "--_1rdacuj": Ye("3px solid ".concat("var(--ds-icon-disabled, ".concat(Zo, ")"))),
            "--_1qca9zt": Ye("3px solid ".concat("var(--ds-icon-subtle, ".concat(Ju, ")"))),
          },
        ),
      }),
      n,
...
function i1(e, t, r) {
  return (t = X(t)), Te(e, tp() ? Reflect.construct(t, r || [], X(e).constructor) : t.apply(e, r));
}
function tp() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
...
function o1() {
  if (td) return qn;
  (td = 1), Object.defineProperty(qn, "__esModule", { value: !0 }), (qn.default = void 0);
  var e = r(vt()),
    t = r(Li);
  function r(a) {
    return a && a.__esModule ? a : { default: a };
...
function u1() {
  if (rd) return Un;
  (rd = 1), Object.defineProperty(Un, "__esModule", { value: !0 }), (Un.default = void 0);
  var e = r(vt()),
    t = r(Li);
  function r(a) {
    return a && a.__esModule ? a : { default: a };
  ...
  return (n.displayName = "ArrowUpIcon"), (Un.default = n), Un;
}
var l1 = u1();
const d1 = _r(l1);
var f1 = "Escape";
function v1(e) {
  var t = e.onClose,
    ...
    a = y.useCallback(
      function (o) {
        r || n.current || o.key !== f1 || ((n.current = !0), t(o));
      },
      [t, r],
    ),
...
var p1 = y.createContext(null),
  h1 = y.createContext(null);
function g1() {
  var e = y.useContext(h1);
  return e;
}
function b1(e) {
  var t = e.isOpen,
...
var Yn = { none: 0, small: 100, medium: 350, large: 700 },
  Ao = 0.5,
  y1 = { none: Yn.none, small: Yn.small * Ao, medium: Yn.medium * Ao, large: Yn.large * Ao },
  m1 = function () {
  ...
  ap = { appear: !0, isExiting: !1 },
  ip = y.createContext(ap),
  nd = function (t) {
    var r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : ap;
    return S.createElement(ip.Provider, { key: "".concat(t.key, "-provider"), value: r }, t);
  },
  ad = function (t) {
    var r = [];
    return (
  ...
  O1 = function (t, r) {
    for (var n = r.concat([]), a = k1(r), i = 0; i < t.length; i++) {
      var o = t[i],
        c = !a[o.key];
      c && n.splice(i + 1, 0, o);
    }
  ...
  op = y.memo(function (e) {
    ...
    if (
      ...
      (np() && !me("platform_design_system_motion_on_finish_fix")) || typeof c == "boolean")
    )
      return n;
    var b = te(c, 2),
      m = b[0],
      ...
      k.size
        ? (M = M.map(function (L) {
            ...
            return nd(L, {
              ...
              onFinish: B
                ? function () {
                    k.delete(L.key), k.size === 0 && (s([null, n]), f([]));
                  }
                : void 0,
            });
          }))
  ...
  E1 = function () {
    return y.useContext(ip);
  };
op.displayName = "ExitingPersistence";
function x1() {
  var e = y.useRef("");
  return (
    e.current ||
...
var C1 = y.createContext(function () {
      ...
      y.useEffect(
        function () {
          ...
          if (!O) {
            ...
            var B = function () {
              _ === "exiting" && (g == null || g()), L || $(!1), l == null || l(_);
            };
            if (np() && me("platform_design_system_motion_on_finish_fix")) {
              B();
              return;
            }
            return (
      ...
      r(
        {
          ...
          className: M
            ? T([
                ...
                p && n === "linear" && T(["_1pglp3kn"]),
                p && i === "ease-out" && T(["_1pgldkwg"]),
                p && i === "ease-in" && T(["_1pgl1nzg"]),
                p && i === "ease-in-out" && T(["_1pgl1fu8"]),
                ((!p && o === "fade-in") || (p && s === "fade-in")) && T(["_j7hq1cgr"]),
                ((!p && o === "fade-out") || (p && s === "fade-out")) && T(["_j7hq1lln"]),
                ((!p && o === "zoom-in") || (p && s === "zoom-in")) && T(["_j7hqe8p0"]),
                ((!p && o === "zoom-out") || (p && s === "zoom-out")) && T(["_j7hqy6ql"]),
...
var D1 = function (t) {
  ...
  L1 = function (t, r) {
    if (typeof t == "function") return T1(t, r);
    t != null && (t.current = r);
  },
  id = function (t) {
    return t.reduce(function (r, n) {
  ...
  Gn = "popper",
  N1 = "reference",
  sd = Ea.reduce(function (e, t) {
    return e.concat([t + "-" + Hr, t + "-" + ga]);
  }, []),
  cp = [].concat(Ea, [Ms]).reduce(function (e, t) {
...
function Bi(e) {
  return Dt(e) === "html" ? e : e.assignedSlot || e.parentNode || (Ns(e) ? e.host : null) || nr(e);
}
function cd(e) {
...
function Q1(e) {
  ...
  var a = Bi(e);
  for (Ns(a) && (a = a.host); tt(a) && ["html", "body"].indexOf(Dt(a)) < 0; ) {
    var i = Ht(a);
    if (
      i.transform !== "none" ||
      i.perspective !== "none" ||
...
function xa(e) {
  for (var t = Be(e), r = cd(e); r && X1(r) && Ht(r).position === "static"; ) r = cd(r);
  return r && (Dt(r) === "html" || (Dt(r) === "body" && Ht(r).position === "static"))
    ? t
    : r || Q1(e) || t;
}
function $s(e) {
...
function tO(e) {
  ...
  if (!(!i || !o)) {
    var d = eO(a.padding, r),
      ...
      x = ta(w, k, _),
      M = s;
    r.modifiersData[n] = ((t = {}), (t[M] = x), (t.centerOffset = x - k), t);
  }
}
function rO(e) {
  var t = e.state,
  ...
  a != null &&
    ((typeof a == "string" && ((a = t.elements.popper.querySelector(a)), !a)) ||
      (lp(t.elements.popper, a) && (t.elements.arrow = a)));
}
const nO = {
  name: "arrow",
  enabled: !0,
...
var aO = { top: "auto", right: "auto", bottom: "auto", left: "auto" };
function iO(e, t) {
  var r = e.x,
    n = e.y,
...
function ud(e) {
  ...
  if (u) {
    ...
    if (
      ...
      w = rt;
      var $ = d && k === _ && _.visualViewport ? _.visualViewport.height : k[x];
      (p -= $ - n.height), (p *= s ? 1 : -1);
    }
    if (a === Ae || ((a === Re || a === rt) && i === ga)) {
      O = nt;
      var L = d && k === _ && _.visualViewport ? _.visualViewport.width : k[M];
      (v -= L - n.width), (v *= s ? 1 : -1);
    }
  }
  var B = Object.assign({ position: c }, u && aO),
    W = l === !0 ? iO({ x: v, y: p }, Be(r)) : { x: v, y: p };
  if (((v = W.x), (p = W.y), s)) {
    var R;
...
function cO(e) {
  ...
  return (
    ...
    c && s.addEventListener("resize", r.update, za),
    function () {
      i &&
        u.forEach(function (l) {
          l.removeEventListener("scroll", r.update, za);
        }),
        c && s.removeEventListener("resize", r.update, za);
    }
  );
}
const uO = {
...
function fO(e, t) {
  ...
  return { width: i, height: o, x: c + Bs(e), y: s };
}
function vO(e) {
  var t,
    r = nr(e),
    ...
    s = -n.scrollTop;
  return (
    Ht(a || r).direction === "rtl" && (c += vr(r.clientWidth, a ? a.clientWidth : 0) - i),
...
function ra(e, t) {
  ...
  var n = pp(e),
    ...
    i = Be(n),
    o = a ? [i].concat(i.visualViewport || [], qs(n) ? n : []) : n,
    c = t.concat(o);
  return a ? c : c.concat(ra(Bi(o)));
}
function ds(e) {
...
function dd(e, t, r) {
  return t === sp ? ds(fO(e, r)) : mr(t) ? pO(t, r) : ds(vO(nr(e)));
}
function hO(e) {
  var t = ra(Bi(e)),
    ...
    c = i.reduce(
      function (s, u) {
        ...
        return (
          ...
          (s.right = gi(l.right, s.right)),
          (s.bottom = gi(l.bottom, s.bottom)),
...
function ba(e, t) {
  ...
  var r = t,
    ...
    p = r.padding,
    g = p === void 0 ? 0 : p,
    b = fp(typeof g != "number" ? g : vp(g, Ea)),
    m = f === Gn ? N1 : Gn,
    O = e.rects.popper,
    w = e.elements[h ? m : f],
    _ = gO(mr(w) ? w : w.contextElement || nr(e.elements.popper), s, l, o),
    k = Kr(e.elements.reference),
    x = hp({ reference: k, element: O, placement: a }),
    M = ds(Object.assign({}, O, x)),
    $ = f === Gn ? M : k,
    L = {
      top: _.top - $.top + b.top,
  ...
  if (f === Gn && B) {
    ...
    Object.keys(L).forEach(function (R) {
      var E = [nt, rt].indexOf(R) >= 0 ? 1 : -1,
        D = [Re, rt].indexOf(R) >= 0 ? "y" : "x";
      L[R] += W[D] * E;
    });
  }
  return L;
...
function bO(e, t) {
  ...
  var v = f.reduce(function (h, p) {
    return (h[p] = ba(e, { placement: p, boundary: a, rootBoundary: i, padding: o })[jt(p)]), h;
  }, {});
  ...
  if (!t.modifiersData[n]._skip) {
    for (
      var a = r.mainAxis,
        ...
        m = b === g,
        O = s || (m || !h ? [Ya(g)] : yO(g)),
        w = [g].concat(O).reduce(function (Q, de) {
          return Q.concat(
            jt(de) === Ms
              ? bO(t, {
                  placement: de,
      ...
      var B = w[L],
        ...
        E = [Re, rt].indexOf(W) >= 0,
        D = E ? "width" : "height",
        I = ba(t, { placement: B, boundary: l, rootBoundary: d, altBoundary: f, padding: u }),
        N = E ? (R ? nt : Ae) : R ? rt : Re;
      _[D] > k[D] && (N = Ya(N));
      var z = Ya(N),
        A = [];
        ...
        var K = h ? 3 : 1,
          q = function (de) {
            var fe = w.find(function (ye) {
              var we = x.get(ye);
              if (we)
                return we.slice(0, de).every(function (at) {
                  return at;
                });
            });
...
function vd(e) {
  return [Re, nt, rt, Ae].some(function (t) {
    return e[t] >= 0;
  });
}
function wO(e) {
...
function kO(e, t, r) {
  var n = jt(e),
    a = [Ae, Re].indexOf(n) >= 0 ? -1 : 1,
    i = typeof r == "function" ? r(Object.assign({}, t, { placement: e })) : r,
    o = i[0],
    c = i[1];
  return (
    (o = o || 0), (c = (c || 0) * a), [Ae, nt].indexOf(n) >= 0 ? { x: c, y: o } : { x: o, y: c }
  );
}
function SO(e) {
  var t = e.state,
    ...
    a = r.offset,
    i = a === void 0 ? [0, 0] : a,
    o = cp.reduce(function (l, d) {
      return (l[d] = kO(d, t.rects, i)), l;
    }, {}),
    c = o[t.placement],
    s = c.x,
    u = c.y;
...
const EO = { name: "offset", enabled: !0, phase: "main", requires: ["popperOffsets"], fn: SO };
function xO(e) {
  var t = e.state,
    r = e.name;
  t.modifiersData[r] = hp({
    reference: t.rects.reference,
    element: t.rects.popper,
    placement: t.placement,
  });
}
const CO = { name: "popperOffsets", enabled: !0, phase: "read", fn: xO, data: {} };
function PO(e) {
  return e === "x" ? "y" : "x";
}
function RO(e) {
  var t = e.state,
    ...
    h = r.tetherOffset,
    p = h === void 0 ? 0 : h,
    g = ba(t, { boundary: s, rootBoundary: u, padding: d, altBoundary: l }),
    b = jt(t.placement),
    m = Yr(t.placement),
    O = !m,
    w = $s(b),
  ...
  if (k) {
    if (i) {
      var R,
        ...
        ye = de[D],
        we = ta(0, x[I], Q[I]),
        at = O ? x[I] / 2 - K - we - fe - L.mainAxis : q - we - fe - L.mainAxis,
        ve = O ? -x[I] / 2 + K + we + ye + L.mainAxis : G + we + ye + L.mainAxis,
        bt = t.elements.arrow && xa(t.elements.arrow),
        Kt = bt ? (w === "y" ? bt.clientTop || 0 : bt.clientLeft || 0) : 0,
        it = (R = B == null ? void 0 : B[w]) != null ? R : 0,
        yt = N + at - it - Kt,
        Se = N + ve - it,
        mt = ta(v ? gi(z, yt) : z, N, v ? vr(A, Se) : A);
      (k[w] = mt), (W[w] = mt - N);
    }
    if (c) {
      var _t,
        ...
        Ee = Ue + g[ot],
        Ve = Ue - g[en],
        ar = [Re, Ae].indexOf(b) !== -1,
        Ca = (_t = B == null ? void 0 : B[_]) != null ? _t : 0,
        Pa = ar ? Ee : Ue - x[Me] - M[Me] - Ca + L.altAxis,
        Ra = ar ? Ue + x[Me] + M[Me] - Ca - L.altAxis : Ve,
        Aa = v && ar ? Z1(Pa, Ue, Ra) : ta(v ? Pa : Ee, Ue, v ? Ra : Ve);
      (k[_] = Aa), (W[_] = Aa - Ue);
    }
    t.modifiersData[n] = W;
  }
...
function TO(e, t, r) {
  ...
  return (
    (n || (!n && !r)) &&
      ((Dt(t) !== "body" || qs(i)) && (c = IO(t)),
      tt(t) ? ((s = Kr(t, !0)), (s.x += t.clientLeft), (s.y += t.clientTop)) : i && (s.x = Bs(i))),
    {
      ...
      v = {
        ...
        setOptions: function (b) {
          ...
          p(),
            ...
            (l.scrollParents = {
              reference: mr(c) ? ra(c) : c.contextElement ? ra(c.contextElement) : [],
              popper: ra(s),
            });
          var O = MO(FO([].concat(n, l.options.modifiers)));
          return (
        ...
        forceUpdate: function () {
          if (!f) {
            ...
            if (hd(m, O)) {
              (l.rects = {
                reference: TO(m, xa(O), l.options.strategy === "fixed"),
                popper: Fs(O),
              }),
                (l.reset = !1),
              ...
              for (var w = 0; w < l.orderedModifiers.length; w++) {
                ...
                var _ = l.orderedModifiers[w],
                  ...
                  $ = _.name;
                typeof k == "function" &&
                  (l = k({ state: l, options: M, name: $, instance: v }) || l);
              }
            }
          }
        },
...
var zO = [uO, CO, sO, J1, EO, _O, AO, nO, OO],
  BO = $O({ defaultModifiers: zO }),
  jo,
  gd;
function qO() {
  if (gd) return jo;
    ...
    var a = y.useRef(null),
      ...
      l = y.useMemo(
        function () {
          ...
          return VO(a.current, f) ? a.current || f : ((a.current = f), f);
        },
...
function tk(e) {
  var t = e.children,
    ...
    b = y.useMemo(
      function () {
        var O = {
            name: "preventOverflow",
            options: { padding: fs, rootBoundary: v ? "viewport" : "document" },
          },
          w = { name: "offset", options: { offset: [p, g] } },
          _ = v ? XO({ viewportPadding: fs }) : [];
        return [].concat(QO, [O, w], Ne(_));
      },
      [p, g, v],
    ),
    m = y.useMemo(
  ...
  return S.createElement(JO, { modifiers: m, placement: o, strategy: d, referenceElement: s }, r);
}
var gp = "atlaskit-portal-container",
  bp = "body > .atlaskit-portal-container",
  yp = "atlaskit-portal",
  rk = function (t) {
  ...
  _p = function () {
    var t = document.querySelector(bp);
    if (!t) {
      var r,
      ...
      return (
        ...
        (r = mp()) === null || r === void 0 || r.appendChild(n),
        n
      );
    }
    return t;
  ...
  ak = function (t) {
    t.parentElement || _p().appendChild(t);
  },
  wp = function () {
...
var Op = typeof window < "u" ? y.useLayoutEffect : y.useEffect;
function ck(e) {
  var t = e.zIndex,
    r = e.children,
    n = y.useState(null),
  ...
  return i ? bi.createPortal(c, i) : null;
}
var uk = function (t) {
    var r = y.useState(!1),
      n = te(r, 2),
      ...
      o = y.useState(function () {
        return t === "layoutEffect" ? Op : y.useEffect;
      }),
      c = te(o, 1),
      s = c[0];
    return (
  ...
  fk = function (t) {
    return bd.hasOwnProperty(t) ? bd[t] : null;
  },
  vk = function (t, r) {
    var n = { layer: fk(Number(r)), zIndex: r };
...
function hk(e) {
  ...
  return (
    ...
    me("platform_design_system_team_portal_logic_r18_fix")
      ? S.createElement(ck, { zIndex: r }, n)
      : o
        ? S.createElement(sk, { zIndex: r }, n)
        : null
  );
}
var na = new Set(),
...
function md() {
  if (!ya) {
    ya = Ni.bindAll(window, [
      { type: "dragend", listener: Io },
      { type: "pointerdown", listener: Io },
      {
        type: "pointermove",
        listener: (function () {
          var t = 0;
...
function gk() {
  return Ni.bindAll(window, [
    { type: "dragstart", listener: md },
    { type: "dragenter", listener: md },
  ]);
}
var Ba = null;
function bk(e) {
...
function yk(e) {
  ...
  function d() {
    ...
    wt && (Jn(), wt.entry.hide({ isImmediate: !0 }), wt.entry.done(), (wt = null)),
    ...
    (t = "waiting-to-show"), _d(h, e.delay);
  }
  d();
  var f = {
    keep: o,
...
var kp = "tooltipPrimitiveZindex",
  _k = gt({ zindex: "var(".concat(kp, ")"), cursor: "default" }),
  Sp = y.forwardRef(function (t, r) {
    var n = t.style,
      a = t.className,
      i = t.children,
      o = t.placement,
...
Sp.displayName = "TooltipPrimitive";
function kd(e, t) {
  var r = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e);
...
var Ep = y.forwardRef(function (t, r) {
  var n = t.style,
    a = t.className,
    i = t.children,
    o = t.truncate,
  ...
  return y.createElement(
    Sp,
    {
      ...
      style: Sd(
        ...
        {},
        {
          "--_yr7xfv": Ye("var(--ds-background-neutral-bold, ".concat(dr, ")")),
          "--_ywovvi": Ye("var(--ds-text-inverse, ".concat(Bt, ")")),
        },
      ),
    },
    i,
...
Ep.displayName = "TooltipContainer";
function Ed(e) {
...
var wk = Lv.tooltip(),
  Cd = { componentName: "tooltip", packageName: "@atlaskit/tooltip", packageVersion: "20.0.6" },
  Ok = { top: "bottom", bottom: "top", left: "right", right: "left" },
  kk = function (t) {
    return t.split("-")[0];
  };
function xp(e) {
  var t = e.children,
    ...
    D = E === void 0 ? !1 : E,
    I = n === "mouse" ? i : n,
    N = qu(Fr({ fn: b, action: "displayed", analyticsData: $ }, Cd)),
    z = qu(Fr({ fn: O, action: "hidden", analyticsData: $ }, Cd)),
    A = y.useRef(null),
    K = y.useState("hide"),
    q = te(K, 2),
    G = q[0],
    ...
    de = y.useRef(null),
    fe = function (ce) {
      (de.current = ce), (Q.current = ce ? ce.firstElementChild : null);
    },
    ...
    Kt = Vn(w),
    it = y.useRef(!1),
    yt = y.useCallback(function (U) {
      (A.current = U), (it.current = !1);
    }, []),
    Se = y.useCallback(
      function () {
        A.current &&
          (it.current && ve.current(), (A.current = null), (it.current = !1), ie("hide"));
      },
      [ve],
    ),
    mt = y.useCallback(
      function () {
        A.current && (A.current.abort(), it.current && ve.current(), (A.current = null));
      },
      [ve],
    );
  y.useEffect(
  ...
  y.useEffect(function () {
    return bk({
      onRegister: function (ce) {
        var Mt = ce.isDragging;
        _t.current = Mt;
      },
      onDragStart: function () {
        var ce;
        (ce = A.current) === null || ce === void 0 || ce.requestHide({ isImmediate: !0 }),
          (_t.current = !0);
      },
      onDragEnd: function () {
        _t.current = !1;
  ...
  var ot = y.useCallback(
      function (U) {
        var ce;
        if (!_t.current) {
          if ((A.current && !A.current.isActive() && mt(), A.current && A.current.isActive())) {
            A.current.keep();
            return;
          }
          if (!(Kt.current && !((ce = Kt.current) !== null && ce !== void 0 && ce.call(Kt)))) {
            var Mt = {
                source: U,
                delay: bt.current,
                show: function (Er) {
                  var rn = Er.isImmediate;
                  it.current || ((it.current = !0), at.current()),
                    ie(rn ? "show-immediate" : "fade-in");
                },
                hide: function (Er) {
                  var rn = Er.isImmediate;
                  ie(rn ? "hide" : "before-fade-out");
                },
                done: Se,
              },
              Gi = yk(Mt);
    ...
    en = y.useCallback(
      function () {
        var U;
        (U = A.current) === null || U === void 0 || U.requestHide({ isImmediate: !0 });
      },
      [A],
    );
  v1({ onClose: en, isDisabled: G === "hide" || G === "fade-out" }),
    y.useEffect(
      function () {
        if (G === "hide") return ke;
        G === "before-fade-out" && ie("fade-out");
        var U = Ni.bind(window, {
          type: "scroll",
          listener: function () {
  ...
  var Ue = y.useCallback(
      function () {
        M && A.current && A.current.requestHide({ isImmediate: !0 });
      },
      [M],
    ),
    Me = y.useCallback(
      function () {
        k && A.current && A.current.requestHide({ isImmediate: !0 });
      },
      [k],
    ),
    Ee = y.useCallback(
      function (U) {
        if (!(de.current && U.target === de.current) && !U.defaultPrevented) {
          U.preventDefault();
          var ce =
            n === "mouse"
              ? { type: "mouse", mouse: Ed({ left: U.clientX, top: U.clientY }) }
              : { type: "keyboard" };
          ot(ce);
        }
      },
    ...
    Ve = y.useCallback(function (U) {
      (de.current && U.target === de.current) ||
        U.defaultPrevented ||
        (U.preventDefault(), A.current && A.current.requestHide({ isImmediate: !1 }));
    }, []),
    ar =
      n === "mouse"
        ? function (U) {
            ...
            (ce = A.current) !== null &&
              ce !== void 0 &&
              ce.isActive() &&
              (A.current.mousePosition = Ed({ left: U.clientX, top: U.clientY }));
          }
        : void 0,
    ...
    Pa = y.useCallback(
      function () {
        try {
          if (
            Q.current &&
            !Q.current.matches(":focus-visible") &&
    ...
    Ui = G !== "hide" && !!o,
    Vs = !D && Ui,
    Gs = G !== "hide" && G !== "fade-out",
    Tp = y.useCallback(function () {
      var U;
      (U = A.current) === null || U === void 0 || U.requestHide({ isImmediate: !0 });
    }, []);
  b1({
    isOpen: Ui && (me("platform_dst_open_layer_observer_close_layers") ? Gs : !0),
    onClose: Tp,
  });
  var Hs = function () {
      var ce;
      if (n === "mouse" && (ce = A.current) !== null && ce !== void 0 && ce.mousePosition) {
        var Mt;
        return (Mt = A.current) === null || Mt === void 0 ? void 0 : Mt.mousePosition;
      }
      return Q.current || void 0;
    },
    tn = mk("tooltip", Vs),
    Vi = {
      onMouseOver: Ee,
  ...
  v && (Vi["data-testid"] = "".concat(v, "--container"));
  var Ws = typeof t == "function";
  y.useEffect(
    function () {
      if (!Ws) {
        var U = Q.current;
        if (!(!U || !tn))
          return (
            U.setAttribute("aria-describedby", tn),
            function () {
  ...
  var Ks = Vs
    ? S.createElement(
        "span",
        { "data-testid": v ? "".concat(v, "-hidden") : void 0, hidden: !0, id: tn },
  ...
  return S.createElement(
    ...
    typeof t == "function"
      ? S.createElement(
          S.Fragment,
          null,
          t(Fr(Fr({}, Vi), {}, { "aria-describedby": tn, ref: ye })),
          Ks,
        )
      : S.createElement(Dp, J({}, Vi, { ref: fe, role: "presentation" }), t, Ks),
    Ui
      ? S.createElement(
          hk,
          { zIndex: wk },
          S.createElement(tk, { placement: I, referenceElement: Hs(), strategy: B }, function (U) {
            var ce = U.ref,
              Mt = U.style,
              Gi = U.update,
              Hi = U.placement,
              Er = n === "mouse" ? void 0 : Ok[kk(Hi)];
            return S.createElement(
              op,
              { appear: !0 },
              Gs &&
                S.createElement(
                  ...
                  function (rn) {
                    ...
                    return S.createElement(
                      ...
                      {
                        ref: ce,
                        className: "Tooltip ".concat(Lp),
                        style: Fr(Fr({}, Mt), R && { pointerEvents: "none" }),
                        truncate: s,
                        placement: I,
                        testId: Hs() ? v : v && "".concat(v, "--unresolved"),
                        onMouseOut: Ve,
                        onMouseOver: Ca,
                      },
...
var Sk = [
  ...
  Ek = { headCellContainer: "_1e0c1txw _4cvr1h6o" },
  Cp = function (t) {
    var r = t.content,
      n = t.inlineStyles,
      a = t.testId;
    ...
    var i = t.innerRef,
      ...
      A = S.createElement(
        Mi,
        { xcss: Ek.headCellContainer, onMouseEnter: N, onMouseLeave: z, onFocus: D, onBlur: I },
        S.createElement(
          xp,
          { content: c === yr ? f : h },
          S.createElement(
            e0,
            { onClick: s, xcss: Hn.buttonWrapper, "aria-roledescription": g },
            S.createElement(
              pi,
              { xcss: R ? Hn.hideIconHeaderWrapper : Hn.visibleHeaderWrapper },
              S.createElement(
                jv,
            ...
            E &&
              S.createElement(
                pi,
                { xcss: W ? Hn.sortIconVisibleWrapper : Hn.sortIconHiddenWrapper },
                c === yr
                  ? S.createElement(d1, {
                      label: "",
                      color: "var(--ds-text-subtle, #44546F)",
  ...
  xk = ["isRanking", "refHeight", "refWidth"];
function Ck(e, t, r) {
  return (t = X(t)), Te(e, Pp() ? Reflect.construct(t, r || [], X(e).constructor) : t.apply(e, r));
}
function Pp() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
...
var Pk = (function (e) {
    function t() {
      return pe(this, t), Ck(this, t, arguments);
    }
    return (
      Le(t, e),
      he(t, [
        {
          ...
          value: function () {
            ...
            var i = n.refWidth,
              o = se(n, xk),
              c = iv(a, i);
            return S.createElement(Cp, J({ inlineStyles: c }, o));
          },
        },
      ])
    );
  ...
  Rk = rp(Pk),
  Ak = ["content", "inlineStyles", "testId", "isRanking", "innerRef", "isSortable", "onClick"],
  Rp = function (t) {
    var r = t.content,
      n = t.inlineStyles,
      a = t.testId;
  ...
  jk = ["isRanking", "refHeight", "refWidth"];
function Ik(e, t, r) {
  return (t = X(t)), Te(e, Ap() ? Reflect.construct(t, r || [], X(e).constructor) : t.apply(e, r));
}
function Ap() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
...
var Dk = (function (e) {
    function t() {
      return pe(this, t), Ik(this, t, arguments);
    }
    return (
      Le(t, e),
      he(t, [
        {
          ...
          value: function () {
            ...
            var i = n.refWidth,
              o = se(n, jk),
              c = iv(a, i);
            return S.createElement(Rp, J({ inlineStyles: c }, o));
          },
        },
      ])
    );
...
function Nk(e, t, r) {
  return (t = X(t)), Te(e, jp() ? Reflect.construct(t, r || [], X(e).constructor) : t.apply(e, r));
}
function jp() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
...
var Fk = (function (e) {
    function t(r) {
      var n;
      return pe(this, t), (n = Nk(this, t, [r])), (n.state = { activeSortButtonId: null }), n;
    }
    return (
      Le(t, e),
      he(t, [
        {
          ...
          value: function () {
            si(this.props.sortKey, this.props.head);
          },
        },
        {
          key: "UNSAFE_componentWillReceiveProps",
              ...
              S.createElement(
                ...
                g.map(function (m, O) {
                  var w = m.ascendingSortTooltip,
                    ...
                    E = m.width,
                    D = se(m, Mk),
                    I = "head-cell-".concat(O),
                    N = function () {
                      n.setState({ activeSortButtonId: I }), L && u(m)();
                    };
  ...
  $k = ["isRankable", "isRanking", "onRankStart", "onRankEnd", "isRankingDisabled"];
function zk(e) {
  switch (e) {
    case di:
      return yr;
...
var Bk = function (t) {
    ...
    var we = function (Ee) {
        return function () {
          ...
          if (Ve) {
            ...
            var ar = Ve !== o ? yr : zk(c);
            fe && fe({ key: Ve, item: Ee, sortOrder: ar });
          }
        };
      },
      at = function (Ee, Ve) {
      ...
      Kt = function () {
        return z || (av(i || [], M, m).length > 2 ? fi : gm);
      },
      it = function () {
        return h ? S.createElement(Cm, { testId: l }) : $ && S.createElement(Pm, { testId: l }, $);
      },
      yt = i && i.length,
      Se,
      mt = !1;
    d && Number.isInteger(d) && m && yt && yt <= d
      ? ((Se = Math.ceil(d / m)), (mt = !0))
      : (Se = yt && m ? Math.ceil(yt / m) : 0),
      (Se = Se < 1 ? 1 : Se);
    var _t = M > Se ? Se : M,
      ot = !!yt,
      en = Kt(),
    ...
    return S.createElement(
      ...
      S.createElement(
        ...
        S.createElement(
          Sm,
          { isFixedSize: g, "aria-label": f, hasDataRow: ot, testId: l, isLoading: h },
          !!r && S.createElement(Em, null, r),
          n &&
            S.createElement(Fk, {
              head: n,
              onSort: we,
      ...
      !ot &&
        Ue &&
        S.createElement(Ov, { isLoading: h, spinnerSize: fi, testId: l, loadingLabel: s }, Ue),
    );
  },
  qk = y.lazy(function () {
    return ay(
      () => import("./body-BmOxLV5f.js"),
      __vite__mapDeps([0, 1, 2, 3, 4]),
      import.meta.url,
    );
  }),
  Uk = y.forwardRef(function (t, r) {
    var n = t.isRankable,
      a = n === void 0 ? !1 : n,
      i = t.isRanking,
      o = t.onRankStart,
    ...
    var p = S.createElement(Um, J({ ref: r }, u));
    return l && v
      ? S.createElement(
          Gm,
          { fallback: p },
...
function Vk(e, t, r) {
  return (t = X(t)), Te(e, Ip() ? Reflect.construct(t, r || [], X(e).constructor) : t.apply(e, r));
}
function Ip() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
...
const Gk = (e, t) => {
    ...
    switch (t) {
      ...
      case "HISTORY": {
        r.push({ key: "summaryBeginTime", content: "summaryBeginTime", isSortable: !0, width: 10 }),
...
function Yk() {
  ...
  const r = async () => {
      ...
      try {
        ...
        console.error(h), Ke("explain error", h.message);
      } finally {
        e.stopLoading();
      }
    },
    ...
    a = async () => {
      ...
      try {
        ...
        console.error(h), Ke("explain analyze error", h.message);
      } finally {
        e.stopLoading();
      }
    },
    ...
    o = async () => {
      ...
      try {
        ...
        console.error(h), Ke("execute query error", h.message);
      } finally {
        e.stopLoading();
      }
    },
    ...
    s = async () => {
      ...
      try {
        ...
        console.error(h), Ke("Optimize error", h.message);
      } finally {
        e.stopLoading();
      }
    },
    ...
    l = async () => {
      ...
      try {
        ...
        console.error(h), Ke("dropStats error", h.message);
      } finally {
        e.stopLoading();
      }
    },
    d = async () => {
      ...
      try {
        ...
        console.error(h), Ke("deoptimize error", h.message);
      } finally {
        e.stopLoading();
      }
    },
    f = async () => {
      ...
      try {
        ...
        console.error(h), Ke("History error", h.message);
      } finally {
        e.stopLoading();
      }
    },
    v = async () => {
      ...
      try {
        ...
        console.error(h), Ke("Slowquery error", h.message);
      } finally {
        e.stopLoading();
      }
    };
        ...
        children: [
            ...
            children: [
              ...
              P.jsx("div", {
                ...
                children: P.jsxs("div", {
                  ...
                  children: [
                    P.jsx("button", { onClick: o, children: "1. Execute SQL" }),
            ...
            children: [
              ...
              P.jsx("div", {
                ...
                children: P.jsxs("div", {
                  className: "button-row",
                  children: [
                    P.jsx("button", { onClick: s, children: "4. Add optimization indexes" }),
                    P.jsx("button", { onClick: o, children: "5. Execute SQL" }),
            ...
            children: [
              ...
              P.jsx("div", {
                ...
                children: P.jsxs("div", {
                  className: "button-row",
                  children: [
                    P.jsx("button", { onClick: c, children: "8. Execute CTE" }),
                    P.jsx("button", { onClick: n, children: "9. Explain CTE  (optional)" }),
                    P.jsx("button", { onClick: i, children: "10. Explain Analyze CTE" }),
                  ],
                }),
              }),
            ],
              ...
              P.jsx("div", {
                ...
                children: P.jsxs("div", {
                  ...
                  children: [
                    ...
                    P.jsx("button", { onClick: c, children: "10. Execute CTE" }),
                    P.jsx("button", { onClick: n, children: "11. Explain CTE (optional)" }),
                    P.jsx("button", { onClick: i, children: "12. Explain Analyze CTE" }),
                  ],
                }),
              }),
            ],
          ...
          P.jsxs("section", {
            ...
            children: [
              ...
              P.jsx("div", {
                className: "button-group",
                children: P.jsx("button", { onClick: f, children: "Show Query History" }),
              }),
            ],
          }),
          P.jsx("div", { className: "section-spacer" }),
...
const Jk = Ii(Yk),
  Xk = document.getElementById("root"),
  Qk = Fp.createRoot(Xk),
  Pd = () => {
    Qk.render(P.jsx(ev, { ...tv, children: P.jsx(Jk, {}) }));
  };
Pe.view.theme
  .enable()
  .then(() => {
