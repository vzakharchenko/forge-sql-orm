const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      "./body-DddyKcwy.js",
      "./react-dom-vendor-BO7srUs7.js",
      "./client-core-vendor-CfdH7eUg.js",
      "./lodash-vendor-kZ2JueWD.js",
      "./body-BBWlFbG-.css",
    ]),
) => i.map((i) => d[i]);
import { r as vt, a as yi, c as ph } from "./react-dom-vendor-BO7srUs7.js";
import { g as Ps, a as tr, r as Zt, s as Ve } from "./client-core-vendor-CfdH7eUg.js";
import { r as hh } from "./lodash-vendor-kZ2JueWD.js";
function gh(e, t) {
...
var dc;
function yh() {
  return (dc || ((dc = 1), (Ki.exports = bh())), Ki.exports);
}
var x = yh(),
  Yi = {},
  Go = function (e, t) {
...
function of(e, t, r, n, a, i) {
  ...
  for (
    ...
    var g = (0, r[v])(s === "accessor" ? { get: l.get, set: l.set } : l[c], p);
    if (s === "accessor") {
...
function bf(e, t, r) {
  ...
  function o(v) {
    return function (p) {
      return Promise.resolve(p).then(v, d);
    };
  }
  function s(v, p) {
    n[v] &&
  ...
  function f(v, p) {
    (v(p), i.shift(), i.length && c(i[0][0], i[0][1]));
  }
}
function yf(e) {
  var t, r;
...
function wf(e) {
  ...
  var t = {};
  if (e != null) for (var r = Ho(e), n = 0; n < r.length; n++) r[n] !== "default" && mi(t, e, r[n]);
  return (mh(t, e), t);
}
function Of(e) {
...
const wh = {
    ...
    __rewriteRelativeImportExtension: Pf,
  },
  Oh = Object.freeze(
...
function Oe() {
  if (pc) return on;
  ((pc = 1), Object.defineProperty(on, "__esModule", { value: !0 }), (on.getCallBridge = void 0));
  const e = Dt();
  function t(n) {
    return !!n?.callBridge;
  }
...
function Rf() {
  if (hc) return cn;
  ((hc = 1), Object.defineProperty(cn, "__esModule", { value: !0 }), (cn.withRateLimiter = void 0));
  const e = Dt(),
    t = (r, n, a, i) => {
      let o = Date.now(),
        s = 0;
...
function Sh() {
  if (gc) return an;
  ((gc = 1), Object.defineProperty(an, "__esModule", { value: !0 }), (an.invoke = void 0));
  const e = Oe(),
    t = Dt(),
    r = Rf(),
    n = (0, e.getCallBridge)(),
    a = (o) => {
      if (o && Object.values(o).some((s) => typeof s == "function"))
    ...
    i = (o, s) => {
      ...
      return (a(s), n("invoke", { functionKey: o, payload: s }));
    };
  return (
...
function Eh() {
  return (
    bc ||
      ((bc = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), It.__exportStar(Sh(), e));
      })(Ji)),
    Ji
  );
}
    ...
    yc ||
      ...
      (function (e) {
        ...
        const s = (0, t.getCallBridge)(),
          ...
          u = (d) => async (f) => {
            c(f);
            const v = { ...f, invokeType: `ui-${d.toLowerCase()}-fetch` },
              p = await s("invoke", v),
              { success: h, payload: g, error: b } = p ?? {},
              m = { ...(h ? g : b) };
            if (m && m.headers)
              for (const O in m.headers)
                Array.isArray(m.headers[O]) && (m.headers[O] = m.headers[O].join(","));
            return m;
          },
          l = (d) => {
            const f = u(d);
...
function xh() {
  if (mc) return un;
  ((mc = 1), Object.defineProperty(un, "__esModule", { value: !0 }), (un.invokeRemote = void 0));
  const e = Af(),
...
function Ch() {
  if (_c) return ln;
  ((_c = 1), Object.defineProperty(ln, "__esModule", { value: !0 }), (ln.invokeService = void 0));
  const e = Af(),
...
function Rh() {
  if (Oc) return fn;
  ((Oc = 1), Object.defineProperty(fn, "__esModule", { value: !0 }), (fn.submit = void 0));
  const e = Oe(),
    t = Dt(),
    r = (0, e.getCallBridge)(),
    n = async (a) => {
...
function Ah() {
  if (kc) return vn;
  ((kc = 1), Object.defineProperty(vn, "__esModule", { value: !0 }), (vn.close = void 0));
  const e = Oe(),
    t = Dt(),
    r = (0, e.getCallBridge)(),
    n = async (a) => {
...
function Ih() {
  if (Ec) return hn;
  ((Ec = 1), Object.defineProperty(hn, "__esModule", { value: !0 }), (hn.createHistory = void 0));
...
function Lh() {
  if (Ac) return yn;
  ((Ac = 1), Object.defineProperty(yn, "__esModule", { value: !0 }), (yn.ensureLocale = void 0));
  const e = jf(),
...
var no = {},
  Ic;
function Nh() {
  return (Ic || ((Ic = 1), Object.defineProperty(no, "__esModule", { value: !0 })), no);
}
var Dc;
function Df() {
  return (
...
function $h() {
  if (Tc) return gn;
  ((Tc = 1), Object.defineProperty(gn, "__esModule", { value: !0 }), (gn.getContext = void 0));
  const e = Oe(),
    t = Df(),
    r = (0, e.getCallBridge)(),
    n = async () => {
...
function Lf() {
  if (Fc) return On;
  ((Fc = 1), Object.defineProperty(On, "__esModule", { value: !0 }), (On.events = void 0));
  const e = Oe(),
    t = Bh(),
    r = (0, e.getCallBridge)(),
    n = async (i, o) => {
...
function qh() {
  if (zc) return wn;
  ((zc = 1), Object.defineProperty(wn, "__esModule", { value: !0 }), (wn.emitReadyEvent = void 0));
  const e = Lf(),
    t = Mf(),
    r = "EXTENSION_READY",
    n = async () => {
...
function Mf() {
  if (Bc) return dn;
  ((Bc = 1), Object.defineProperty(dn, "__esModule", { value: !0 }), (dn.view = void 0));
  const e = Rh(),
    t = Ah(),
    r = jh(),
    n = Ih(),
...
function Nf() {
  return (
    qc ||
      ((qc = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), It.__exportStar(Mf(), e));
      })(Zi)),
    Zi
  );
}
...
function Uh() {
  if (Uc) return kn;
  ((Uc = 1), Object.defineProperty(kn, "__esModule", { value: !0 }), (kn.router = void 0));
  const t = (0, Oe().getCallBridge)(),
    r = async (o) => {
...
function Vh() {
  return (
    Vc ||
      ((Vc = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), It.__exportStar(Uh(), e));
      })(io)),
    io
  );
}
...
function Gh() {
  if (Gc) return Sn;
  ((Gc = 1), Object.defineProperty(Sn, "__esModule", { value: !0 }), (Sn.Modal = void 0));
  const e = Oe(),
    t = Dt(),
    r = (0, e.getCallBridge)(),
    n = () => {};
...
function Hh() {
  return (
    Hc ||
      ((Hc = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), It.__exportStar(Gh(), e));
      })(oo)),
    oo
  );
}
...
function Wh() {
  if (Wc) return En;
  ((Wc = 1), Object.defineProperty(En, "__esModule", { value: !0 }), (En.productFetchApi = void 0));
  const e = Tf(),
    t = async (a) => {
      const i = {};
    ...
    n = (a) => {
      const i = async (o, s, c) => {
        ...
        const f = {
          ...
          m = b ? (0, e.base64ToBlob)(v, p["content-type"]) : v;
        return new Response(m || null, { headers: p, status: g, statusText: h });
      };
      return {
...
function Kh() {
  ...
  (Object.defineProperty($t, "__esModule", { value: !0 }),
    ($t.requestBitbucket = $t.requestJira = $t.requestConfluence = void 0));
  const t = Oe();
  return (
...
function Yh() {
  if (Yc) return xn;
  ((Yc = 1), Object.defineProperty(xn, "__esModule", { value: !0 }), (xn.showFlag = void 0));
  const e = Oe(),
    t = Dt(),
    r = (0, e.getCallBridge)(),
    n = (a) => {
...
function Xh() {
  return (
    Xc ||
      ((Xc = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), It.__exportStar(Lf(), e));
      })(co)),
    co
  );
}
...
function Qh() {
  if (Qc) return Cn;
  ((Qc = 1), Object.defineProperty(Cn, "__esModule", { value: !0 }), (Cn.__realtime = void 0));
  const t = (0, Oe().getCallBridge)(),
    r = (a, i) => t("publishRealtimeChannel", { channelName: a, eventPayload: i }),
    n = (a, i) => t("subscribeRealtimeChannel", { channelName: a, onEvent: i });
  return ((Cn.__realtime = { publish: r, subscribe: n }), Cn);
}
var Zc;
function Zh() {
  return (
    Zc ||
      ((Zc = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), It.__exportStar(Qh(), e));
      })(uo)),
    uo
  );
}
...
function eg() {
  ...
  return ((Ft.createTranslationFunction = o), Ft);
}
var tu;
function tg() {
  return (
...
function er(e) {
  ...
  return typeof r == "function" && r.toString() === ag;
}
function qf(e) {
  var t = e?.constructor;
...
function og(e) {
  ...
  return r.length
    ? [].concat(
        t,
        r.filter(function (n) {
          return wi.propertyIsEnumerable.call(e, n);
        }),
      )
    : t;
}
...
function Gt(e, t) {
  return wi.hasOwnProperty.call(e, t);
}
var sg =
...
function cg(e, t) {
  for (var r = 0; r < t.length; r++) {
    ...
    ((n.enumerable = n.enumerable || !1),
      ...
      Object.defineProperty(e, lg(n.key), n));
  }
}
function Jr(e, t, r) {
...
function wa(e, t, r) {
  (Gt(e, St) || ki(e, St, hr({}, e[St])), yg(r) || (e[St][t] = r));
}
function fg(e) {
  return (Gt(e, St) || ki(e, St, hr({}, e[St])), e[St]);
}
function Oa(e) {
...
function Wf(e, t, r) {
  ...
  var n = new rr(e);
  return (t !== $r && kb(n, t), r !== $r && pv(n, r), n);
}
function vg(e, t) {
  return xv(e, t);
}
...
var ti = { structural: vg, default: pg };
function gr(e, t, r) {
  return yv(e)
    ? e
    : Array.isArray(e)
...
function hg(e, t, r) {
  if (e == null || Ii(e) || ji(e) || Or(e) || kt(e)) return e;
  ...
  if (qt(e)) return se.set(e, { name: r, deep: !1 });
}
function Ei(e) {
  return e;
}
...
var bg = "override";
function yg(e) {
  return e.annotationType_ === bg;
}
function ka(e, t) {
  return { annotationType_: e, options_: t, make_: mg, extend_: _g, decorate_20223_: wg };
}
function mg(e, t, r, n) {
  var a;
...
function Kf(e, t, r, n, a) {
  var i, o, s, c, u, l, d;
  (a === void 0 && (a = R.safeDescriptors), Og(e, t, r, n));
  var f = n.value;
...
function Yf(e, t) {
  return { annotationType_: e, options_: t, make_: kg, extend_: Sg, decorate_20223_: Eg };
}
function kg(e, t, r, n) {
  var a;
  if (n === e.target_) return this.extend_(e, t, r, !1) === null ? 0 : 2;
...
function Jf(e, t, r, n, a, i) {
  (i === void 0 && (i = R.safeDescriptors), xg(e, t, r, n));
  var o = n.value;
  if ((ua(o) || (o = Ur(o)), a)) {
    var s;
...
function js(e, t) {
  return { annotationType_: e, options_: t, make_: Cg, extend_: Pg, decorate_20223_: Rg };
}
function Cg(e, t, r) {
...
function xi(e, t) {
  return { annotationType_: e, options_: t, make_: jg, extend_: Ig, decorate_20223_: Dg };
}
function jg(e, t, r) {
  return this.extend_(e, t, r, !1) === null ? 0 : 1;
}
...
var Lg = "true",
  Mg = Xf();
function Xf(e) {
  return { annotationType_: Lg, options_: e, make_: Ng, extend_: $g, decorate_20223_: Fg };
}
function Ng(e, t, r, n) {
  var a, i;
  if (r.get) return Ci.make_(e, t, r, n);
  if (r.set) {
...
function $g(e, t, r, n) {
  var a, i;
  if (r.get) return Ci.extend_(e, t, r, n);
  if (r.set)
...
var zg = "observable",
  Bg = "observable.ref",
  qg = "observable.shallow",
  Ug = "observable.struct",
...
var Yo = xi(zg),
  Vg = xi(Bg, { enhancer: Ei }),
  Gg = xi(qg, { enhancer: hg }),
  Hg = xi(Ug, { enhancer: gg }),
  Zf = xt(Yo);
function Ta(e) {
  return e.deep === !0 ? gr : e.deep === !1 ? Ei : Kg(e.defaultDecorator);
}
function Wg(e) {
  var t;
...
function ev(e, t, r) {
  if (Oa(t)) return Yo.decorate_20223_(e, t);
  if (pr(t)) {
    wa(e, t, Yo);
    return;
  }
...
var Yg = {
    ...
    array: function (t, r) {
      var n = Da(r);
      return (R.useProxies === !1 || n.proxy === !1 ? Wb : Nb)(t, Ta(n), n.name);
    },
    map: function (t, r) {
      var n = Da(r);
    ...
    object: function (t, r, n) {
      return kr(function () {
        return Cb(R.useProxies === !1 || n?.proxy === !1 ? Xr({}, n) : Tb({}, n), t, r);
      });
    },
    ref: xt(Vg),
    shallow: xt(Gg),
  ...
  Jg = "computed.struct",
  Jo = js(tv),
  Xg = js(Jg, { equals: ti.structural }),
  Ci = function (t, r) {
    if (Oa(r)) return Jo.decorate_20223_(t, r);
    if (pr(r)) return wa(t, r, Jo);
    if (er(t)) return xt(js(tv, t));
    var n = er(r) ? r : {};
...
function br(e, t, r, n) {
  r === void 0 && (r = !1);
  function a() {
    return eb(e, r, t, n || this, arguments);
  }
  return (
    (a.isMobxAction = !0),
    (a.toString = function () {
...
var fr = (function (e) {
    ...
    return (
      ...
      (r.prepareNewValue_ = function (a) {
        if (Ye(this)) {
          var i = Je(this, { object: this, type: Ct, newValue: a });
      ...
      (r.setNewValue_ = function (a) {
        ...
        ((this.value_ = a),
          this.reportChanged(),
          ut(this) && lt(this, { type: Ct, object: this, newValue: a, oldValue: i }));
      }),
      (r.get = function () {
  ...
  ft = (function () {
    ...
    return (
      ...
      (t.suspend_ = function () {
        this.keepAlive_ || (Qo(this), (this.value_ = void 0));
      }),
...
function Xo(e) {
  switch (e.dependenciesState_) {
    ...
    case X.POSSIBLY_STALE_: {
      for (var t = Is(!0), r = wr(), n = e.observing_, a = n.length, i = 0; i < a; i++) {
        var o = n[i];
        if (Ai(o)) {
          ...
          if (e.dependenciesState_ === X.STALE_) return (Ht(r), Zn(t), !0);
        }
      }
      return (av(e), Ht(r), Zn(t), !1);
    }
  }
}
function rv(e, t, r) {
  ...
  return (R.inBatch--, (R.trackingDerivation = a), ab(e), Zn(n), i);
}
function ab(e) {
  for (
    var t = e.observing_,
  ...
  for (; a--; ) {
    var u = r[a];
    u.diffValue === 1 && ((u.diffValue = 0), ob(u, e));
  }
...
function ib() {
  if (((R.pendingReactions.length || R.inBatch || R.isRunningReactions) && Y(36), (iv = !0), Ha)) {
    var e = _i();
    (--e.__mobxInstanceCount === 0 && (e.__mobxGlobals = void 0), (R = new Ga()));
  }
}
function ob(e, t) {
  (e.observers_.add(t),
...
function cv(e) {
  ...
  return t !== null
    ? (t.runId_ !== e.lastAccessedBy_ &&
      ...
      e.isBeingObserved)
    : (e.observers_.size === 0 && R.inBatch > 0 && sv(e), !1);
}
function uv(e) {
...
var At = (function () {
  ...
  return (
    ...
    (t.schedule_ = function () {
      this.isScheduled || ((this.isScheduled = !0), R.pendingReactions.push(this), lv());
    }),
    (t.runReaction_ = function () {
      if (!this.isDisposed) {
        (Xe(), (this.isScheduled = !1));
        var n = R.trackingContext;
        if (((R.trackingContext = this), Xo(this))) {
    ...
    (t.dispose = function () {
      this.isDisposed || ((this.isDisposed = !0), this.isRunning || (Xe(), Qo(this), Qe()));
    }),
...
var dv = "action",
  ...
  es = ka(dv),
  gb = ka(vb, { bound: !0 }),
  ts = ka(fv, { autoAction: !0 }),
  bb = ka(pb, { autoAction: !0, bound: !0 });
function vv(e) {
  var t = function (n, a) {
    if (dt(n)) return br(n.name || hb, n, e);
    if (dt(a)) return br(n, a, e);
    if (Oa(a)) return (e ? ts : es).decorate_20223_(n, a);
    if (pr(a)) return wa(n, a, e ? ts : es);
    if (pr(n)) return xt(ka(e ? fv : dv, { name: n, autoAction: e }));
  };
  return t;
}
var Ze = vv(!1);
...
function xb(e) {
  ...
  var t = e.useProxies,
    r = e.enforceActions;
  if (
    (t !== void 0 && (R.useProxies = t === La ? !0 : t === Sb ? !1 : typeof Proxy < "u"),
    t === "ifavailable" && (R.verifyProxies = !0),
    r !== void 0)
  ) {
    var n = r === La ? La : r === Eb;
    ((R.enforceActions = n), (R.allowStateChanges = !(n === !0 || n === La)));
  }
  ([
    ...
    e.reactionScheduler && db(e.reactionScheduler));
}
function Cb(e, t, r, n) {
  var a = sg(t);
  return (
...
function gv(e) {
  var t = { name: e.name_ };
  return (
    e.observing_ && e.observing_.length > 0 && (t.dependencies = Rb(e.observing_).map(gv)),
    t
  );
}
function Rb(e) {
...
var lo = Yf("flow"),
  jb = Yf("flow.bound", { bound: !0 }),
  Ur = Object.assign(function (t, r) {
    if (Oa(r)) return lo.decorate_20223_(t, r);
    if (pr(r)) return wa(t, r, lo);
    var n = t,
        ...
        var s = this,
          ...
          v = new Promise(function (p, h) {
            ...
            function O(w) {
              ...
              return w.done ? p(w.value) : ((f = Promise.resolve(w.value)), f.then(b, m));
            }
            b(void 0);
          });
        return (
          (v.cancel = Ze(a + " - runid: " + u + " - cancel", function () {
            try {
              f && ou(f);
              var p = l.return(void 0),
                h = Promise.resolve(p.value);
              (h.then($r, $r), ou(h), d(new bv()));
            } catch (g) {
              d(g);
            }
          })),
...
function Ib(e, t) {
  return e ? Ii(e) || !!e[N] || As(e) || ii(e) || Ai(e) : !1;
}
function yv(e) {
  return Ib(e);
}
...
function Tb(e, t) {
  ...
  return (
    zf(),
    (e = Xr(e, t)),
    (n = (r = e[N]).proxy_) != null ? n : (r.proxy_ = new Proxy(e, Db))
  );
}
function Ye(e) {
    ...
    return (
      ...
      (t.spliceWithArray_ = function (n, a, i) {
        ...
        if (
          ...
          var c = Je(this, { object: this.proxy_, type: su, index: n, removedCount: a, added: i });
          if (!c) return Wo;
      ...
      (t.set_ = function (n, a) {
        var i = this.values_;
        if ((this.legacyMode_ && n > i.length && Y(17, n, i.length), n < i.length)) {
          this.atom_;
          var o = i[n];
          if (Ye(this)) {
            var s = Je(this, { type: Ct, object: this.proxy_, index: n, newValue: a });
            if (!s) return;
            a = s.newValue;
          }
...
var $b = _r("ObservableArrayAdministration", Ts);
function ji(e) {
  return Oi(e) && $b(e[N]);
}
var Fb = {},
  ...
  _v = (function () {
    ...
    return (
      ...
      (t.has = function (n) {
        ...
        if (!i) {
          var o = (i = new fr(this.has_(n), Ei, "ObservableMap.key?", !1));
      ...
      (t.set = function (n, a) {
        var i = this.has_(n);
        if (Ye(this)) {
          var o = Je(this, { type: i ? Ct : Xt, object: this, newValue: a, name: n });
          if (!o) return this;
          a = o.newValue;
        }
      ...
      (t.delete = function (n) {
        ...
        if ((this.keysAtom_, Ye(this))) {
          var i = Je(this, { type: si, object: this, name: n });
          if (!i) return !1;
        }
        if (this.has_(n)) {
          var o = ea(),
      ...
      (t.replace = function (n) {
        ...
        return (
          Ut(function () {
            for (
              var i = zb(n), o = new Map(), s = !1, c = Fr(a.data_.keys()), u;
              !(u = c()).done;
            ...
            for (var v = Fr(i.entries()), p; !(p = v()).done; ) {
              var h = p.value,
                g = h[0],
                b = h[1],
                m = a.data_.has(g);
            ...
            if (!s)
              if (a.data_.size !== o.size) a.keysAtom_.reportChanged();
                ...
                for (var w = a.data_.keys(), _ = o.keys(), k = w.next(), E = _.next(); !k.done; ) {
                  if (k.value !== E.value) {
  ...
  Or = _r("ObservableMap", _v);
function cu(e) {
  return ((e[Symbol.toStringTag] = "MapIterator"), Ms(e));
}
function zb(e) {
...
var Bb = {},
  wv = (function () {
    ...
    return (
      ...
      (t.delete = function (n) {
        var a = this;
        if (Ye(this)) {
          var i = Je(this, { type: si, object: this, oldValue: n });
          if (!i) return !1;
        }
        if (this.has(n)) {
          var o = !1,
      ...
      (t.intersection = function (n) {
        if (qt(n) && !kt(n)) return n.intersection(this);
        var a = new Set(this);
        return a.intersection(n);
      }),
      (t.union = function (n) {
        if (qt(n) && !kt(n)) return n.union(this);
        var a = new Set(this);
        return a.union(n);
      }),
      ...
      (t.symmetricDifference = function (n) {
        if (qt(n) && !kt(n)) return n.symmetricDifference(this);
        var a = new Set(this);
      ...
      (t.isDisjointFrom = function (n) {
        if (qt(n) && !kt(n)) return n.isDisjointFrom(this);
        var a = new Set(this);
  ...
  kt = _r("ObservableSet", wv);
function uu(e) {
  return ((e[Symbol.toStringTag] = "SetIterator"), Ms(e));
}
  ...
  Ov = (function () {
    ...
    return (
      ...
      (t.setObservablePropValue_ = function (n, a) {
        ...
        if (Ye(this)) {
          var o = Je(this, { type: Ct, object: this.proxy_ || this.target_, name: n, newValue: a });
          if (!o) return null;
          a = o.newValue;
        }
        if (((a = i.prepareNewValue_(a)), a !== R.UNCHANGED)) {
      ...
      (t.get_ = function (n) {
        return (R.trackingDerivation && !Gt(this.target_, n) && this.has_(n), this.target_[n]);
      }),
      ...
      (t.has_ = function (n) {
        ...
        return (
          a ||
            ((a = new fr(n in this.target_, Ei, "ObservableObject.key?", !1)),
      ...
      (t.make_ = function (n, a) {
        if ((a === !0 && (a = this.defaultAnnotation_), a !== !1)) {
          if (!(n in this.target_)) {
            var i;
            if ((i = this.target_[St]) != null && i[n]) return;
            Y(1, a.annotationType_, this.name_ + "." + n.toString());
          }
          for (var o = this.target_; o && o !== wi; ) {
            var s = ei(o, n);
            if (s) {
      ...
      (t.delete_ = function (n, a) {
        if ((a === void 0 && (a = !1), this.keysAtom_, !Gt(this.target_, n))) return !0;
        if (Ye(this)) {
          var i = Je(this, { object: this.proxy_ || this.target_, name: n, type: du });
          if (!i) return null;
        }
        try {
          var o;
          ...
          if (
            (u && (this.values_.delete(n), u instanceof fr && (l = u.value_), uv(u)),
...
function Xr(e, t) {
  ...
  var n = (r = t?.name) != null ? r : "ObservableObject",
    a = new Ov(e, new Map(), String(n), Wg(t));
  return (ki(e, N, a), e);
}
var qb = _r("ObservableObjectAdministration", Ov);
function fu(e) {
  return (
    lu[e] ||
    (lu[e] = {
...
var Ls = (function (e) {
  function t(n, a, i, o) {
    ...
    return (
      ...
      (s = e.call(this) || this),
      kr(function () {
        var c = new Ts(i, a, o, !0);
        ((c.proxy_ = s),
          Uf(s, N, c),
          n && n.length && s.spliceWithArray(0, 0, n),
          Vb && Object.defineProperty(s, "0", Ub));
      }),
      s
    );
  }
...
function Hb(e) {
  Et(Ls.prototype, "" + e, Sv(e));
}
function Ev(e) {
  if (e > fo) {
    for (var t = fo; t < e + 100; t++) Hb(t);
    fo = e;
  }
}
Ev(1e3);
...
function ci(e, t) {
  if (typeof e == "object" && e !== null) {
    if (ji(e)) return (t !== void 0 && Y(23), e[N].atom_);
    if (kt(e)) return e.atom_;
    if (Or(e)) {
      if (t === void 0) return e.keysAtom_;
      var r = e.data_.get(t) || e.hasMap_.get(t);
      return (r || Y(25, t, rs(e)), r);
    }
    if (Ii(e)) {
      if (!t) return Y(26);
      var n = e[N].values_.get(t);
      return (n || Y(27, t, rs(e)), n);
    }
    if (As(e) || Ai(e) || ii(e)) return e;
  } else if (dt(e) && ii(e[N])) return e[N];
  Y(28);
}
function Kb(e, t) {
  if ((e || Y(29), As(e) || Ai(e) || ii(e) || Or(e) || kt(e))) return e;
  if (e[N]) return e[N];
  Y(24, e);
}
function rs(e, t) {
...
function ns(e, t, r, n, a) {
  ...
  if ((n.push(e), a.push(t), s)) {
    ...
    for (var v = 0; v < f; v++) {
      var p = d[v];
      if (!(Gt(t, p) && ns(e[p], t[p], r - 1, n, a))) return !1;
    }
  }
  return (n.pop(), a.pop(), !0);
}
function hu(e) {
  return ji(e) ? e.slice() : Yr(e) || Or(e) || qt(e) || kt(e) ? Array.from(e.entries()) : e;
}
var gu,
  Yb = ((gu = _i().Iterator) == null ? void 0 : gu.prototype) || {};
function Ms(e) {
  return ((e[Symbol.iterator] = Jb), Object.assign(Object.create(Yb), e));
}
function Jb() {
  return this;
}
...
typeof __MOBX_DEVTOOLS_GLOBAL_HOOK__ == "object" &&
  __MOBX_DEVTOOLS_GLOBAL_HOOK__.injectMobx({ spy: fb, extras: { getDebugName: rs }, $mobx: N });
var y = vt();
const S = tr(y),
  bu = gh({ __proto__: null, default: S }, [y]);
  ...
  ry = (function () {
    function e(t) {
      ...
      (Object.defineProperty(this, "finalize", {
        ...
        Object.defineProperty(this, "sweep", {
          ...
          writable: !0,
          value: function (n) {
            (n === void 0 && (n = ey), clearTimeout(r.sweepTimeout), (r.sweepTimeout = void 0));
            var a = Date.now();
    ...
    return (
      ...
      Object.defineProperty(e.prototype, "scheduleSweep", {
        ...
        writable: !0,
        value: function () {
          this.sweepTimeout === void 0 && (this.sweepTimeout = setTimeout(this.sweep, ty));
        },
      }),
      e
    );
  })(),
  ny = typeof FinalizationRegistry < "u" ? FinalizationRegistry : ry,
  la = new ny(function (e) {
    var t;
...
function ay() {
  ...
  function s(d, f) {
    var v = f(),
      p = n({ inst: { value: v, getSnapshot: f } }),
      h = p[0].inst,
      g = p[1];
    return (
      i(
        function () {
          ((h.value = v), (h.getSnapshot = f), c(h) && g({ inst: h }));
        },
        [d, v, f],
      ),
      a(
...
var mu;
function iy() {
  return (mu || ((mu = 1), (vo.exports = ay())), vo.exports);
}
var oy = iy();
function _u(e) {
...
function sy(e, t) {
  ...
  var a = r.current;
  (a.reaction || (_u(a), la.register(r, a, a)),
    S.useDebugValue(a.reaction, Zb),
    oy.useSyncExternalStore(a.subscribe, a.getSnapshot, a.getSnapshot));
  var i, o;
  if (
  ...
  cy =
    (go =
      (ho = Object.getOwnPropertyDescriptor(function () {}, "name")) === null || ho === void 0
        ? void 0
        : ho.configurable) !== null && go !== void 0
      ? go
      : !1,
  wu = Cv
...
function uy(e, t) {
  ...
  return (
    ...
    cy && Object.defineProperty(o, "name", { value: e.name, writable: !0, configurable: !0 }),
...
function dy(e, t) {
  Object.keys(e).forEach(function (r) {
    ly[r] || Object.defineProperty(t, r, Object.getOwnPropertyDescriptor(e, r));
  });
}
var bo;
Qb(yi.unstable_batchedUpdates);
bo = la.finalizeAllImmediately;
function fy(e, t) {
  if (ku(e, t)) return !0;
  ...
  for (var a = 0; a < r.length; a++)
    if (!Object.hasOwnProperty.call(t, r[a]) || !ku(e[r[a]], t[r[a]])) return !1;
  return !0;
}
function ku(e, t) {
...
function py(e, t, r) {
  ...
  if (!(a && a[Pv])) {
    var i = e[t],
      o = Rv(e, t, a ? a.enumerable : void 0, n, i);
    Object.defineProperty(e, t, o);
  }
}
function Rv(e, t, r, n, a) {
  var i,
    o = xu(a, n);
  return (
    (i = {}),
...
function hy(e) {
  ...
  if (e.__proto__ !== y.PureComponent) {
    if (!t.shouldComponentUpdate) t.shouldComponentUpdate = Ru;
    else if (t.shouldComponentUpdate !== Ru)
      throw new Error(
...
function gy(e) {
  var t = e.bind(this),
    r = as(this);
  function n() {
    r.reaction || ((r.reaction = by(r)), r.mounted || la.register(this, r, this));
    var a = void 0,
      i = void 0;
    if (
...
function Av(e) {
  var t = e.children,
    ...
    a = S.useRef(os({}, n, r)),
    i = a.current;
  return S.createElement(Au.Provider, { value: i }, t);
}
...
var _y = Object.defineProperty,
  ...
  Tt = (e, t, r, n) => {
    for (var a = n > 1 ? void 0 : n ? wy(t, r) : t, i = e.length - 1, o; i >= 0; i--)
      (o = e[i]) && (a = (n ? o(t, r, a) : o(a)) || a);
    return (n && a && _y(t, r, a), a);
  };
class ht {
  constructor() {
    ((this.isLoading = !1), Ds(this));
  }
  showPlan(t, r) {
...
Tt([se], ht.prototype, "isLoading", 2);
Tt([se], ht.prototype, "plan", 2);
Tt([se], ht.prototype, "planString", 2);
Tt([se], ht.prototype, "slowQueries", 2);
Tt([se], ht.prototype, "history", 2);
Tt([Ze.bound], ht.prototype, "showPlan", 1);
Tt([Ze.bound], ht.prototype, "saveSlowQuery", 1);
Tt([Ze.bound], ht.prototype, "saveHistory", 1);
Tt([Ze], ht.prototype, "loading", 1);
Tt([Ze], ht.prototype, "stopLoading", 1);
const Oy = new ht();
var ky = Object.defineProperty,
  Sy = Object.getOwnPropertyDescriptor,
  Ns = (e, t, r, n) => {
    for (var a = n > 1 ? void 0 : n ? Sy(t, r) : t, i = e.length - 1, o; i >= 0; i--)
      (o = e[i]) && (a = (n ? o(t, r, a) : o(a)) || a);
    return (n && a && ky(t, r, a), a);
  };
class Ti {
  constructor() {
    ((this.state = "ROOT"), (this.lastState = "ROOT"), Ds(this));
  }
  saveState(t) {
    ((this.lastState = this.state), (this.state = t));
  }
}
Ns([se], Ti.prototype, "state", 2);
Ns([se], Ti.prototype, "lastState", 2);
Ns([Ze.bound], Ti.prototype, "saveState", 1);
const $s = new Ti();
class Ey {
  constructor() {
    ((this.usersStore = Oy), (this.stateStore = $s));
  }
}
const jv = new Ey(),
  xy = y.createContext(jv),
  Li = () => y.useContext(xy);
function le(e, t) {
          ...
          if (
            ...
            return new Promise((h, g) => {
              (p.addEventListener("load", h),
                p.addEventListener("error", () => g(new Error(`Unable to preload CSS for ${l}`))));
            });
        }),
      );
    }
  ...
  return de(e, [
    {
      ...
      value: function (r) {
        return (
          ...
          Ae(r) === "object" && (this.payload = yo(yo({}, this.payload), r)),
          this
        );
      },
    },
...
function Le(e) {
  return Fy(e) || zy(e) || Dv(e) || By();
}
function qy(e, t) {
  for (; !{}.hasOwnProperty.call(e, t) && (e = W(e)) !== null; );
  return e;
}
function li() {
  return (
...
function Uy(e, t, r) {
  return (
    (t = W(t)),
    Ie(e, Mv() ? Reflect.construct(t, r || [], W(e).constructor) : t.apply(e, r))
  );
}
function Mv() {
  try {
    ...
    de(t, [
      {
        key: "update",
        value: function (n) {
          return this.hasFired ? this : Vy(t, "update", this, 3)([n]);
        },
      },
    ])
  );
})($y);
function Lu(e, t, r, n, a, i, o) {
  try {
    var s = e[i](o),
      c = s.value;
  } catch (u) {
    ...
    $u ||
      ...
      (function (e) {
        ...
        function r() {
          ...
          function c(g, b, m, O) {
            var w = b && b.prototype instanceof l ? b : l,
                ...
                (function (k, E, I) {
                  var D,
                    ...
                    Z = {
                      ...
                      f: B.bind(n, 4),
                      d: function (J, j) {
                        return ((D = J), (P = 0), (L = n), (Z.n = j), u);
                      },
                    };
                  function B(V, J) {
                    for (P = V, L = J, a = 0; !U && z && !j && a < F.length; a++) {
                      var j,
                        q = F[a],
                        he = Z.p,
                        K = q[2];
                      V > 3
                        ? (j = K === J) &&
                          ((L = q[(P = q[4]) ? 5 : ((P = 3), 3)]), (q[4] = q[5] = n))
                        : q[0] <= he &&
                          ((j = V < 2 && he < q[1])
                            ? ((P = 0), (Z.v = J), (Z.n = q[1]))
                            : he < K &&
                              (j = V < 3 || q[0] > J || J > K) &&
                              ((q[4] = V), (q[5] = J), (Z.n = K), (P = 0)));
                    }
                    if (j || V > 1) return u;
                    throw ((U = !0), J);
                  }
                  return function (V, J, j) {
                    ...
                    for (U && J === 1 && B(J, j), P = J, L = j; (a = P < 2 ? n : L) || !U; ) {
                      D || (P ? (P < 3 ? (P > 1 && (Z.n = -1), B(P, L)) : (Z.n = L)) : (Z.v = L));
                      try {
                        if (((z = 2), D)) {
                          if ((P || (V = "next"), (a = D[V]))) {
                            if (!(a = a.call(D, L)))
                            ...
                            (P === 1 && (a = D.return) && a.call(D),
                              P < 2 &&
                                ...
                                (P = 1)));
                          D = n;
                        } else if ((a = (U = Z.n < 0) ? L : k.call(E, Z)) !== u) break;
                      } catch (q) {
                        ((D = n), (P = 1), (L = q));
                      } finally {
                        z = 1;
          ...
          var v = [][o]
              ...
              : (t((a = {}), o, function () {
                ...
                a),
            p = (f.prototype = l.prototype = Object.create(v));
          function h(g) {
            return (
              Object.setPrototypeOf
                ? Object.setPrototypeOf(g, f)
                : ((g.__proto__ = f), t(g, s, "GeneratorFunction")),
              (g.prototype = Object.create(p)),
              g
            );
          }
          return (
      ...
      (function (e) {
        ...
        function c() {
            ...
            return function (m) {
              (g ||
                ((g = {
                  ...
                  delegateYield: function (w, _, k) {
                    return ((g.resultName = _), b(m.d, s(w), k));
                  },
                  finish: function (w) {
                    return b(m.f, w);
                  },
          ...
          return ((e.exports = c =
            function () {
              return {
                wrap: function (b, m, O, w) {
                  return u.w(p(b), m, O, w && w.reverse());
                },
                ...
                AsyncIterator: i,
                async: function (b, m, O, w, _) {
                  return (f(m) ? a : n)(p(b), m, O, w, _);
                },
                keys: o,
                values: s,
              };
...
function Zy() {
  if (Wu) return Ma;
  ((Wu = 1), Object.defineProperty(Ma, "__esModule", { value: !0 }));
  const e = Zt();
  let t = class {
    constructor(n) {
      ((this._sdkKey = n),
  ...
  var e =
    ...
    function (a, i, o, s) {
      ...
      return new (o || (o = Promise))(function (u, l) {
        ...
        function v(p) {
          p.done ? u(p.value) : c(p.value).then(d, f);
        }
        v((s = s.apply(a, i || [])).next());
      });
    };
      ...
      return e(this, void 0, void 0, function* () {
        ...
        if (g?.has_updates) {
          const m =
            g?.hash_used !==
            ((h =
              (p = (v = this._option) === null || v === void 0 ? void 0 : v.networkConfig) ===
                null || p === void 0
                ? void 0
...
function tm() {
  ...
  function o(l, d, f, v) {
    const h = l.getDynamicConfig(d.config_name, r(v) ? void 0 : t).get(d.param_name);
    return n(h, f) ? f : h;
  }
  function s(l, d, f, v) {
    const h = l.getExperiment(d.experiment_name, r(v) ? void 0 : t).get(d.param_name);
    return n(h, f) ? f : h;
  }
  function c(l, d, f, v) {
    const h = l.getLayer(d.layer_name, r(v) ? void 0 : t).get(d.param_name);
    return n(h, f) ? f : h;
  }
  function u(l, d, f) {
    return (v, p) => {
...
function nm() {
  ...
  var e =
    ...
    function (s, c, u, l) {
      ...
      return new (u || (u = Promise))(function (f, v) {
        ...
        function g(b) {
          b.done ? f(b.value) : d(b.value).then(p, h);
        }
  ...
  const t = Zt(),
    ...
    a = tm(),
    i = rm();
  let o = class cs extends t.StatsigClientBase {
    static instance(c) {
      const u = (0, t._getStatsigGlobal)().instance(c);
      return u instanceof cs
        ? u
        : (t.Log.warn(
            (0, t._isServerEnv)()
    ...
    constructor(c, u, l = null) {
      ...
      const p = (f = l?.plugins) !== null && f !== void 0 ? f : [];
    ...
    _updateUserSyncImpl(c, u, l) {
      ...
      const p = u?.disableBackgroundCacheRefresh;
      return p === !0 || (p == null && v?.source === "Bootstrap")
    ...
    _getFeatureGateImpl(c, u) {
      var l, d;
      const { result: f, details: v } = this._store.getGate(c),
        p = (0, t._makeFeatureGate)(c, v, f),
        h =
    ...
    _getDynamicConfigImpl(c, u) {
      var l, d;
      const { result: f, details: v } = this._store.getConfig(c),
        p = (0, t._makeDynamicConfig)(c, v, f),
        h =
          (d =
    ...
    _getLayerImpl(c, u) {
      var l, d, f;
      const { result: v, details: p } = this._store.getLayer(c),
        h = (0, t._makeLayer)(c, p, v),
        g =
          (d =
    ...
    _getParameterStoreImpl(c, u) {
      var l, d;
      const { result: f, details: v } = this._store.getParamStore(c);
      ...
      return (
        h != null &&
          ...
          (p.details = h.details),
          (p.get = (0, a._makeParamStoreGetter)(this, h.config, u))),
        p
      );
    }
  };
        ...
        (function (r) {
          ...
          function u(d, f, v, p) {
            ...
            if (I === "*" || I === "**" || v[I]) {
              if (I === "*") {
                for (m in v)
                  m !== "_listeners" && v.hasOwnProperty(m) && (h = h.concat(u(d, f, v[m], p + 1)));
                return h;
              } else if (I === "**") {
                ((k = p + 1 === E || (p + 2 === E && D === "*")),
                  k && v._listeners && (h = h.concat(u(d, f, v, E))));
                for (m in v)
                  m !== "_listeners" &&
                    v.hasOwnProperty(m) &&
                    (m === "*" || m === "**"
                      ? (v[m]._listeners && !k && (h = h.concat(u(d, f, v[m], E))),
                        (h = h.concat(u(d, f, v[m], p))))
                      : m === D
                        ? (h = h.concat(u(d, f, v[m], p + 2)))
                        : (h = h.concat(u(d, f, v[m], p))));
                return h;
              }
              h = h.concat(u(d, f, v[I], p + 1));
            }
            if (((O = v["*"]), O && u(d, f, O, p + 1), (w = v["**"]), w))
              if (p < E) {
                w._listeners && u(d, f, w, E);
                for (m in w)
                  m !== "_listeners" &&
                    w.hasOwnProperty(m) &&
                    (m === D
                      ...
                      : m === I
                        ? u(d, f, w[m], p + 1)
                        : ((_ = {}), (_[m] = w[m]), u(d, f, { "**": _ }, p + 1)));
              } else
                w._listeners ? u(d, f, w, E) : w["*"] && w["*"]._listeners && u(d, f, w["*"], E);
            return h;
          }
          function l(d, f) {
            d = typeof d == "string" ? d.split(this.delimiter) : d.slice();
            for (var v = 0, p = d.length; v + 1 < p; v++)
              if (d[v] === "**" && d[v + 1] === "**") return;
            for (var h = this.listenerTree, g = d.shift(); g !== r; ) {
              if ((h[g] || (h[g] = {}), (h = h[g]), d.length === 0))
                return (
                  h._listeners
                    ? (typeof h._listeners == "function" && (h._listeners = [h._listeners]),
                      h._listeners.push(f),
                      !h._listeners.warned &&
                        this._maxListeners > 0 &&
                        h._listeners.length > this._maxListeners &&
                        ((h._listeners.warned = !0), s.call(this, h._listeners.length, g)))
                    : (h._listeners = f),
                  !0
                );
              g = d.shift();
          ...
          ((c.prototype.delimiter = "."),
            ...
            (c.prototype.event = ""),
            (c.prototype.once = function (d, f) {
              return this._once(d, f, !1);
            }),
            (c.prototype.prependOnceListener = function (d, f) {
              return this._once(d, f, !0);
            }),
            (c.prototype._once = function (d, f, v) {
              return (this._many(d, 1, f, v), this);
            }),
            (c.prototype.many = function (d, f, v) {
              return this._many(d, f, v, !1);
            }),
            (c.prototype.prependMany = function (d, f, v) {
              return this._many(d, f, v, !0);
            }),
            (c.prototype._many = function (d, f, v, p) {
              var h = this;
              if (typeof v != "function")
                throw new Error("many only accepts instances of Function");
              function g() {
                return (--f === 0 && h.off(d, g), v.apply(this, arguments));
              }
              return ((g._origin = v), this._on(d, g, p), h);
            }),
                ...
                for (h = 0, p = b.length; h < p; h++)
                  switch (((this.event = d), f)) {
                    case 1:
                      ...
                      break;
                    case 2:
                      b[h].call(this, d, arguments[1]);
                      break;
                    case 3:
                      b[h].call(this, d, arguments[1], arguments[2]);
                      break;
                    default:
                      b[h].apply(this, v);
                  }
                ...
                for (h = 0, p = b.length; h < p; h++)
                  switch (((this.event = d), f)) {
                    case 1:
                      ...
                      break;
                    case 2:
                      b[h].call(this, arguments[1]);
                      break;
                    case 3:
                      b[h].call(this, arguments[1], arguments[2]);
                      break;
                    default:
                      b[h].apply(this, v);
                  }
            ...
            (c.prototype.emitAsync = function () {
              ...
              var f = [],
                ...
                m;
              if (this._all) {
                if (v > 3) for (p = new Array(v), b = 1; b < v; b++) p[b] = arguments[b];
                for (g = 0, h = this._all.length; g < h; g++)
                  switch (((this.event = d), v)) {
                    ...
                    case 3:
                      ...
                      break;
                    default:
                      f.push(this._all[g].apply(this, p));
                  }
              }
              if (this.wildcard) {
                m = [];
              ...
              if (typeof m == "function")
                switch (((this.event = d), v)) {
                  ...
                  case 3:
                    ...
                    break;
                  default:
                    for (p = new Array(v - 1), b = 1; b < v; b++) p[b - 1] = arguments[b];
                    f.push(m.apply(this, p));
                }
              else if (m && m.length) {
                if (((m = m.slice()), v > 3))
                  for (p = new Array(v - 1), b = 1; b < v; b++) p[b - 1] = arguments[b];
            ...
            (c.prototype.prependListener = function (d, f) {
              return this._on(d, f, !0);
            }),
            (c.prototype.onAny = function (d) {
              return this._onAny(d, !1);
            }),
            (c.prototype.prependAny = function (d) {
              return this._onAny(d, !0);
            }),
            (c.prototype.addListener = c.prototype.on),
            (c.prototype._onAny = function (d, f) {
              if (typeof d != "function")
                throw new Error("onAny only accepts instances of Function");
              return (
                this._all || (this._all = []),
                f ? this._all.unshift(d) : this._all.push(d),
                this
              );
            }),
            (c.prototype._on = function (d, f, v) {
                  ...
                  : (this._events[d]
                      ? (typeof this._events[d] == "function" &&
                        ...
                        !this._events[d].warned &&
                          ...
                          ((this._events[d].warned = !0), s.call(this, this._events[d].length, d)))
                      : (this._events[d] = f),
                    this)
              );
            }),
            (c.prototype.off = function (d, f) {
              if (typeof f != "function")
                throw new Error("removeListener only takes instances of Function");
              var v,
                p = [];
              if (this.wildcard) {
                var h = typeof d == "string" ? d.split(this.delimiter) : d.slice();
                p = u.call(this, null, h, this.listenerTree, 0);
              } else {
                if (!this._events[d]) return this;
                ((v = this._events[d]), p.push({ _listeners: v }));
              }
                ...
                if (k !== r) {
                  ...
                  for (var I in E) {
                    ...
                    P instanceof Function ||
                      typeof P != "object" ||
                      P === null ||
                      (Object.keys(P).length > 0 && _(k[D]),
                      Object.keys(P).length === 0 && delete k[D]);
                  }
                }
              }
            ...
            (c.prototype.offAny = function (d) {
              ...
              if (d && this._all && this._all.length > 0) {
                for (p = this._all, f = 0, v = p.length; f < v; f++)
                  if (d === p[f]) return (p.splice(f, 1), this.emit("removeListenerAny", d), this);
              } else {
                for (p = this._all, f = 0, v = p.length; f < v; f++)
                  this.emit("removeListenerAny", p[f]);
                this._all = [];
              }
              return this;
            }),
...
var sm = Uv.EventEmitter2 || om,
  Na = "@all-features",
  cm = (function () {
    function e() {
      (le(this, e), C(this, "eventToValue", new Map()), (this.emitter = new sm()));
    }
    return de(e, [
      {
        key: "onGateUpdated",
      ...
      },
      {
        ...
        value: function (r, n, a, i, o, s) {
          ...
          var d = function () {
            var v = o(r, n, a, Yt(Yt({}, s), {}, { fireExperimentExposure: !1 })),
              p = c.eventToValue.get(i);
            p !== v && (c.eventToValue.set(i, v), i(v));
          };
          return (
            this.emitter.on(u, d),
            function () {
...
var $a = function (t) {
    return us({ perimeter: lm() ? fa.FEDRAMP_MODERATE : fa.COMMERCIAL }, t);
  },
  An = function (t, r) {
    if (!t && !r) return !0;
    if (!t || !r) return !1;
  ...
  vm = Object.entries(Fs).map(function (e) {
    var t = Q(e, 2),
      r = t[0],
      n = t[1];
...
function hm(e, t, r) {
  if (Gv()) return Reflect.construct.apply(null, arguments);
  var n = [null];
  n.push.apply(n, t);
...
function ds(e) {
  ...
  return (
    (ds = function (n) {
      ...
      function a() {
        return hm(n, arguments, W(this).constructor);
      }
      return (
...
function gm(e, t, r) {
  return (
    (t = W(t)),
    Ie(e, Hv() ? Reflect.construct(t, r || [], W(e).constructor) : t.apply(e, r))
  );
}
function Hv() {
  try {
...
var ym = 5e3,
  mm = "https://api.atlassian.com/flags",
  _m = "https://api.stg.atlassian.com/flags",
  wm = "https://api.dev.atlassian.com/flags",
  Om = "https://api.stg.atlassian-us-gov-mod.com/flags",
  km = "https://api.atlassian-us-gov-mod.com/flags",
  Sm = "/gateway/api/flags",
  jo = (function () {
    function e() {
      le(this, e);
    }
                ...
                function (p) {
                  for (;;)
                    switch ((p.prev = p.next)) {
                      case 0:
                        return (
                          (c = e.getBaseUrl(o.environment, o.useGatewayURL, o.perimeter)),
                          (u = o.fetchTimeoutMs || ym),
                          AbortSignal.timeout
                      ...
                      case 5:
                        return ((f = p.sent), (p.next = 8), this.handleResponseError(f));
                      case 8:
                        return ((p.next = 10), this.extractResponseBody(f));
                      case 10:
...
function Em(e, t, r) {
  return (
    (t = W(t)),
    Ie(e, Wv() ? Reflect.construct(t, r || [], W(e).constructor) : t.apply(e, r))
  );
}
function Wv() {
  try {
...
var Cm = (function (e) {
  function t() {
    ...
    return (
      le(this, t),
      (r = Em(this, t, ["NoFetchDataAdapter", "nofetch"])),
...
var Io = "LocalOverride:Recognized",
  Am = "STATSIG_OVERRIDES",
    ...
    return de(e, [
      ...
      },
      {
        ...
        value: function () {
          ...
          for (var o = 0, s = a; o < s.length; o++) {
            ...
            for (
              var h = 0, g = Object.entries((b = c.configs) !== null && b !== void 0 ? b : {});
              h < g.length;
              h++
            ) {
              var b,
            ...
            for (
              var _ = 0, k = Object.entries((E = c.layers) !== null && E !== void 0 ? E : {});
              _ < k.length;
              _++
            ) {
              var E,
          ...
          for (var a = 0, i = Object.entries(n); a < i.length; a++)
            for (
              ...
              var d = Q(l[u], 2),
                f = d[0],
                v = d[1];
              this._djb2Map.set(Ge(Ve._DJB2(f), s), v);
            }
          this._overrides = n;
        },
      },
      ...
      },
      {
        ...
        value: function (r, n) {
          ...
          return i == null
            ? null
            : Ee(Ee({}, r), {}, { value: i, details: Ee(Ee({}, r.details), {}, { reason: Io }) });
        },
      },
      {
          ...
          return i == null
            ...
            : Ee(
                ...
                {},
                {
                  ...
                  details: Ee(Ee({}, r.details), {}, { reason: Io }),
                },
              );
        },
      },
  ...
  Im = ["sdkKey", "environment", "updateUserCompletionCallback", "perimeter"];
function fl(e, t) {
  var r = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e);
...
var vl = "client-default-key",
  Dm = "https://xp.atlassian.com/v1/rgstr",
  Tm = (function () {
    function e() {
      var t = this,
      ...
      (le(this, e),
        ...
        C(this, "subscriptions", new cm()),
        C(this, "dataAdapter", new Cm()),
        C(this, "statsigValuesUpdated", function () {
          (t.user && t.statsigClient.updateUserSync(t.user, { disableBackgroundCacheRefresh: !0 }),
            t.subscriptions.anyUpdated());
        }),
        (this.overrideAdapter = i || new jm(a)));
    }
    return de(e, [
      {
        key: "initialize",
                          ...
                          (this.initPromise = this.initFromValues(u, i, o, c)
                            ...
                            .finally(function () {
                              var p = performance.now(),
                                h = p - l;
                              s.fireClientEvent(l, h, "initializeFromValues", s.initCompleted);
                            })),
                          v.abrupt("return", this.initPromise)
                        );
                      case 10:
                    ...
                    switch ((l.prev = l.next)) {
                      case 0:
                        return (
                          ...
                          (s = $a(a)),
                          (c = function () {
                            return jo.fetchExperimentValues(s, i, o).then(function (f) {
                              var v = f.experimentValues,
                                p = f.customAttributes;
                              return { experimentValues: v, customAttributesFromFetch: p };
                            });
                          }),
                          (l.next = 5),
        ...
        value: function (r) {
          ...
          try {
            ...
            return (
              ...
              new al(r, {}, "", { time: Date.now(), reason: Fs.Error })
            );
          }
        },
      },
                    ...
                    switch ((g.prev = g.next)) {
                      case 0:
                        return (
                          (s = Jt({}, a)),
                          (g.prev = 1),
                          (l = jo.fetchClientSdk(a).then(function (b) {
                            return (s.sdkKey = b.clientSdkKey);
                          })),
                          (d = jo.fetchExperimentValues(a, i, o)),
                          (g.next = 6),
                          Promise.all([l, d])
                        );
                      case 6:
                    ...
                    switch ((g.prev = g.next)) {
                      case 0:
                        return (
                          ...
                          i.stableId
                            ...
                            : (v.disableStableID = !0),
                          (g.prev = 12),
                          (this.statsigClient = new ct.StatsigClient(l, this.user, v)),
                      ...
                      case 19:
                        return (
                          ...
                          (this.statsigClient = new ct.StatsigClient(vl, this.user, v)),
                  ...
                  for (;;)
                    switch ((b.prev = b.next)) {
                      ...
                      case 20:
                        ...
                        break;
                      case 22:
                        ((b.prev = 22), (b.t1 = b.catch(15)), (p = !1), (h = String(b.t1)));
                      case 26:
                        if (
...
T = G;
C(G, "client", new Tm());
C(G, "hasCheckGateErrorOccurred", !1);
C(G, "hasGetExperimentValueErrorOccurred", !1);
C(G, "checkGate", function (e, t) {
  try {
    if (
      typeof window < "u" &&
...
C(G, "getExperimentValue", function (e, t, r, n) {
  try {
    if (
      typeof window < "u" &&
      window.__CRITERION__ &&
...
C(G, "initializeCalled", T.client.initializeCalled.bind(T.client));
C(G, "initializeCompleted", T.client.initializeCompleted.bind(T.client));
C(G, "initialize", T.client.initialize.bind(T.client));
C(G, "initializeWithProvider", T.client.initializeWithProvider.bind(T.client));
C(G, "initializeFromValues", T.client.initializeFromValues.bind(T.client));
C(G, "manuallyLogGateExposure", T.client.manuallyLogGateExposure.bind(T.client));
C(G, "getExperiment", T.client.getExperiment.bind(T.client));
C(G, "manuallyLogExperimentExposure", T.client.manuallyLogExperimentExposure.bind(T.client));
C(G, "manuallyLogLayerExposure", T.client.manuallyLogLayerExposure.bind(T.client));
C(G, "shutdownStatsig", T.client.shutdownStatsig.bind(T.client));
C(G, "overrideGate", T.client.overrideGate.bind(T.client));
C(G, "clearGateOverride", T.client.clearGateOverride.bind(T.client));
C(G, "overrideConfig", T.client.overrideConfig.bind(T.client));
C(G, "clearConfigOverride", T.client.clearConfigOverride.bind(T.client));
C(G, "setOverrides", T.client.setOverrides.bind(T.client));
C(G, "getOverrides", T.client.getOverrides.bind(T.client));
C(G, "clearAllOverrides", T.client.clearAllOverrides.bind(T.client));
C(G, "isCurrentUser", T.client.isCurrentUser.bind(T.client));
C(G, "onGateUpdated", T.client.onGateUpdated.bind(T.client));
C(G, "onExperimentValueUpdated", T.client.onExperimentValueUpdated.bind(T.client));
C(G, "onAnyUpdated", T.client.onAnyUpdated.bind(T.client));
C(G, "updateUser", T.client.updateUser.bind(T.client));
C(G, "updateUserWithProvider", T.client.updateUserWithProvider.bind(T.client));
C(G, "updateUserWithValues", T.client.updateUserWithValues.bind(T.client));
C(G, "getPackageVersion", T.client.getPackageVersion.bind(T.client));
C(G, "getLayer", T.client.getLayer.bind(T.client));
C(G, "getLayerValue", T.client.getLayerValue.bind(T.client));
var fs = G;
if (typeof window < "u")
  if (window.__FEATUREGATES_JS__ === void 0) window.__FEATUREGATES_JS__ = G;
    ...
    var pl =
      ((Fa = fs) === null || Fa === void 0 || (Do = Fa.getPackageVersion) === null || Do === void 0
        ? void 0
        : Do.call(Fa)) || "4.10.0 or earlier";
    if (pl !== zr) {
      var Lm = `Multiple versions of FeatureGateClients found on the current page.
...
var Rr,
  ...
  $m = function () {
    var t;
    Nm && (t = console).debug.apply(t, arguments);
  },
  zs = {},
  Fm = "@atlaskit/platform-feature-flags",
  ta = "__PLATFORM_FEATURE_FLAGS__",
  Kv = typeof process < "u" && typeof zs < "u",
  zm = Kv ? zs.ENABLE_PLATFORM_FF === "true" : !1,
  Bm = Kv ? zs.STORYBOOK_ENABLE_PLATFORM_FF === "true" : !1,
  qm = zm || Bm,
  Um = { booleanResolver: void 0 },
...
function Km(e, t) {
  var r = y.useState(function () {
    ...
    n = y.useRef(!0),
    a = y.useRef(r),
    i = n.current || !!(t && a.current.inputs && Wm(t, a.current.inputs)),
    ...
    f = y.useCallback(
      function (v) {
        var p = u({
          ...
          h = Jm({ componentName: n, packageName: i, packageVersion: o }, l.current);
        p.context.push(h);
        var g = p.clone();
        (g && g.fire("atlaskit"), d.current(v, p));
      },
      [r, n, a, i, o, u, l, d],
    );
  return f;
    ...
    d = y.useCallback(
      function () {
        var f = c({
          ...
          v = Xm({ componentName: n, packageName: a, packageVersion: i }, u.current);
        f.context.push(v);
        var p = f.clone();
        (p && p.fire("atlaskit"), l.current(f));
      },
      [r, n, a, i, c, u, l],
    );
  return d;
...
function A(e) {
  ...
  for (const n of e) {
    ...
    const a = n.split(" ");
    for (const i of a) {
      const o = i.startsWith("_") ? i.slice(0, Zm) : i;
      t[o] = i;
    }
  }
  let r = "";
...
var yl = "#FF5630",
  ...
  ps = "rgba(9, 30, 66, 0.08)",
  US = "rgba(9, 30, 66, 0.25)",
  VS = "rgba(9, 30, 66, 0.31)",
  st = "#9FB0CC",
  a_ = "#8C9CB8",
  To = "#67758F",
  Dn = "#3B475C",
  ...
  Tn = "#1B2638",
  Tr = "#0D1424",
  i_ = ["isFixedSize", "hasDataRow", "children", "testId", "isLoading"];
function Cl(e, t) {
  var r = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e);
...
var o_ = y.forwardRef(function (e, t) {
    var r = e.isFixedSize,
      n = e.hasDataRow,
      a = e.children,
      i = e.testId,
    ...
    return y.createElement(
      ...
      H({ inert: o ? "" : void 0, ref: t }, s, {
        ...
        style: Pl(
          Pl(
            {},
            {
              "--local-dynamic-table-hover-bg":
                "var(--ds-background-neutral-subtle-hovered, ".concat(e_, ")"),
          ...
          {},
          { "--_k02y3n": Ke("2px solid ".concat("var(--ds-border, ".concat(vs, ")"))) },
        ),
      }),
      a,
    );
...
function f_(e, t, r) {
  return (
    (t = W(t)),
    Ie(e, Qv() ? Reflect.construct(t, r || [], W(e).constructor) : t.apply(e, r))
  );
}
function Qv() {
  try {
...
function p_(e) {
  var t = (function (r) {
    function n() {
      ...
      return ((a = f_(this, n, [].concat(o))), C(a, "state", { pageRows: [] }), a);
    }
    return (
      De(n, r),
      de(
          ...
          },
          {
            ...
            value: function () {
              ...
              return S.createElement(
                e,
                H({ pageRows: this.state.pageRows, head: o }, c, { ref: s }),
              );
            },
          },
        ],
        [
          {
            ...
            value: function (i, o) {
              ...
              var p, h;
              return (
                v ? ((p = s), (h = s)) : ((p = v_(c, s, u, l) || []), (h = Tv(p, d, f))),
                Al(Al({}, o), {}, { pageRows: h })
              );
            },
          },
  ...
  return S.forwardRef(function (r, n) {
    return S.createElement(t, H({}, r, { forwardedRef: n }));
  });
}
...
var m_ = y.forwardRef(function (e, t) {
  ...
  O_ = function (t) {
    ...
    return S.createElement(
      ...
      s.map(function (u, l) {
        ...
        return S.createElement(
          b_,
          H({ "data-testid": f || (a && "".concat(a, "--cell-").concat(l)) }, v, {
            isFixedSize: i,
            key: l,
            shouldTruncate: h,
            width: g,
...
function k_(e, t, r) {
  return (
    (t = W(t)),
    Ie(e, ep() ? Reflect.construct(t, r || [], W(e).constructor) : t.apply(e, r))
  );
}
function ep() {
  try {
...
var S_ = (function (e) {
    function t() {
      return (le(this, t), k_(this, t, arguments));
    }
    return (
      De(t, e),
      de(t, [
  ...
  E_ = p_(
    S.forwardRef(function (e, t) {
      return S.createElement(S_, H({}, e, { forwardedRef: t }));
    }),
  );
function x_(e, t, r) {
  return (
    (t = W(t)),
    Ie(e, tp() ? Reflect.construct(t, r || [], W(e).constructor) : t.apply(e, r))
  );
}
function tp() {
  try {
...
var C_ = (function (e) {
  function t(r) {
    var n;
    return (le(this, t), (n = x_(this, t, [r])), (n.state = { hasError: !1 }), n);
  }
  return (
    De(t, e),
    de(
...
var P_ = { xsmall: 8, small: 16, medium: 24, large: 48, xlarge: 96 };
function R_(e) {
  return e === "inherit"
...
var za = {
  ...
  A_ = typeof window > "u" ? y.useEffect : y.useLayoutEffect,
  rp = S.memo(
      ...
      return (
        ...
        S.createElement(
          "span",
          {
            ...
            className: A([za.wrapperStyles, za.rotateStyles]),
          },
          S.createElement(
            "svg",
            {
  ...
  I_ = function (t) {
    ...
    return y.createElement(
      "div",
      {
        ...
        style: Ll(Ll({}, C({}, Ml, n)), {}, { "--_cnddr8": Ke("var(".concat(Ml, ")")) }),
      },
      r,
    );
  },
...
function T_(e, t, r) {
  return (
    (t = W(t)),
    Ie(e, np() ? Reflect.construct(t, r || [], W(e).constructor) : t.apply(e, r))
  );
}
function np() {
  try {
...
var ap = (function (e) {
  function t() {
    return (le(this, t), T_(this, t, arguments));
  }
  return (
    De(t, e),
    de(t, [
      {
        ...
        value: function () {
          ...
          return S.createElement(
            j_,
            { testId: c },
            i ? S.createElement(I_, { contentsOpacity: s, testId: c }, a) : a,
            i &&
              S.createElement(
                D_,
                { testId: c },
...
var L_ = ["children", "testId"],
  M_ = y.forwardRef(function (e, t) {
    var r = e.children,
      n = e.testId,
      a = ae(e, L_);
    return y.createElement(
      "div",
      H({}, a, { "data-testid": n, ref: t, className: A(["_kqswh2mm _6rth1ejb"]) }),
      r,
    );
  }),
  N_ = function (t) {
  ...
  $_ = y.forwardRef(function (e, t) {
    var r = e.children;
    return y.createElement("div", { ref: t, className: A(["_kqswh2mm _152tidpf"]) }, r);
  });
function F_(e, t, r) {
  return (
    (t = W(t)),
    Ie(e, ip() ? Reflect.construct(t, r || [], W(e).constructor) : t.apply(e, r))
  );
}
function ip() {
  try {
      ...
      },
      {
        ...
        value: function () {
          ...
          if (!(!o || typeof o.getBoundingClientRect != "function" || !s)) {
            ...
            if (d) {
              var h = p >= l * 3;
              if (h && !this.isFullyVerticallyVisible(c, i)) {
                if (f >= 0) {
                  var g = i - f,
                    b = g / 2 + f - l / 2,
                    m = g < l * 3 ? f + l : b;
            ...
            if (k && typeof k.getBoundingClientRect == "function") {
              var E = k.getBoundingClientRect().top,
                I = (f - E) / 2;
...
C(op, "defaultProps", {
  isLoading: !0,
  spinnerSize: vi,
  contentsOpacity: "var(--ds-opacity-loading, ".concat("".concat(Jv), ")"),
  loadingLabel: "Loading table",
});
function z_(e) {
  var t =
    ...
    return y.createElement(
      "span",
      {
        ...
        className: A([
          ...
          "_12va1onz _jcxd1r8n",
          v && "_1bsb1kw7 _4t3i1kw7",
          (m === "utility" || O === "small") && "_vwz4utpp",
        ]),
      },
      y.createElement("svg", {
        fill: "none",
        ...
        className: A([
          ...
          v ? "_1bsb1kw7 _4t3i1kw7" : m === "utility" ? U_[g] : O === "small" ? q_[g] : B_[g],
        ]),
      }),
    );
  });
const H_ = Object.freeze(
    Object.defineProperty({ __proto__: null, Icon: Nl, default: Nl }, Symbol.toStringTag, {
      value: "Module",
    }),
  ),
  Mi = Ps(H_);
...
function sp() {
  if ($l) return Mn;
  (($l = 1), Object.defineProperty(Mn, "__esModule", { value: !0 }), (Mn.default = void 0));
  var e = r(vt()),
    t = r(Mi);
  function r(a) {
...
var W_ = {
  ...
  hs = y.memo(function (t) {
    var r = t,
      ...
      h = d && f ? { width: d + "px", height: f + "px" } : null;
    return y.createElement(
      "span",
      H(
        {
  ...
  K_ = ["dangerouslySetGlyph", "size"],
  Bl = {
    utility: { small: "compact", medium: "spacious" },
    core: { small: "none", medium: "spacious" },
  },
  Y_ = y.memo(function (t) {
    var r = t.dangerouslySetGlyph,
      n = t.size,
      a = ae(t, K_),
      i = a.newIcon,
      o = n ?? "medium",
      s = !a.isFacadeDisabled && et("platform-visual-refresh-icons-legacy-facade");
    if (s && i && (o === "small" || o === "medium"))
      if (a.iconType === "utility") {
        var c = i;
        return S.createElement(
          c,
          H({}, a, {
            spacing: et("platform-visual-refresh-icons-facade-button-fix") ? Bl.utility[o] : "none",
    ...
    return S.createElement(hs, H({ dangerouslySetGlyph: r, size: n }, a));
  });
const J_ = Object.freeze(
    Object.defineProperty(
      { __proto__: null, Icon: hs, IconFacade: Y_, default: hs },
      Symbol.toStringTag,
      { value: "Module" },
    ),
  ),
...
function X_() {
  if (ql) return Nn;
  ((ql = 1), Object.defineProperty(Nn, "__esModule", { value: !0 }), (Nn.default = void 0));
  var e = n(vt()),
    t = cp,
    r = n(sp());
  function n(i) {
  ...
  return ((a.displayName = "ChevronLeftLargeIcon"), (Nn.default = a), Nn);
}
var Ul;
function Q_() {
  if (Ul) return Ln;
  ((Ul = 1), Object.defineProperty(Ln, "__esModule", { value: !0 }), (Ln.default = void 0));
  var e = n(vt()),
    t = n(sp()),
    r = n(X_());
  function n(i) {
  ...
  return ((a.Name = "ChevronLeftIconMigration"), (Ln.default = a), Ln);
}
var Z_ = Q_();
const e0 = tr(Z_);
var $n = {},
...
function up() {
  if (Vl) return Fn;
  ((Vl = 1), Object.defineProperty(Fn, "__esModule", { value: !0 }), (Fn.default = void 0));
  var e = r(vt()),
    t = r(Mi);
  function r(a) {
    return a && a.__esModule ? a : { default: a };
...
function t0() {
  if (Gl) return zn;
  ((Gl = 1), Object.defineProperty(zn, "__esModule", { value: !0 }), (zn.default = void 0));
  var e = n(vt()),
    t = cp,
    r = n(up());
  function n(i) {
  ...
  return ((a.displayName = "ChevronRightLargeIcon"), (zn.default = a), zn);
}
var Hl;
function r0() {
  if (Hl) return $n;
  ((Hl = 1), Object.defineProperty($n, "__esModule", { value: !0 }), ($n.default = void 0));
  var e = n(vt()),
    t = n(up()),
    r = n(t0());
  function n(i) {
...
var n0 = r0();
const a0 = tr(n0);
var qs = y.createContext("elevation.surface"),
  i0 = function () {
    return y.useContext(qs);
  };
...
var o0 = [
  ...
  Ni = y.forwardRef(function (e, t) {
    ...
    return i ? y.createElement(qs.Provider, { value: i }, I) : I;
  });
function v0(e) {
  return e in lp;
}
...
var gs = {
  ...
  O0 = function (t) {
    var r = t.children;
    return y.createElement("span", { className: A([gs.separator]) }, r);
  },
  Wa = y.memo(
    y.forwardRef(function (e, t) {
      var r = e.as,
        ...
        h = e.role,
        g = e.children,
        b = typeof f == "string" ? y.createElement(O0, null, f) : f,
        m = b
      ...
      return y.createElement(
        hi,
        {
          ...
          rowGap: d,
          wrap: s ? "wrap" : void 0,
          xcss: g0(u === "hug" && gs.hug, u === "fill" && gs.fill, v),
          testId: p,
          ref: t,
        },
        m,
...
var k0 = "Invariant failed";
function S0(e, t) {
  if (!e) throw new Error(k0);
}
var fp = y.createContext(!1),
  E0 = function () {
  ...
  P0 = function (t, r) {
    ...
    if (t !== "inherit") {
      if (t) return t;
      if (!r) return Yl.hasOwnProperty(n) ? Yl[n] : "color.text";
    }
  },
  Lr = {
  ...
  R0 = { medium: "_11c82smr", UNSAFE_small: "_11c8dcr7", large: "_11c81ixg", small: "_11c81o8v" },
  A0 = { bold: "_k48pmoej", medium: "_k48p1wq8", regular: "_k48pi7a9", semibold: "_k48p1pd9" },
  j0 = {
  ...
  I0 = y.forwardRef(function (e, t) {
    ...
    return v ? h : y.createElement(x0, { value: !0 }, h);
  });
function D0() {
...
var T0 = ["as", "children", "isInset", "testId", "style", "xcss"],
  L0 = ["className"];
function Jl(e, t) {
  var r = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
...
var M0 = y.forwardRef(function (e, t) {
    var r = e.as,
      n = r === void 0 ? "button" : r,
      a = e.children,
      i = e.isInset,
    ...
    return y.createElement(
      ...
      H({}, l, {
        ...
        style: Xl(
          Xl({}, s),
          {},
          { "--_1203r2w": Ke("calc(0px - ".concat("var(--ds-border-width-outline, 2px)", ")")) },
        ),
      }),
      a,
    );
  ...
  F0 = y.forwardRef(function (e, t) {
    var r = e.children,
      ...
      b = y.useCallback(
        function (w, _) {
          (g && g.tracePress(c, w.timeStamp), s(w, _));
        },
        [s, g, c],
      ),
      m = va({
    ...
    return y.createElement(
      M0,
      H({ as: "button", tabIndex: p ?? (D0() && !n ? 0 : void 0), style: d }, O, {
        type: i,
        onClick: m,
        disabled: n,
        xcss: dp(Ql.root, n && Ql.disabled, v),
        testId: f,
        ref: t,
      }),
      r,
...
function vp() {
  if (Zl) return Bn;
  ((Zl = 1), Object.defineProperty(Bn, "__esModule", { value: !0 }), (Bn.bind = void 0));
  function e(t, r) {
    var n = r.type,
      a = r.listener,
      i = r.options;
...
var $i = B0(),
  ...
  pp = function (e) {
    return (e === void 0 && (e = ""), { value: 1, prefix: e, uid: q0() });
  },
  U0 = pp(),
  V0 = y.createContext(pp()),
  G0 = function (e) {
    return e.value++;
  },
  H0 = function (e) {
  ...
  No,
  rd = (No = S.useId) !== null && No !== void 0 ? No : void 0;
function J0() {
  if (rd && et("platform-dst-react-18-use-id")) {
    var e = rd();
    return function (t) {
...
function qn(e, t) {
  return uw(Bi("", null, null, "", null, null, 0), e, { length: -e.length }, t);
}
function vw() {
  return pe;
}
...
function _p(e) {
  return ((zi = Vr = 1), (mp = wt((Qr = e))), (je = 0), []);
}
function wp(e) {
  return ((Qr = ""), e);
}
function Ya(e) {
  return yp(xa(je - 1, ys(e === 91 ? e + 2 : e === 40 ? e + 1 : e)));
}
function hw(e) {
  for (; (pe = Pt()) && pe < 33; ) $e();
...
function bw(e, t) {
  for (; $e() && e + pe !== 57; ) if (e + pe === 84 && Pt() === 47) break;
  return "/*" + xa(t, je - 1) + "*" + Fi(e === 47 ? e : $e());
}
function yw(e) {
  for (; !ga(Pt()); ) $e();
  return xa(e, je);
...
function mw(e) {
  return wp(Ja("", null, null, null, [""], (e = _p(e)), 0, [0], e));
}
function Ja(e, t, r, n, a, i, o, s, c) {
  for (
    ...
    switch (((p = m), (m = $e()))) {
      case 40:
        if (p != 108 && ye(E, d - 1) == 58) {
          bs((E += te(Ya(m), "&", "&\f")), "&\f") != -1 && (b = -1);
          break;
        }
      case 34:
      case 39:
        ...
        switch (m) {
          ...
          case 59 + l:
            (b == -1 && (E = te(E, /\f/g, "")),
              v > 0 &&
                wt(E) - d &&
                Ba(v > 32 ? ad(E + ";", n, r, d - 1) : ad(te(E, " ", "") + ";", n, r, d - 2), c));
            break;
          case 59:
            E += ";";
          default:
            if ((Ba((k = nd(E, t, r, u, l, a, s, O, (w = []), (_ = []), d)), i), m === 123))
              if (l === 0) Ja(E, t, k, k, w, i, d, s, _);
              else
                switch (f === 99 && ye(E, 3) === 110 ? 100 : f) {
                  ...
                  case 115:
                    Ja(
                      ...
                      k,
                      k,
                      n && Ba(nd(e, k, k, 0, 0, a, s, O, a, (w = []), d), _),
                      a,
                      _,
                      d,
                      s,
      ...
      default:
        if (h < 1) {
          if (m == 123) --h;
          else if (m == 125 && h++ == 0 && pw() == 125) continue;
        }
        switch (((E += Fi(m)), m * h)) {
          case 38:
            b = l > 0 ? 1 : ((E += "\f"), -1);
          ...
          case 44:
            ...
            break;
          case 64:
            (Pt() === 45 && (E += Ya($e())), (f = Pt()), (l = d = wt((O = E += yw(Ka())))), m++);
            break;
          case 45:
            p === 45 && wt(E) == 2 && (h = 0);
        }
...
function nd(e, t, r, n, a, i, o, s, c, u, l) {
  for (var d = a - 1, f = a === 0 ? i : [""], v = Gs(f), p = 0, h = 0, g = 0; p < n; ++p)
    for (var b = 0, m = ha(e, d + 1, (d = cw((h = o[p])))), O = e; b < v; ++b)
      (O = yp(h > 0 ? f[b] + " " + m : te(m, /&\f/g, f[b]))) && (c[g++] = O);
  return Bi(e, t, r, a === 0 ? Us : s, c, u, l);
}
function _w(e, t, r) {
  return Bi(e, t, r, gp, Fi(vw()), ha(e, 2, -2), 0);
}
function ad(e, t, r, n) {
  return Bi(e, t, r, Vs, ha(e, 0, n), ha(e, n + 1, -1), n);
}
function Br(e, t) {
  for (var r = "", n = Gs(e), a = 0; a < n; a++) r += t(e[a], a, e, t) || "";
  return r;
}
function ww(e, t, r, n) {
  switch (e.type) {
  ...
  return wt((r = Br(e.children, n))) ? (e.return = e.value + "{" + r + "}") : "";
}
function Ow(e) {
  var t = Gs(e);
...
var Ew = function (t, r, n) {
    for (var a = 0, i = 0; (a = i), (i = Pt()), a === 38 && i === 12 && (r[n] = 1), !ga(i); ) $e();
    return xa(t, je);
  },
  xw = function (t, r) {
    var n = -1,
    ...
    do
      switch (ga(a)) {
        case 0:
          (a === 38 && Pt() === 12 && (r[n] = 1), (t[n] += Ew(je - 1, r, n)));
          break;
        case 2:
          t[n] += Ya(a);
          break;
  ...
  Pw = function (t) {
    if (!(t.type !== "rule" || !t.parent || t.length < 1)) {
      ...
      if (!(t.props.length === 1 && r.charCodeAt(0) !== 58 && !id.get(n)) && !a) {
        id.set(t, !0);
        for (var i = [], o = Cw(r, i), s = n.props, c = 0, u = 0; c < o.length; c++)
          ...
          case 102:
            return (
              te(
                e,
                /(.+:)(.+)-([^]+)/,
                "$1" + ee + "$2-$3$1" + gi + (ye(e, t + 3) == 108 ? "$3" : "$2-$3"),
              ) + e
            );
          case 115:
            return ~bs(e, "stretch") ? Op(te(e, "stretch", "fill-available"), t) + e : e;
        }
      break;
    case 4949:
      if (ye(e, t + 1) !== 115) break;
    case 6444:
      switch (ye(e, wt(e) - 3 - (~bs(e, "!important") && 10))) {
        case 107:
          return te(e, ":", ":" + ee) + e;
        case 101:
          return (
...
var Aw = function (t, r, n, a) {
    if (t.length > -1 && !t.return)
      switch (t.type) {
        ...
        case Us:
          if (t.length)
            return fw(t.props, function (i) {
              switch (dw(i, /(::plac\w+|:read-\w+)/)) {
                case ":read-only":
                case ":read-write":
                  return Br([qn(t, { props: [te(i, /:(read-\w+)/, ":" + gi + "$1")] })], a);
                case "::placeholder":
                  return Br(
                    [
                      qn(t, { props: [te(i, /:(plac\w+)/, ":" + ee + "input-$1")] }),
                      qn(t, { props: [te(i, /:(plac\w+)/, ":" + gi + "$1")] }),
  ...
  Iw = function (t) {
      ...
      u = [Pw, Rw];
    {
      ...
      c = function (g, b, m, O) {
        ((l = m), v(g ? g + "{" + b.styles + "}" : b.styles), O && (p.inserted[b.name] = !0));
      };
    }
    var p = {
      key: r,
...
var sd;
function Tw() {
  return (sd || ((sd = 1), ($o.exports = Dw())), $o.exports);
}
var Fo, cd;
function Lw() {
  if (cd) return Fo;
  ...
  function o(p) {
    return e.isMemo(p) ? a : i[p.$$typeof] || t;
  }
  ...
  function v(p, h, g) {
    if (typeof h != "string") {
      ...
      var m = c(h);
      u && (m = m.concat(u(h)));
      for (var O = o(p), w = o(h), _ = 0; _ < m.length; ++_) {
        var k = m[_];
...
var Hs = function (t, r, n) {
    var a = t.key + "-" + r.name;
    (n === !1 || Mw === !1) && t.registered[a] === void 0 && (t.registered[a] = r.styles);
  },
  Sp = function (t, r, n) {
    Hs(t, r, n);
    var a = t.key + "-" + r.name;
...
var $w = {
  ...
  zo = Sw(function (e) {
    return Ep(e) ? e : e.replace(Fw, "-$&").toLowerCase();
  }),
  ld = function (t, r) {
    switch (t) {
      case "animation":
      case "animationName":
        if (typeof r == "string")
          return r.replace(zw, function (n, a, i) {
            return ((Ot = { name: a, styles: i, next: Ot }), a);
          });
    }
    return $w[t] !== 1 && !Ep(t) && typeof r == "number" && r !== 0 ? r + "px" : r;
  };
function ba(e, t, r) {
  if (r == null) return "";
  var n = r;
  ...
  switch (typeof r) {
    ...
    case "object": {
      ...
      if (i.styles !== void 0) {
        ...
        if (o !== void 0)
          for (; o !== void 0; )
            ((Ot = { name: o.name, styles: o.styles, next: Ot }), (o = o.next));
        var s = i.styles + ";";
        return s;
      }
      return Bw(e, t, r);
  ...
  if (Array.isArray(r)) for (var a = 0; a < r.length; a++) n += ba(e, t, r[a]) + ";";
    ...
    for (var i in r) {
      ...
      if (typeof o != "object") {
        ...
        for (var c = 0; c < o.length; c++) ud(o[c]) && (n += zo(i) + ":" + ld(i, o[c]) + ";");
      else {
        var u = ba(e, t, o);
        switch (i) {
          case "animation":
...
function Ws(e, t, r) {
  ...
  dd.lastIndex = 0;
  for (var u = "", l; (l = dd.exec(a)) !== null; ) u += "-" + l[1];
  var d = Nw(a) + u;
...
var qw = function (t) {
  ...
  Uw = bu.useInsertionEffect ? bu.useInsertionEffect : !1,
  xp = Uw || qw,
  Cp = y.createContext(typeof HTMLElement < "u" ? Iw({ key: "css" }) : null);
Cp.Provider;
var Pp = function (t) {
  ...
  Vw = function (t, r) {
    var n = {};
    for (var a in r) Ks.call(r, a) && (n[a] = r[a]);
    return ((n[ms] = t), n);
  },
  Gw = function (t) {
    var r = t.cache,
  ...
  Hw = Pp(function (e, t, r) {
    ...
    var s = Ws(i, void 0, y.useContext(Rp));
    o += t.key + "-" + s.name;
    var c = {};
    for (var u in e) Ks.call(e, u) && u !== "css" && u !== ms && (c[u] = e[u]);
    return (
      (c.className = o),
      r && (c.ref = r),
      y.createElement(
        y.Fragment,
        null,
        y.createElement(Gw, { cache: t, serialized: s, isStringTag: typeof a == "string" }),
        y.createElement(a, c),
      )
    );
  }),
  ...
  Vt = function (t, r) {
    var n = arguments;
    if (r == null || !Ks.call(r, "css")) return y.createElement.apply(void 0, n);
    var a = n.length,
      i = new Array(a);
    ((i[0] = Ww), (i[1] = Vw(t, r)));
  ...
  Xw = Pp(function (e, t) {
    var r = [],
      n = function () {
        ...
        var d = Ws(u, t.registered);
        return (r.push(d), Hs(t, d, !1), t.key + "-" + d.name);
      },
      a = function () {
        for (var c = arguments.length, u = new Array(c), l = 0; l < c; l++) u[l] = arguments[l];
        return Yw(t.registered, n, Kw(u));
      },
    ...
    return y.createElement(
      y.Fragment,
      null,
      y.createElement(Jw, { cache: t, serializedArr: r }),
      o,
    );
  });
function Qw(e, t) {
...
var _s = 2,
  ws = Lt({
    outline: "".concat(_s, "px solid ", "var(--ds-border-focused, #2684FF)"),
    outlineOffset: _s,
  }),
  Os = Lt({
  ...
  pd = {
    background: {
      default: {
        ...
        hover: {
          light: "var(--ds-background-neutral-hovered, ".concat(ps, ")"),
          dark: "var(--ds-background-neutral-hovered, ".concat(xl, ")"),
        },
        active: {
          light: "var(--ds-background-neutral-pressed, ".concat(vd, ")"),
      ...
      primary: {
        default: {
          ...
          dark: "var(--ds-background-brand-bold, ".concat(pi, ")"),
        },
        hover: {
          light: "var(--ds-background-brand-bold-hovered, ".concat(kl, ")"),
          dark: "var(--ds-background-brand-bold-hovered, ".concat(Jn, ")"),
        },
        active: {
          light: "var(--ds-background-brand-bold-pressed, ".concat(Sl, ")"),
          dark: "var(--ds-background-brand-bold-pressed, ".concat(Ol, ")"),
        },
        disabled: {
          light: "var(--ds-background-disabled, ".concat(In, ")"),
          dark: "var(--ds-background-disabled, ".concat(Dn, ")"),
      ...
      warning: {
        default: {
          light: "var(--ds-background-warning-bold, ".concat(wl, ")"),
          dark: "var(--ds-background-warning-bold, ".concat(wl, ")"),
        },
        hover: {
          light: "var(--ds-background-warning-bold-hovered, ".concat(_l, ")"),
          dark: "var(--ds-background-warning-bold-hovered, ".concat(_l, ")"),
        },
        active: {
      ...
      danger: {
        default: {
          light: "var(--ds-background-danger-bold, ".concat(ml, ")"),
          dark: "var(--ds-background-danger-bold, ".concat(ml, ")"),
        },
        hover: {
          light: "var(--ds-background-danger-bold-hovered, ".concat(yl, ")"),
          dark: "var(--ds-background-danger-bold-hovered, ".concat(yl, ")"),
        },
        active: {
      ...
      subtle: {
        ...
        hover: {
          light: "var(--ds-background-neutral-subtle-hovered, ".concat(ps, ")"),
          dark: "var(--ds-background-neutral-subtle-hovered, ".concat(xl, ")"),
        },
        active: {
          light: "var(--ds-background-neutral-subtle-pressed, ".concat(vd, ")"),
    ...
    color: {
      ...
      link: {
        default: {
          ...
          dark: "var(--ds-link, ".concat(pi, ")"),
        },
        hover: {
          light: "var(--ds-link, ".concat(kl, ")"),
          dark: "var(--ds-link, ".concat(Jn, ")"),
        },
        active: {
          light: "var(--ds-link-pressed, ".concat(Sl, ")"),
          dark: "var(--ds-link-pressed, ".concat(Ol, ")"),
        },
        disabled: {
          light: "var(--ds-text-disabled, ".concat(ur, ")"),
      ...
      "subtle-link": {
        default: {
          light: "var(--ds-text-subtle, ".concat(r_, ")"),
          dark: "var(--ds-text-subtle, ".concat(st, ")"),
        },
        hover: {
          light: "var(--ds-text-subtle, ".concat(t_, ")"),
          dark: "var(--ds-text-subtle, ".concat(Xv, ")"),
        },
        active: {
          light: "var(--ds-text, ".concat(n_, ")"),
          dark: "var(--ds-text, ".concat(a_, ")"),
        },
        disabled: {
          light: "var(--ds-text-disabled, ".concat(ur, ")"),
          dark: "var(--ds-text-disabled, ".concat(To, ")"),
...
var Qt = X0(),
  Bo = ["default", "primary", "danger", "warning"],
  ks = { default: "".concat(32 / 14, "em"), compact: "".concat(24 / 14, "em"), none: "auto" },
  i1 = { default: ks.default, compact: ks.compact, none: "inherit" },
  o1 = {
    default: "0 ".concat(Qt + Qt / 4, "px"),
    compact: "0 ".concat(Qt + Qt / 4, "px"),
    none: "0",
  },
  s1 = { compact: "0 ".concat(Qt / 4, "px"), default: "0 ".concat(Qt / 4, "px"), none: "0" },
  c1 = { default: "middle", compact: "middle", none: "baseline" },
  jp = { content: "0 ".concat(Qt / 4, "px"), icon: "0 ".concat(Qt / 4, "px") },
  Ip = {
...
function Mr(e) {
  var t = e.appearance,
    ...
    n = e.mode;
  return {
    background: bd({ group: pd.background[t], key: r, mode: n }),
    color: "".concat(bd({ group: pd.color[t], key: r, mode: n }), " !important"),
  };
}
function b1(e) {
  var t = e.appearance,
          ...
          ne(
            ne(
              {
                "&:visited": ne({}, s),
                "&:hover": ne(
                  ne({}, Mr({ appearance: t, key: a ? "selected" : "hover", mode: n })),
                  {},
                  {
                    textDecoration:
                ...
                "&:active": ne(
                  ne({}, Mr({ appearance: t, key: a ? "selected" : "active", mode: n })),
                  {},
                ...
                "&[disabled]": ne(
                  ne({}, Mr({ appearance: t, key: "disabled", mode: n })),
                  {},
            ...
            {},
            {
              '&[data-has-overlay="true"]:not([disabled]):hover, &[data-has-overlay="true"]:not([disabled]):active':
                ne({}, Mr({ appearance: t, key: a ? "selected" : "default", mode: n })),
            },
          ),
      ),
      et("platform-component-visual-refresh") &&
              ...
              ne(
                ne(
                  ne(
                    ne(
                      ne(
                        ne(ne({}, t === "default" && u1), t === "primary" && l1),
                        t === "link" && d1,
                      ),
                      t === "subtle" && f1,
                    ),
...
var _1 = {
  ...
  E1 = function (t, r) {
    return Ys(t) ? t : t ? Vt("span", { css: r }, t) : null;
  },
  x1 = S.forwardRef(function (t, r) {
    ...
    var z = t.spacing,
      F = z === void 0 ? "default" : z,
      U = t.tabIndex,
      Z = U === void 0 ? 0 : U,
      B = t.type,
      V = B === void 0 ? (d ? void 0 : "button") : B,
      J = t.testId,
      j = ae(t, w1),
      q = y.useRef(),
      he = y.useCallback(
    ...
    Qw(q, s);
    var K = y.useContext(Bs),
      be = y.useCallback(
        function (ue, gt) {
          (K && K.tracePress(g, ue.timeStamp), E(ue, gt));
        },
        [E, K, g],
      ),
      ce = va({
    ...
    return (
      ...
      Vt(
        ...
        Vt(
          ...
          h ? Vt("span", { css: [Be, yd({ spacing: F }), md(u, k1)] }, h) : null,
          E1(u, [Be, y1({ spacing: F })]),
          p ? Vt("span", { css: [Be, yd({ spacing: F }), md(u, S1)] }, p) : null,
          L ? Vt("span", { css: [_1, at] }, L) : null,
        ),
      )
    );
  });
...
var P1 = [
  ...
  _d = typeof navigator < "u" && navigator.userAgent.toLowerCase().indexOf("firefox") > -1,
  Js = S.memo(
    S.forwardRef(function (t, r) {
      var n = t.appearance,
        ...
        O = rw(),
        w = O.mode,
        _ = C1({ children: i, iconBefore: o, iconAfter: s }),
        k = y.useState(!1),
        E = Q(k, 2),
        I = E[0],
        D = E[1],
...
function R1(e) {
  return S.createElement(Js, H({}, e, { appearance: "subtle" }));
}
...
function j1(e) {
  ...
  return S.createElement(
    ...
    S.createElement(
      ...
      S.createElement(hp, null, "Skipped pages from ", n, " to ", a),
      "…",
    ),
  );
}
...
function D1(e, t) {
  if (e.length !== t.length) return !1;
  for (var r = 0; r < e.length; r++) if (!I1(e[r], t[r])) return !1;
  return !0;
}
function T1(e, t) {
  t === void 0 && (t = D1);
...
var L1 = function (t, r, n, a) {
  ...
  if (l && !d) {
    ...
    return [].concat(
      Le(f(0, 1)),
      [o({ key: "ellipsis-1", testId: a && "".concat(a, "-ellipsis"), from: 2, to: c - v })],
      Le(f(c - v)),
    );
  }
  if (!l && d) {
    ...
    return [].concat(
      Le(f(0, p)),
      [o({ key: "ellipsis-1", testId: a && "".concat(a, "-ellipsis"), from: p + 1, to: c - 1 })],
      Le(f(c - 1)),
    );
  }
  var h = i - 4;
...
function $1(e, t) {
  var r = e.components,
      ...
      M1(
        {
          fn: function (j, q) {
            var he = j.event,
              K = j.selectedPageIndex;
            (o === void 0 && Z(K), w && w(he, _[K], q));
          },
          action: "changed",
    ...
    V = function (j, q, he) {
      var K = _[U],
        be = "".concat(l, " ").concat(k ? k(j, q) : j),
        ce = j === K;
      return S.createElement(
        Wa,
        { as: "li", xcss: Ss.paginationMenuItem, key: "page-".concat(k ? k(j, q) : q) },
        S.createElement(
          R1,
          {
            component: n.Page,
            onClick: function (ge) {
              return B({ event: ge, selectedPageIndex: q });
            },
  ...
  return S.createElement(
    ...
    S.createElement(
      ...
      S.createElement(wd, {
        ...
        onClick: function (j) {
          return B({ event: j, selectedPageIndex: U - 1 });
        },
        isDisabled: L || U === 0,
        iconBefore: S.createElement(Ed, { chevronDirection: "left" }),
        "aria-label": f,
      ...
      S.createElement(
        ...
        L1(_, U, { max: m, ellipsis: I, transform: V }, P),
      ),
      S.createElement(wd, {
        key: "right-navigator",
        component: n.Next,
        ...
        isDisabled: L || U === _.length - 1,
        iconBefore: S.createElement(Ed, { chevronDirection: "right" }),
        "aria-label": p,
...
var F1 = y.memo(y.forwardRef($1));
function z1(e, t, r) {
  return (
    (t = W(t)),
    Ie(e, Dp() ? Reflect.construct(t, r || [], W(e).constructor) : t.apply(e, r))
  );
}
function Dp() {
  try {
      ...
      de(t, [
        {
          ...
          value: function () {
            var n = this.props,
              ...
              c = n.testId,
              u = n.isDisabled,
              l = Le(Array(a)).map(function (f, v) {
                return v + 1;
              }),
              d = o - 1;
            return S.createElement(F1, {
              selectedIndex: d,
              isDisabled: u,
              label: s?.label,
              nextLabel: s?.next,
...
var Cd = "--local-dynamic-table-text-color",
  V1 = function (t) {
    var r = t.isRanking,
      n = t.testId,
      a = ae(t, q1);
    return y.createElement(
      "thead",
      H({ "data-testid": n }, a, { className: A(["_179rglyw", r && "_1e0c1ule"]) }),
    );
  },
  Tp = y.forwardRef(function (e, t) {
    var r = e.width,
      n = e.children,
      a = e.isSortable,
      i = e.sortOrder,
      ...
      d = ae(e, U1),
      f = Un(
        Un(Un({}, u), r && Zv({ width: r })),
        {},
        C({}, Cd, "var(--ds-text-subtlest, ".concat(El, ")")),
      ),
      v = i === yr,
      p = i === fi,
      h = function () {
    ...
    return y.createElement(
      g,
      H({ "aria-sort": h(), onClick: b ? void 0 : c, ref: t, "data-testid": l }, d, {
        className: A([
        ...
        style: Un(
          ...
          {
            "--_k02y3n": Ke("2px solid ".concat("var(--ds-border, ".concat(vs, ")"))),
            "--_17ckjys": Ke("var(--ds-text-subtle, ".concat("var(".concat(Cd, ")"), ")")),
            "--_jz8ahf": Ke("solid 2px ".concat("var(--ds-border-focused, ".concat(pi, ")"))),
            "--_6j4ewu": Ke("var(--ds-background-neutral-hovered, ".concat(ps, ")")),
            "--_1rdacuj": Ke("3px solid ".concat("var(--ds-icon-disabled, ".concat(vs, ")"))),
            "--_1qca9zt": Ke("3px solid ".concat("var(--ds-icon-subtle, ".concat(El, ")"))),
          },
        ),
      }),
      n,
...
function G1(e, t, r) {
  return (
    (t = W(t)),
    Ie(e, Lp() ? Reflect.construct(t, r || [], W(e).constructor) : t.apply(e, r))
  );
}
function Lp() {
  try {
      ...
      de(r, [
        ...
        },
        {
          ...
          value: function () {
            ...
            return S.createElement(
              e,
              H({ refWidth: i, refHeight: o, innerRef: this.innerRef }, this.props),
            );
          },
        },
      ])
...
function Y1() {
  if (Rd) return Gn;
  ((Rd = 1), Object.defineProperty(Gn, "__esModule", { value: !0 }), (Gn.default = void 0));
  var e = r(vt()),
    t = r(Mi);
  function r(a) {
    return a && a.__esModule ? a : { default: a };
...
function Z1(e) {
  var t = e.onClose,
    ...
    a = y.useCallback(
      function (o) {
        r || n.current || o.key !== Q1 || ((n.current = !0), t(o));
      },
      [t, r],
    ),
...
var Xn = { none: 0, small: 100, medium: 350, large: 700 },
  qo = 0.5,
  aO = { none: Xn.none, small: Xn.small * qo, medium: Xn.medium * qo, large: Xn.large * qo },
  iO = function () {
  ...
  $p = y.createContext(Np),
  Ad = function (t) {
    var r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Np;
    return S.createElement($p.Provider, { key: "".concat(t.key, "-provider"), value: r }, t);
  },
  jd = function (t) {
    var r = [];
    return (
  ...
  uO = function (t, r) {
    for (var n = r.concat([]), a = lO(r), i = 0; i < t.length; i++) {
      var o = t[i],
        s = !a[o.key];
      s && n.splice(i + 1, 0, o);
    }
  ...
  Fp = y.memo(function (e) {
    ...
    if (
      (y.useEffect(function () {
        h.appear || g({ appear: !0, isExiting: !1 });
      }, []),
      typeof s == "boolean")
    )
      return n;
      ...
      k.size
        ? (I = I.map(function (P) {
            ...
            return Ad(P, {
              ...
              onFinish: L
                ? function () {
                    (k.delete(P.key), k.size === 0 && (c([null, n]), f([])));
                  }
                : void 0,
            });
          }))
...
var pO = y.createContext(function () {
      ...
      r(
        {
          ...
          className: I
            ? A([
                ...
                O && A(["_1y0ctrqk"]),
                f === "small" && A(["_5sag1yx9"]),
                f === "medium" && A(["_5sag1ttt"]),
                f === "large" && A(["_5sagpwmj"]),
                h && f === "small" && A(["_5sag14ed"]),
                h && f === "medium" && A(["_5sagluct"]),
                h && f === "large" && A(["_5sag1ttt"]),
                h && A(["_ju255cps _1o51q7pw"]),
                !h && n === "linear" && A(["_1pglp3kn"]),
                !h && n === "ease-out" && A(["_1pgldkwg"]),
                !h && n === "ease-in" && A(["_1pgl1nzg"]),
                !h && n === "ease-in-out" && A(["_1pgl1fu8"]),
                h && n === "linear" && A(["_1pglp3kn"]),
                h && i === "ease-out" && A(["_1pgldkwg"]),
                h && i === "ease-in" && A(["_1pgl1nzg"]),
                h && i === "ease-in-out" && A(["_1pgl1fu8"]),
                ((!h && o === "fade-in") || (h && c === "fade-in")) && A(["_j7hq1cgr"]),
                ((!h && o === "fade-out") || (h && c === "fade-out")) && A(["_j7hq1lln"]),
                ((!h && o === "zoom-in") || (h && c === "zoom-in")) && A(["_j7hqe8p0"]),
                ((!h && o === "zoom-out") || (h && c === "zoom-out")) && A(["_j7hqy6ql"]),
                ((!h && o === "slide-in-from-top") || (h && c === "slide-in-from-top")) &&
                  A(["_j7hqqshu"]),
                ((!h && o === "slide-out-from-top") || (h && c === "slide-out-from-top")) &&
                  A(["_j7hq7ri4"]),
                ((!h && o === "slide-in-from-right") || (h && c === "slide-in-from-right")) &&
                  A(["_j7hqdfjr"]),
                ((!h && o === "slide-out-from-right") || (h && c === "slide-out-from-right")) &&
                  A(["_j7hqonfj"]),
                ((!h && o === "slide-in-from-bottom") || (h && c === "slide-in-from-bottom")) &&
                  A(["_j7hq1liq"]),
                ((!h && o === "slide-out-from-bottom") || (h && c === "slide-out-from-bottom")) &&
                  A(["_j7hqhnf1"]),
                ((!h && o === "slide-in-from-left") || (h && c === "slide-in-from-left")) &&
                  A(["_j7hq1bh1"]),
                ((!h && o === "slide-out-from-left") || (h && c === "slide-out-from-left")) &&
                  A(["_j7hqj08w"]),
                ((!h && o === "fade-in-from-top") || (h && c === "fade-in-from-top")) &&
                  A(["_j7hq2iua"]),
                ((!h && o === "fade-out-from-top") || (h && c === "fade-out-from-top")) &&
                  A(["_j7hq39va"]),
                ((!h && o === "fade-in-from-left") || (h && c === "fade-in-from-left")) &&
                  A(["_j7hq15m2"]),
                ((!h && o === "fade-out-from-left") || (h && c === "fade-out-from-left")) &&
                  A(["_j7hq1yiv"]),
                ((!h && o === "fade-in-from-bottom") || (h && c === "fade-in-from-bottom")) &&
                  A(["_j7hq1w00"]),
                ((!h && o === "fade-out-from-bottom") || (h && c === "fade-out-from-bottom")) &&
                  A(["_j7hqzy3z"]),
                ((!h && o === "fade-in-from-right") || (h && c === "fade-in-from-right")) &&
                  A(["_j7hqpqak"]),
                ((!h && o === "fade-out-from-right") || (h && c === "fade-out-from-right")) &&
                  A(["_j7hq1ebg"]),
                ((!h && o === "fade-in-from-top-constant") ||
                  (h && c === "fade-in-from-top-constant")) &&
                  A(["_j7hqm2e2"]),
                ((!h && o === "fade-out-from-top-constant") ||
                  (h && c === "fade-out-from-top-constant")) &&
                  A(["_j7hq97jn"]),
                ((!h && o === "fade-in-from-left-constant") ||
                  (h && c === "fade-in-from-left-constant")) &&
                  A(["_j7hqovgq"]),
                ((!h && o === "fade-out-from-left-constant") ||
                  (h && c === "fade-out-from-left-constant")) &&
                  A(["_j7hq15do"]),
                ((!h && o === "fade-in-from-bottom-constant") ||
                  (h && c === "fade-in-from-bottom-constant")) &&
                  A(["_j7hq797a"]),
                ((!h && o === "fade-out-from-bottom-constant") ||
                  (h && c === "fade-out-from-bottom-constant")) &&
                  A(["_j7hqwo7r"]),
                ((!h && o === "fade-in-from-right-constant") ||
                  (h && c === "fade-in-from-right-constant")) &&
                  A(["_j7hqt8u5"]),
                ((!h && o === "fade-out-from-right-constant") ||
                  (h && c === "fade-out-from-right-constant")) &&
                  A(["_j7hq1pgp"]),
              ])
            : "",
  ...
  bO = { top: "bottom", bottom: "top", left: "right", right: "left" },
  yO = function (t) {
    var r = t.children,
      n = t.duration,
      a = n === void 0 ? "large" : n,
...
var _O = function (t) {
  ...
  OO = function (t, r) {
    if (typeof t == "function") return wO(t, r);
    t != null && (t.current = r);
  },
  Id = function (t) {
    return t.reduce(function (r, n) {
  ...
  Wn = "popper",
  SO = "reference",
  Td = Ca.reduce(function (e, t) {
    return e.concat([t + "-" + Gr, t + "-" + ya]);
  }, []),
  Bp = [].concat(Ca, [Xs]).reduce(function (e, t) {
...
function qi(e) {
  return jt(e) === "html" ? e : e.assignedSlot || e.parentNode || (Qs(e) ? e.host : null) || nr(e);
}
function Ld(e) {
...
function FO(e) {
  ...
  var a = qi(e);
  for (Qs(a) && (a = a.host); tt(a) && ["html", "body"].indexOf(jt(a)) < 0; ) {
    var i = Wt(a);
    if (
      i.transform !== "none" ||
      i.perspective !== "none" ||
...
function Pa(e) {
  for (var t = Fe(e), r = Ld(e); r && $O(r) && Wt(r).position === "static"; ) r = Ld(r);
  return r && (jt(r) === "html" || (jt(r) === "body" && Wt(r).position === "static"))
    ? t
    : r || FO(e) || t;
}
function ec(e) {
...
function qO(e) {
  ...
  if (!(!i || !o)) {
    var d = BO(a.padding, r),
      ...
      E = na(w, k, _),
      I = c;
    r.modifiersData[n] = ((t = {}), (t[I] = E), (t.centerOffset = E - k), t);
  }
}
function UO(e) {
  var t = e.state,
  ...
  a != null &&
    ((typeof a == "string" && ((a = t.elements.popper.querySelector(a)), !a)) ||
      (Up(t.elements.popper, a) && (t.elements.arrow = a)));
}
const VO = {
  name: "arrow",
  enabled: !0,
...
function Md(e) {
  var t,
    ...
    p = o.y,
    h = p === void 0 ? 0 : p,
    g = typeof l == "function" ? l({ x: v, y: h }) : { x: v, y: h };
  ((v = g.x), (h = g.y));
  ...
  if (u) {
    ...
    if (
      ...
      w = rt;
      var D = d && k === _ && _.visualViewport ? _.visualViewport.height : k[E];
      ((h -= D - n.height), (h *= c ? 1 : -1));
    }
    if (a === Re || ((a === Pe || a === rt) && i === ya)) {
      O = nt;
      var P = d && k === _ && _.visualViewport ? _.visualViewport.width : k[I];
      ((v -= P - n.width), (v *= c ? 1 : -1));
    }
  }
  var L = Object.assign({ position: s }, u && GO),
    z = l === !0 ? HO({ x: v, y: h }, Fe(r)) : { x: v, y: h };
  if (((v = z.x), (h = z.y), c)) {
    var F;
  ...
  return Object.assign(
    {},
    L,
    ((t = {}), (t[w] = m ? h + "px" : ""), (t[O] = b ? v + "px" : ""), (t.transform = ""), t),
  );
}
function WO(e) {
  var t = e.state,
...
const KO = { name: "computeStyles", enabled: !0, phase: "beforeWrite", fn: WO, data: {} };
var qa = { passive: !0 };
function YO(e) {
  var t = e.state,
    r = e.instance,
...
var XO = { left: "right", right: "left", bottom: "top", top: "bottom" };
function Xa(e) {
...
function rc(e) {
  return Wr(nr(e)).left + tc(e).scrollLeft;
}
function ZO(e, t) {
  var r = Fe(e),
    n = nr(e),
  ...
  return { width: i, height: o, x: s + rc(e), y: c };
}
function ek(e) {
  var t,
    r = nr(e),
    ...
    c = -n.scrollTop;
  return (
    Wt(a || r).direction === "rtl" && (s += vr(r.clientWidth, a ? a.clientWidth : 0) - i),
...
function aa(e, t) {
  ...
  var n = Wp(e),
    ...
    i = Fe(n),
    o = a ? [i].concat(i.visualViewport || [], nc(n) ? n : []) : n,
    s = t.concat(o);
  return a ? s : s.concat(aa(qi(o)));
}
function xs(e) {
...
function $d(e, t, r) {
  return t === zp ? xs(ZO(e, r)) : mr(t) ? tk(t, r) : xs(ek(nr(e)));
}
function rk(e) {
  var t = aa(qi(e)),
  ...
  return mr(n)
    ? t.filter(function (a) {
        return mr(a) && Up(a, n) && jt(a) !== "body";
      })
    : [];
}
function nk(e, t, r, n) {
  var a = t === "clippingParents" ? rk(e) : [].concat(t),
    i = [].concat(a, [r]),
    o = i[0],
    s = i.reduce(
      function (c, u) {
        ...
        return (
          ...
          (c.right = bi(l.right, c.right)),
          (c.bottom = bi(l.bottom, c.bottom)),
...
function ma(e, t) {
  ...
  var r = t,
    ...
    h = r.padding,
    g = h === void 0 ? 0 : h,
    b = Gp(typeof g != "number" ? g : Hp(g, Ca)),
    m = f === Wn ? SO : Wn,
    O = e.rects.popper,
    w = e.elements[p ? m : f],
    _ = nk(mr(w) ? w : w.contextElement || nr(e.elements.popper), c, l, o),
    k = Wr(e.elements.reference),
    E = Kp({ reference: k, element: O, placement: a }),
    I = xs(Object.assign({}, O, E)),
    D = f === Wn ? I : k,
    P = {
...
function ak(e, t) {
  ...
  var v = f.reduce(function (p, h) {
    return ((p[h] = ma(e, { placement: h, boundary: a, rootBoundary: i, padding: o })[Rt(h)]), p);
  }, {});
  ...
  if (!t.modifiersData[n]._skip) {
    for (
      var a = r.mainAxis,
        ...
        m = b === g,
        O = c || (m || !p ? [Xa(g)] : ik(g)),
        w = [g].concat(O).reduce(function (ce, fe) {
          return ce.concat(
            Rt(fe) === Xs
              ? ak(t, {
                  placement: fe,
      ...
      var L = w[P],
        ...
        U = [Pe, rt].indexOf(z) >= 0,
        Z = U ? "width" : "height",
        B = ma(t, { placement: L, boundary: l, rootBoundary: d, altBoundary: f, padding: u }),
        V = U ? (F ? nt : Re) : F ? rt : Pe;
      _[Z] > k[Z] && (V = Xa(V));
      var J = Xa(V),
        j = [];
...
const fk = { name: "offset", enabled: !0, phase: "main", requires: ["popperOffsets"], fn: dk };
function vk(e) {
  var t = e.state,
    r = e.name;
  t.modifiersData[r] = Kp({
    reference: t.rects.reference,
    element: t.rects.popper,
    placement: t.placement,
  });
}
const pk = { name: "popperOffsets", enabled: !0, phase: "read", fn: vk, data: {} };
function hk(e) {
  return e === "x" ? "y" : "x";
}
function gk(e) {
  var t = e.state,
    ...
    E = t.rects.reference,
    I = t.rects.popper,
    D = typeof h == "function" ? h(Object.assign({}, t.rects, { placement: t.placement })) : h,
    P =
      typeof D == "number"
  ...
  if (k) {
    if (i) {
      var F,
        ...
        K = m === Gr ? -I[B] : -E[B],
        be = t.elements.arrow,
        ce = v && be ? Zs(be) : { width: 0, height: 0 },
        ...
        Be = fe[Z],
        me = na(0, E[B], ce[B]),
        at = O ? E[B] / 2 - q - me - ge - P.mainAxis : he - me - ge - P.mainAxis,
        ue = O ? -E[B] / 2 + q + me + Be + P.mainAxis : K + me + Be + P.mainAxis,
        gt = t.elements.arrow && Pa(t.elements.arrow),
        Kt = gt ? (w === "y" ? gt.clientTop || 0 : gt.clientLeft || 0) : 0,
        it = (F = L?.[w]) != null ? F : 0,
        bt = V + at - it - Kt,
        ke = V + ue - it,
        yt = na(v ? bi(J, bt) : J, V, v ? vr(j, ke) : j);
      ((k[w] = yt), (z[w] = yt - V));
    }
    if (s) {
      var mt,
        ...
        Ra = (mt = L?.[_]) != null ? mt : 0,
        Aa = ar ? Se : qe - E[Te] - I[Te] - Ra + P.altAxis,
        ja = ar ? qe + E[Te] + I[Te] - Ra - P.altAxis : Ue,
        Ia = v && ar ? zO(Aa, qe, ja) : na(v ? Aa : Se, qe, v ? ja : Ue);
      ((k[_] = Ia), (z[_] = Ia - qe));
    }
    t.modifiersData[n] = z;
  }
...
function wk(e, t, r) {
  ...
  return (
    (n || (!n && !r)) &&
      ((jt(t) !== "body" || nc(i)) && (s = mk(t)),
      tt(t) ? ((c = Wr(t, !0)), (c.x += t.clientLeft), (c.y += t.clientTop)) : i && (c.x = rc(i))),
    {
...
var Bd = { placement: "bottom", modifiers: [], strategy: "absolute" };
function qd() {
  for (var e = arguments.length, t = new Array(e), r = 0; r < e; r++) t[r] = arguments[r];
    ...
    var l = {
      ...
      v = {
        ...
        setOptions: function (b) {
          ...
          var O = kk(Ek([].concat(n, l.options.modifiers)));
          return (
        ...
        forceUpdate: function () {
          if (!f) {
            ...
            if (qd(m, O)) {
              ((l.rects = {
                reference: wk(m, Pa(O), l.options.strategy === "fixed"),
                popper: Zs(O),
              }),
                (l.reset = !1),
              ...
              for (var w = 0; w < l.orderedModifiers.length; w++) {
                ...
                var _ = l.orderedModifiers[w],
                  ...
                  D = _.name;
                typeof k == "function" &&
                  (l = k({ state: l, options: I, name: D, instance: v }) || l);
              }
            }
          }
        },
...
var Ck = [JO, pk, KO, NO, fk, sk, bk, VO, uk],
  Pk = xk({ defaultModifiers: Ck }),
  Uo,
  Ud;
function Rk() {
  if (Ud) return Uo;
    ...
    var a = y.useRef(null),
      ...
      l = y.useMemo(
        function () {
          ...
          return jk(a.current, f) ? a.current || f : ((a.current = f), f);
        },
      ...
      fn: function (n) {
        ...
        if (
          ...
          var l = u.viewport,
            ...
            b = l.width - 2 * t,
            m = l.height - 2 * t;
          (h === "top" && (m = c.rects.reference.y + g.y - t),
            h === "bottom" && (m = l.height - f.y - t),
            h === "left" && (b = c.rects.reference.x + g.x - t),
            h === "right" && (b = l.width - f.x - t),
  ...
  var t = e.children,
    ...
    b = y.useMemo(
      function () {
        var O = {
            name: "preventOverflow",
            options: { padding: Cs, rootBoundary: v ? "viewport" : "document" },
          },
          w = { name: "offset", options: { offset: [h, g] } },
          _ = v ? $k({ viewportPadding: Cs }) : [];
        return [].concat(Fk, [O, w], Le(_));
      },
      [h, g, v],
    ),
    m = y.useMemo(
      function () {
        return u == null ? b : [].concat(Le(b), Le(u));
      },
      [b, u],
    );
  return S.createElement(Nk, { modifiers: m, placement: o, strategy: d, referenceElement: c }, r);
}
var Yp = "atlaskit-portal-container",
  Jp = "body > .atlaskit-portal-container",
  Xp = "atlaskit-portal",
  Uk = function (t) {
    var r = document.createElement("div");
    return ((r.className = Xp), (r.style.zIndex = "".concat(t)), r);
  },
  Qp = function () {
  ...
  Zp = function () {
    ...
    if (!t) {
      ...
      return (
        ...
        (r = Qp()) === null || r === void 0 || r.appendChild(n),
        n
      );
    }
    return t;
...
var th = typeof window < "u" ? y.useLayoutEffect : y.useEffect;
function Yk(e) {
  var t = e.zIndex,
    r = e.children,
    n = y.useState(null),
  ...
  var s = S.createElement(y.Suspense, { fallback: null }, r);
...
var Jk = function (t) {
    var r = y.useState(!1),
      ...
      o = y.useState(function () {
        return t === "layoutEffect" ? th : y.useEffect;
      }),
      s = Q(o, 1),
      c = s[0];
    return (
  ...
  eS = function (t, r) {
    var n = { layer: Zk(Number(r)), zIndex: r };
...
function rS(e) {
  ...
  return (
    ...
    et("platform_design_system_team_portal_logic_r18_fix")
      ? S.createElement(Yk, { zIndex: r }, n)
      : o
        ? S.createElement(Kk, { zIndex: r }, n)
        : null
  );
}
var ia = new Set(),
...
function Hd() {
  if (!_a) {
    _a = $i.bindAll(window, [
      { type: "dragend", listener: Vo },
      { type: "pointerdown", listener: Vo },
      {
        type: "pointermove",
        listener: (function () {
          var t = 0;
...
function iS(e) {
  ...
  function d() {
    var v = !!(_t && _t.isVisible());
    (_t && (Qn(), _t.entry.hide({ isImmediate: !0 }), _t.entry.done(), (_t = null)),
    ...
    ((t = "waiting-to-show"), Wd(p, e.delay));
  }
  d();
  var f = {
    keep: o,
...
var rh = y.forwardRef(function (t, r) {
  var n = t.style,
    a = t.className,
    i = t.children,
    o = t.placement,
...
nh.displayName = "TooltipContainer";
function Jd(e) {
...
var sS = Q0.tooltip(),
  Qd = { componentName: "tooltip", packageName: "@atlaskit/tooltip", packageVersion: "20.3.1" },
  cS = { top: "bottom", bottom: "top", left: "right", right: "left" },
  uS = function (t) {
    return t.split("-")[0];
  };
function ah(e) {
  var t = e.children,
    ...
    Z = U === void 0 ? !1 : U,
    B = n === "mouse" ? i : n,
    V = bl(Nr({ fn: b, action: "displayed", analyticsData: D }, Qd)),
    J = bl(Nr({ fn: O, action: "hidden", analyticsData: D }, Qd)),
    j = y.useRef(null),
    q = y.useState("hide"),
    he = Q(q, 2),
    K = he[0],
    ...
    fe = y.useRef(null),
    ge = function (ie) {
      ((fe.current = ie), (ce.current = ie ? ie.firstElementChild : null));
    },
    Be = y.useCallback(function (M) {
      ce.current = M;
    }, []),
    me = Hn(K),
    at = Hn(V),
    ...
    Kt = Hn(w),
    it = y.useRef(!1),
    bt = y.useCallback(function (M) {
      ((j.current = M), (it.current = !1));
    }, []),
    ke = y.useCallback(
      function () {
        j.current &&
          (it.current && ue.current(), (j.current = null), (it.current = !1), be("hide"));
      },
      [ue],
    ),
    yt = y.useCallback(
      function () {
        j.current && (j.current.abort(), it.current && ue.current(), (j.current = null));
      },
      [ue],
    );
  y.useEffect(
  ...
  var ot = y.useCallback(
      function (M) {
        var ie;
        if (!mt.current) {
          if ((j.current && !j.current.isActive() && yt(), j.current && j.current.isActive())) {
            j.current.keep();
            return;
          }
          if (!(Kt.current && !((ie = Kt.current) !== null && ie !== void 0 && ie.call(Kt)))) {
            var Mt = {
                source: M,
                delay: gt.current,
                show: function (Sr) {
    ...
    Zr = y.useCallback(
      function () {
        var M;
        (M = j.current) === null || M === void 0 || M.requestHide({ isImmediate: !0 });
      },
      [j],
    );
  (Z1({ onClose: Zr, isDisabled: K === "hide" || K === "fade-out" }),
    y.useEffect(
      function () {
        if (K === "hide") return we;
        K === "before-fade-out" && be("fade-out");
        var M = $i.bind(window, {
          type: "scroll",
          listener: function () {
  ...
  var qe = y.useCallback(
    ...
    Te = y.useCallback(
      function () {
        k && j.current && j.current.requestHide({ isImmediate: !0 });
      },
      [k],
    ),
    Se = y.useCallback(
      function (M) {
        if (!(fe.current && M.target === fe.current) && !M.defaultPrevented) {
          ...
          var ie =
            n === "mouse"
              ? { type: "mouse", mouse: Jd({ left: M.clientX, top: M.clientY }) }
              : { type: "keyboard" };
          ot(ie);
        }
      },
    ...
    Ue = y.useCallback(function (M) {
      (fe.current && M.target === fe.current) ||
        M.defaultPrevented ||
        (M.preventDefault(), j.current && j.current.requestHide({ isImmediate: !1 }));
    }, []),
    ar =
      n === "mouse"
        ? function (M) {
            ...
            (ie = j.current) !== null &&
              ie !== void 0 &&
              ie.isActive() &&
              (j.current.mousePosition = Jd({ left: M.clientX, top: M.clientY }));
          }
        : void 0,
    ...
    Aa = y.useCallback(
      function () {
        try {
          if (
            ce.current &&
            !ce.current.matches(":focus-visible") &&
            et("platform-tooltip-focus-visible")
          )
            return;
        } catch {}
        ot({ type: "keyboard" });
    ...
    Vi = K !== "hide" && !!o,
    ic = !Z && Vi,
    oc = K !== "hide" && K !== "fade-out",
    fh = y.useCallback(function () {
      var M;
      (M = j.current) === null || M === void 0 || M.requestHide({ isImmediate: !0 });
    }, []);
  nO({ isOpen: Vi && oc, onClose: fh });
  var sc = function () {
      var ie;
  ...
  return S.createElement(
    ...
    typeof t == "function"
      ? S.createElement(
          S.Fragment,
          null,
          t(Nr(Nr({}, Gi), {}, { "aria-describedby": en, ref: Be })),
          uc,
        )
      : S.createElement(dh, H({}, Gi, { ref: ge, role: "presentation" }), t, uc),
    Vi
      ? S.createElement(
          rS,
          { zIndex: sS },
          S.createElement(qk, { placement: B, referenceElement: sc(), strategy: L }, function (M) {
            var ie = M.ref,
              Mt = M.style,
              Hi = M.update,
              Wi = M.placement,
              Sr = n === "mouse" ? void 0 : cS[uS(Wi)];
            return S.createElement(
              Fp,
              { appear: !0 },
              oc &&
                S.createElement(
                  yO,
                  {
                    ...
                    exitDirection: Sr,
                    onFinish: Ia,
                    duration: K !== "show-immediate" ? "medium" : "none",
                  },
                  function (tn) {
                    var vh = tn.className;
                    return S.createElement(
...
var lS = [
  ...
  ih = function (t) {
    ...
    var i = t.innerRef,
      ...
      p = v === void 0 ? "Sort descending" : v,
      h = t.buttonAriaRoleDescription,
      ...
      j = S.createElement(
        Ni,
        { xcss: Zd.headCellContainer, onMouseEnter: V, onMouseLeave: J, onFocus: Z, onBlur: B },
        S.createElement(
          ah,
          { content: s === yr ? f : p },
          S.createElement(
            ...
            S.createElement(
              ...
              S.createElement("span", { className: A([Zd.text]) }, r),
            ),
            U &&
              S.createElement(
                hi,
...
function fS(e, t, r) {
  return (
    (t = W(t)),
    Ie(e, oh() ? Reflect.construct(t, r || [], W(e).constructor) : t.apply(e, r))
  );
}
function oh() {
  try {
...
var vS = (function (e) {
    function t() {
      return (le(this, t), fS(this, t, arguments));
    }
    return (
      De(t, e),
      de(t, [
        {
          ...
          value: function () {
            ...
            var i = n.refWidth,
              o = ae(n, dS),
              s = Lv(a, i);
            return S.createElement(ih, H({ inlineStyles: s }, o));
          },
        },
      ])
    );
...
function bS(e, t, r) {
  return (
    (t = W(t)),
    Ie(e, ch() ? Reflect.construct(t, r || [], W(e).constructor) : t.apply(e, r))
  );
}
function ch() {
  try {
...
var yS = (function (e) {
    function t() {
      return (le(this, t), bS(this, t, arguments));
    }
    return (
      De(t, e),
      de(t, [
        {
          ...
          value: function () {
            ...
            var i = n.refWidth,
              o = ae(n, gS),
              s = Lv(a, i);
            return S.createElement(sh, H({ inlineStyles: s }, o));
          },
        },
      ])
    );
...
function OS(e, t, r) {
  return (
    (t = W(t)),
    Ie(e, uh() ? Reflect.construct(t, r || [], W(e).constructor) : t.apply(e, r))
  );
}
function uh() {
  try {
...
var kS = (function (e) {
    function t(r) {
      var n;
      return (le(this, t), (n = OS(this, t, [r])), (n.state = { activeSortButtonId: null }), n);
    }
    return (
      De(t, e),
      de(t, [
        ...
        },
        {
          ...
          value: function () {
            ...
            return S.createElement(
              V1,
              H({}, b, { isRanking: l, testId: f && "".concat(f, "--head") }),
              S.createElement(
                "tr",
                null,
                g.map(function (m, O) {
                  var w = m.ascendingSortTooltip,
                    ...
                    U = m.width,
                    Z = ae(m, wS),
                    B = "head-cell-".concat(O),
                    V = function () {
                      (n.setState({ activeSortButtonId: B }), P && u(m)());
                    };
...
var xS = function (t) {
    ...
    var me = function (Se) {
      ...
      Kt = function () {
        return J || (Tv(i || [], I, m).length > 2 ? vi : Qm);
      },
      it = function () {
        return p ? S.createElement(u_, { testId: l }) : D && S.createElement(l_, { testId: l }, D);
      },
      bt = i && i.length,
      ke,
      yt = !1;
    (d && Number.isInteger(d) && m && bt && bt <= d
      ? ((ke = Math.ceil(d / m)), (yt = !0))
      : (ke = bt && m ? Math.ceil(bt / m) : 0),
      (ke = ke < 1 ? 1 : ke));
    var mt = I > ke ? ke : I,
      ot = !!bt,
      Zr = Kt(),
    ...
    return S.createElement(
      ...
      S.createElement(
        ...
        S.createElement(
          o_,
          { isFixedSize: g, "aria-label": f, hasDataRow: ot, testId: l, isLoading: p },
          !!r && S.createElement(s_, null, r),
          n &&
            S.createElement(kS, {
              head: n,
              onSort: me,
          ...
          ot &&
            S.createElement(PS, {
              ...
              isFixedSize: g || !1,
              onPageRowsUpdate: u,
              isTotalPagesControlledExternally: yt,
              testId: l,
              isRankable: L,
              isRanking: be,
              onRankStart: ue,
              onRankEnd: gt,
              isRankingDisabled: F || p || !1,
            }),
        ),
      ),
      ke <= 1
      ...
      !ot &&
        qe &&
        S.createElement(ap, { isLoading: p, spinnerSize: vi, testId: l, loadingLabel: c }, qe),
    );
  },
  CS = y.lazy(function () {
    return My(
      () => import("./body-DddyKcwy.js"),
  ...
  PS = y.forwardRef(function (t, r) {
    ...
    var h = S.createElement(E_, H({ ref: r }, u));
    return l && v
      ? S.createElement(
          C_,
          { fallback: h },
...
function RS(e, t, r) {
  return (
    (t = W(t)),
    Ie(e, lh() ? Reflect.construct(t, r || [], W(e).constructor) : t.apply(e, r))
  );
}
function lh() {
  try {
...
const AS = (e, t) => {
  ...
  jS = Di(() => {
    const { usersStore: e } = Li(),
      ...
      r = e.slowQueries;
    return !r || r.length === 0
      ? x.jsx("div", { children: "SlowQuery is EMPTY" })
      : x.jsx("div", {
          children: x.jsxs("div", {
            children: [
              x.jsx(Ui, {
                      ...
                      content: n.parsedPlan
                        ? x.jsx(x.Fragment, {
                            children: x.jsx("button", {
                              onClick: () => {
                                n.parsedPlan &&
                                  (e.showPlan(n.parsedPlan, n.plan), $s.saveState("PLAN"));
                              },
                              children: "Show Plan",
                            }),
                          })
                ...
                emptyView: x.jsx("div", { children: "Duplicate Table is EMPTY" }),
                isRankable: !0,
              }),
              x.jsx("br", {}),
              x.jsx("br", {}),
  ...
  IS = Di(() => {
    const { usersStore: e } = Li(),
      ...
      r = e.plan;
    return !r || r.length === 0
      ? x.jsxs("div", { children: ["$", e.planString] })
      : x.jsx("div", {
          children: x.jsxs("div", {
            children: [
              x.jsx(Ui, {
  ...
  DS = Di(() => {
    const { usersStore: e } = Li(),
      ...
      r = e.history;
    return !r || r.length === 0
      ? x.jsx("div", { children: "Query history is EMPTY" })
      : x.jsx("div", {
          children: x.jsxs("div", {
            children: [
              x.jsx(Ui, {
...
function TS() {
  ...
  const r = async () => {
      e.loading();
      try {
        const p = await Ce.invoke("explain");
        (e.showPlan(p, "Plan does not exists"), t.saveState("PLAN"));
      } catch (p) {
        (console.error(p), We("explain error", p.message));
      } finally {
        e.stopLoading();
      }
    },
    n = async () => {
      e.loading();
      try {
        const p = await Ce.invoke("explainWith");
        (e.showPlan(p, "Plan does not exists"), t.saveState("PLAN"));
      } catch (p) {
        (console.error(p), We("explain error", p.message));
      } finally {
    ...
    a = async () => {
      e.loading();
      try {
        const p = await Ce.invoke("explainAnalyze");
        (e.showPlan(p, "Plan does not exists"), t.saveState("PLAN"));
      } catch (p) {
        (console.error(p), We("explain analyze error", p.message));
      } finally {
        e.stopLoading();
      }
    },
    i = async () => {
      e.loading();
      try {
        const p = await Ce.invoke("explainAnalyzeWith");
        (e.showPlan(p, "Plan does not exists"), t.saveState("PLAN"));
      } catch (p) {
        (console.error(p), We("explain analyze error", p.message));
      } finally {
    ...
    o = async () => {
      ...
      try {
        ...
        (console.error(p), We("execute query error", p.message));
      } finally {
        e.stopLoading();
      }
    },
    ...
    c = async () => {
      ...
      try {
        ...
        (console.error(p), We("Optimize error", p.message));
      } finally {
        e.stopLoading();
      }
    },
    ...
    l = async () => {
      ...
      try {
        ...
        (console.error(p), We("dropStats error", p.message));
      } finally {
        e.stopLoading();
      }
    },
    d = async () => {
      ...
      try {
        ...
        (console.error(p), We("deoptimize error", p.message));
      } finally {
        e.stopLoading();
      }
    },
    f = async () => {
      e.loading();
      try {
        const p = await Ce.invoke("analyzeQueriesHistory", {
        ...
        (e.saveHistory(p), t.saveState("HISTORY"));
      } catch (p) {
        (console.error(p), We("History error", p.message));
      } finally {
        e.stopLoading();
      }
    },
    v = async () => {
      e.loading();
      try {
        const p = await Ce.invoke("analyzeSlowQueries");
        (e.saveSlowQuery(p), t.saveState("SLOW_QUERY"));
      } catch (p) {
        (console.error(p), We("Slowquery error", p.message));
      } finally {
        e.stopLoading();
      }
    };
  switch (t.state) {
    case "ROOT":
      return x.jsxs("div", {
        ...
        children: [
          x.jsx("div", { className: "section-spacer" }),
          x.jsxs("section", {
            className: "analysis-section",
            children: [
              x.jsx("h2", { children: "Stage 1: Initial Query Analysis" }),
              x.jsx("div", {
              ...
              x.jsx("div", {
                ...
                children: x.jsxs("div", {
                  ...
                  children: [
                    x.jsx("button", { onClick: o, children: "1. Execute SQL" }),
                    x.jsx("button", { onClick: r, children: "2. Explain (optional) " }),
                    x.jsx("button", { onClick: a, children: "3. Explain Analyze" }),
                  ],
                }),
              }),
            ],
          ...
          x.jsxs("section", {
            className: "analysis-section",
            children: [
              x.jsx("h2", { children: "Stage 2: Adding Indexes — Better but Not Yet Great" }),
              x.jsx("div", {
                className: "query-example",
                children: x.jsx("pre", {
                  children:
              ...
              x.jsx("div", {
                ...
                children: x.jsxs("div", {
                  className: "button-row",
                  children: [
                    x.jsx("button", { onClick: c, children: "4. Add optimization indexes" }),
                    x.jsx("button", { onClick: o, children: "5. Execute SQL" }),
                    x.jsx("button", { onClick: r, children: "6. Explain (optional) " }),
                    x.jsx("button", { onClick: a, children: "7. Explain Analyze" }),
                  ],
                }),
              }),
            ],
            ...
            children: [
              ...
              x.jsx("div", {
                ...
                children: x.jsxs("div", {
                  className: "button-row",
                  children: [
                    x.jsx("button", { onClick: s, children: "8. Execute CTE" }),
                    x.jsx("button", { onClick: n, children: "9. Explain CTE (optional)" }),
                    x.jsx("button", { onClick: i, children: "10. Explain Analyze CTE" }),
                  ],
                }),
              }),
            ],
          ...
          x.jsxs("section", {
            className: "analysis-section",
            children: [
              x.jsx("h2", { children: "Stage 4: Final Optimization — Goodbye Full Table Scans" }),
              x.jsx("div", {
                className: "query-example",
                children: x.jsx("pre", {
                  children:
              ...
              x.jsx("div", {
                ...
                children: x.jsxs("div", {
                  ...
                  children: [
                    ...
                    x.jsx("button", { onClick: s, children: "10. Execute CTE" }),
                    x.jsx("button", { onClick: n, children: "11. Explain CTE (optional)" }),
                    x.jsx("button", { onClick: i, children: "12. Explain Analyze CTE" }),
                  ],
                }),
              }),
            ],
          ...
          x.jsxs("section", {
            className: "analysis-section",
            children: [
              x.jsx("h2", { children: "Additional action" }),
              x.jsx("div", {
                className: "button-group",
                children: x.jsxs("div", {
                  className: "button-row",
                  children: [
                    x.jsx("button", { onClick: d, children: "Drop indexes(back to Stage 1)" }),
                    x.jsx("button", { onClick: l, children: "DROP STATS from all tables" }),
                  ],
                }),
              }),
            ],
          ...
          x.jsxs("section", {
            className: "analysis-section",
            children: [
              x.jsx("h2", { children: "Query History Analysis" }),
              x.jsx("div", {
                className: "button-group",
                children: x.jsx("button", { onClick: f, children: "Show Query History" }),
              }),
            ],
          }),
          x.jsx("div", { className: "section-spacer" }),
          x.jsxs("section", {
            className: "analysis-section",
            children: [
              x.jsx("h2", { children: "Slow Query Analysis" }),
              x.jsx("div", {
                className: "button-group",
                children: x.jsx("button", { onClick: v, children: "Analyze Slow Queries" }),
              }),
            ],
          }),
        ],
    ...
    case "SLOW_QUERY":
      return x.jsxs("div", {
        ...
        children: [
          ...
          x.jsx("div", { className: "results-spacer" }),
          x.jsx(jS, {}),
        ],
      });
    case "HISTORY":
    ...
    default:
      return x.jsxs("div", { children: ["ERROR: unsupported state ", t.state] });
  }
}
const LS = Di(TS),
  ...
  NS = ph.createRoot(MS),
  ef = () => {
    NS.render(x.jsx(Av, { ...jv, children: x.jsx(LS, {}) }));
  };
Ce.view.theme
  .enable()
  .then(() => {
