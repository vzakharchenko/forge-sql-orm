import { r as jr, a as ko, c as Do } from "./react-dom-vendor-BO7srUs7.js";
import { g as Lo, a as No, r as xo } from "./lodash-vendor-COZk6-qw.js";
(function () {
...
var xr;
function Fo() {
  return (xr || ((xr = 1), (Ut.exports = qo())), Ut.exports);
}
var A = Fo(),
  E = jr();
const dr = Lo(E);
...
function bi() {
  for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(Tr(arguments[t]));
  return e;
}
function gi() {
...
function wi(e) {
  ...
  return t
    ? t.call(e)
    : ((e = typeof gt == "function" ? gt(e) : e[Symbol.iterator]()),
      (n = {}),
      r("next"),
      r("throw"),
      r("return"),
...
function Ai(e) {
  ...
  var t = {};
  if (e != null) for (var n = hr(e), r = 0; r < n.length; r++) n[r] !== "default" && Tt(t, e, n[r]);
  return ($o(t, e), t);
}
function Ei(e) {
...
function Mi(e) {
  function t(o) {
    ((e.error = e.hasError ? new Vo(o, e.error, "An error was suppressed during disposal.") : o),
      (e.hasError = !0));
  }
  var n,
    r = 0;
...
const Uo = {
    ...
    __disposeResources: Mi,
    __rewriteRelativeImportExtension: Ci,
  },
  Go = Object.freeze(
...
function H() {
  if (Fr) return Be;
  ((Fr = 1), Object.defineProperty(Be, "__esModule", { value: !0 }), (Be.BridgeAPIError = void 0));
...
function P() {
  if ($r) return Ce;
  (($r = 1), Object.defineProperty(Ce, "__esModule", { value: !0 }), (Ce.getCallBridge = void 0));
  const e = H();
  function t(r) {
    return !!r?.callBridge;
  }
  ...
  return ((Ce.getCallBridge = n), Ce);
}
var Ie = {},
  Vr;
function Bi() {
  if (Vr) return Ie;
  ((Vr = 1), Object.defineProperty(Ie, "__esModule", { value: !0 }), (Ie.withRateLimiter = void 0));
  const e = H(),
    t = (n, r, i, o) => {
      let a = Date.now(),
        s = 0;
...
function zo() {
  if (Ur) return Me;
  ((Ur = 1), Object.defineProperty(Me, "__esModule", { value: !0 }), (Me.invoke = void 0));
  const e = P(),
    t = H(),
    n = Bi(),
    r = (0, e.getCallBridge)(),
...
function Wo() {
  return (
    Gr ||
      ((Gr = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), W.__exportStar(zo(), e));
      })(Kt)),
    Kt
  );
}
...
function Ho() {
  if (zr) return ke;
  ((zr = 1), Object.defineProperty(ke, "__esModule", { value: !0 }), (ke.invokeRemote = void 0));
  const e = Ii(),
...
function Jo() {
  if (Wr) return De;
  ((Wr = 1), Object.defineProperty(De, "__esModule", { value: !0 }), (De.invokeService = void 0));
  const e = Ii(),
  ...
  return (
    Hr ||
      ...
      (function (e) {
        Object.defineProperty(e, "__esModule", { value: !0 });
        const t = W;
        (t.__exportStar(Ho(), e), t.__exportStar(Jo(), e));
      })(zt)),
    zt
  );
}
...
function Yo() {
  if (Jr) return Ne;
  ((Jr = 1), Object.defineProperty(Ne, "__esModule", { value: !0 }), (Ne.submit = void 0));
  const e = P(),
    t = H(),
    n = (0, e.getCallBridge)(),
    r = async (i) => {
...
function Zo() {
  if (Xr) return xe;
  ((Xr = 1), Object.defineProperty(xe, "__esModule", { value: !0 }), (xe.close = void 0));
  const e = P(),
    t = H(),
    n = (0, e.getCallBridge)(),
    r = async (i) => {
...
function Qo() {
  if (Yr) return qe;
  ((Yr = 1), Object.defineProperty(qe, "__esModule", { value: !0 }), (qe.refresh = void 0));
  const e = P(),
    t = H(),
    n = (0, e.getCallBridge)(),
    r = async (i) => {
...
function ea() {
  if (Zr) return Fe;
  ((Zr = 1), Object.defineProperty(Fe, "__esModule", { value: !0 }), (Fe.createHistory = void 0));
...
function ra() {
  if (rn) return Ve;
  ((rn = 1), Object.defineProperty(Ve, "__esModule", { value: !0 }), (Ve.Translator = void 0));
  const e = Di();
  class t {
    locale;
    translationsGetter;
...
function na() {
  if (nn) return Ue;
  ((nn = 1), Object.defineProperty(Ue, "__esModule", { value: !0 }), (Ue.ensureLocale = void 0));
  const e = ki(),
...
var Zt = {},
  an;
function oa() {
  return (an || ((an = 1), Object.defineProperty(Zt, "__esModule", { value: !0 })), Zt);
}
var sn;
function Li() {
  return (
...
function aa() {
  if (un) return $e;
  ((un = 1), Object.defineProperty($e, "__esModule", { value: !0 }), ($e.getContext = void 0));
  const e = P(),
    t = Li(),
    n = (0, e.getCallBridge)(),
    r = async () => {
...
function ua() {
  if (ln) return Ke;
  ((ln = 1), Object.defineProperty(Ke, "__esModule", { value: !0 }), (Ke.theme = void 0));
  const t = (0, P().getCallBridge)();
...
function xi() {
  if (vn) return We;
  ((vn = 1), Object.defineProperty(We, "__esModule", { value: !0 }), (We.events = void 0));
  const e = P(),
    t = ca(),
    n = (0, e.getCallBridge)(),
    r = async (o, a) => {
  ...
  return ((We.events = { emit: r, on: i }), We);
}
var hn;
function la() {
  if (hn) return ze;
  ((hn = 1), Object.defineProperty(ze, "__esModule", { value: !0 }), (ze.emitReadyEvent = void 0));
  const e = xi(),
    t = qi(),
    n = "EXTENSION_READY",
    r = async () => {
  ...
  return ((ze.emitReadyEvent = r), ze);
}
var _n;
function qi() {
  if (_n) return Le;
  ((_n = 1), Object.defineProperty(Le, "__esModule", { value: !0 }), (Le.view = void 0));
  const e = Yo(),
    t = Zo(),
    n = Qo(),
    r = ea(),
...
function Fi() {
  return (
    pn ||
      ((pn = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), W.__exportStar(qi(), e));
      })(Ht)),
    Ht
  );
}
...
function fa() {
  if (bn) return He;
  ((bn = 1), Object.defineProperty(He, "__esModule", { value: !0 }), (He.router = void 0));
  const t = (0, P().getCallBridge)(),
    n = async (a) => {
    ...
    o = async () => t("reload");
  return ((He.router = { getUrl: n, navigate: r, open: i, reload: o }), He);
}
var gn;
function da() {
  return (
    gn ||
      ((gn = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), W.__exportStar(fa(), e));
      })(er)),
    er
  );
}
...
function va() {
  if (yn) return Je;
  ((yn = 1), Object.defineProperty(Je, "__esModule", { value: !0 }), (Je.Modal = void 0));
  const e = P(),
    t = H(),
    n = (0, e.getCallBridge)(),
    r = () => {};
...
function ha() {
  return (
    mn ||
      ((mn = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), W.__exportStar(va(), e));
      })(tr)),
    tr
  );
}
...
function _a() {
  if (On) return Xe;
  ((On = 1), Object.defineProperty(Xe, "__esModule", { value: !0 }), (Xe.productFetchApi = void 0));
  const e = Ni(),
    t = async (i) => {
      const o = {};
  ...
  return ((Xe.productFetchApi = r), Xe);
}
var wn;
function pa() {
  if (wn) return Y;
  ...
  const t = P();
  return (
    (e = (0, _a().productFetchApi)((0, t.getCallBridge)())),
...
function ba() {
  if (Sn) return Ye;
  ((Sn = 1), Object.defineProperty(Ye, "__esModule", { value: !0 }), (Ye.showFlag = void 0));
  const e = P(),
    t = H(),
    n = (0, e.getCallBridge)(),
    r = (i) => {
...
function ya() {
  return (
    En ||
      ((En = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), W.__exportStar(xi(), e));
      })(nr)),
    nr
  );
}
...
function Oa() {
  return (
    Rn ||
      ((Rn = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), W.__exportStar(ma(), e));
      })(ir)),
    ir
  );
}
...
var Vi = {};
Object.freeze(Vi);
var Ea = typeof Proxy < "u",
  Pa = Object.toString();
function Ui() {
  Ea || g("Proxy not available");
}
function Gi(e) {
  var t = !1;
  return function () {
...
function oe(e) {
  ...
  return typeof n == "function" && n.toString() === Pa;
}
function Ki(e) {
  var t = e?.constructor;
...
function Pe(e, t, n) {
  return (t && Ma(e.prototype, t), Object.defineProperty(e, "prototype", { writable: !1 }), e);
}
function Oe(e, t) {
...
function G(e) {
  function t(n, r) {
    if (st(r)) return e.decorate_20223_(n, r);
    at(n, r, e);
  }
  return Object.assign(t, e);
}
function at(e, t, n) {
  (te(e, V) || It(e, V, de({}, e[V])), Fa(n) || (e[V][t] = n));
}
function ka(e) {
  return (te(e, V) || It(e, V, de({}, e[V])), e[V]);
}
function st(e) {
...
function Xi(e, t, n) {
  ...
  var r = new ae(e);
  return (t !== me && Ks(r, t), n !== me && go(r, n), r);
}
function Da(e, t) {
  return Mo(e, t);
}
...
var Ot = { structural: Da, default: La };
function ve(e, t, n) {
  return wo(e)
    ? e
    : Array.isArray(e)
...
function Na(e, t, n) {
  if (e == null || Vt(e) || $t(e) || be(e) || $(e)) return e;
...
var qa = "override";
function Fa(e) {
  return e.annotationType_ === qa;
}
function ut(e, t) {
  return { annotationType_: e, options_: t, make_: $a, extend_: Va, decorate_20223_: Ua };
}
function $a(e, t, n, r) {
  var i;
...
function Yi(e, t, n, r, i) {
  var o, a, s, c, u, l, f;
  (i === void 0 && (i = d.safeDescriptors), Ga(e, t, n, r));
  var v = r.value;
...
function Zi(e, t) {
  return { annotationType_: e, options_: t, make_: Ka, extend_: za, decorate_20223_: Wa };
}
function Ka(e, t, n, r) {
  var i;
  if (r === e.target_) return this.extend_(e, t, n, !1) === null ? 0 : 2;
  if (
    ...
    i.bound &&
    (!te(e.target_, t) || !it(e.target_[t])) &&
    this.extend_(e, t, n, !1) === null
  )
    return 0;
  if (it(n.value)) return 1;
  var o = Qi(e, this, t, n, !1, !1);
  return (U(r, t, o), 2);
}
function za(e, t, n, r) {
  var i,
    o = Qi(e, this, t, n, (i = this.options_) == null ? void 0 : i.bound);
...
function Qi(e, t, n, r, i, o) {
  (o === void 0 && (o = d.safeDescriptors), Ha(e, t, n, r));
  var a = r.value;
  if ((it(a) || (a = Ae(a)), i)) {
    var s;
...
function Cr(e, t) {
  return { annotationType_: e, options_: t, make_: Ja, extend_: Xa, decorate_20223_: Ya };
}
function Ja(e, t, n) {
...
function Lt(e, t) {
  return { annotationType_: e, options_: t, make_: Qa, extend_: es, decorate_20223_: ts };
}
function Qa(e, t, n) {
  return this.extend_(e, t, n, !1) === null ? 0 : 1;
}
...
var ns = "true",
  is = eo();
function eo(e) {
  return { annotationType_: ns, options_: e, make_: os, extend_: as, decorate_20223_: ss };
}
function os(e, t, n, r) {
  var i, o;
  if (n.get) return Nt.make_(e, t, n, r);
  if (n.set) {
  ...
  if (r !== e.target_ && typeof n.value == "function") {
    ...
    var l = (s = this.options_) != null && s.autoBind ? rt.bound : rt;
...
function as(e, t, n, r) {
  var i, o;
  if (n.get) return Nt.extend_(e, t, n, r);
  if (n.set)
...
var us = "observable",
  cs = "observable.ref",
  ls = "observable.shallow",
  fs = "observable.struct",
  to = { deep: !0, name: void 0, defaultDecorator: void 0, proxy: !0 };
Object.freeze(to);
function ft(e) {
  return e || to;
}
var br = Lt(us),
  ds = Lt(cs, { enhancer: Dt }),
  vs = Lt(ls, { enhancer: Na }),
  hs = Lt(fs, { enhancer: xa }),
  ro = G(br);
function dt(e) {
  return e.deep === !0 ? ve : e.deep === !1 ? Dt : ps(e.defaultDecorator);
}
function _s(e) {
  var t;
  return e ? ((t = e.defaultDecorator) != null ? t : eo(e)) : void 0;
}
function ps(e) {
  var t, n;
...
function no(e, t, n) {
  if (st(t)) return br.decorate_20223_(e, t);
  if (fe(t)) {
    at(e, t, br);
    return;
  }
...
var bs = {
    box: function (t, n) {
      var r = ft(n);
      return new le(t, dt(r), r.name, !0, r.equals);
    },
    array: function (t, n) {
      var r = ft(n);
      return (d.useProxies === !1 || r.proxy === !1 ? pu : au)(t, dt(r), r.name);
    },
    map: function (t, n) {
      var r = ft(n);
      return new Ao(t, dt(r), r.name);
    },
    set: function (t, n) {
      var r = ft(n);
    ...
    object: function (t, n, r) {
      return ge(function () {
        return Js(d.useProxies === !1 || r?.proxy === !1 ? Re({}, r) : ru({}, r), t, n);
      });
    },
    ref: G(ds),
    shallow: G(vs),
  ...
  gs = "computed.struct",
  gr = Cr(io),
  ys = Cr(gs, { equals: Ot.structural }),
  Nt = function (t, n) {
    if (st(n)) return gr.decorate_20223_(t, n);
    if (fe(n)) return at(t, n, gr);
    if (oe(t)) return G(Cr(io, t));
    var r = oe(n) ? n : {};
...
var Cn,
  ...
  ms = 1,
  Os =
    (Cn = (Bn = mt(function () {}, "name")) == null ? void 0 : Bn.configurable) != null ? Cn : !1,
  In = { value: "action", configurable: !0, writable: !1, enumerable: !1 };
function he(e, t, n, r) {
  n === void 0 && (n = !1);
  function i() {
    return ws(e, n, t, r || this, arguments);
  }
  return (
    (i.isMobxAction = !0),
    (i.toString = function () {
...
function Ss(e, t, n, r) {
  ...
  return ((wt = l.actionId_), l);
}
function As(e) {
  (wt !== e.actionId_ && g(30),
    (wt = e.parentActionId_),
...
var le = (function (e) {
    ...
    return (
      ...
      (n.prepareNewValue_ = function (i) {
        if (B(this)) {
          var o = I(this, { object: this, type: K, newValue: i });
      ...
      (n.setNewValue_ = function (i) {
        ...
        ((this.value_ = i),
          this.reportChanged(),
          L(this) && N(this, { type: K, object: this, newValue: i, oldValue: o }));
      }),
      (n.get = function () {
  ...
  q = (function () {
    function e(n) {
      ((this.dependenciesState_ = m.NOT_TRACKING_),
        ...
        (this.value_ = new At(null)),
        (this.name_ = void 0),
        (this.triggeredBy_ = void 0),
        (this.flags_ = 0),
        (this.derivation = void 0),
        (this.setter_ = void 0),
        (this.isTracing_ = St.NONE),
        (this.scope_ = void 0),
        (this.equals_ = void 0),
        ...
        (this.equals_ = n.equals || (n.compareStructural || n.struct ? Ot.structural : Ot.default)),
    ...
    return (
      ...
      (t.get = function () {
        ...
        else if ((fo(this), yr(this))) {
          var r = d.trackingContext;
          (this.keepAlive_ && !r && (d.trackingContext = this),
            this.trackAndCompute() && Ts(this),
            (d.trackingContext = r));
        }
        var i = this.value_;
        if (ht(i)) throw i.cause;
        return i;
      }),
      (t.set = function (r) {
        if (this.setter_) {
      ...
      (t.trackAndCompute = function () {
        var r = this.value_,
          ...
          a = i || ht(r) || ht(o) || !this.equals_(r, o);
      ...
      (t.computeValue_ = function (r) {
        ...
        var i = xt(!1),
          o;
        if (r) o = oo(this, this.derivation, this.scope_);
        ...
        return (qt(i), (this.isComputing = !1), o);
      }),
      (t.suspend_ = function () {
...
function yr(e) {
  switch (e.dependenciesState_) {
    ...
    case m.POSSIBLY_STALE_: {
      for (var t = Br(!0), n = pe(), r = e.observing_, i = r.length, o = 0; o < i; o++) {
        var a = r[o];
        if (Ft(a)) {
          ...
          if (e.dependenciesState_ === m.STALE_) return (re(n), et(t), !0);
        }
      }
      return (so(e), re(n), et(t), !1);
    }
  }
}
function oo(e, t, n) {
  ...
  return (d.inBatch--, (d.trackingDerivation = i), Ps(e), et(r), o);
}
function Ps(e) {
  for (
    var t = e.observing_,
  ...
  for (n.length = i, e.newObserving_ = null, o = t.length; o--; ) {
    var c = t[o];
    (c.diffValue === 0 && co(c, e), (c.diffValue = 0));
  }
  for (; i--; ) {
    var u = n[i];
    u.diffValue === 1 && ((u.diffValue = 0), js(u, e));
  }
...
function Rs() {
  if (((d.pendingReactions.length || d.inBatch || d.isRunningReactions) && g(36), (uo = !0), pt)) {
    var e = Mt();
    (--e.__mobxInstanceCount === 0 && (e.__mobxGlobals = void 0), (d = new _t()));
  }
}
function js(e, t) {
  (e.observers_.add(t),
...
function co(e, t) {
  (e.observers_.delete(t), e.observers_.size === 0 && lo(e));
}
function lo(e) {
...
function fo(e) {
  ...
  return t !== null
    ? (t.runId_ !== e.lastAccessedBy_ &&
      ...
      e.isBeingObserved)
    : (e.observers_.size === 0 && d.inBatch > 0 && lo(e), !1);
}
function vo(e) {
...
var z = (function () {
  ...
  return (
    ...
    (t.schedule_ = function () {
      this.isScheduled || ((this.isScheduled = !0), d.pendingReactions.push(this), ho());
    }),
    (t.runReaction_ = function () {
      if (!this.isDisposed) {
        (k(), (this.isScheduled = !1));
        var r = d.trackingContext;
        if (((d.trackingContext = this), yr(this))) {
    ...
    (t.track = function (r) {
      if (!this.isDisposed) {
        ...
        var o = oo(this, r, void 0);
        ((d.trackingContext = i),
          (this.isRunning = !1),
          (this.isTrackPending = !1),
          this.isDisposed && mr(this),
          ht(o) && this.reportExceptionInDerivation_(o.cause),
          D());
      }
    }),
    ...
    (t.dispose = function () {
      this.isDisposed || ((this.isDisposed = !0), this.isRunning || (k(), mr(this), D()));
    }),
...
function ho() {
  d.inBatch > 0 || d.isRunningReactions || Or(Bs);
}
function Bs() {
  d.isRunningReactions = !0;
  for (var e = d.pendingReactions, t = 0; e.length > 0; ) {
    ++t === Cs && (console.error("[mobx] cycle in reaction: " + e[0]), e.splice(0));
    for (var n = e.splice(0), r = 0, i = n.length; r < i; r++) n[r].runReaction_();
  }
  d.isRunningReactions = !1;
}
var Et = _e("Reaction", z);
function Is(e) {
  var t = Or;
  Or = function (r) {
    return e(function () {
...
var _o = "action",
  ...
  wr = ut(_o),
  xs = ut(Ds, { bound: !0 }),
  Sr = ut(po, { autoAction: !0 }),
  qs = ut(Ls, { autoAction: !0, bound: !0 });
function bo(e) {
  var t = function (r, i) {
    if (x(r)) return he(r.name || Ns, r, e);
    if (x(i)) return he(r, i, e);
    if (st(i)) return (e ? Sr : wr).decorate_20223_(r, i);
    if (fe(i)) return at(r, i, e ? Sr : wr);
    if (fe(r)) return G(ut(e ? po : _o, { name: r, autoAction: e }));
  };
  return t;
}
var we = bo(!1);
...
var zs = "never",
  ...
  Ws = "observed";
function Hs(e) {
  e.isolateGlobalState === !0 && Rs();
  var t = e.useProxies,
    n = e.enforceActions;
  if (
    (t !== void 0 && (d.useProxies = t === vt ? !0 : t === zs ? !1 : typeof Proxy < "u"),
    t === "ifavailable" && (d.verifyProxies = !0),
    n !== void 0)
  ) {
    var r = n === vt ? vt : n === Ws;
    ((d.enforceActions = r), (d.allowStateChanges = !(r === !0 || r === vt)));
  }
  ([
    ...
    e.reactionScheduler && Is(e.reactionScheduler));
}
function Js(e, t, n, r) {
  var i = Ta(t);
  return (
...
function mo(e) {
  var t = { name: e.name_ };
  return (
    e.observing_ && e.observing_.length > 0 && (t.dependencies = Ys(e.observing_).map(mo)),
    t
  );
}
function Ys(e) {
...
var or = Zi("flow"),
  Qs = Zi("flow.bound", { bound: !0 }),
  Ae = Object.assign(function (t, n) {
    if (st(n)) return or.decorate_20223_(t, n);
    if (fe(n)) return at(t, n, or);
    var r = t,
...
function eu(e, t) {
  return e ? Vt(e) || !!e[_] || Mr(e) || Et(e) || Ft(e) : !1;
}
function wo(e) {
  return eu(e);
}
...
function ru(e, t) {
  ...
  return (
    Ui(),
    (e = Re(e, t)),
    (r = (n = e[_]).proxy_) != null ? r : (n.proxy_ = new Proxy(e, tu))
  );
}
function B(e) {
    ...
    return (
      ...
      (t.spliceWithArray_ = function (r, i, o) {
        ...
        if (
          ...
          var c = I(this, { object: this.proxy_, type: Dn, index: r, removedCount: i, added: o });
          if (!c) return _r;
      ...
      (t.set_ = function (r, i) {
        ...
        if ((this.legacyMode_ && r > o.length && g(17, r, o.length), r < o.length)) {
          ...
          var a = o[r];
          if (B(this)) {
            var s = I(this, { type: K, object: this.proxy_, index: r, newValue: i });
            if (!s) return;
            i = s.newValue;
          }
...
function au(e, t, n, r) {
  return (
    ...
    Ui(),
    ge(function () {
      var i = new Ir(n, t, r, !1);
      zi(i.values_, _, i);
      var o = new Proxy(i.values_, ou);
...
var su = _e("ObservableArrayAdministration", Ir);
function $t(e) {
  return Bt(e) && su(e[_]);
}
var uu = {},
  ...
  Ao = (function () {
    function e(n, r, i) {
      ...
      (r === void 0 && (r = ve),
        ...
        x(Map) || g(18),
        ge(function () {
          ((o.keysAtom_ = Xi("ObservableMap.keys()")),
            (o.data_ = new Map()),
            (o.hasMap_ = new Map()),
            n && o.merge(n));
        }));
    ...
    return (
      ...
      (t.has = function (r) {
        ...
        if (!o) {
          var a = (o = new le(this.has_(r), Dt, "ObservableMap.key?", !1));
      ...
      (t.set = function (r, i) {
        var o = this.has_(r);
        if (B(this)) {
          var a = I(this, { type: o ? K : ie, object: this, newValue: i, name: r });
          if (!a) return this;
          i = a.newValue;
        }
      ...
      (t.delete = function (r) {
        var i = this;
        if ((this.keysAtom_, B(this))) {
          var o = I(this, { type: Rt, object: this, name: r });
          if (!o) return !1;
        }
        if (this.has_(r)) {
          var a = tt(),
      ...
      (t.replace = function (r) {
        ...
        return (
          ee(function () {
            for (
              var o = cu(r), a = new Map(), s = !1, c = Oe(i.data_.keys()), u;
              !(u = c()).done;
            ...
            if (!s)
              if (i.data_.size !== a.size) i.keysAtom_.reportChanged();
                ...
                for (
                  var j = i.data_.keys(), ne = a.keys(), se = j.next(), Lr = ne.next();
                  !se.done;

                ) {
                  if (se.value !== Lr.value) {
                    i.keysAtom_.reportChanged();
                    break;
                  }
                  ((se = j.next()), (Lr = ne.next()));
                }
            i.data_ = a;
          }),
          this
  ...
  be = _e("ObservableMap", Ao);
function Ln(e) {
  return ((e[Symbol.toStringTag] = "MapIterator"), Dr(e));
}
function cu(e) {
...
var lu = {},
  Eo = (function () {
    function e(n, r, i) {
      ...
      (r === void 0 && (r = ve),
        ...
        ge(function () {
          ((o.atom_ = Xi(o.name_)), n && o.replace(n));
        }));
    }
    var t = e.prototype;
    return (
      ...
      (t.delete = function (r) {
        var i = this;
        if (B(this)) {
          var o = I(this, { type: Rt, object: this, oldValue: r });
          if (!o) return !1;
        }
        if (this.has(r)) {
          var a = !1,
      ...
      (t.intersection = function (r) {
        if (Q(r) && !$(r)) return r.intersection(this);
        var i = new Set(this);
        return i.intersection(r);
      }),
      (t.union = function (r) {
        if (Q(r) && !$(r)) return r.union(this);
        var i = new Set(this);
        return i.union(r);
      }),
      ...
      (t.symmetricDifference = function (r) {
        if (Q(r) && !$(r)) return r.symmetricDifference(this);
        var i = new Set(this);
      ...
      (t.isDisjointFrom = function (r) {
        if (Q(r) && !$(r)) return r.isDisjointFrom(this);
        var i = new Set(this);
  ...
  $ = _e("ObservableSet", Eo);
function Nn(e) {
  return ((e[Symbol.toStringTag] = "SetIterator"), Dr(e));
}
  ...
  Po = (function () {
    ...
    return (
      ...
      (t.setObservablePropValue_ = function (r, i) {
        ...
        if (B(this)) {
          var a = I(this, { type: K, object: this.proxy_ || this.target_, name: r, newValue: i });
          if (!a) return null;
          i = a.newValue;
        }
        if (((i = o.prepareNewValue_(i)), i !== d.UNCHANGED)) {
      ...
      (t.has_ = function (r) {
        ...
        return (
          i ||
            ((i = new le(r in this.target_, Dt, "ObservableObject.key?", !1)),
      ...
      (t.make_ = function (r, i) {
        if ((i === !0 && (i = this.defaultAnnotation_), i !== !1)) {
          if (!(r in this.target_)) {
            var o;
            if ((o = this.target_[V]) != null && o[r]) return;
      ...
      (t.delete_ = function (r, i) {
        ...
        if (B(this)) {
          var o = I(this, { object: this.proxy_ || this.target_, name: r, type: qn });
          if (!o) return null;
        }
        try {
          var a;
          ...
          if (!u && (s || c)) {
            var f;
            l = (f = mt(this.target_, r)) == null ? void 0 : f.value;
          }
          if (i) {
            if (!Reflect.deleteProperty(this.target_, r)) return !1;
          } else delete this.target_[r];
          if (
            (u && (this.values_.delete(r), u instanceof le && (l = u.value_), vo(u)),
      ...
      (t.ownKeys_ = function () {
        return (this.keysAtom_.reportObserved(), kt(this.target_));
      }),
      (t.keys_ = function () {
...
function Re(e, t) {
  ...
  var r = (n = t?.name) != null ? n : "ObservableObject",
    i = new Po(e, new Map(), String(r), _s(t));
  return (It(e, _, i), e);
}
var fu = _e("ObservableObjectAdministration", Po);
function Fn(e) {
  return (
    xn[e] ||
    (xn[e] = {
...
function Vt(e) {
  return Bt(e) ? fu(e[_]) : !1;
}
function $n(e, t, n) {
  var r;
  (r = e.target_[V]) == null || delete r[n];
}
var du = jo(0),
  vu = (function () {
    var e = !1,
...
var kr = (function (e) {
  function t(r, i, o, a) {
    ...
    return (
      ...
      (s = e.call(this) || this),
      ge(function () {
        var c = new Ir(o, i, a, !0);
        ((c.proxy_ = s),
          zi(s, _, c),
          r && r.length && s.spliceWithArray(0, 0, r),
          vu && Object.defineProperty(s, "0", du));
      }),
      s
    );
  }
...
function _u(e) {
  U(kr.prototype, "" + e, jo(e));
}
function To(e) {
  if (e > ar) {
    for (var t = ar; t < e + 100; t++) _u(t);
    ar = e;
  }
}
To(1e3);
...
function jt(e, t) {
  if (typeof e == "object" && e !== null) {
    if ($t(e)) return (t !== void 0 && g(23), e[_].atom_);
    if ($(e)) return e.atom_;
    if (be(e)) {
      if (t === void 0) return e.keysAtom_;
      var n = e.data_.get(t) || e.hasMap_.get(t);
      return (n || g(25, t, Ar(e)), n);
    }
    if (Vt(e)) {
      if (!t) return g(26);
      var r = e[_].values_.get(t);
      return (r || g(27, t, Ar(e)), r);
    }
    if (Mr(e) || Ft(e) || Et(e)) return e;
  } else if (x(e) && Et(e[_])) return e[_];
  g(28);
}
function bu(e, t) {
  if ((e || g(29), Mr(e) || Ft(e) || Et(e) || be(e) || $(e))) return e;
  if (e[_]) return e[_];
  g(24, e);
}
function Ar(e, t) {
  var n;
  if (t !== void 0) n = jt(e, t);
  else {
    if (nt(e)) return e.name;
    Vt(e) || be(e) || $(e) ? (n = bu(e)) : (n = jt(e));
  }
  return n.name_;
}
function ge(e) {
...
function Er(e, t, n, r, i) {
  ...
  if ((r.push(e), i.push(t), s)) {
    ...
    for (; l--; ) if (!Er(e[l], t[l], n - 1, r, i)) return !1;
  } else {
    var f = Object.keys(e),
      v = f.length;
    ...
    for (var h = 0; h < v; h++) {
      var b = f[h];
      if (!(te(t, b) && Er(e[b], t[b], n - 1, r, i))) return !1;
    }
  }
  return (r.pop(), i.pop(), !0);
}
function Un(e) {
  return $t(e) ? e.slice() : Ee(e) || be(e) || Q(e) || $(e) ? Array.from(e.entries()) : e;
}
var Gn,
  gu = ((Gn = Mt().Iterator) == null ? void 0 : Gn.prototype) || {};
function Dr(e) {
  return ((e[Symbol.iterator] = yu), Object.assign(Object.create(gu), e));
}
function yu() {
  return this;
}
...
typeof __MOBX_DEVTOOLS_GLOBAL_HOOK__ == "object" &&
  __MOBX_DEVTOOLS_GLOBAL_HOOK__.injectMobx({ spy: ks, extras: { getDebugName: Ar }, $mobx: _ });
if (!E.useState) throw new Error("mobx-react-lite requires React with Hooks support");
if (!nu) throw new Error("mobx-react-lite@3 requires mobx at least version 6 to be available");
function mu(e) {
  e();
}
function Ou(e) {
  (e || (e = mu), Hs({ reactionScheduler: e }));
}
function wu(e) {
  return Xs(e);
}
var Su = 1e4,
    ...
    function e(t) {
      ...
      (Object.defineProperty(this, "finalize", {
        ...
        Object.defineProperty(this, "sweep", {
          ...
          writable: !0,
          value: function (r) {
            (r === void 0 && (r = Su), clearTimeout(n.sweepTimeout), (n.sweepTimeout = void 0));
            var i = Date.now();
  ...
  Pu = typeof FinalizationRegistry < "u" ? FinalizationRegistry : Eu,
  ot = new Pu(function (e) {
    var t;
...
function Ru() {
  ...
  var l =
    ...
    typeof window.document.createElement > "u"
      ...
      : s;
  return (
    (ur.useSyncExternalStore = e.useSyncExternalStore !== void 0 ? e.useSyncExternalStore : l),
    ur
  );
}
var zn;
function ju() {
  return (zn || ((zn = 1), (sr.exports = Ru())), sr.exports);
}
var Tu = ju();
function Wn(e) {
...
function Mu(e, t) {
    ...
    var r = {
      ...
      subscribe: function (s) {
        return (
          ot.unregister(r),
          (r.onStoreChange = s),
          r.reaction || (Wn(r), (r.stateVersion = Symbol())),
          function () {
            var c;
  ...
  var i = n.current;
  (i.reaction || (Wn(i), ot.register(n, i, i)),
    dr.useDebugValue(i.reaction, wu),
    Tu.useSyncExternalStore(i.subscribe, i.getSnapshot, i.getSnapshot));
  var o, a;
  if (
...
var cr,
  lr,
  Co = typeof Symbol == "function" && Symbol.for,
  Cu =
    (lr =
      (cr = Object.getOwnPropertyDescriptor(function () {}, "name")) === null || cr === void 0
        ? void 0
        : cr.configurable) !== null && lr !== void 0
      ? lr
      : !1,
  Hn = Co
...
function Bu(e, t) {
  ...
  if (Hn && e.$$typeof === Hn && ((r = !0), (i = e.render), typeof i != "function"))
  ...
  return (
    ...
    Cu && Object.defineProperty(a, "name", { value: e.name, writable: !0, configurable: !0 }),
...
var Iu = { $$typeof: !0, render: !0, compare: !0, type: !0, displayName: !0 };
function ku(e, t) {
  Object.keys(e).forEach(function (n) {
    Iu[n] || Object.defineProperty(t, n, Object.getOwnPropertyDescriptor(e, n));
  });
}
var fr;
Ou(ko.unstable_batchedUpdates);
fr = ot.finalizeAllImmediately;
function Du(e, t) {
  if (Xn(e, t)) return !0;
  ...
  for (var i = 0; i < n.length; i++)
    if (!Object.hasOwnProperty.call(t, n[i]) || !Xn(e[n[i]], t[n[i]])) return !1;
  return !0;
}
function Xn(e, t) {
  return e === t ? e !== 0 || 1 / e === 1 / t : e !== e && t !== t;
}
var Yn = Symbol("patchMixins"),
...
function Qn(e, t) {
  var n = function () {
    for (var i = arguments.length, o = new Array(i), a = 0; a < i; a++) o[a] = arguments[a];
    Zn.call.apply(Zn, [this, e, t].concat(o));
  };
  return n;
}
function Nu(e, t, n) {
  ...
  if (!(i && i[Bo])) {
    var o = e[t],
      a = Io(e, t, i ? i.enumerable : void 0, r, o);
...
var ei = Symbol("ObserverAdministration"),
  ti = Symbol("isMobXReactObserver");
function Pr(e) {
  var t;
  return (t = e[ei]) != null
    ? t
...
function xu(e) {
  ...
  if (e.__proto__ !== E.PureComponent) {
    if (!t.shouldComponentUpdate) t.shouldComponentUpdate = ri;
    else if (t.shouldComponentUpdate !== ri)
      throw new Error(
  ...
  return (
    ...
    Nu(t, "componentWillUnmount", function () {
      var a,
        s = Pr(this);
...
function qu(e) {
  var t = e.bind(this),
    n = Pr(this);
  function r() {
    n.reaction || ((n.reaction = Fu(n)), n.mounted || ot.register(this, n, this));
    var i = void 0,
      o = void 0;
    if (
...
function ri(e, t) {
  return this.state !== t ? !0 : !Du(this.props, e);
}
function $u(e, t) {
  return (
    e.isMobxInjector === !0 &&
...
function Uu() {
  ...
  const a = async () => {
      try {
        const u = await yt.invoke("getCheckList");
        t(u);
      } catch {
        await Qe(
    ...
    s = async (u) => {
      try {
        o(!0);
        const l = await yt.invoke(u ? "updateWithOptimisticLocking" : "update", e);
        l.error
          ? l.concurrent
            ? (await Qe(
  ...
  return n
    ? A.jsx("div", { className: "checklist-container", children: A.jsx(ni, {}) })
    : A.jsxs("div", {
          ...
          A.jsxs("div", {
            ...
            children: [
              ...
              A.jsxs("div", {
                ...
                children: ["Last updated by ", e.updateDisplayName, " on ", Vu(e.updatedAt)],
              }),
            ],
          }),
          A.jsx("div", {
...
const Gu = $u(Uu),
  Ku = document.getElementById("root"),
  zu = Do.createRoot(Ku),
  ii = () => {
    zu.render(A.jsx(Gu, {}));
  };
