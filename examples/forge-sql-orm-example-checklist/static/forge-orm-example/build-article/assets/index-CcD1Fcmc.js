import { r as Pt, c as sr } from "./react-dom-vendor-DUDfcWRj.js";
import { g as ur, r as cr } from "./lodash-vendor-CHXXAK2W.js";
(function () {
...
var Be;
function fr() {
  return (Be || ((Be = 1), (se.exports = lr())), se.exports);
}
var b = fr(),
  te = Pt(),
  ue = {},
...
function xt(e) {
  ...
  var t = {};
  if (e != null) for (var n = je(e), o = 0; o < n.length; o++) n[o] !== "default" && ie(t, e, n[o]);
  return (dr(t, e), t);
}
function Jt(e) {
...
function Xt(e) {
  function t(i) {
    ((e.error = e.hasError ? new hr(i, e.error, "An error was suppressed during disposal.") : i),
      (e.hasError = !0));
  }
  var n,
    o = 0;
...
function w() {
  if (Se) return q;
  ((Se = 1), Object.defineProperty(q, "__esModule", { value: !0 }), (q.BridgeAPIError = void 0));
  class e extends Error {}
  return ((q.BridgeAPIError = e), q);
}
var qe;
function g() {
  if (qe) return S;
  ((qe = 1), Object.defineProperty(S, "__esModule", { value: !0 }), (S.getCallBridge = void 0));
  const e = w();
  function t(o) {
    return !!o?.callBridge;
  }
...
function Zt() {
  if (ke) return k;
  ((ke = 1), Object.defineProperty(k, "__esModule", { value: !0 }), (k.withRateLimiter = void 0));
  const e = w(),
    t = (n, o, r, i) => {
      let a = Date.now(),
        u = 0;
...
function gr() {
  return (
    Ae ||
      ((Ae = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), R.__exportStar(br(), e));
      })(ce)),
    ce
  );
}
        ...
        const u = (0, t.getCallBridge)(),
          ...
          s = (f) => async (h) => {
            ...
            const d = { ...h, invokeType: `ui-${f.toLowerCase()}-fetch` },
              ...
              m = { ...(_ ? y : p) };
            if (m && m.headers)
              for (const ae in m.headers)
                Array.isArray(m.headers[ae]) && (m.headers[ae] = m.headers[ae].join(","));
            return m;
          },
          l = (f) => {
            const h = s(f);
...
function pr() {
  if (Le) return M;
  ((Le = 1), Object.defineProperty(M, "__esModule", { value: !0 }), (M.invokeRemote = void 0));
  const e = Qt(),
...
function wr() {
  if (Ne) return A;
  ((Ne = 1), Object.defineProperty(A, "__esModule", { value: !0 }), (A.invokeService = void 0));
  const e = Qt(),
  ...
  return (
    De ||
      ...
      (function (e) {
        Object.defineProperty(e, "__esModule", { value: !0 });
        const t = R;
        (t.__exportStar(pr(), e), t.__exportStar(wr(), e));
      })(fe)),
    fe
  );
}
...
function Or() {
  if ($e) return L;
  (($e = 1), Object.defineProperty(L, "__esModule", { value: !0 }), (L.submit = void 0));
  const e = g(),
    t = w(),
    n = (0, e.getCallBridge)(),
    o = async (r) => {
...
function Er() {
  if (Ue) return N;
  ((Ue = 1), Object.defineProperty(N, "__esModule", { value: !0 }), (N.close = void 0));
  const e = g(),
    t = w(),
    n = (0, e.getCallBridge)(),
    o = async (r) => {
...
function Pr() {
  if (Ge) return D;
  ((Ge = 1), Object.defineProperty(D, "__esModule", { value: !0 }), (D.open = void 0));
  const e = g(),
    t = w(),
    n = (0, e.getCallBridge)(),
    o = async () => {
...
function Rr() {
  if (Ve) return $;
  ((Ve = 1), Object.defineProperty($, "__esModule", { value: !0 }), ($.refresh = void 0));
  const e = g(),
    t = w(),
    n = (0, e.getCallBridge)(),
    o = async (r) => {
...
function Tr() {
  if (Ke) return V;
  ((Ke = 1), Object.defineProperty(V, "__esModule", { value: !0 }), (V.Translator = void 0));
  const e = tr();
  class t {
    locale;
    translationsGetter;
  ...
  return ((V.Translator = t), V);
}
var x = {},
  ze;
function Br() {
  if (ze) return x;
  ((ze = 1), Object.defineProperty(x, "__esModule", { value: !0 }), (x.ensureLocale = void 0));
  const e = er(),
...
function qr() {
  if (Qe) return G;
  ((Qe = 1), Object.defineProperty(G, "__esModule", { value: !0 }), (G.getContext = void 0));
  const e = g(),
    t = rr(),
    n = (0, e.getCallBridge)(),
    o = async () => {
...
function kr() {
  if (et) return J;
  ((et = 1), Object.defineProperty(J, "__esModule", { value: !0 }), (J.changeWindowTitle = void 0));
  const e = g(),
    t = w(),
    n = (0, e.getCallBridge)(),
    o = async (r) => {
...
function Mr() {
  if (tt) return H;
  ((tt = 1), Object.defineProperty(H, "__esModule", { value: !0 }), (H.theme = void 0));
  const t = (0, g().getCallBridge)();
  return ((H.theme = { enable: () => t("enableTheming") }), H);
}
var W = {},
  K = {},
  ge = {},
...
function or() {
  if (ot) return K;
  ((ot = 1), Object.defineProperty(K, "__esModule", { value: !0 }), (K.events = void 0));
  const e = g(),
    t = Ar(),
    n = (0, e.getCallBridge)(),
    o = async (i, a) => {
...
function Fr() {
  if (it) return W;
  ((it = 1), Object.defineProperty(W, "__esModule", { value: !0 }), (W.emitReadyEvent = void 0));
  const e = or(),
    t = ir(),
    n = "EXTENSION_READY",
    o = async () => {
  ...
  return ((W.emitReadyEvent = o), W);
}
var at;
function ir() {
  if (at) return F;
  ((at = 1), Object.defineProperty(F, "__esModule", { value: !0 }), (F.view = void 0));
  const e = Or(),
    t = Er(),
    n = Pr(),
    o = Rr(),
...
function ar() {
  return (
    st ||
      ((st = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), R.__exportStar(ir(), e));
      })(he)),
    he
  );
}
...
function Lr() {
  if (ut) return z;
  ((ut = 1), Object.defineProperty(z, "__esModule", { value: !0 }), (z.router = void 0));
  const t = (0, g().getCallBridge)(),
    n = async (a) => {
...
function Nr() {
  return (
    ct ||
      ((ct = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), R.__exportStar(Lr(), e));
      })(pe)),
    pe
  );
}
...
function Dr() {
  if (lt) return X;
  ((lt = 1), Object.defineProperty(X, "__esModule", { value: !0 }), (X.Modal = void 0));
  const e = g(),
    t = w(),
    n = (0, e.getCallBridge)(),
    o = () => {};
...
function Ur() {
  if (dt) return Y;
  ((dt = 1), Object.defineProperty(Y, "__esModule", { value: !0 }), (Y.productFetchApi = void 0));
  const e = nr(),
    t = async (r) => {
      const i = {};
    ...
    o = (r) => {
      const i = async (a, u, c) => {
        ...
        const h = {
          ...
          m = p ? (0, e.base64ToBlob)(d, v["content-type"]) : d;
        return new Response(m || null, { headers: v, status: y, statusText: _ });
      };
      return {
...
function Vr() {
  if (vt) return Z;
  ((vt = 1), Object.defineProperty(Z, "__esModule", { value: !0 }), (Z.showFlag = void 0));
  const e = g(),
    t = w(),
    n = (0, e.getCallBridge)(),
    o = (r) => {
...
function Hr() {
  if (bt) return Q;
  ((bt = 1), Object.defineProperty(Q, "__esModule", { value: !0 }), (Q.realtime = void 0));
  const t = (0, g().getCallBridge)(),
...
function zr() {
  ...
  return ((P.createTranslationFunction = a), P);
}
var mt;
function Xr() {
  return (
...
function Zr() {
  ...
  return n
    ? b.jsx("div", { className: "checklist-container", children: b.jsx(Ot, {}) })
    : b.jsxs("div", {
          ...
          b.jsxs("div", {
            ...
            children: [
              ...
              b.jsxs("div", {
                ...
                children: ["Last updated by ", e.updateDisplayName, " on ", Yr(e.updatedAt)],
              }),
            ],
          }),
          b.jsx("div", {
...
const Qr = document.getElementById("root"),
  en = sr.createRoot(Qr),
  Et = () => {
    en.render(b.jsx(Zr, {}));
  };
