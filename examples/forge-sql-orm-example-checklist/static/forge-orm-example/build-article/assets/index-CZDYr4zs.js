import { r as Tr, a as No, c as Lo } from "./react-dom-vendor-DTSHKYJW.js";
import { g as xo, a as qo, r as Fo } from "./lodash-vendor-RhPBt8ex.js";
(function () {
...
var qr;
function Vo() {
  return (qr || ((qr = 1), (Ut.exports = $o())), Ut.exports);
}
var E = Vo(),
  A = Tr();
const vr = xo(A);
...
function Pi(e) {
  ...
  var t = {};
  if (e != null) for (var n = _r(e), r = 0; r < n.length; r++) n[r] !== "default" && Tt(t, e, n[r]);
  return (Uo(t, e), t);
}
function Ri(e) {
...
function P() {
  if (Vr) return Me;
  ((Vr = 1), Object.defineProperty(Me, "__esModule", { value: !0 }), (Me.getCallBridge = void 0));
  const e = F();
  function t(r) {
    return !!r?.callBridge;
  }
  ...
  return ((Me.getCallBridge = n), Me);
}
var Be = {},
  Ur;
function ki() {
  if (Ur) return Be;
  ((Ur = 1), Object.defineProperty(Be, "__esModule", { value: !0 }), (Be.withRateLimiter = void 0));
  const e = F(),
    t = (n, r, i, o) => {
      let a = Date.now(),
        s = 0;
  ...
  return ((Be.withRateLimiter = t), Be);
}
var Gr;
function Ho() {
  return (
      ...
      (function (e) {
        ...
        const t = P(),
          ...
          a = (c, u) => {
            ...
            return (o(u), i("invoke", { functionKey: c, payload: u }));
          };
...
function Xo() {
  if (Wr) return Ie;
  ((Wr = 1), Object.defineProperty(Ie, "__esModule", { value: !0 }), (Ie.invokeRemote = void 0));
  const e = Di(),
    t = (n) => (0, e._invokeEndpointFn)(e.InvokeType.REMOTE)(n);
  return ((Ie.invokeRemote = t), Ie);
}
var ke = {},
  Hr;
function Yo() {
  if (Hr) return ke;
  ((Hr = 1), Object.defineProperty(ke, "__esModule", { value: !0 }), (ke.invokeService = void 0));
  const e = Di(),
    t = (n) => (0, e._invokeEndpointFn)(e.InvokeType.SERVICE)(n);
  return ((ke.invokeService = t), ke);
}
var Jr;
function Zo() {
  return (
...
function ea() {
  if (Yr) return Le;
  ((Yr = 1), Object.defineProperty(Le, "__esModule", { value: !0 }), (Le.close = void 0));
  const e = P(),
    t = F(),
    n = (0, e.getCallBridge)(),
    r = async (i) => {
  ...
  return ((Le.close = r), Le);
}
var xe = {},
  Zr;
function ta() {
  if (Zr) return xe;
  ((Zr = 1), Object.defineProperty(xe, "__esModule", { value: !0 }), (xe.open = void 0));
  const e = P(),
    t = F(),
    n = (0, e.getCallBridge)(),
    r = async () => {
...
function ra() {
  if (Qr) return qe;
  ((Qr = 1), Object.defineProperty(qe, "__esModule", { value: !0 }), (qe.refresh = void 0));
  const e = P(),
    t = F(),
    n = (0, e.getCallBridge)(),
    r = async (i) => {
...
function na() {
  if (en) return Fe;
  ((en = 1), Object.defineProperty(Fe, "__esModule", { value: !0 }), (Fe.createHistory = void 0));
...
function oa() {
  if (on) return Ve;
  ((on = 1), Object.defineProperty(Ve, "__esModule", { value: !0 }), (Ve.Translator = void 0));
  const e = Li();
  class t {
    locale;
    translationsGetter;
...
function aa() {
  if (an) return Ue;
  ((an = 1), Object.defineProperty(Ue, "__esModule", { value: !0 }), (Ue.ensureLocale = void 0));
  const e = Ni(),
...
function ca() {
  if (ln) return $e;
  ((ln = 1), Object.defineProperty($e, "__esModule", { value: !0 }), ($e.getContext = void 0));
  const e = P(),
    t = xi(),
    n = (0, e.getCallBridge)(),
    r = async () => {
...
function fa() {
  if (dn) return Ke;
  ((dn = 1), Object.defineProperty(Ke, "__esModule", { value: !0 }), (Ke.theme = void 0));
  const t = (0, P().getCallBridge)();
...
function Fi() {
  if (_n) return We;
  ((_n = 1), Object.defineProperty(We, "__esModule", { value: !0 }), (We.events = void 0));
  const e = P(),
    t = da(),
    n = (0, e.getCallBridge)(),
    r = async (o, a) => {
...
function va() {
  if (pn) return ze;
  ((pn = 1), Object.defineProperty(ze, "__esModule", { value: !0 }), (ze.emitReadyEvent = void 0));
  const e = Fi(),
    t = $i(),
    n = "EXTENSION_READY",
    r = async () => {
...
function $i() {
  if (bn) return De;
  ((bn = 1), Object.defineProperty(De, "__esModule", { value: !0 }), (De.view = void 0));
  const e = Qo(),
    t = ea(),
    n = ta(),
    r = ra(),
...
function ha() {
  if (yn) return He;
  ((yn = 1), Object.defineProperty(He, "__esModule", { value: !0 }), (He.router = void 0));
  const t = (0, P().getCallBridge)(),
    n = async (a) => {
...
function pa() {
  if (On) return Je;
  ((On = 1), Object.defineProperty(Je, "__esModule", { value: !0 }), (Je.Modal = void 0));
  const e = P(),
    t = F(),
    n = (0, e.getCallBridge)(),
    r = () => {};
...
function ga() {
  if (Sn) return Xe;
  ((Sn = 1), Object.defineProperty(Xe, "__esModule", { value: !0 }), (Xe.productFetchApi = void 0));
  const e = qi(),
    t = async (i) => {
      const o = {};
...
function ma() {
  if (An) return Ye;
  ((An = 1), Object.defineProperty(Ye, "__esModule", { value: !0 }), (Ye.showFlag = void 0));
  const e = P(),
    t = F(),
    n = (0, e.getCallBridge)(),
    r = (i) => {
...
function Sa() {
  if (jn) return Ze;
  ((jn = 1), Object.defineProperty(Ze, "__esModule", { value: !0 }), (Ze.__realtime = void 0));
  const t = (0, P().getCallBridge)(),
    n = (a, s) => t("publishRealtimeChannel", { channelName: a, eventPayload: s }),
    r = (a, s, c) => t("subscribeRealtimeChannel", { channelName: a, onEvent: s, options: c }),
    i = (a, s) => t("publishRealtimeChannel", { channelName: a, eventPayload: s, isGlobal: !0 }),
    o = (a, s, c) =>
      t("subscribeRealtimeChannel", { channelName: a, onEvent: s, options: c, isGlobal: !0 });
  return ((Ze.__realtime = { publish: n, subscribe: r, publishGlobal: i, subscribeGlobal: o }), Ze);
}
var Tn;
function Ea() {
  return (
...
function at(e, t, n) {
  (te(e, U) || It(e, U, de({}, e[U])), Ua(n) || (e[U][t] = n));
}
function La(e) {
  return (te(e, U) || It(e, U, de({}, e[U])), e[U]);
}
function st(e) {
...
var Ot = { structural: xa, default: qa };
function ve(e, t, n) {
  return Eo(e)
    ? e
    : Array.isArray(e)
...
function us(e, t, n, r) {
  ...
  if (r !== e.target_ && typeof n.value == "function") {
    ...
    if (Wi(n.value)) {
      var c,
        u = (c = this.options_) != null && c.autoBind ? Ee.bound : Ee;
...
var gr = Nt(fs),
  _s = Nt(ds, { enhancer: Dt }),
  ps = Nt(vs, { enhancer: Fa }),
  bs = Nt(hs, { enhancer: $a }),
  io = K(gr);
function dt(e) {
  return e.deep === !0 ? ve : e.deep === !1 ? Dt : ys(e.defaultDecorator);
}
function gs(e) {
  var t;
...
function oo(e, t, n) {
  if (st(t)) return gr.decorate_20223_(e, t);
  if (fe(t)) {
    at(e, t, gr);
    return;
  }
...
var ms = {
    ...
    array: function (t, n) {
      var r = ft(n);
      return (d.useProxies === !1 || r.proxy === !1 ? yu : cu)(t, dt(r), r.name);
    },
    map: function (t, n) {
      var r = ft(n);
      return new Po(t, dt(r), r.name);
    },
    set: function (t, n) {
      var r = ft(n);
      return new Ro(t, dt(r), r.name);
    },
  ...
  Os = "computed.struct",
  yr = Br(ao),
  ws = Br(Os, { equals: Ot.structural }),
  Lt = function (t, n) {
    if (st(n)) return yr.decorate_20223_(t, n);
    if (fe(n)) return at(t, n, yr);
    if (oe(t)) return K(Br(ao, t));
    var r = oe(n) ? n : {};
...
var In,
  ...
  Ss = 1,
  Es =
    (In = (kn = mt(function () {}, "name")) == null ? void 0 : kn.configurable) != null ? In : !1,
  Dn = { value: "action", configurable: !0, writable: !1, enumerable: !1 };
function he(e, t, n, r) {
  n === void 0 && (n = !1);
  function i() {
    return As(e, n, t, r || this, arguments);
  }
  return (
    (i.isMobxAction = !0),
    (i.toString = function () {
...
var le = (function (e) {
    ...
    return (
      ...
      (n.setNewValue_ = function (i) {
        ...
        ((this.value_ = i),
          this.reportChanged(),
          N(this) && L(this, { type: z, object: this, newValue: i, oldValue: o }));
      }),
      (n.get = function () {
...
function so(e, t, n) {
  ...
  return (d.inBatch--, (d.trackingDerivation = i), Ts(e), et(r), o);
}
function Ts(e) {
  for (
    var t = e.observing_,
  ...
  for (; i--; ) {
    var u = n[i];
    u.diffValue === 1 && ((u.diffValue = 0), Cs(u, e));
  }
...
function Ms() {
  if (((d.pendingReactions.length || d.inBatch || d.isRunningReactions) && g(36), (lo = !0), pt)) {
    var e = Mt();
...
var bo = "action",
  ...
  Sr = ut(bo),
  $s = ut(xs, { bound: !0 }),
  Er = ut(go, { autoAction: !0 }),
  Vs = ut(qs, { autoAction: !0, bound: !0 });
function yo(e) {
  var t = function (r, i) {
    if (x(r)) return he(r.name || Fs, r, e);
    if (x(i)) return he(r, i, e);
    if (st(i)) return (e ? Er : Sr).decorate_20223_(r, i);
    if (fe(i)) return at(r, i, e ? Er : Sr);
    if (fe(r)) return K(ut(e ? go : bo, { name: r, autoAction: e }));
  };
  return t;
}
var we = yo(!1);
...
function Ys(e) {
  ...
  var t = e.useProxies,
    n = e.enforceActions;
  if (
    (t !== void 0 && (d.useProxies = t === vt ? !0 : t === Js ? !1 : typeof Proxy < "u"),
  ...
  ([
    ...
    e.reactionScheduler && Ns(e.reactionScheduler));
}
function Zs(e, t, n, r) {
  var i = Ba(t);
  return (
...
var ar = eo("flow"),
  ...
  Ee = Object.assign(function (t, n) {
    if (st(n)) return ar.decorate_20223_(t, n);
    if (fe(n)) return at(t, n, ar);
    var r = t,
...
function nu(e, t) {
  return e ? Vt(e) || !!e[_] || Cr(e) || At(e) || Ft(e) : !1;
}
function Eo(e) {
  return nu(e);
}
    ...
    return (
      ...
      (t.spliceWithArray_ = function (r, i, o) {
        ...
        if (
          ...
          var c = I(this, { object: this.proxy_, type: Ln, index: r, removedCount: i, added: o });
          if (!c) return pr;
        ...
        var a = !this.owned_ && tt(),
          ...
          c =
            s || a
              ...
              : null;
        (this.atom_.reportChanged(), s && L(this, c));
      }),
...
function jt(e, t) {
  if (typeof e == "object" && e !== null) {
    ...
    if (Cr(e) || Ft(e) || At(e)) return e;
  } else if (x(e) && At(e[_])) return e[_];
  g(28);
}
function mu(e, t) {
  if ((e || g(29), Cr(e) || Ft(e) || At(e) || be(e) || V(e))) return e;
  if (e[_]) return e[_];
  g(24, e);
}
function Ar(e, t) {
...
function Kn(e) {
  return $t(e) ? e.slice() : Ae(e) || be(e) || Q(e) || V(e) ? Array.from(e.entries()) : e;
}
var zn,
  Ou = ((zn = Mt().Iterator) == null ? void 0 : zn.prototype) || {};
function Nr(e) {
...
typeof __MOBX_DEVTOOLS_GLOBAL_HOOK__ == "object" &&
  __MOBX_DEVTOOLS_GLOBAL_HOOK__.injectMobx({ spy: Ls, extras: { getDebugName: Ar }, $mobx: _ });
...
function Iu(e, t) {
  ...
  var i = n.current;
  (i.reaction || (Jn(i), ot.register(n, i, i)),
    vr.useDebugValue(i.reaction, Au),
    Bu.useSyncExternalStore(i.subscribe, i.getSnapshot, i.getSnapshot));
  var o, a;
  if (
...
var Nu = { $$typeof: !0, render: !0, compare: !0, type: !0, displayName: !0 };
function Lu(e, t) {
  Object.keys(e).forEach(function (n) {
    Nu[n] || Object.defineProperty(t, n, Object.getOwnPropertyDescriptor(e, n));
  });
}
var dr;
Eu(No.unstable_batchedUpdates);
dr = ot.finalizeAllImmediately;
function xu(e, t) {
  if (Zn(e, t)) return !0;
...
function Vu(e) {
  var t = e.bind(this),
    n = Rr(this);
  function r() {
    n.reaction || ((n.reaction = Uu(n)), n.mounted || ot.register(this, n, this));
    var i = void 0,
      o = void 0;
    if (
...
function Gu(e, t) {
  return (
    ...
    Object.prototype.isPrototypeOf.call(A.Component, e) ||
    Object.prototype.isPrototypeOf.call(A.PureComponent, e)
      ? $u(e)
      : Du(e)
  );
}
...
function oi() {
  return E.jsx("div", {
    ...
    children: E.jsx("div", { className: "loading-spinner" }),
  });
}
function zu() {
  ...
  return n
    ? E.jsx("div", { className: "checklist-container", children: E.jsx(oi, {}) })
    : E.jsxs("div", {
        ...
        children: [
          ...
          E.jsxs("div", {
            ...
            children: [
              E.jsx("h2", { children: "Issue Checklist" }),
              E.jsxs("div", {
            ...
            children: JSON.parse(e.checkList).map((u, l) =>
              E.jsxs(
                "div",
                {
                  ...
                  children: [
                    E.jsx("input", { type: "checkbox", checked: u.done, onChange: () => c(l) }),
          ...
          E.jsxs("div", {
            className: "buttons",
            children: [
              E.jsx("button", { onClick: () => s(!0), children: "Update with Locking" }),
              E.jsx("button", { onClick: () => s(!1), children: "Update without Locking" }),
            ],
          }),
        ],
      });
