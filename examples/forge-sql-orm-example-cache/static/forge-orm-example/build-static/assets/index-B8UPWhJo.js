import { r as $t, c as kr } from "./react-dom-vendor-BOEB6BZs.js";
import { g as qr, a as Lr, r as P } from "./client-core-vendor-kqFzl-gg.js";
import { r as Ur } from "./lodash-vendor-wRvQIJsp.js";
(function () {
...
var We;
function zr() {
  return (We || ((We = 1), (we.exports = Nr())), we.exports);
}
var f = zr(),
  S = $t();
const Gr = qr(S);
...
function mr(e) {
  ...
  var t = {};
  if (e != null) for (var a = ze(e), o = 0; o < a.length; o++) a[o] !== "default" && me(t, e, a[o]);
  return (Vr(t, e), t);
}
function br(e) {
...
function Or(e) {
  function t(i) {
    ((e.error = e.hasError ? new Kr(i, e.error, "An error was suppressed during disposal.") : i),
      (e.hasError = !0));
  }
  var a,
    o = 0;
...
function E() {
  if (Je) return N;
  ((Je = 1), Object.defineProperty(N, "__esModule", { value: !0 }), (N.BridgeAPIError = void 0));
...
function w() {
  if (Qe) return U;
  ((Qe = 1), Object.defineProperty(U, "__esModule", { value: !0 }), (U.getCallBridge = void 0));
  const e = E();
  function t(o) {
    return !!o?.callBridge;
  }
...
function be() {
  if (Ye) return z;
  ((Ye = 1), Object.defineProperty(z, "__esModule", { value: !0 }), (z.withRateLimiter = void 0));
  const e = E(),
    t = (a, o, n, i) => {
      let r = Date.now(),
        c = 0;
...
function Yr() {
  return (
    Ze ||
      ((Ze = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), C.__exportStar(Qr(), e));
      })(xe)),
    xe
  );
}
...
function Xr() {
  if (et) return G;
  ((et = 1), Object.defineProperty(G, "__esModule", { value: !0 }), (G.invokeRemote = void 0));
  const e = Cr(),
...
function Zr() {
  if (tt) return V;
  ((tt = 1), Object.defineProperty(V, "__esModule", { value: !0 }), (V.invokeService = void 0));
  const e = Cr(),
  ...
  return (
    rt ||
      ...
      (function (e) {
        Object.defineProperty(e, "__esModule", { value: !0 });
        const t = C;
        (t.__exportStar(Xr(), e), t.__exportStar(Zr(), e));
      })(Oe)),
    Oe
  );
}
...
function en() {
  if (nt) return W;
  ((nt = 1), Object.defineProperty(W, "__esModule", { value: !0 }), (W.submit = void 0));
  const e = w(),
    t = E(),
    a = (0, e.getCallBridge)(),
    o = async (n) => {
...
function nn() {
  if (st) return Q;
  ((st = 1), Object.defineProperty(Q, "__esModule", { value: !0 }), (Q.refresh = void 0));
  const e = w(),
    t = E(),
    a = (0, e.getCallBridge)(),
    o = async (n) => {
  ...
  return ((Q.refresh = o), Q);
}
var Y = {},
  at;
function on() {
  if (at) return Y;
  ((at = 1), Object.defineProperty(Y, "__esModule", { value: !0 }), (Y.createHistory = void 0));
...
function ln() {
  if (ft) return $;
  ((ft = 1), Object.defineProperty($, "__esModule", { value: !0 }), ($.ensureLocale = void 0));
  const e = Rr(),
...
function dn() {
  if (pt) return X;
  ((pt = 1), Object.defineProperty(X, "__esModule", { value: !0 }), (X.getContext = void 0));
  const e = w(),
    t = Fr(),
    a = (0, e.getCallBridge)(),
    o = async () => {
...
const Nn = () => {
  ...
  zn = document.getElementById("root"),
  Gn = kr.createRoot(zn),
  Zt = () => {
    Gn.render(f.jsx(Gr.StrictMode, { children: f.jsx(Nn, {}) }));
  };
_e.view.theme
  .enable()
  .then(() => {
