import { r as rr, c as Gr } from "./react-dom-vendor-BOEB6BZs.js";
import { g as Vr, r as F } from "./client-core-vendor-D3kwrIkk.js";
import { r as Kr } from "./lodash-vendor-DXG1mS21.js";
(function () {
...
var We;
function Jr() {
  return (We || ((We = 1), (Ee.exports = Hr())), Ee.exports);
}
var p = Jr(),
  S = rr(),
  Oe = {},
...
function Er(e) {
  ...
  var t = {};
  if (e != null) for (var o = Ge(e), i = 0; i < o.length; i++) o[i] !== "default" && be(t, e, o[i]);
  return (Wr(t, e), t);
}
function Or(e) {
...
function jr(e) {
  function t(n) {
    ((e.error = e.hasError ? new Xr(n, e.error, "An error was suppressed during disposal.") : n),
      (e.hasError = !0));
  }
  var o,
    i = 0;
...
function O() {
  if (Ye) return x;
  ((Ye = 1), Object.defineProperty(x, "__esModule", { value: !0 }), (x.BridgeAPIError = void 0));
...
function w() {
  if (Ze) return N;
  ((Ze = 1), Object.defineProperty(N, "__esModule", { value: !0 }), (N.getCallBridge = void 0));
  const e = O();
  function t(i) {
    return !!i?.callBridge;
  }
...
function me() {
  if (Qe) return z;
  ((Qe = 1), Object.defineProperty(z, "__esModule", { value: !0 }), (z.withRateLimiter = void 0));
  const e = O(),
    t = (o, i, s, n) => {
      let r = Date.now(),
        c = 0;
...
function en() {
  return (
    et ||
      ((et = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), j.__exportStar($r(), e));
      })(Se)),
    Se
  );
}
...
function tn() {
  if (rt) return G;
  ((rt = 1), Object.defineProperty(G, "__esModule", { value: !0 }), (G.invokeRemote = void 0));
  const e = Fr(),
...
function rn() {
  if (nt) return V;
  ((nt = 1), Object.defineProperty(V, "__esModule", { value: !0 }), (V.invokeService = void 0));
  const e = Fr(),
    t = (o) => (0, e._invokeEndpointFn)(e.InvokeType.SERVICE)(o);
  return ((V.invokeService = t), V);
}
var it;
function nn() {
  return (
...
function sn() {
  if (st) return H;
  ((st = 1), Object.defineProperty(H, "__esModule", { value: !0 }), (H.submit = void 0));
  const e = w(),
    t = O(),
    o = (0, e.getCallBridge)(),
    i = async (s) => {
...
function an() {
  if (at) return J;
  ((at = 1), Object.defineProperty(J, "__esModule", { value: !0 }), (J.close = void 0));
  const e = w(),
    t = O(),
    o = (0, e.getCallBridge)(),
    i = async (s) => {
...
function on() {
  if (ot) return W;
  ((ot = 1), Object.defineProperty(W, "__esModule", { value: !0 }), (W.open = void 0));
  const e = w(),
    t = O(),
    o = (0, e.getCallBridge)(),
    i = async () => {
...
function un() {
  if (ut) return X;
  ((ut = 1), Object.defineProperty(X, "__esModule", { value: !0 }), (X.refresh = void 0));
  const e = w(),
    t = O(),
    o = (0, e.getCallBridge)(),
    i = async (s) => {
  ...
  return ((X.refresh = i), X);
}
var Y = {},
  lt;
function ln() {
  if (lt) return Y;
  ((lt = 1), Object.defineProperty(Y, "__esModule", { value: !0 }), (Y.createHistory = void 0));
...
function dn() {
  if (_t) return Q;
  ((_t = 1), Object.defineProperty(Q, "__esModule", { value: !0 }), (Q.Translator = void 0));
  const e = Dr();
  class t {
    locale;
    translationsGetter;
  ...
  return ((Q.Translator = t), Q);
}
var $ = {},
  ht;
function fn() {
  if (ht) return $;
  ((ht = 1), Object.defineProperty($, "__esModule", { value: !0 }), ($.ensureLocale = void 0));
  const e = Ar(),
...
function vn() {
  if (yt) return Z;
  ((yt = 1), Object.defineProperty(Z, "__esModule", { value: !0 }), (Z.getContext = void 0));
  const e = w(),
    t = Tr(),
    o = (0, e.getCallBridge)(),
    i = async () => {
...
function Mr() {
  if (Pt) return K;
  ((Pt = 1), Object.defineProperty(K, "__esModule", { value: !0 }), (K.view = void 0));
  const e = sn(),
    t = an(),
    o = on(),
    i = un(),
...
function kn() {
  ...
  const t = F(),
    ...
    s = Bn(),
    n = Mn();
  let r = class Ve extends t.StatsigClientBase {
    static instance(u) {
...
var ve = Vn();
const Kn = "_container_16ann_1",
  Hn = "_header_16ann_9",
  Jn = "_controls_16ann_20",
  Wn = "_searchSection_16ann_28",
  Xn = "_searchInput_16ann_34",
  Yn = "_orgSelect_16ann_35",
  Zn = "_input_16ann_36",
  Qn = "_select_16ann_37",
  $n = "_addButton_16ann_63",
